...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;)V
    ...
    iput-object p1, p0, LX/0bw;->A02:Landroidx/appcompat/widget/Toolbar;
...
.method public AsU(LX/0dn;LX/0dp;)Z
    ...
    iget-object v4, p0, LX/0bw;->A02:Landroidx/appcompat/widget/Toolbar;
    ...
    iput-object v3, p0, LX/0bw;->A01:LX/0dp;

    invoke-virtual {v4}, Landroid/view/View;->requestLayout()V

    const/4 v1, 0x0

    iput-boolean v1, p2, LX/0dp;->A0N:Z

    iget-object v0, p2, LX/0dp;->A0E:LX/0dn;
...
.method public AwG(LX/0dn;LX/0dp;)Z
    ...
    :cond_1
    invoke-virtual {p2}, LX/0dp;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, v4, Landroidx/appcompat/widget/Toolbar;->A0G:Landroid/view/View;

    iput-object p2, p0, LX/0bw;->A01:LX/0dp;
    ...
    iput-boolean v2, p2, LX/0dp;->A0N:Z

    invoke-static {p2}, LX/0dn;->A00(LX/0dp;)V
...
.method public B9V(Landroid/content/Context;LX/0dn;)V
    ...
    iget-object v1, p0, LX/0bw;->A00:LX/0dn;

    if-eqz v1, :cond_0

    iget-object v0, p0, LX/0bw;->A01:LX/0dp;

    if-eqz v0, :cond_0

    invoke-virtual {v1, v0}, LX/0dn;->A0M(LX/0dp;)Z

    :cond_0
    iput-object p2, p0, LX/0bw;->A00:LX/0dn;
...
.method public Bjl(Z)V
    ...
    iget-object v4, p0, LX/0bw;->A01:LX/0dp;

    if-eqz v4, :cond_1

    iget-object v3, p0, LX/0bw;->A00:LX/0dn;

    if-eqz v3, :cond_0

    invoke-virtual {v3}, LX/0dn;->size()I
    ...
    invoke-virtual {v3, v1}, LX/0dn;->getItem(I)Landroid/view/MenuItem;
    ...
    :cond_0
    invoke-virtual {p0, v3, v4}, LX/0bw;->AsU(LX/0dn;LX/0dp;)Z
