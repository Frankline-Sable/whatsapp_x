...
# static fields
.field public static volatile A00:LX/0PR;
...
.method public static A01(Landroid/content/Context;LX/0Wk;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-virtual {p1}, LX/0Wk;->A02()Landroid/content/pm/ShortcutInfo;
    ...
    :cond_1
    invoke-virtual {p1, v0}, LX/0Wk;->A03(Landroid/content/Intent;)V

    return-object v0
.end method

.method public static A02(Landroid/content/Context;)LX/0PR;
    .locals 6

    sget-object v0, LX/0ZF;->A00:LX/0PR;
    ...
    invoke-static {v4, v0, v2, v1, v5}, LX/001;->A0o(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;I)Ljava/lang/reflect/Method;
    ...
    sput-object v0, LX/0ZF;->A00:LX/0PR;
    :try_end_0
...
.method public static A03(Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_1
    :try_start_0
    invoke-static {p0}, LX/0ZF;->A02(Landroid/content/Context;)LX/0PR;

    move-result-object v0

    invoke-virtual {v0}, LX/0PR;->A02()Ljava/util/List;
...
.method public static A04(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v0, LX/0ZF;->A01:Ljava/util/List;
    ...
    sput-object v6, LX/0ZF;->A01:Ljava/util/List;
...
.method public static A05(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, LX/0Wk;->A01(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, LX/0Wk;->A01(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
...
.method public static A06(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, LX/0PR;->A00()Ljava/lang/Object;

    invoke-static {p0}, LX/0ZF;->A04(Landroid/content/Context;)Ljava/util/List;
...
.method public static A07(Landroid/content/Context;LX/0Wk;)V
    .locals 3
    ...
    invoke-static {p0}, LX/0ZF;->A09(Landroid/content/Context;)Z
...
.method public static A08(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {p1}, LX/001;->A0s(Ljava/util/Collection;)Ljava/util/Iterator;
    ...
    iget-object v1, v4, LX/0Wk;->A09:Landroidx/core/graphics/drawable/IconCompat;
    ...
    iput-object v0, v4, LX/0Wk;->A09:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-virtual {v0}, LX/0Wk;->A02()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-virtual {v0, p1}, LX/0PR;->A01(Ljava/util/List;)Ljava/lang/Object;
...
.method public static A09(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v4}, LX/0ZE;->A05(Landroid/content/Context;Ljava/lang/String;)I
