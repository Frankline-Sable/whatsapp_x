...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0YV;->A02:Ljava/util/WeakHashMap;

    invoke-static {}, LX/002;->A0I()Ljava/lang/Object;

    move-result-object v0

    sput-object v0, LX/0YV;->A00:Ljava/lang/Object;
...
.method public static A00(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;I)I
    ...
    invoke-static {p0, p1, p2}, LX/0SA;->A00(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;I)I
...
.method public static A01(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v4, p0, p1}, LX/0Op;-><init>(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;)V

    sget-object v7, LX/0YV;->A00:Ljava/lang/Object;

    monitor-enter v7

    :try_start_0
    sget-object v3, LX/0YV;->A02:Ljava/util/WeakHashMap;
    ...
    iget-object v1, v5, LX/0M5;->A02:Landroid/content/res/Configuration;

    iget-object v0, v4, LX/0Op;->A01:Landroid/content/res/Resources;
    ...
    iget-object v2, v4, LX/0Op;->A00:Landroid/content/res/Resources$Theme;

    if-nez v2, :cond_0

    iget v0, v5, LX/0M5;->A00:I
    ...
    :cond_1
    iget-object v5, v5, LX/0M5;->A01:Landroid/content/res/ColorStateList;
    ...
    sget-object v0, LX/0YV;->A01:Ljava/lang/ThreadLocal;
    ...
    :goto_2
    :try_start_1
    invoke-static {p0, p1, v0}, LX/0W0;->A01(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v0, v5, v1, p0}, LX/0M5;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p0, p1, p2}, LX/0SA;->A01(Landroid/content/res/Resources$Theme;Landroid/content/res/Resources;I)Landroid/content/res/ColorStateList;
...
.method public static A03(Landroid/content/Context;Landroid/util/TypedValue;LX/0PS;IIZZ)Landroid/graphics/Typeface;
    .locals 31
    ...
    sget-object v21, LX/0WA;->A00:LX/0Rc;

    move/from16 v1, p4

    invoke-static {v0, v10, v2, v4, v1}, LX/0WA;->A00(Landroid/content/res/Resources;Ljava/lang/String;III)Ljava/lang/String;

    move-result-object v5

    move-object/from16 v4, v21

    invoke-virtual {v4, v5}, LX/0Rc;->A04(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v4, v3}, LX/0lN;-><init>(Landroid/graphics/Typeface;LX/0PS;)V
    ...
    invoke-static {v14}, LX/0YV;->A04(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {v11, v5}, LX/0I5;->A00(Landroid/content/res/TypedArray;I)I
    ...
    :goto_8
    new-instance v9, LX/0OB;

    move-object/from16 v5, v20

    move-object/from16 v4, v19

    invoke-direct {v9, v5, v4, v15, v12}, LX/0OB;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {v8, v9, v6, v5, v4}, LX/0MT;-><init>(LX/0OB;Ljava/lang/String;II)V
    ...
    invoke-direct/range {v24 .. v30}, LX/0My;-><init>(Ljava/lang/String;Ljava/lang/String;IIIZ)V
    ...
    invoke-direct {v8, v4}, LX/0Ki;-><init>([LX/0My;)V
    ...
    invoke-virtual {v3, v0}, LX/0PS;->A00(I)V
    ...
    instance-of v4, v8, LX/0MT;

    if-eqz v4, :cond_24

    check-cast v8, LX/0MT;

    iget-object v7, v8, LX/0MT;->A03:Ljava/lang/String;
    ...
    invoke-direct {v4, v3}, LX/0TX;-><init>(LX/0PS;)V

    iget-object v7, v8, LX/0MT;->A02:LX/0OB;

    new-instance v8, LX/0NZ;

    invoke-direct {v8, v5, v4}, LX/0NZ;-><init>(Landroid/os/Handler;LX/0TX;)V
    ...
    iget-object v4, v7, LX/0OB;->A00:Ljava/lang/String;

    invoke-virtual {v5, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v4, "-"

    invoke-static {v4, v5, v1}, LX/000;->A0X(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/String;

    move-result-object v9

    sget-object v4, LX/0WK;->A00:LX/0Rc;

    invoke-virtual {v4, v9}, LX/0Rc;->A04(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v7, v9, v1}, LX/0WK;->A00(Landroid/content/Context;LX/0OB;Ljava/lang/String;I)LX/0Td;

    move-result-object v4

    invoke-virtual {v8, v4}, LX/0NZ;->A00(LX/0Td;)V

    iget-object v4, v4, LX/0Td;->A01:Landroid/graphics/Typeface;
    ...
    invoke-direct/range {v12 .. v17}, LX/0xa;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;II)V
    :try_end_3
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3 .. :try_end_3} :catch_4
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_5

    :try_start_4
    sget-object v4, LX/0WK;->A03:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {v4, v5}, LX/0Td;-><init>(I)V
    ...
    invoke-direct {v11, v8, v4}, LX/0xh;-><init>(Ljava/lang/Object;I)V

    sget-object v9, LX/0WK;->A02:Ljava/lang/Object;
    ...
    :try_start_9
    sget-object v8, LX/0WK;->A01:LX/0Xm;

    invoke-virtual {v8, v5}, LX/0Xm;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v5, v4}, LX/0Xm;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct/range {v11 .. v16}, LX/0xa;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;II)V

    sget-object v8, LX/0WK;->A03:Ljava/util/concurrent/ExecutorService;

    new-instance v7, LX/0dz;

    invoke-direct {v7, v5}, LX/0dz;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v5, v7, v9}, LX/0mx;-><init>(Landroid/os/Handler;LX/0t9;Ljava/util/concurrent/Callable;)V
    ...
    invoke-direct {v5, v4}, LX/0Td;-><init>(Landroid/graphics/Typeface;)V

    invoke-virtual {v8, v5}, LX/0NZ;->A00(LX/0Td;)V

    goto :goto_15

    :cond_24
    sget-object v5, LX/0WA;->A01:LX/0Qf;

    check-cast v8, LX/0Ki;

    move-object/from16 v4, p0

    invoke-virtual {v5, v4, v0, v8, v1}, LX/0Qf;->A01(Landroid/content/Context;Landroid/content/res/Resources;LX/0Ki;I)Landroid/graphics/Typeface;
    ...
    invoke-direct {v5, v4, v3}, LX/0lN;-><init>(Landroid/graphics/Typeface;LX/0PS;)V

    invoke-virtual {v7, v5}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :goto_17
    invoke-static {v0, v10, v2, v6, v1}, LX/0WA;->A00(Landroid/content/res/Resources;Ljava/lang/String;III)Ljava/lang/String;
    ...
    sget-object v7, LX/0WA;->A01:LX/0Qf;
    ...
    invoke-virtual/range {v7 .. v12}, LX/0Qf;->A02(Landroid/content/Context;Landroid/content/res/Resources;Ljava/lang/String;II)Landroid/graphics/Typeface;

    move-result-object v4

    if-eqz v4, :cond_27

    invoke-static {v0, v10, v2, v5, v1}, LX/0WA;->A00(Landroid/content/res/Resources;Ljava/lang/String;III)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v2}, LX/000;->A1C(Ljava/lang/String;Ljava/lang/StringBuilder;I)V

    const-string v0, ") is not a Font: "

    invoke-static {v7, v0, v3}, LX/000;->A0N(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
