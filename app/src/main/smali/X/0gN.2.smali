...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0gN;->A04:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;LX/0YL;)V
    ...
    invoke-direct {v0, p1}, LX/0WX;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/0gN;->A01:Landroid/content/Context;

    iput-object p2, p0, LX/0gN;->A02:LX/0YL;

    iput-object v1, p0, LX/0gN;->A00:Landroid/app/job/JobScheduler;

    iput-object v0, p0, LX/0gN;->A03:LX/0WX;
...
.method public static A00(Landroid/app/job/JobScheduler;Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v1, LX/0gN;->A04:Ljava/lang/String;
...
.method public static A01(Landroid/app/job/JobScheduler;Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, LX/0gN;->A00(Landroid/app/job/JobScheduler;Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-direct {v0, v1, v2}, LX/0Pu;-><init>(Ljava/lang/String;I)V
    ...
    iget-object v0, v0, LX/0Pu;->A01:Ljava/lang/String;
...
.method public static A02(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v3, LX/0gN;->A04:Ljava/lang/String;
...
.method public static A03(Landroid/content/Context;)V
    ...
    invoke-static {v2, p0}, LX/0gN;->A00(Landroid/app/job/JobScheduler;Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v2, v0}, LX/0gN;->A02(Landroid/app/job/JobScheduler;I)V
...
.method public static A04(Landroid/content/Context;LX/0YL;)Z
    .locals 9
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {v8, p0}, LX/0gN;->A00(Landroid/app/job/JobScheduler;Landroid/content/Context;)Ljava/util/List;

    move-result-object v7

    iget-object v5, p1, LX/0YL;->A04:Landroidx/work/impl/WorkDatabase;
    ...
    iget-object v0, v1, LX/0gU;->A01:LX/0Rk;

    invoke-virtual {v0}, LX/0Rk;->A09()V

    const/4 v2, 0x0

    invoke-static {v0, v4, v6}, LX/0J2;->A00(LX/0Rk;LX/0uz;Z)Landroid/database/Cursor;
    ...
    invoke-static {v8, v0}, LX/0gN;->A02(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-interface {v4, v2, v0, v1}, LX/0vf;->BDs(Ljava/lang/String;J)I
...
.method public A05(LX/0Xi;I)V
    ...
    iget-object v0, p0, LX/0gN;->A03:LX/0WX;

    invoke-virtual {v0, p1, p2}, LX/0WX;->A01(LX/0Xi;I)Landroid/app/job/JobInfo;
    ...
    sget-object v4, LX/0gN;->A04:Ljava/lang/String;
    ...
    iget-object v2, p1, LX/0Xi;->A0J:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v0}, LX/0Xh;->A04(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, LX/0gN;->A00:Landroid/app/job/JobScheduler;
    ...
    iget-object v1, p1, LX/0Xi;->A0D:LX/0Fg;

    sget-object v0, LX/0Fg;->A02:LX/0Fg;

    if-ne v1, v0, :cond_0

    iput-boolean v7, p1, LX/0Xi;->A0H:Z
    ...
    invoke-virtual {v0, v4, v1}, LX/0Xh;->A04(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, LX/0gN;->A05(LX/0Xi;I)V
    ...
    iget-object v1, p0, LX/0gN;->A01:Landroid/content/Context;

    iget-object v0, p0, LX/0gN;->A00:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, LX/0gN;->A00(Landroid/app/job/JobScheduler;Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v2, v1, v7}, LX/000;->A1P([Ljava/lang/Object;II)V

    iget-object v1, p0, LX/0gN;->A02:LX/0YL;
    ...
    iget-object v0, v1, LX/0YL;->A02:LX/0OP;
...
.method public Ary(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/0gN;->A01:Landroid/content/Context;

    iget-object v2, p0, LX/0gN;->A00:Landroid/app/job/JobScheduler;

    invoke-static {v2, v0, p1}, LX/0gN;->A01(Landroid/app/job/JobScheduler;Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, LX/0gN;->A02:LX/0YL;
    ...
    iget-object v3, v0, LX/0gU;->A01:LX/0Rk;

    invoke-virtual {v3}, LX/0Rk;->A09()V

    iget-object v2, v0, LX/0gU;->A03:LX/0Qo;
...
.method public varargs Bcr([LX/0Xi;)V
    ...
    iget-object v8, p0, LX/0gN;->A02:LX/0YL;

    iget-object v7, v8, LX/0YL;->A04:Landroidx/work/impl/WorkDatabase;

    new-instance v6, LX/0Oh;

    invoke-direct {v6, v7}, LX/0Oh;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    :try_start_0
    invoke-virtual {v7}, Landroidx/work/impl/WorkDatabase;->A0J()LX/0vf;

    move-result-object v0

    iget-object v9, v10, LX/0Xi;->A0J:Ljava/lang/String;

    invoke-interface {v0, v9}, LX/0vf;->B7x(Ljava/lang/String;)LX/0Xi;
    ...
    sget-object v2, LX/0gN;->A04:Ljava/lang/String;
    ...
    invoke-interface {v0, v12}, LX/0v8;->B6r(LX/0Pu;)LX/0Q6;

    move-result-object v0

    if-eqz v0, :cond_5

    iget v11, v0, LX/0Q6;->A01:I

    :goto_2
    invoke-virtual {p0, v10, v11}, LX/0gN;->A05(LX/0Xi;I)V
    ...
    invoke-static {v0, v1, v9}, LX/0gN;->A01(Landroid/app/job/JobScheduler;Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_3
    invoke-virtual {p0, v10, v0}, LX/0gN;->A05(LX/0Xi;I)V

    goto :goto_1

    :cond_4
    iget-object v0, v8, LX/0YL;->A02:LX/0OP;

    iget v1, v0, LX/0OP;->A02:I

    iget v0, v0, LX/0OP;->A01:I

    invoke-virtual {v6, v1, v0}, LX/0Oh;->A01(II)I
    ...
    iget-object v2, v12, LX/0Pu;->A01:Ljava/lang/String;

    iget v0, v12, LX/0Pu;->A00:I

    new-instance v1, LX/0Q6;

    invoke-direct {v1, v2, v0, v11}, LX/0Q6;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v7}, Landroidx/work/impl/WorkDatabase;->A0G()LX/0v8;

    move-result-object v0

    invoke-interface {v0, v1}, LX/0v8;->BA3(LX/0Q6;)V
