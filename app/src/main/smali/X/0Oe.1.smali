...
# direct methods
.method public constructor <init>(LX/0PQ;LX/03u;Ljava/util/concurrent/Executor;)V
    .locals 3
    ...
    invoke-static {p2}, LX/00M;->A01(LX/03u;)LX/0eU;

    move-result-object v2

    new-instance v1, LX/0Y5;

    invoke-direct {v1, p2}, LX/0Y5;-><init>(LX/0tQ;)V
    ...
    iput-object v2, p0, LX/0Oe;->A00:LX/0eU;

    if-eqz v0, :cond_0

    iput-object p3, v0, LX/08X;->A0H:Ljava/util/concurrent/Executor;

    iput-object p1, v0, LX/08X;->A04:LX/0PQ;
...
.method public A00()V
    ...
    iget-object v1, p0, LX/0Oe;->A00:LX/0eU;
...
.method public A01(LX/0Mv;)V
    .locals 4

    if-eqz p1, :cond_3

    iget-object v3, p0, LX/0Oe;->A00:LX/0eU;
    ...
    :cond_0
    invoke-virtual {v3}, LX/0eU;->A0t()Z
    ...
    invoke-virtual {v3}, LX/0eU;->A0K()V

    :cond_2
    invoke-virtual {v2, p1}, Landroidx/biometric/BiometricFragment;->A1R(LX/0Mv;)V
