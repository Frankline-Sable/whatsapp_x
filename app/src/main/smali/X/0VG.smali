...
.method public constructor <init>(LX/0Pe;)V
    ...
    iput-object p1, p0, LX/0VG;->A00:LX/0Pe;

    return-void
.end method

.method public static final A00(Landroidx/window/extensions/embedding/SplitInfo;)LX/0Q5;
    .locals 5
    ...
    invoke-direct {v3, v0, v1}, LX/0Qk;-><init>(Ljava/util/List;Z)V
    ...
    invoke-direct {v2, v0, v4}, LX/0Qk;-><init>(Ljava/util/List;Z)V
    ...
    invoke-direct {v0, v3, v2, v1}, LX/0Q5;-><init>(LX/0Qk;LX/0Qk;F)V
...
# virtual methods
.method public final A01(LX/0Aj;Ljava/lang/Class;)Landroidx/window/extensions/embedding/ActivityRule;
    .locals 6
    ...
    iget-object v1, p1, LX/0Aj;->A00:Ljava/util/Set;

    invoke-virtual {p0, v1}, LX/0VG;->A07(Ljava/util/Set;)Ljava/lang/Object;

    move-result-object v0

    aput-object v0, v2, v5

    invoke-virtual {p0, v1}, LX/0VG;->A08(Ljava/util/Set;)Ljava/lang/Object;
...
.method public final A02(LX/0Ak;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPairRule;
    .locals 7
    ...
    iget-object v1, p1, LX/0Ak;->A00:Ljava/util/Set;

    invoke-virtual {p0, v1}, LX/0VG;->A06(Ljava/util/Set;)Ljava/lang/Object;

    move-result-object v0

    aput-object v0, v4, v3

    invoke-virtual {p0, v1}, LX/0VG;->A05(Ljava/util/Set;)Ljava/lang/Object;

    move-result-object v0

    aput-object v0, v4, v2

    invoke-virtual {p0, p1}, LX/0VG;->A04(LX/0Am;)Ljava/lang/Object;
    ...
    iget-boolean v0, p1, LX/0Ak;->A01:Z
...
.method public final A03(LX/0Al;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPlaceholderRule;
    .locals 8
    ...
    iget-object v0, p1, LX/0Al;->A00:Landroid/content/Intent;

    aput-object v0, v2, v5

    iget-object v1, p1, LX/0Al;->A01:Ljava/util/Set;
...
.method public final A04(LX/0Am;)Ljava/lang/Object;
    .locals 3

    iget-object v2, p0, LX/0VG;->A00:LX/0Pe;
    ...
    invoke-direct {v0, p1}, LX/0qK;-><init>(LX/0Am;)V

    invoke-virtual {v2, v0, v1}, LX/0Pe;->A01(LX/8cV;LX/8cl;)Ljava/lang/Object;
...
.method public final A05(Ljava/util/Set;)Ljava/lang/Object;
    ...
    iget-object v3, p0, LX/0VG;->A00:LX/0Pe;
    ...
    invoke-direct {v0, p1}, LX/0qk;-><init>(Ljava/util/Set;)V

    invoke-virtual {v3, v0, v2, v1}, LX/0Pe;->A02(LX/8cW;LX/8cl;LX/8cl;)Ljava/lang/Object;
...
.method public final A06(Ljava/util/Set;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, LX/0ql;-><init>(Ljava/util/Set;)V
...
.method public final A08(Ljava/util/Set;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, LX/0qJ;-><init>(Ljava/util/Set;)V
...
.method public final A09(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1, v0}, LX/3je;->A0S(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v0}, LX/0VG;->A00(Landroidx/window/extensions/embedding/SplitInfo;)LX/0Q5;
...
.method public final A0A(Ljava/util/Set;)Ljava/util/Set;
    ...
    iget-object v0, p0, LX/0VG;->A00:LX/0Pe;

    :try_start_0
    invoke-virtual {v0}, LX/0Pe;->A00()Ljava/lang/Class;
    ...
    invoke-virtual {p0, v1, v4}, LX/0VG;->A02(LX/0Ak;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPairRule;
    ...
    invoke-virtual {p0, v1, v4}, LX/0VG;->A03(LX/0Al;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPlaceholderRule;
    ...
    invoke-virtual {p0, v1, v4}, LX/0VG;->A01(LX/0Aj;Ljava/lang/Class;)Landroidx/window/extensions/embedding/ActivityRule;
