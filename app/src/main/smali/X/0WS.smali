...
.method public static final A00(Landroid/content/Context;Ljava/util/List;)LX/0vG;
    .locals 8
    ...
    invoke-interface {v1}, LX/0vG;->isAvailableOnDevice()Z
...
# virtual methods
.method public final A02(Landroid/content/Context;)LX/0vG;
    .locals 2
    ...
    invoke-direct {v0, p1}, LX/0eO;-><init>(Landroid/content/Context;)V

    return-object v0

    :cond_0
    invoke-static {p1}, LX/0WS;->A01(Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {p1, v1}, LX/0WS;->A00(Landroid/content/Context;Ljava/util/List;)LX/0vG;
