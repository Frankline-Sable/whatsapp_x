...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput v0, p0, LX/0X5;->A01:I

    const/4 v0, -0x1

    iput v0, p0, LX/0X5;->A00:I

    iput-object p1, p0, LX/0X5;->A0B:Landroid/widget/TextView;

    new-instance v0, LX/0YG;

    invoke-direct {v0, p1}, LX/0YG;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, LX/0X5;->A0C:LX/0YG;

    return-void
.end method

.method public static A00(Landroid/content/Context;Landroid/content/res/TypedArray;LX/0Y3;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    :try_start_0
    iget-object v0, p2, LX/0Y3;->A00:LX/0YF;

    invoke-virtual {v0, p0, v1}, LX/0YF;->A06(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static A01(Landroid/content/Context;LX/0Y3;I)LX/0MO;
    .locals 2

    monitor-enter p1

    :try_start_0
    iget-object v0, p1, LX/0Y3;->A00:LX/0YF;

    invoke-virtual {v0, p0, p2}, LX/0YF;->A05(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object p0, v1, LX/0MO;->A00:Landroid/content/res/ColorStateList;
...
.method public A03()V
    ...
    iget-object v0, p0, LX/0X5;->A05:LX/0MO;
    ...
    iget-object v0, p0, LX/0X5;->A09:LX/0MO;

    if-nez v0, :cond_0

    iget-object v0, p0, LX/0X5;->A06:LX/0MO;

    if-nez v0, :cond_0

    iget-object v0, p0, LX/0X5;->A03:LX/0MO;

    if-eqz v0, :cond_1

    :cond_0
    iget-object v0, p0, LX/0X5;->A0B:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v1, v0}, LX/0X5;->A0A(Landroid/graphics/drawable/Drawable;LX/0MO;)V
    ...
    :cond_1
    iget-object v0, p0, LX/0X5;->A07:LX/0MO;

    if-nez v0, :cond_2

    iget-object v0, p0, LX/0X5;->A04:LX/0MO;
...
.method public A04(I)V
    ...
    iget-object v4, p0, LX/0X5;->A0C:LX/0YG;

    iget-object v0, v4, LX/0YG;->A09:Landroid/widget/TextView;
    ...
    iget-object v0, v4, LX/0YG;->A08:Landroid/content/Context;
    ...
    invoke-virtual {v4, v2, v1, v0}, LX/0YG;->A05(FFF)V

    invoke-virtual {v4}, LX/0YG;->A07()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v4}, LX/0YG;->A04()V
    ...
    iput v1, v4, LX/0YG;->A03:I

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, v4, LX/0YG;->A01:F

    iput v0, v4, LX/0YG;->A00:F

    iput v0, v4, LX/0YG;->A02:F

    new-array v0, v1, [I

    iput-object v0, v4, LX/0YG;->A07:[I

    iput-boolean v1, v4, LX/0YG;->A06:Z
...
.method public A06(Landroid/content/Context;I)V
    ...
    invoke-direct {v5, p1, v0}, LX/0Uw;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {v5, v1}, LX/0Uw;->A01(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, LX/0X5;->A0B:Landroid/widget/TextView;
    ...
    :cond_4
    invoke-virtual {p0, p1, v5}, LX/0X5;->A07(Landroid/content/Context;LX/0Uw;)V
    ...
    iget-object v2, p0, LX/0X5;->A02:Landroid/graphics/Typeface;
...
.method public final A07(Landroid/content/Context;LX/0Uw;)V
    .locals 15

    iget v2, p0, LX/0X5;->A01:I

    const/4 v0, 0x2

    move-object/from16 v8, p2

    iget-object v1, v8, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    iput-boolean v14, p0, LX/0X5;->A0A:Z
    ...
    :goto_0
    iput-object v0, p0, LX/0X5;->A02:Landroid/graphics/Typeface;
    ...
    :cond_5
    iget v9, p0, LX/0X5;->A00:I

    iget v7, p0, LX/0X5;->A01:I
    ...
    iget-object v6, p0, LX/0X5;->A0B:Landroid/widget/TextView;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, v6}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    new-instance v10, LX/05u;

    invoke-direct {v10, p0, v0, v9, v7}, LX/05u;-><init>(LX/0X5;Ljava/lang/ref/WeakReference;II)V

    :try_start_0
    iget v12, p0, LX/0X5;->A01:I
    ...
    iget-object v9, v8, LX/0Uw;->A00:Landroid/util/TypedValue;
    ...
    iput-object v9, v8, LX/0Uw;->A00:Landroid/util/TypedValue;

    :cond_6
    iget-object v8, v8, LX/0Uw;->A01:Landroid/content/Context;
    ...
    invoke-static/range {v8 .. v14}, LX/0YV;->A03(Landroid/content/Context;Landroid/util/TypedValue;LX/0PS;IIZZ)Landroid/graphics/Typeface;
    ...
    :cond_7
    iput-object v6, p0, LX/0X5;->A02:Landroid/graphics/Typeface;

    :cond_8
    iget-object v0, p0, LX/0X5;->A02:Landroid/graphics/Typeface;
    :try_end_1
    ...
    :try_start_2
    iput-boolean v0, p0, LX/0X5;->A0A:Z
    :try_end_2
...
.method public A08(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, p0, LX/0X5;->A08:LX/0MO;
    ...
    iput-object v1, p0, LX/0X5;->A08:LX/0MO;
    ...
    iput-object v1, p0, LX/0X5;->A05:LX/0MO;

    iput-object v1, p0, LX/0X5;->A09:LX/0MO;

    iput-object v1, p0, LX/0X5;->A06:LX/0MO;

    iput-object v1, p0, LX/0X5;->A03:LX/0MO;

    iput-object v1, p0, LX/0X5;->A07:LX/0MO;

    iput-object v1, p0, LX/0X5;->A04:LX/0MO;
...
.method public final A0A(Landroid/graphics/drawable/Drawable;LX/0MO;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, LX/0YF;->A04(Landroid/graphics/drawable/Drawable;LX/0MO;[I)V
...
.method public A0B(Landroid/util/AttributeSet;I)V
    ...
    iget-object v11, v12, LX/0X5;->A0B:Landroid/widget/TextView;
    ...
    invoke-static {v10, v1, v3, v0, v13}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;
    ...
    iget-object v2, v0, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-static/range {v18 .. v23}, LX/0ZR;->A0B(Landroid/content/Context;Landroid/content/res/TypedArray;Landroid/util/AttributeSet;Landroid/view/View;[II)V
    ...
    invoke-static {v10, v9, v0}, LX/0X5;->A01(Landroid/content/Context;LX/0Y3;I)LX/0MO;

    move-result-object v0

    iput-object v0, v12, LX/0X5;->A05:LX/0MO;
    ...
    iput-object v0, v12, LX/0X5;->A09:LX/0MO;
    ...
    iput-object v0, v12, LX/0X5;->A06:LX/0MO;
    ...
    iput-object v0, v12, LX/0X5;->A03:LX/0MO;
    ...
    iput-object v0, v12, LX/0X5;->A07:LX/0MO;
    ...
    iput-object v0, v12, LX/0X5;->A04:LX/0MO;
    ...
    invoke-direct {v3, v10, v0}, LX/0Uw;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    :goto_0
    invoke-virtual {v12, v10, v3}, LX/0X5;->A07(Landroid/content/Context;LX/0Uw;)V

    if-ge v7, v4, :cond_3c

    const/4 v1, 0x3

    iget-object v4, v3, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-static {v10, v15, v0, v1, v13}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;
    ...
    iget-object v15, v1, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v1, v13}, LX/0Uw;->A01(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v13, v1, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    :cond_b
    invoke-virtual {v12, v10, v1}, LX/0X5;->A07(Landroid/content/Context;LX/0Uw;)V
    ...
    :cond_f
    iget-object v4, v12, LX/0X5;->A02:Landroid/graphics/Typeface;

    if-eqz v4, :cond_10

    iget v1, v12, LX/0X5;->A00:I

    const/4 v0, -0x1

    if-ne v1, v0, :cond_36

    iget v0, v12, LX/0X5;->A01:I
    ...
    :cond_12
    :goto_9
    iget-object v4, v12, LX/0X5;->A0C:LX/0YG;

    iget-object v0, v4, LX/0YG;->A08:Landroid/content/Context;

    move-object/from16 v19, v0

    sget-object v3, LX/0Ka;->A08:[I
    ...
    invoke-static/range {v13 .. v18}, LX/0ZR;->A0B(Landroid/content/Context;Landroid/content/res/TypedArray;Landroid/util/AttributeSet;Landroid/view/View;[II)V
    ...
    invoke-static {v13}, LX/0YG;->A02([I)[I

    move-result-object v0

    iput-object v0, v4, LX/0YG;->A07:[I

    invoke-virtual {v4}, LX/0YG;->A08()Z
    ...
    iget v1, v4, LX/0YG;->A03:I

    const/4 v0, 0x1

    if-ne v1, v0, :cond_1b

    iget-boolean v0, v4, LX/0YG;->A05:Z

    if-nez v0, :cond_1a

    invoke-static/range {v19 .. v19}, LX/000;->A09(Landroid/content/Context;)Landroid/util/DisplayMetrics;
    ...
    :cond_19
    invoke-virtual {v4, v7, v5, v6}, LX/0YG;->A05(FFF)V
    ...
    iget v0, v4, LX/0YG;->A03:I

    if-eqz v0, :cond_1c

    iget-object v1, v4, LX/0YG;->A07:[I
    ...
    iget v0, v4, LX/0YG;->A01:F

    invoke-static {v0}, Ljava/lang/Math;->round(F)I

    move-result v2

    iget v0, v4, LX/0YG;->A00:F

    invoke-static {v0}, Ljava/lang/Math;->round(F)I

    move-result v1

    iget v0, v4, LX/0YG;->A02:F
    ...
    invoke-direct {v6, v10, v0}, LX/0Uw;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/16 v0, 0x8

    const/4 v5, -0x1

    iget-object v4, v6, LX/0Uw;->A02:Landroid/content/res/TypedArray;

    invoke-static {v10, v4, v9, v0}, LX/0X5;->A00(Landroid/content/Context;Landroid/content/res/TypedArray;LX/0Y3;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v6, v1}, LX/0Uw;->A01(I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-static {v0, v11}, LX/0Ys;->A01(Landroid/content/res/ColorStateList;Landroid/widget/TextView;)V
    ...
    invoke-static {v0, v11}, LX/0Ys;->A02(Landroid/graphics/PorterDuff$Mode;Landroid/widget/TextView;)V
    ...
    invoke-static {v11, v3}, LX/0Ys;->A04(Landroid/widget/TextView;I)V

    :cond_25
    if-eq v1, v5, :cond_26

    invoke-static {v11, v1}, LX/0Ys;->A05(Landroid/widget/TextView;I)V

    :cond_26
    if-eq v2, v5, :cond_27

    invoke-static {v2}, LX/0SH;->A00(I)V
...
.method public A0C([II)V
    ...
    iget-object v5, p0, LX/0X5;->A0C:LX/0YG;

    iget-object v0, v5, LX/0YG;->A09:Landroid/widget/TextView;
    ...
    :cond_0
    invoke-static {v2}, LX/0YG;->A02([I)[I

    move-result-object v0

    iput-object v0, v5, LX/0YG;->A07:[I

    invoke-virtual {v5}, LX/0YG;->A08()Z
    ...
    :cond_1
    iget-object v0, v5, LX/0YG;->A08:Landroid/content/Context;
    ...
    :cond_2
    iput-boolean v3, v5, LX/0YG;->A05:Z

    :cond_3
    invoke-virtual {v5}, LX/0YG;->A07()Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {v5}, LX/0YG;->A04()V
