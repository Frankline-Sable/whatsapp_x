...
.method public static final A00(Landroid/content/Context;LX/0Ow;Z)LX/0Ow;
    .locals 11
    ...
    invoke-static {p0}, LX/0ZH;->A04(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v8}, LX/0ZH;->A03(Ljava/nio/channels/FileChannel;)LX/0Ow;
    ...
    :try_start_4
    invoke-static {v3, v8}, LX/0ZH;->A09(Ljava/lang/Throwable;Ljava/nio/channels/FileChannel;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :try_start_5
    invoke-static {v6, v3}, LX/0ZH;->A08(Ljava/io/RandomAccessFile;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v7, v4, v5}, LX/000;->A1A(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :try_start_a
    invoke-static {v1, v8}, LX/0ZH;->A09(Ljava/lang/Throwable;Ljava/nio/channels/FileChannel;)V
    ...
    :try_start_c
    invoke-static {v6, v1}, LX/0ZH;->A08(Ljava/io/RandomAccessFile;Ljava/lang/Throwable;)V
...
.method public static A01(Landroid/content/SharedPreferences;)LX/0Ow;
    .locals 5

    const-string v0, "cre"

    invoke-static {v0}, LX/0Wd;->A00(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v0}, LX/0ZH;->A05(Ljava/lang/String;)Ljava/security/PublicKey;

    move-result-object v0

    invoke-static {v0}, LX/0Wx;->A01(Ljava/security/PublicKey;)Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v1, v2}, LX/0Ow;-><init>(Ljava/lang/String;J)V

    return-object v0
.end method

.method public static final A02(Ljava/io/File;)LX/0Ow;
    .locals 8
    ...
    invoke-static {v3}, LX/0ZH;->A03(Ljava/nio/channels/FileChannel;)LX/0Ow;
    ...
    :try_start_2
    invoke-static {v0, v3}, LX/0ZH;->A09(Ljava/lang/Throwable;Ljava/nio/channels/FileChannel;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    invoke-static {v2, v0}, LX/0ZH;->A07(Ljava/io/FileInputStream;Ljava/lang/Throwable;)V
    ...
    :try_start_4
    invoke-static {v1, v3}, LX/0ZH;->A09(Ljava/lang/Throwable;Ljava/nio/channels/FileChannel;)V
    ...
    invoke-static {v2, v1}, LX/0ZH;->A07(Ljava/io/FileInputStream;Ljava/lang/Throwable;)V

    throw v0
.end method

.method public static A03(Ljava/nio/channels/FileChannel;)LX/0Ow;
    .locals 5
    ...
    invoke-direct {v0, v1}, LX/0Gr;-><init>(Ljava/lang/Exception;)V
...
.method public static A04(Landroid/content/Context;)Ljava/io/File;
    ...
    :goto_0
    invoke-static {p0}, LX/0S4;->A01(Landroid/content/Context;)Ljava/io/File;
...
.method public static A05(Ljava/lang/String;)Ljava/security/PublicKey;
    ...
    invoke-direct {v0, p0}, LX/0Gr;-><init>(Ljava/lang/Exception;)V
...
.method public static final A06(Landroid/content/Context;LX/0Ow;)V
    .locals 3
    ...
    :try_start_0
    invoke-static {v2}, LX/0ZH;->A01(Landroid/content/SharedPreferences;)LX/0Ow;
    ...
    return-void
    :try_end_0
    .catch LX/0Gr; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v0, p1, LX/0Ow;->A01:Ljava/lang/String;
...
.method public static synthetic A07(Ljava/io/FileInputStream;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0}, LX/7RG;->A00(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static synthetic A09(Ljava/lang/Throwable;Ljava/nio/channels/FileChannel;)V
    ...
    invoke-static {p0, v0}, LX/7RG;->A00(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
# virtual methods
.method public final A0A(Landroid/content/Context;)LX/0Ow;
    .locals 5
    ...
    invoke-direct {v4, v2, v0, v1}, LX/0Ow;-><init>(Ljava/lang/String;J)V

    const/4 v0, 0x1

    invoke-static {p1, v4, v0}, LX/0ZH;->A00(Landroid/content/Context;LX/0Ow;Z)LX/0Ow;
    ...
    :cond_2
    invoke-static {p1, v4}, LX/0ZH;->A06(Landroid/content/Context;LX/0Ow;)V
