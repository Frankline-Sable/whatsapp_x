...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Landroidx/appcompat/widget/AppCompatSpinner;I)V
    ...
    iput-object p3, p0, LX/04j;->A04:Landroidx/appcompat/widget/AppCompatSpinner;

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, p4, v0}, LX/0c0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    invoke-static {}, LX/002;->A08()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, LX/04j;->A03:Landroid/graphics/Rect;

    iput-object p3, p0, LX/0c0;->A07:Landroid/view/View;

    const/4 v1, 0x1

    iput-boolean v1, p0, LX/0c0;->A0G:Z
    ...
    invoke-direct {v0, p0, v1, p3}, LX/0xV;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v0, p0, LX/0c0;->A08:Landroid/widget/AdapterView$OnItemClickListener;

    return-void
.end method

.method public static synthetic A00(LX/04j;)V
    .locals 0

    invoke-super {p0}, LX/0c0;->Bgi()V
...
.method public A03()V
    ...
    iget-object v2, p0, LX/0c0;->A0B:Landroid/widget/PopupWindow;

    invoke-virtual {v2}, Landroid/widget/PopupWindow;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iget-object v5, p0, LX/04j;->A04:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    invoke-static {v5}, LX/0Z2;->A01(Landroid/view/View;)I
    ...
    iget-object v1, p0, LX/04j;->A01:Landroid/widget/ListAdapter;
    ...
    invoke-static {v0, v4, v2}, LX/001;->A0C(III)I

    move-result v0

    :goto_1
    invoke-virtual {p0, v0}, LX/0c0;->A02(I)V
    ...
    :cond_3
    invoke-virtual {p0, v1}, LX/0c0;->A02(I)V
...
.method public B1X()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, LX/04j;->A02:Ljava/lang/CharSequence;
...
.method public Bdj(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, LX/0c0;->Bdj(Landroid/widget/ListAdapter;)V

    iput-object p1, p0, LX/04j;->A01:Landroid/widget/ListAdapter;
...
.method public BfD(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, LX/04j;->A02:Ljava/lang/CharSequence;
...
.method public Bgj(II)V
    ...
    iget-object v4, p0, LX/0c0;->A0B:Landroid/widget/PopupWindow;

    invoke-virtual {v4}, Landroid/widget/PopupWindow;->isShowing()Z

    move-result v5

    invoke-virtual {p0}, LX/04j;->A03()V
    ...
    iget-object v3, p0, LX/04j;->A04:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    invoke-direct {v0, v1, p0}, LX/0bd;-><init>(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;LX/04j;)V
