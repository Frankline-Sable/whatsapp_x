...
.method public constructor <init>(LX/0eU;I)V
    ...
    iput-object v1, p0, LX/0Ab;->A00:LX/0eR;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/0Ab;->A03:Ljava/util/ArrayList;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/0Ab;->A02:Ljava/util/ArrayList;

    iput-object v1, p0, LX/0Ab;->A01:LX/0f4;

    iput-object p1, p0, LX/0Ab;->A06:LX/0eU;

    iput p2, p0, LX/0Ab;->A05:I
...
.method public A03()Landroid/os/Parcelable;
    ...
    iget-object v2, p0, LX/0Ab;->A03:Ljava/util/ArrayList;
    ...
    :goto_1
    iget-object v1, p0, LX/0Ab;->A02:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, LX/0Ab;->A06:LX/0eU;

    invoke-virtual {v0, v4, v2, v1}, LX/0eU;->A0U(Landroid/os/Bundle;LX/0f4;Ljava/lang/String;)V
...
.method public A08(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    iget-object v4, p0, LX/0Ab;->A02:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, p1, v5}, LX/0eU;->A0C(Landroid/os/Bundle;Ljava/lang/String;)LX/0f4;
    ...
    :cond_3
    invoke-virtual {v1, v3}, LX/0f4;->A14(Z)V
...
.method public A09(Landroid/view/ViewGroup;)V
    ...
    iget-object v2, p0, LX/0Ab;->A00:LX/0eR;
    ...
    iput-boolean v1, p0, LX/0Ab;->A04:Z
    ...
    iput-object v0, p0, LX/0Ab;->A00:LX/0eR;
...
.method public A0B(Landroid/view/ViewGroup;Ljava/lang/Object;I)V
    ...
    iget-object v0, p0, LX/0Ab;->A01:LX/0f4;
    ...
    iput-object v2, p0, LX/0Ab;->A00:LX/0eR;

    :cond_0
    iget-object v1, p0, LX/0Ab;->A01:LX/0f4;
    ...
    iget-object v1, p0, LX/0Ab;->A00:LX/0eR;
    ...
    :goto_1
    iput-object p2, p0, LX/0Ab;->A01:LX/0f4;
...
.method public A0D(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    :cond_1
    iget-object v0, p0, LX/0Ab;->A00:LX/0eR;

    if-nez v0, :cond_2

    iget-object v1, p0, LX/0Ab;->A06:LX/0eU;
    ...
    :cond_2
    invoke-virtual {p0, p2}, LX/0Ab;->A0G(I)LX/0f4;

    move-result-object v3

    iget-object v1, p0, LX/0Ab;->A03:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v0}, LX/0f4;->A14(Z)V

    iget v2, p0, LX/0Ab;->A05:I

    if-nez v2, :cond_5

    invoke-virtual {v3, v0}, LX/0f4;->A15(Z)V
    ...
    invoke-virtual {v1, v3, v0}, LX/0eR;->A09(LX/0f4;I)V
    ...
    invoke-virtual {v1, v3, v0}, LX/0eR;->A0B(LX/0f4;LX/0GY;)V
...
.method public A0E(Landroid/view/ViewGroup;Ljava/lang/Object;I)V
    ...
    iget-object v0, p0, LX/0Ab;->A02:Ljava/util/ArrayList;

    invoke-virtual {v0, p3, v1}, Ljava/util/AbstractList;->set(ILjava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, LX/0Ab;->A00:LX/0eR;

    invoke-virtual {v0, p2}, LX/0eR;->A07(LX/0f4;)V
...
.method public abstract A0G(I)LX/0f4;
.end method
