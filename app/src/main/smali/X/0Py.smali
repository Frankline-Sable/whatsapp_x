...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, LX/0Py;->A02:Landroid/widget/ImageView;
...
.method public A00()V
    ...
    iget-object v4, p0, LX/0Py;->A02:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, LX/0Py;->A01:LX/0MO;
    ...
    iput-object v2, p0, LX/0Py;->A01:LX/0MO;
    ...
    invoke-static {v4}, LX/0XP;->A00(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-static {v4}, LX/0XP;->A01(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    iget-object v1, p0, LX/0Py;->A00:LX/0MO;
...
.method public A01(I)V
    ...
    iget-object v1, p0, LX/0Py;->A02:Landroid/widget/ImageView;

    if-eqz p1, :cond_1

    invoke-static {v1, p1}, LX/0YF;->A02(Landroid/view/View;I)Landroid/graphics/drawable/Drawable;
...
.method public A02(Landroid/util/AttributeSet;I)V
    ...
    iget-object v7, p0, LX/0Py;->A02:Landroid/widget/ImageView;

    invoke-virtual {v7}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v8, LX/0Ka;->A05:[I
    ...
    invoke-static {v1, p1, v8, p2, v0}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;
    ...
    invoke-static {v7, v0}, LX/0YF;->A02(Landroid/view/View;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v7}, LX/0SW;->A00(Landroid/content/res/ColorStateList;Landroid/widget/ImageView;)V
    ...
    invoke-static {v0, v7}, LX/0SW;->A01(Landroid/graphics/PorterDuff$Mode;Landroid/widget/ImageView;)V
    :try_end_0
