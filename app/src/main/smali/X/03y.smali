...
.method public bridge synthetic A05(Landroid/content/Context;Ljava/lang/Object;)Landroid/content/Intent;
    ...
    iget-object v2, p2, LX/0aR;->A02:Landroid/content/Intent;
    ...
    iget-object v0, p2, LX/0aR;->A03:Landroid/content/IntentSender;

    new-instance v2, LX/0O2;

    invoke-direct {v2, v0}, LX/0O2;-><init>(Landroid/content/IntentSender;)V

    const/4 v0, 0x0

    iput-object v0, v2, LX/0O2;->A02:Landroid/content/Intent;

    iget v1, p2, LX/0aR;->A01:I

    iget v0, p2, LX/0aR;->A00:I

    iput v1, v2, LX/0O2;->A01:I

    iput v0, v2, LX/0O2;->A00:I

    invoke-virtual {v2}, LX/0O2;->A00()LX/0aR;
