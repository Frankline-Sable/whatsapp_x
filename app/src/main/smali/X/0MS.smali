...
.method public constructor <init>(Landroid/content/Context;Landroidx/constraintlayout/widget/ConstraintLayout;I)V
    ...
    iput-object v0, v10, LX/0MS;->A01:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, v10, LX/0MS;->A00:Landroid/util/SparseArray;

    const/16 v17, 0x0

    move-object/from16 v0, v17

    iput-object v0, v10, LX/0MS;->A02:LX/0Gu;

    move-object/from16 v0, p2

    iput-object v0, v10, LX/0MS;->A03:Landroidx/constraintlayout/widget/ConstraintLayout;
    ...
    invoke-direct {v1, v11, v0}, LX/0Mw;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    if-eqz v9, :cond_2

    iget-object v0, v9, LX/0MR;->A03:Ljava/util/ArrayList;
    ...
    new-instance v9, LX/0MR;

    move-object/from16 v0, v18

    invoke-direct {v9, v11, v0}, LX/0MR;-><init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v1, v10, LX/0MS;->A01:Landroid/util/SparseArray;

    iget v0, v9, LX/0MR;->A01:I
    ...
    iget-object v1, v12, LX/0YJ;->A00:Ljava/util/HashMap;

    iget v0, v8, LX/0PC;->A00:I

    invoke-static {v8, v1, v0}, LX/000;->A18(Ljava/lang/Object;Ljava/util/AbstractMap;I)V
    ...
    invoke-virtual {v12, v11, v0}, LX/0YJ;->A05(Landroid/content/Context;Landroid/util/AttributeSet;)LX/0PC;
    ...
    iget-object v0, v8, LX/0PC;->A01:Ljava/util/HashMap;
    ...
    sget-object v3, LX/0GK;->A03:LX/0GK;
    ...
    sget-object v3, LX/0GK;->A04:LX/0GK;
    ...
    invoke-static {v11}, LX/000;->A09(Landroid/content/Context;)Landroid/util/DisplayMetrics;
    ...
    sget-object v3, LX/0GK;->A05:LX/0GK;
    ...
    sget-object v3, LX/0GK;->A06:LX/0GK;
    ...
    sget-object v3, LX/0GK;->A07:LX/0GK;
    ...
    invoke-direct {v1, v3, v4, v6}, LX/0UQ;-><init>(LX/0GK;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object v0, v8, LX/0PC;->A02:LX/0U5;

    iput v15, v0, LX/0U5;->A0b:I
    ...
    iput-boolean v15, v0, LX/0U5;->A0y:Z

    iput-boolean v15, v0, LX/0U5;->A0w:Z
    ...
    iget-object v4, v8, LX/0PC;->A05:LX/0U4;

    invoke-static/range {v18 .. v18}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;

    move-result-object v1

    sget-object v0, LX/0KW;->A07:[I

    invoke-virtual {v11, v1, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    iput-boolean v15, v4, LX/0U4;->A0C:Z
    ...
    sget-object v0, LX/0U4;->A0D:Landroid/util/SparseIntArray;
    ...
    :pswitch_0
    iget v0, v4, LX/0U4;->A01:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A01:F

    goto :goto_f

    :pswitch_1
    iget v0, v4, LX/0U4;->A02:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A02:F

    goto :goto_f

    :pswitch_2
    iget v0, v4, LX/0U4;->A03:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A03:F

    goto :goto_f

    :pswitch_3
    iget v0, v4, LX/0U4;->A04:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A04:F

    goto :goto_f

    :pswitch_4
    iget v0, v4, LX/0U4;->A05:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A05:F

    goto :goto_f

    :pswitch_5
    iget v0, v4, LX/0U4;->A06:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A06:F

    goto :goto_f

    :pswitch_6
    iget v0, v4, LX/0U4;->A07:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A07:F

    goto :goto_f

    :pswitch_7
    iget v0, v4, LX/0U4;->A08:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A08:F

    goto :goto_f

    :pswitch_8
    iget v0, v4, LX/0U4;->A09:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A09:F

    goto :goto_f

    :pswitch_9
    iget v0, v4, LX/0U4;->A0A:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A0A:F

    goto :goto_f

    :pswitch_a
    iput-boolean v15, v4, LX/0U4;->A0B:Z

    iget v0, v4, LX/0U4;->A00:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v4, LX/0U4;->A00:F
    ...
    iget-object v4, v8, LX/0PC;->A04:LX/0Mh;

    invoke-static/range {v18 .. v18}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;

    move-result-object v1

    sget-object v0, LX/0KW;->A05:[I

    invoke-virtual {v11, v1, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    iput-boolean v15, v4, LX/0Mh;->A04:Z
    ...
    iget v0, v4, LX/0Mh;->A00:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0Mh;->A00:F
    ...
    iget v0, v4, LX/0Mh;->A02:I

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    iput v0, v4, LX/0Mh;->A02:I
    ...
    iget v0, v4, LX/0Mh;->A01:F

    invoke-virtual {v3, v5, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0Mh;->A01:F
    ...
    iget-object v4, v8, LX/0PC;->A03:LX/0U1;

    invoke-static/range {v18 .. v18}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;

    move-result-object v1

    sget-object v0, LX/0KW;->A04:[I

    invoke-virtual {v11, v1, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    iput-boolean v15, v4, LX/0U1;->A06:Z
    ...
    sget-object v0, LX/0U1;->A07:Landroid/util/SparseIntArray;
    ...
    :pswitch_b
    iget v0, v4, LX/0U1;->A00:F

    invoke-virtual {v3, v6, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U1;->A00:F

    goto :goto_14

    :pswitch_c
    iget v0, v4, LX/0U1;->A02:I

    invoke-static {v3, v6, v0}, LX/0YJ;->A00(Landroid/content/res/TypedArray;II)I

    move-result v0

    iput v0, v4, LX/0U1;->A02:I
    ...
    :goto_13
    iput-object v0, v4, LX/0U1;->A05:Ljava/lang/String;

    goto :goto_14

    :cond_19
    sget-object v5, LX/0Jp;->A00:[Ljava/lang/String;
    ...
    :pswitch_f
    iget v0, v4, LX/0U1;->A04:I

    invoke-virtual {v3, v6, v0}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    iput v0, v4, LX/0U1;->A04:I

    goto :goto_14

    :pswitch_10
    iget v0, v4, LX/0U1;->A01:F

    invoke-virtual {v3, v6, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v0

    iput v0, v4, LX/0U1;->A01:F
    ...
    iget-object v3, v8, LX/0PC;->A02:LX/0U5;

    invoke-static/range {v18 .. v18}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;

    move-result-object v1

    sget-object v0, LX/0KW;->A03:[I

    invoke-virtual {v11, v1, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v2

    iput-boolean v15, v3, LX/0U5;->A0w:Z
    ...
    sget-object v6, LX/0U5;->A10:Landroid/util/SparseIntArray;
    ...
    :goto_16
    invoke-static {v0, v5, v4}, LX/000;->A1C(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
    ...
    :pswitch_13
    iget-boolean v0, v3, LX/0U5;->A0x:Z
    ...
    :pswitch_1c
    iget v0, v3, LX/0U5;->A0C:I

    invoke-static {v2, v4, v0}, LX/0YJ;->A00(Landroid/content/res/TypedArray;II)I
    ...
    :cond_1b
    iget-boolean v0, v3, LX/0U5;->A0u:Z
    ...
    :cond_1c
    iget-boolean v0, v3, LX/0U5;->A0v:Z
    ...
    :cond_20
    invoke-static/range {v18 .. v18}, LX/0MS;->A00(Lorg/xmlpull/v1/XmlPullParser;)Ljava/lang/RuntimeException;
    ...
    :cond_25
    :goto_1a
    iget-object v0, v10, LX/0MS;->A00:Landroid/util/SparseArray;
