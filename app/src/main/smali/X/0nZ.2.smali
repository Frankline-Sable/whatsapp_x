...
.method public constructor <init>(Landroid/content/BroadcastReceiver$PendingResult;Landroid/content/Context;Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver;)V
    ...
    iput-object p4, p0, LX/0nZ;->A03:Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver;

    iput-object p3, p0, LX/0nZ;->A02:Landroid/content/Intent;

    iput-object p2, p0, LX/0nZ;->A01:Landroid/content/Context;

    iput-object p1, p0, LX/0nZ;->A00:Landroid/content/BroadcastReceiver$PendingResult;
...
.method public run()V
    ...
    :try_start_0
    iget-object v2, p0, LX/0nZ;->A02:Landroid/content/Intent;
    ...
    iget-object v1, p0, LX/0nZ;->A01:Landroid/content/Context;

    const-class v0, Landroidx/work/impl/background/systemalarm/ConstraintProxy$BatteryNotLowProxy;

    invoke-static {v1, v0, v6}, LX/0Sv;->A00(Landroid/content/Context;Ljava/lang/Class;Z)V

    const-class v0, Landroidx/work/impl/background/systemalarm/ConstraintProxy$BatteryChargingProxy;

    invoke-static {v1, v0, v5}, LX/0Sv;->A00(Landroid/content/Context;Ljava/lang/Class;Z)V

    const-class v0, Landroidx/work/impl/background/systemalarm/ConstraintProxy$StorageNotLowProxy;

    invoke-static {v1, v0, v4}, LX/0Sv;->A00(Landroid/content/Context;Ljava/lang/Class;Z)V

    const-class v0, Landroidx/work/impl/background/systemalarm/ConstraintProxy$NetworkStateProxy;

    invoke-static {v1, v0, v3}, LX/0Sv;->A00(Landroid/content/Context;Ljava/lang/Class;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, LX/0nZ;->A00:Landroid/content/BroadcastReceiver$PendingResult;
