...
# direct methods
.method public constructor <init>(LX/0DV;Ljava/io/File;Ljava/io/OutputStream;Ljava/security/MessageDigest;)V
    .locals 2

    iput-object p1, p0, LX/0pF;->A02:LX/0DV;

    iput-object p2, p0, LX/0pF;->A03:Ljava/io/File;
...
.method public close()V
    ...
    invoke-static {v3}, LX/39L;->A07([B)Ljava/lang/String;
    ...
    iget-object v1, p0, LX/0pF;->A02:LX/0DV;

    invoke-virtual {v1, v3}, LX/0DV;->A0C([B)LX/0Wl;

    move-result-object v0

    invoke-static {v0, p0}, LX/0DV;->A00(LX/0Wl;Ljava/io/OutputStream;)V
    ...
    iget-object v4, v1, LX/0RQ;->A00:LX/0vc;

    invoke-interface {v4}, LX/0vc;->Auk()Z

    instance-of v0, v4, LX/0iO;

    if-eqz v0, :cond_0

    iget-object v3, p0, LX/0pF;->A03:Ljava/io/File;

    move-object v0, v4

    check-cast v0, LX/0iO;

    iget-object v0, v0, LX/0iO;->A00:Ljava/io/File;
    ...
    invoke-interface {v4}, LX/0vc;->AwE()Z
...
.method public write(I)V
    ...
    iget-wide v2, p0, LX/0pF;->A00:J

    const-wide/16 v0, 0x1

    add-long/2addr v2, v0

    iput-wide v2, p0, LX/0pF;->A00:J
