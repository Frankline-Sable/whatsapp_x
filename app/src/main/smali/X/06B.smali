...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/06B;->A0A:Landroid/graphics/Rect;

    new-instance v0, LX/0eP;

    invoke-direct {v0}, LX/0eP;-><init>()V

    sput-object v0, LX/06B;->A0B:LX/0rq;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, LX/06B;->A05:Landroid/graphics/Rect;

    invoke-static {}, LX/002;->A08()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, LX/06B;->A04:Landroid/graphics/Rect;

    invoke-static {}, LX/002;->A08()Landroid/graphics/Rect;

    move-result-object v0

    iput-object v0, p0, LX/06B;->A06:Landroid/graphics/Rect;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, LX/06B;->A09:[I

    const/high16 v0, -0x80000000

    iput v0, p0, LX/06B;->A00:I

    iput v0, p0, LX/06B;->A02:I

    iput v0, p0, LX/06B;->A01:I

    if-eqz p1, :cond_1

    iput-object p1, p0, LX/06B;->A07:Landroid/view/View;
    ...
    iput-object v0, p0, LX/06B;->A08:Landroid/view/accessibility/AccessibilityManager;
...
.method public static A04(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    invoke-static {p0, p1, p3}, LX/06B;->A02(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z

    move-result v1

    invoke-static {p0, p2, p3}, LX/06B;->A02(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    invoke-static {p0, p1, p3}, LX/06B;->A00(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    :goto_2
    invoke-static {v1, v0, v3}, LX/001;->A0C(III)I
...
.method public A0C(Landroid/view/View;)LX/0Uk;
    ...
    iget-object v0, p0, LX/06B;->A03:LX/06T;

    if-nez v0, :cond_0

    new-instance v0, LX/06T;

    invoke-direct {v0, p0}, LX/06T;-><init>(LX/06B;)V

    iput-object v0, p0, LX/06B;->A03:LX/06T;
...
.method public A0D(Landroid/view/View;LX/0VS;)V
    ...
    invoke-virtual {p0, p2}, LX/06B;->A0K(LX/0VS;)V
...
.method public A0F(I)LX/0VS;
    ...
    iget-object v6, p0, LX/06B;->A07:Landroid/view/View;
    ...
    invoke-direct {v5, v0}, LX/0VS;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    iget-object v4, v5, LX/0VS;->A01:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {p0, v3}, LX/06B;->A0M(Ljava/util/List;)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, LX/06B;->A0G(I)LX/0VS;
...
.method public final A0G(I)LX/0VS;
    .locals 11
    ...
    iget-object v3, v5, LX/0VS;->A01:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    sget-object v2, LX/06B;->A0A:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v5, p1}, LX/06B;->A0L(LX/0VS;I)V

    invoke-virtual {v5}, LX/0VS;->A01()Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, LX/06B;->A04:Landroid/graphics/Rect;
    ...
    iget-object v10, p0, LX/06B;->A09:[I

    invoke-virtual {v6, v10}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v8, p0, LX/06B;->A05:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-object v7, p0, LX/06B;->A06:Landroid/graphics/Rect;
...
.method public final A0H()V
    ...
    iget-object v0, p0, LX/06B;->A08:Landroid/view/accessibility/AccessibilityManager;
    ...
    iget-object v3, p0, LX/06B;->A07:Landroid/view/View;
    ...
    invoke-static {v1, v0}, LX/0SR;->A01(Landroid/view/accessibility/AccessibilityEvent;I)V
...
.method public final A0I(II)V
    ...
    invoke-virtual {p0, p1}, LX/06B;->A0F(I)LX/0VS;
    ...
    invoke-static {v3, v1, p1}, LX/0Ie;->A00(Landroid/view/View;Landroid/view/accessibility/AccessibilityRecord;I)V
...
.method public A0K(LX/0VS;)V
    .locals 0

    return-void
.end method

.method public abstract A0L(LX/0VS;I)V
.end method
...
.method public final A0N(I)Z
    ...
    invoke-virtual {p0, p1, v1}, LX/06B;->A0J(IZ)V

    const/16 v0, 0x8

    invoke-virtual {p0, p1, v0}, LX/06B;->A0I(II)V
...
.method public final A0O(I)Z
    ...
    iget-object v1, p0, LX/06B;->A07:Landroid/view/View;
    ...
    invoke-virtual {p0, v1}, LX/06B;->A0N(I)Z

    :cond_2
    if-eq p1, v0, :cond_0

    iput p1, p0, LX/06B;->A02:I
...
.method public final A0Q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v4}, LX/06B;->A0M(Ljava/util/List;)V

    new-instance v3, LX/0j7;

    invoke-direct {v3}, LX/0j7;-><init>()V
    ...
    invoke-virtual {p0, v0}, LX/06B;->A0G(I)LX/0VS;
    ...
    invoke-virtual {v3, v0, v1}, LX/0j7;->A03(ILjava/lang/Object;)V
    ...
    invoke-virtual {v3, v1, v0}, LX/0j7;->A01(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, LX/06B;->A0F(I)LX/0VS;
    ...
    iget-object v0, v3, LX/0j7;->A02:[Ljava/lang/Object;

    aget-object v11, v0, v4

    check-cast v11, LX/0VS;

    if-eq v11, v8, :cond_4

    iget-object v0, v11, LX/0VS;->A01:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v0, v12}, Landroid/view/accessibility/AccessibilityNodeInfo;->getBoundsInParent(Landroid/graphics/Rect;)V

    invoke-static {v6, v12, p1}, LX/06B;->A03(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-static {v6, v5, p1}, LX/06B;->A03(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {v6, v12, v5, p1}, LX/06B;->A04(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z

    move-result v0

    if-nez v0, :cond_3

    invoke-static {v6, v5, v12, p1}, LX/06B;->A04(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z

    move-result v0

    if-nez v0, :cond_4

    invoke-static {v6, v12, p1}, LX/06B;->A00(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I

    move-result v1

    invoke-static {v6, v12, p1}, LX/06B;->A01(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    invoke-static {v6, v5, p1}, LX/06B;->A00(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I

    move-result v2

    invoke-static {v6, v5, p1}, LX/06B;->A01(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    :cond_9
    iget-object v0, p0, LX/06B;->A07:Landroid/view/View;
    ...
    sget-object v5, LX/06B;->A0B:LX/0rq;

    iget v4, v3, LX/0j7;->A00:I
    ...
    invoke-direct {v0, v5, v6}, LX/0oI;-><init>(LX/0rq;Z)V
    ...
    :cond_16
    iget-object v0, v3, LX/0j7;->A01:[I

    aget v7, v0, v1

    :cond_17
    invoke-virtual {p0, v7}, LX/06B;->A0O(I)Z
...
.method public final A0R(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v3, v4}, LX/06B;->A0Q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v1, v0, v4}, LX/06B;->A0P(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, v0, v4}, LX/06B;->A0Q(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v2, v4}, LX/06B;->A0Q(ILandroid/graphics/Rect;)Z
...
.method public final A0S(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, LX/06B;->A08:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput v3, p0, LX/06B;->A01:I

    const/16 v0, 0x100

    invoke-virtual {p0, v1, v0}, LX/06B;->A0I(II)V
    ...
    invoke-virtual {p0, v1, v0}, LX/06B;->A0E(FF)I
    ...
    iput v2, p0, LX/06B;->A01:I

    const/16 v0, 0x80

    invoke-virtual {p0, v2, v0}, LX/06B;->A0I(II)V
