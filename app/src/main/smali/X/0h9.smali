...
.method public bridge synthetic BYb(LX/0ix;F)Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, LX/0ix;->A0C()LX/0GP;
    ...
    invoke-virtual/range {p1 .. p1}, LX/0ix;->A0G()V

    :cond_0
    :goto_0
    invoke-virtual/range {p1 .. p1}, LX/0ix;->A0N()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static/range {p1 .. p1}, LX/0ix;->A03(LX/0ix;)F
    ...
    invoke-virtual/range {p1 .. p1}, LX/0ix;->A0I()V

    :cond_2
    move-object/from16 v10, p0

    iget v1, v10, LX/0h9;->A00:I
    ...
    invoke-direct {v10, v9, v8}, LX/0Ll;-><init>([F[I)V
    ...
    iget-object v1, v10, LX/0Ll;->A00:[F
    ...
    :cond_b
    iget-object v0, v10, LX/0Ll;->A01:[I
