...
.method public constructor <init>(LX/428;)V
    ...
    iput-object p1, p0, LX/0iL;->A00:LX/428;

    return-void
.end method

.method public static A00(LX/5ke;)Landroid/view/animation/Interpolator;
    .locals 5
    ...
    invoke-static {v1, v1, v4, v4}, LX/0SU;->A00(FFFF)Landroid/view/animation/PathInterpolator;
    ...
    invoke-virtual {p0, v0, v4}, LX/5ke;->A0D(IF)F
...
.method public static A01(LX/5ke;)LX/0Fm;
    .locals 2
...
.method public static A02(LX/4a4;LX/41E;)LX/0u2;
    .locals 1

    new-instance v0, LX/0hQ;

    invoke-direct {v0, p0, p1}, LX/0hQ;-><init>(LX/4a4;LX/41E;)V

    return-object v0
.end method

.method public static A03(LX/4a4;LX/5Z9;)V
    .locals 12

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, LX/5Z9;->A00(I)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, LX/5m6;->A05(LX/4a4;LX/5Z9;I)LX/5Vq;
    ...
    :cond_0
    invoke-static {p0, v7}, LX/5d5;->A00(LX/4a4;LX/5ke;)LX/5d5;
    ...
    invoke-virtual {v2, v1, v0}, LX/5ke;->A0G(II)I
    ...
    invoke-virtual {v2, v0, v1}, LX/5ke;->A0G(II)I
    ...
    invoke-static {v0}, LX/0iL;->A00(LX/5ke;)Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v2, v10}, LX/0PI;-><init>(LX/5Vq;)V

    invoke-virtual {v2, v9}, LX/0PI;->A01(LX/5d5;)V

    iput v11, v2, LX/0PI;->A00:I

    iput v8, v2, LX/0PI;->A02:I

    iput v6, v2, LX/0PI;->A01:I

    iput-object v5, v2, LX/0PI;->A04:Landroid/view/animation/Interpolator;

    iput-object v4, v2, LX/0PI;->A03:Landroid/view/animation/Interpolator;

    invoke-static {p0, v1}, LX/0iL;->A02(LX/4a4;LX/41E;)LX/0u2;

    move-result-object v0

    iput-object v0, v2, LX/0PI;->A07:LX/0u2;
    ...
    iput-object v0, v2, LX/0PI;->A06:LX/0u1;

    invoke-virtual {v7}, LX/5ke;->A0P()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v2, LX/0PI;->A09:Ljava/lang/String;

    invoke-virtual {v2}, LX/0PI;->A00()LX/0Wj;

    move-result-object v0

    invoke-virtual {v0}, LX/0Wj;->A02()V

    return-void
.end method

.method public static A04(LX/4a4;LX/5Z9;)V
    .locals 6

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, LX/5Z9;->A01(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, LX/5d5;
    ...
    invoke-virtual {v1, v5, v0}, LX/5bd;->A08(LX/5d5;Ljava/util/Map;)V

    new-instance v3, LX/0PI;

    invoke-direct {v3, v2}, LX/0PI;-><init>(LX/5Vq;)V

    invoke-virtual {v3, v5}, LX/0PI;->A01(LX/5d5;)V

    const/16 v1, 0x23

    const/16 v0, 0x1388

    invoke-virtual {v4, v1, v0}, LX/5ke;->A0G(II)I

    move-result v0

    iput v0, v3, LX/0PI;->A00:I

    const/16 v0, 0x2a

    const/16 v1, 0x64

    invoke-virtual {v4, v0, v1}, LX/5ke;->A0G(II)I

    move-result v0

    iput v0, v3, LX/0PI;->A02:I
    ...
    iput-object v0, v3, LX/0PI;->A04:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, v3, LX/0PI;->A03:Landroid/view/animation/Interpolator;
    ...
    invoke-static {p0, v0}, LX/0iL;->A02(LX/4a4;LX/41E;)LX/0u2;

    move-result-object v0

    iput-object v0, v3, LX/0PI;->A07:LX/0u2;
    ...
    invoke-direct {v0, p0, v1, v2}, LX/0xm;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object v0, v3, LX/0PI;->A06:LX/0u1;

    invoke-virtual {v5}, LX/5d5;->A05()LX/5ke;
    ...
    iput-object v0, v3, LX/0PI;->A09:Ljava/lang/String;

    invoke-static {v4}, LX/0iL;->A06(LX/5ke;)Z

    move-result v0

    iput-boolean v0, v3, LX/0PI;->A0A:Z

    invoke-static {v4}, LX/0iL;->A01(LX/5ke;)LX/0Fm;

    move-result-object v0

    iput-object v0, v3, LX/0PI;->A05:LX/0Fm;

    invoke-virtual {v3}, LX/0PI;->A00()LX/0Wj;
...
.method public static A05(LX/5Z9;)V
    .locals 2

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, LX/5Z9;->A00(I)Ljava/lang/Object;
    ...
    sget-object v0, LX/0XT;->A00:Ljava/lang/ref/WeakReference;
...
.method public static A06(LX/5ke;)Z
    .locals 1
...
# virtual methods
.method public A07(LX/4a4;LX/5Z9;LX/787;)Ljava/lang/Object;
    .locals 1

    :try_start_0
    iget-object v0, p3, LX/787;->A00:Ljava/lang/String;

    invoke-static {v0}, LX/7Xl;->A01(Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2, p3}, LX/0iL;->A08(LX/4a4;LX/5Z9;LX/787;)Ljava/lang/Object;
...
.method public final A08(LX/4a4;LX/5Z9;LX/787;)Ljava/lang/Object;
    .locals 12

    iget-object v9, p3, LX/787;->A00:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, LX/0iL;->A00:LX/428;
    ...
    invoke-virtual {p2, v6}, LX/5Z9;->A00(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ljava/util/Collection;

    invoke-virtual {p2, v4}, LX/5Z9;->A00(I)Ljava/lang/Object;
    ...
    invoke-static {p1, p2}, LX/0iL;->A04(LX/4a4;LX/5Z9;)V
    ...
    invoke-virtual {v0}, LX/5aE;->A05()LX/5YQ;
    ...
    invoke-virtual {p2, v6}, LX/5Z9;->A01(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Ljava/util/List;

    invoke-virtual {p2, v4}, LX/5Z9;->A01(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1, v6}, LX/5Si;->A03(Ljava/lang/Object;I)V

    invoke-virtual {v0}, LX/5Si;->A02()LX/5Z9;

    move-result-object v0

    invoke-static {p1, v0, v4}, LX/5YT;->A00(LX/4a4;LX/5Z9;LX/41E;)Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {v1}, LX/5aa;->A02(Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, p0, p1, v2}, LX/0oH;-><init>(LX/0iL;LX/4a4;LX/41E;)V
    ...
    invoke-static {v0}, LX/001;->A03(Landroid/animation/ValueAnimator;)F

    move-result v0

    invoke-static {v0}, LX/5aa;->A01(F)Ljava/lang/Number;
    ...
    invoke-virtual {v0, v3, v6}, LX/5Si;->A04(Ljava/lang/Object;I)V

    invoke-virtual {v0}, LX/5Si;->A02()LX/5Z9;

    move-result-object v0

    invoke-static {p1, v0, v8}, LX/5YT;->A00(LX/4a4;LX/5Z9;LX/41E;)Ljava/lang/Object;
    ...
    :pswitch_3
    invoke-static {p1, p2}, LX/0iL;->A03(LX/4a4;LX/5Z9;)V
    ...
    invoke-static {p1, p2, v3}, LX/5m6;->A05(LX/4a4;LX/5Z9;I)LX/5Vq;
    ...
    invoke-direct {v2, p0, v0, p1, v1}, LX/0nb;-><init>(LX/0iL;LX/5Vq;LX/4a4;LX/41E;)V
    ...
    invoke-virtual {p2, v3}, LX/5Z9;->A01(I)Ljava/lang/Object;
    ...
    invoke-static {v7}, LX/001;->A03(Landroid/animation/ValueAnimator;)F
    ...
    :pswitch_8
    invoke-static {p2}, LX/0iL;->A05(LX/5Z9;)V
    ...
    invoke-virtual {p2, v3}, LX/5Z9;->A00(I)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v0}, LX/5Z9;->A00(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Ljava/lang/String;

    invoke-virtual {p2, v5}, LX/5Z9;->A00(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Ljava/lang/String;

    invoke-static/range {v2 .. v7}, LX/5En;->A00(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v6}, LX/5Si;->A04(Ljava/lang/Object;I)V
    ...
    invoke-static {p1, v0, v3}, LX/5YT;->A00(LX/4a4;LX/5Z9;LX/41E;)Ljava/lang/Object;
    ...
    invoke-static {v1}, LX/7Sj;->A00(Ljava/lang/Object;)LX/41E;
    ...
    invoke-virtual {p2, v0}, LX/5Z9;->A01(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v5, v6}, LX/5Si;->A04(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p0, p1, v1, v9}, LX/0Zc;-><init>(LX/0iL;LX/4a4;LX/5Z9;LX/41E;)V

    invoke-virtual {v5, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance v0, LX/0ZT;

    invoke-direct {v0, p0, p1, v1, v8}, LX/0ZT;-><init>(LX/0iL;LX/4a4;LX/5Z9;LX/41E;)V
...
.method public bridge synthetic Aw8(LX/5Z9;LX/787;LX/5PX;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p3, p1, p2}, LX/0iL;->A07(LX/4a4;LX/5Z9;LX/787;)Ljava/lang/Object;
