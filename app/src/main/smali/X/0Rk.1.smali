...
.field public volatile A0B:LX/0wg;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v3, v2, v1}, LX/0UU;-><init>(LX/0Rk;Ljava/util/Map;Ljava/util/Map;[Ljava/lang/String;)V

    iput-object v0, p0, LX/0Rk;->A06:LX/0UU;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0Rk;->A02:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;-><init>()V

    iput-object v0, p0, LX/0Rk;->A0A:Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    iput-object v0, p0, LX/0Rk;->A07:Ljava/lang/ThreadLocal;
    ...
    iput-object v0, p0, LX/0Rk;->A08:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0Rk;->A09:Ljava/util/Map;
...
# virtual methods
.method public A00()LX/0wd;
    .locals 1

    iget-object v0, p0, LX/0Rk;->A00:LX/0wd;
...
.method public A01(Ljava/lang/String;)LX/0wU;
    .locals 1
    ...
    invoke-interface {v0, p1}, LX/0wg;->Asc(Ljava/lang/String;)LX/0wU;
...
.method public A02(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, LX/0Rk;->A0C()V
...
.method public A06()Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p0, LX/0Rk;->A03:Ljava/util/concurrent/Executor;
...
.method public final A07()Ljava/util/concurrent/locks/Lock;
    ...
    iget-object v0, p0, LX/0Rk;->A0A:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method public A08()V
    ...
    iget-boolean v0, p0, LX/0Rk;->A05:Z
...
.method public A09()V
    ...
    iget-object v0, p0, LX/0Rk;->A07:Ljava/lang/ThreadLocal;
...
.method public A0A()V
    ...
    iget-object v0, p0, LX/0Rk;->A06:LX/0UU;

    invoke-virtual {v0, v1}, LX/0UU;->A00(LX/0wg;)V

    check-cast v1, LX/0fc;

    iget-object v1, v1, LX/0fc;->A00:Landroid/database/sqlite/SQLiteDatabase;
...
.method public final A0C()V
    ...
    iget-object v3, p0, LX/0Rk;->A06:LX/0UU;

    iget-object v2, v3, LX/0UU;->A0A:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, v3, LX/0UU;->A03:LX/0Rk;

    invoke-virtual {v0}, LX/0Rk;->A06()Ljava/util/concurrent/Executor;

    move-result-object v1

    iget-object v0, v3, LX/0UU;->A06:Ljava/lang/Runnable;
...
.method public A0D()Z
    ...
    iget-object v0, p0, LX/0Rk;->A0B:LX/0wg;
