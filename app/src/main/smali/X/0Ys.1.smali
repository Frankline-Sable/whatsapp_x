...
.method public static A00(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)Landroid/view/ActionMode$Callback;
    ...
    invoke-direct {v0, p0, p1}, LX/0ao;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
...
.method public static A01(Landroid/content/res/ColorStateList;Landroid/widget/TextView;)V
    ...
    invoke-static {p0, p1}, LX/0YS;->A02(Landroid/content/res/ColorStateList;Landroid/widget/TextView;)V
...
.method public static A02(Landroid/graphics/PorterDuff$Mode;Landroid/widget/TextView;)V
    ...
    invoke-static {p0, p1}, LX/0YS;->A03(Landroid/graphics/PorterDuff$Mode;Landroid/widget/TextView;)V
...
.method public static A03(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, LX/0SZ;->A00(Landroid/widget/TextView;I)V

    :cond_0
    return-void

    :cond_1
    instance-of v0, p0, LX/0vq;

    if-eqz v0, :cond_0

    check-cast p0, LX/0vq;

    invoke-interface {p0, p1}, LX/0vq;->setAutoSizeTextTypeWithDefaults(I)V
...
.method public static A04(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0, p1}, LX/0Sa;->A01(Landroid/widget/TextView;I)V
    ...
    invoke-static {p0}, LX/0SY;->A01(Landroid/widget/TextView;)Z
...
.method public static A07(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, LX/0SZ;->A01(Landroid/widget/TextView;IIII)V
    ...
    invoke-interface {p0, p1, p2, p3, p4}, LX/0vq;->setAutoSizeTextTypeUniformWithConfiguration(IIII)V
