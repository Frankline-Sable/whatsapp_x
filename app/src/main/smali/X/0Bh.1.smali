...
.method public static A00(LX/0gt;)LX/0Bh;
    .locals 1

    iget-object p0, p0, LX/0gt;->A00:Ljava/util/List;

    new-instance v0, LX/0Bh;

    invoke-direct {v0, p0}, LX/0Bh;-><init>(Ljava/util/List;)V
...
.method public bridge synthetic A0B(LX/0Xg;F)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, LX/0Bh;->A0H(LX/0Xg;F)F
...
.method public A0G()F
    ...
    invoke-virtual {p0, v1, v0}, LX/0Bh;->A0H(LX/0Xg;F)F
...
.method public A0H(LX/0Xg;F)F
    ...
    iput v3, p1, LX/0Xg;->A03:F

    :cond_1
    iget v1, p1, LX/0Xg;->A01:F
    ...
    iput v1, p1, LX/0Xg;->A01:F

    :cond_2
    invoke-static {v1, v3, p2}, LX/001;->A00(FFF)F
