...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LX/0Wk;->A0L:Z

    return-void
.end method

.method public static A00(Landroid/content/pm/ShortcutInfo;)LX/0Uv;
    .locals 2
    ...
    invoke-static {v0}, LX/0Uv;->A00(Landroid/content/LocusId;)LX/0Uv;
...
.method public static A01(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, v1}, LX/0WV;-><init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
...
.method public A02()Landroid/content/pm/ShortcutInfo;
    ...
    iget-object v2, p0, LX/0Wk;->A05:Landroid/content/Context;

    iget-object v0, p0, LX/0Wk;->A0D:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0Wk;->A0B:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, LX/0Wk;->A0P:[Landroid/content/Intent;
    ...
    iget-object v1, p0, LX/0Wk;->A09:Landroidx/core/graphics/drawable/IconCompat;

    if-eqz v1, :cond_0

    iget-object v0, p0, LX/0Wk;->A05:Landroid/content/Context;
    ...
    :cond_0
    iget-object v0, p0, LX/0Wk;->A0C:Ljava/lang/CharSequence;
    ...
    :cond_1
    iget-object v0, p0, LX/0Wk;->A0A:Ljava/lang/CharSequence;
    ...
    :cond_2
    iget-object v0, p0, LX/0Wk;->A04:Landroid/content/ComponentName;
    ...
    :cond_3
    iget-object v0, p0, LX/0Wk;->A0F:Ljava/util/Set;
    ...
    iget-object v0, p0, LX/0Wk;->A0Q:[LX/0PD;
    ...
    :cond_7
    iget-object v0, p0, LX/0Wk;->A08:LX/0Uv;

    if-eqz v0, :cond_8

    invoke-virtual {v0}, LX/0Uv;->A01()Landroid/content/LocusId;
    ...
    :cond_8
    iget-boolean v0, p0, LX/0Wk;->A0N:Z
    ...
    invoke-static {v3, v0}, LX/0I4;->A00(Landroid/content/pm/ShortcutInfo$Builder;I)V
    ...
    :cond_a
    iget-object v2, p0, LX/0Wk;->A06:Landroid/os/PersistableBundle;
    ...
    iput-object v2, p0, LX/0Wk;->A06:Landroid/os/PersistableBundle;
    ...
    :goto_1
    iget-object v5, p0, LX/0Wk;->A0Q:[LX/0PD;

    array-length v0, v5

    if-ge v6, v0, :cond_c

    iget-object v4, p0, LX/0Wk;->A06:Landroid/os/PersistableBundle;
    ...
    invoke-static {v0}, LX/0S0;->A00(LX/0PD;)Landroid/os/PersistableBundle;
    ...
    iget-object v0, v0, LX/0Uv;->A01:Ljava/lang/String;
...
.method public A03(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, LX/0Wk;->A0P:[Landroid/content/Intent;
    ...
    iget-object v0, p0, LX/0Wk;->A09:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_1
    iget-object v3, p0, LX/0Wk;->A09:Landroidx/core/graphics/drawable/IconCompat;

    iget-object v5, p0, LX/0Wk;->A05:Landroid/content/Context;
