...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0AD;->A03:[Ljava/lang/String;
    ...
    sput-object v0, LX/0AD;->A01:Landroid/util/Property;
    ...
    sput-object v0, LX/0AD;->A02:Landroid/util/Property;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0AD;->A00:Landroid/graphics/Matrix;
...
.method public A05(Landroid/view/ViewGroup;LX/0Uo;LX/0Uo;)Landroid/animation/Animator;
    ...
    iget-object v13, v0, LX/0Uo;->A02:Ljava/util/Map;
    ...
    iget-object v3, v4, LX/0Uo;->A02:Ljava/util/Map;
    ...
    invoke-virtual {v11, v5}, LX/0jA;->A0W(Landroid/view/View;)Z
    ...
    invoke-virtual {v11, v2}, LX/0jA;->A0W(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_7

    invoke-virtual {v11, v5, v1}, LX/0jA;->A0D(Landroid/view/View;Z)LX/0Uo;

    move-result-object v0

    if-eqz v0, :cond_8

    iget-object v0, v0, LX/0Uo;->A00:Landroid/view/View;
    ...
    iget-object v1, v4, LX/0Uo;->A00:Landroid/view/View;

    const v0, 0x7f0b11a1

    invoke-virtual {v1, v0, v5}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    iget-object v2, v11, LX/0AD;->A00:Landroid/graphics/Matrix;
    ...
    sget-object v2, LX/0Jx;->A00:Landroid/graphics/Matrix;

    :cond_4
    if-nez v7, :cond_5

    sget-object v7, LX/0Jx;->A00:Landroid/graphics/Matrix;
    ...
    iget-object v9, v4, LX/0Uo;->A00:Landroid/view/View;
    ...
    sget-object v20, LX/0WH;->A02:LX/0RN;

    move-object/from16 v2, p1

    move-object/from16 v0, v20

    invoke-virtual {v0, v3, v2}, LX/0RN;->A03(Landroid/graphics/Matrix;Landroid/view/View;)V
    ...
    iget-object v5, v4, LX/0Uo;->A00:Landroid/view/View;
    ...
    invoke-static {v5, v1}, LX/0ZN;->A0C(Landroid/view/View;F)V
    ...
    invoke-direct {v2, v5, v1}, LX/0OD;-><init>(Landroid/view/View;[F)V

    sget-object v14, LX/0AD;->A01:Landroid/util/Property;

    new-array v0, v0, [F

    new-instance v10, LX/0ZX;

    invoke-direct {v10, v0}, LX/0ZX;-><init>([F)V
    ...
    sget-object v1, LX/0AD;->A02:Landroid/util/Property;
    ...
    invoke-direct/range {v14 .. v20}, LX/00D;-><init>(Landroid/graphics/Matrix;Landroid/view/View;LX/0OD;LX/0QX;LX/0AD;Z)V
    ...
    sget-object v7, LX/0fm;->A01:Ljava/lang/Class;
    ...
    invoke-static {v7, v1, v6, v4, v0}, LX/002;->A0M(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;I)Ljava/lang/reflect/Method;

    move-result-object v0

    sput-object v0, LX/0fm;->A02:Ljava/lang/reflect/Method;
    ...
    :goto_4
    sput-boolean v5, LX/0fm;->A04:Z

    :cond_9
    sget-object v5, LX/0fm;->A02:Ljava/lang/reflect/Method;
    ...
    invoke-static {v9, v2, v1}, LX/000;->A12(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    new-instance v14, LX/0fm;

    invoke-direct {v14, v0}, LX/0fm;-><init>(Landroid/view/View;)V
    ...
    :goto_5
    new-instance v14, LX/02x;

    invoke-direct {v14, v9}, LX/02x;-><init>(Landroid/view/View;)V

    iput-object v3, v14, LX/02x;->A01:Landroid/graphics/Matrix;

    if-nez v15, :cond_10

    new-instance v15, LX/03L;

    invoke-direct {v15, v2}, LX/03L;-><init>(Landroid/view/ViewGroup;)V

    :goto_6
    invoke-static {v2, v15}, LX/02x;->A00(Landroid/view/View;Landroid/view/View;)V

    invoke-static {v2, v14}, LX/02x;->A00(Landroid/view/View;Landroid/view/View;)V

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v8

    iget-object v0, v14, LX/02x;->A04:Landroid/view/View;

    invoke-static {v0, v8}, LX/03L;->A00(Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v0, LX/02x;->A04:Landroid/view/View;

    invoke-static {v0, v7}, LX/03L;->A00(Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-static {v3, v2}, LX/0TN;->A00(Landroid/view/ViewGroup;I)I
    ...
    :cond_10
    iget-boolean v0, v15, LX/03L;->A01:Z

    if-eqz v0, :cond_14

    iget-object v1, v15, LX/03L;->A00:Landroid/view/ViewGroup;
    ...
    iget-object v2, v0, LX/0Uo;->A00:Landroid/view/View;

    invoke-interface {v14, v2, v1}, LX/0v0;->Bbu(Landroid/view/View;Landroid/view/ViewGroup;)V

    :goto_f
    iget-object v0, v11, LX/0jA;->A07:LX/0AA;
    ...
    invoke-direct {v0, v9, v14}, LX/0AJ;-><init>(Landroid/view/View;LX/0v0;)V

    invoke-virtual {v11, v0}, LX/0jA;->A0B(LX/0vV;)LX/0jA;
    ...
    invoke-virtual {v0, v9, v1}, LX/0RN;->A04(Landroid/view/View;F)V
...
.method public A0U(LX/0Uo;)V
    ...
    invoke-virtual {p0, p1}, LX/0AD;->A0Z(LX/0Uo;)V
...
.method public A0Y()[Ljava/lang/String;
    ...
    sget-object v0, LX/0AD;->A03:[Ljava/lang/String;

    return-object v0
.end method

.method public final A0Z(LX/0Uo;)V
    .locals 6

    iget-object v4, p1, LX/0Uo;->A00:Landroid/view/View;
    ...
    iget-object v3, p1, LX/0Uo;->A02:Ljava/util/Map;
    ...
    invoke-virtual {v0, v5, v2}, LX/0RN;->A02(Landroid/graphics/Matrix;Landroid/view/View;)V
