...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v1, LX/0Fw;->A02:LX/0Fw;

    new-instance v0, LX/0YX;

    invoke-direct {v0, v1}, LX/0YX;-><init>(LX/0Fw;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;

    iput-object v0, p0, LX/0g4;->A01:LX/0YX;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0g4;->A04:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, LX/0g4;->A03:Ljava/util/Map;
...
# virtual methods
.method public final A00(Landroid/app/Activity;)LX/0Pg;
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;
    ...
    :goto_0
    iget-object v1, p0, LX/0g4;->A01:LX/0YX;
    ...
    :cond_2
    invoke-virtual {v1, v0, v2}, LX/0YX;->A04(Landroidx/window/sidecar/SidecarDeviceState;Landroidx/window/sidecar/SidecarWindowLayoutInfo;)LX/0Pg;
...
.method public final A02(Landroid/app/Activity;Landroid/os/IBinder;)V
    ...
    iget-object v0, p0, LX/0g4;->A04:Ljava/util/Map;

    invoke-interface {v0, p2, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;
    ...
    :cond_1
    iget-object v1, p0, LX/0g4;->A00:LX/0th;

    if-eqz v1, :cond_2

    invoke-virtual {p0, p1}, LX/0g4;->A00(Landroid/app/Activity;)LX/0Pg;

    move-result-object v0

    invoke-interface {v1, p1, v0}, LX/0th;->BY4(Landroid/app/Activity;LX/0Pg;)V

    :cond_2
    iget-object v1, p0, LX/0g4;->A03:Ljava/util/Map;
    ...
    invoke-direct {v0, p1, p0}, LX/0Zh;-><init>(Landroid/app/Activity;LX/0g4;)V
...
.method public A03()Z
    ...
    :try_start_0
    iget-object v7, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;
    ...
    invoke-static {v0, v5, v2}, LX/000;->A1P([Ljava/lang/Object;II)V

    invoke-virtual {v1, v7, v0}, Ljava/lang/reflect/Method;->invoke(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "getPosture"

    invoke-static {v4, v7, v0}, LX/000;->A0J(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
...
.method public BY3(Landroid/app/Activity;)V
    .locals 5
    ...
    iget-object v3, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;
    ...
    iget-object v2, p0, LX/0g4;->A04:Ljava/util/Map;
...
.method public BeM(LX/0th;)V
    .locals 4

    new-instance v0, LX/0g3;

    invoke-direct {v0, p1}, LX/0g3;-><init>(LX/0th;)V

    iput-object v0, p0, LX/0g4;->A00:LX/0th;

    iget-object v3, p0, LX/0g4;->A02:Landroidx/window/sidecar/SidecarInterface;

    if-eqz v3, :cond_0

    iget-object v2, p0, LX/0g4;->A01:LX/0YX;

    new-instance v1, Landroidx/window/layout/SidecarCompat$TranslatingCallback;

    invoke-direct {v1, p0}, Landroidx/window/layout/SidecarCompat$TranslatingCallback;-><init>(LX/0g4;)V

    new-instance v0, Landroidx/window/layout/DistinctElementSidecarCallback;

    invoke-direct {v0, v2, v1}, Landroidx/window/layout/DistinctElementSidecarCallback;-><init>(LX/0YX;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V
