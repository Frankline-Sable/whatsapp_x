...
# static fields
.field public static A07:LX/0YF;

.field public static final A08:Landroid/graphics/PorterDuff$Mode;

.field public static final A09:LX/05G;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/0YF;->A08:Landroid/graphics/PorterDuff$Mode;

    new-instance v0, LX/05G;

    invoke-direct {v0}, LX/05G;-><init>()V

    sput-object v0, LX/0YF;->A09:LX/05G;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/0YF;->A06:Ljava/util/WeakHashMap;
...
.method public static declared-synchronized A00(Landroid/graphics/PorterDuff$Mode;I)Landroid/graphics/PorterDuffColorFilter;
    ...
    const-class v4, LX/0YF;

    monitor-enter v4

    :try_start_0
    sget-object v3, LX/0YF;->A09:LX/05G;

    add-int/lit8 v0, p1, 0x1f

    mul-int/lit8 v2, v0, 0x1f

    invoke-static {p0, v2}, LX/002;->A02(Ljava/lang/Object;I)I
    ...
    invoke-virtual {v3, v0}, LX/0Rc;->A04(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v0, v1}, LX/0Rc;->A08(Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_0
...
.method public static A01(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p0, p1}, LX/0YF;->A06(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static declared-synchronized A03()LX/0YF;
    .locals 4
    ...
    :try_start_0
    sget-object v0, LX/0YF;->A07:LX/0YF;

    if-nez v0, :cond_0

    new-instance v2, LX/0YF;

    invoke-direct {v2}, LX/0YF;-><init>()V

    sput-object v2, LX/0YF;->A07:LX/0YF;
    ...
    invoke-virtual {v2, v1, v0}, LX/0YF;->A0A(LX/0sq;Ljava/lang/String;)V
    ...
    invoke-direct {v1}, LX/0c6;-><init>()V
    ...
    invoke-direct {v1}, LX/0c8;-><init>()V
...
.method public static A04(Landroid/graphics/drawable/Drawable;LX/0MO;[I)V
    .locals 3

    invoke-static {p0}, LX/0Xw;->A03(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    iget-boolean v0, p1, LX/0MO;->A02:Z

    if-nez v0, :cond_5

    iget-boolean v0, p1, LX/0MO;->A03:Z
    ...
    iget-object v1, p1, LX/0MO;->A01:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v1, v0}, LX/0YF;->A00(Landroid/graphics/PorterDuff$Mode;I)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_3
    sget-object v1, LX/0YF;->A08:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    iget-object v2, p1, LX/0MO;->A00:Landroid/content/res/ColorStateList;
...
.method public declared-synchronized A05(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    iget-object v0, p0, LX/0YF;->A04:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, v3}, LX/0j7;->A01(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, LX/0YF;->A01:LX/0r1;
    ...
    invoke-static {p1, v6}, LX/0Xx;->A02(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v0, LX/0Xx;->A01:[I

    aput-object v0, v2, v4

    const v0, 0x7f0401a3

    invoke-static {p1, v0}, LX/0Xx;->A01(Landroid/content/Context;I)I

    move-result v0

    aput v0, v1, v4

    sget-object v0, LX/0Xx;->A03:[I
    ...
    invoke-static {p1, v6}, LX/0Xx;->A00(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v6}, LX/0Xx;->A01(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, LX/0cA;->A00(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v2, LX/0cA;->A04:[I

    invoke-static {v0, p2}, LX/0cA;->A02([II)Z
    ...
    invoke-static {p1, v0}, LX/0Xx;->A02(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    iget-object v0, v2, LX/0cA;->A05:[I
    ...
    :cond_5
    iget-object v0, v2, LX/0cA;->A03:[I
    ...
    :cond_7
    invoke-static {p1, v1}, LX/0Xx;->A01(Landroid/content/Context;I)I
    ...
    :cond_8
    :goto_1
    invoke-static {p1, v1}, LX/0WF;->A00(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, LX/0YF;->A04:Ljava/util/WeakHashMap;
    ...
    :cond_b
    invoke-virtual {v1, p2, v3}, LX/0j7;->A02(ILjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized A06(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, LX/0YF;->A07(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized A07(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v0}, LX/0YF;->A06(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v2, p0, LX/0YF;->A02:LX/0Xm;

    const/4 v4, 0x0

    if-eqz v2, :cond_8

    invoke-virtual {v2}, LX/0Xm;->isEmpty()Z

    move-result v0

    if-nez v0, :cond_8

    iget-object v0, p0, LX/0YF;->A03:LX/0j7;

    const-string v5, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2, v4}, LX/0j7;->A01(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, LX/0YF;->A03:LX/0j7;

    :cond_2
    iget-object v6, p0, LX/0YF;->A00:Landroid/util/TypedValue;
    ...
    iput-object v6, p0, LX/0YF;->A00:Landroid/util/TypedValue;
    ...
    invoke-virtual {p0, p1, v0, v1}, LX/0YF;->A08(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, LX/0YF;->A03:LX/0j7;

    invoke-virtual {v2, p2, v3}, LX/0j7;->A02(ILjava/lang/Object;)V

    iget-object v2, p0, LX/0YF;->A02:LX/0Xm;

    invoke-virtual {v2, v3}, LX/0Xm;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v3, p1, v2, v7, v8}, LX/0sq;->Au4(Landroid/content/Context;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v4, v0, v1}, LX/0YF;->A09(Landroid/content/Context;Landroid/graphics/drawable/Drawable;J)V
    ...
    invoke-virtual {v0, p2, v5}, LX/0j7;->A02(ILjava/lang/Object;)V

    :cond_8
    :goto_2
    if-nez v4, :cond_11

    iget-object v5, p0, LX/0YF;->A00:Landroid/util/TypedValue;
    ...
    iput-object v5, p0, LX/0YF;->A00:Landroid/util/TypedValue;
    ...
    invoke-virtual {p0, p1, v2}, LX/0YF;->A06(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2}, LX/0S4;->A00(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, LX/0YF;->A05(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v1

    if-eqz v1, :cond_14

    invoke-static {v4}, LX/0Xw;->A03(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v1, v4}, LX/0Z1;->A01(Landroid/content/res/ColorStateList;Landroid/graphics/drawable/Drawable;)V

    iget-object v0, p0, LX/0YF;->A01:LX/0r1;
    ...
    invoke-static {v0, v4}, LX/0Z1;->A04(Landroid/graphics/PorterDuff$Mode;Landroid/graphics/drawable/Drawable;)V

    goto/16 :goto_10

    :cond_14
    iget-object v1, p0, LX/0YF;->A01:LX/0r1;
    ...
    sget-object v5, LX/0Y3;->A02:Landroid/graphics/PorterDuff$Mode;

    iget-object v0, v1, LX/0cA;->A02:[I
    ...
    :cond_16
    iget-object v0, v1, LX/0cA;->A01:[I
    ...
    :cond_17
    iget-object v0, v1, LX/0cA;->A00:[I
    ...
    invoke-static {v5, v0}, LX/0Y3;->A00(Landroid/graphics/PorterDuff$Mode;I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p1, v0}, LX/0Xx;->A00(Landroid/content/Context;I)I

    move-result v0

    sget-object v6, LX/0Y3;->A02:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v6, v1, v0}, LX/0cA;->A01(Landroid/graphics/PorterDuff$Mode;Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {v6, v2, v0}, LX/0cA;->A01(Landroid/graphics/PorterDuff$Mode;Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p1, v3}, LX/0Xx;->A01(Landroid/content/Context;I)I
    ...
    invoke-static {v4}, LX/0Xw;->A02(Landroid/graphics/drawable/Drawable;)V
    :try_end_2
...
.method public final declared-synchronized A08(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    iget-object v0, p0, LX/0YF;->A06:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v3, p2, p3, v2}, LX/0j9;->A05(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v3, p2, p3}, LX/0j9;->A08(J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized A09(Landroid/content/Context;Landroid/graphics/drawable/Drawable;J)V
    ...
    invoke-direct {v1}, LX/0j9;-><init>()V
    ...
    invoke-virtual {v1, p3, p4, v0}, LX/0j9;->A0A(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final A0A(LX/0sq;Ljava/lang/String;)V
    .locals 1

    iget-object v0, p0, LX/0YF;->A02:LX/0Xm;
    ...
    iput-object v0, p0, LX/0YF;->A02:LX/0Xm;

    :cond_0
    invoke-virtual {v0, p2, p1}, LX/0Xm;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
