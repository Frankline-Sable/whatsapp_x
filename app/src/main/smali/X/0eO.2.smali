...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/0eO;->A00:Landroid/credentials/CredentialManager;

    return-void
.end method

.method public static final A00(Landroid/credentials/GetCredentialResponse;)LX/0Ks;
    .locals 3
    ...
    invoke-static {v2}, LX/0eO;->A01(Landroid/os/Bundle;)LX/06i;
    ...
    invoke-static {v2}, LX/0eO;->A02(Landroid/os/Bundle;)LX/06h;
    ...
    invoke-direct {v1, p0, v2}, LX/06g;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    :goto_0
    new-instance v0, LX/0Ks;

    invoke-direct {v0, v1}, LX/0Ks;-><init>(LX/0Kq;)V

    return-object v0
.end method

.method public static final A01(Landroid/os/Bundle;)LX/06i;
    .locals 3
...
.method public static final A02(Landroid/os/Bundle;)LX/06h;
    .locals 2
    ...
    invoke-direct {v0, v1, p0}, LX/06h;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static final A03(Landroid/credentials/CreateCredentialException;)LX/0Gn;
    .locals 3
    ...
    invoke-static {v1, v0}, LX/6Bx;->A04(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v2, v0}, LX/0eO;->A04(Ljava/lang/String;Ljava/lang/String;)LX/0Gn;
    ...
    invoke-direct {v1, v0}, LX/06t;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v2, v0}, LX/06n;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
...
.method public static final A04(Ljava/lang/String;Ljava/lang/String;)LX/0Gn;
    .locals 4

    :try_start_0
    const-string v0, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION"

    invoke-static {p0, v0}, LX/8FS;->A0L(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    :try_end_0
    .catch LX/0Gh; {:try_start_0 .. :try_end_0} :catch_1

    :try_start_1
    new-instance v1, LX/07T;

    invoke-direct {v1}, LX/07T;-><init>()V

    const/4 v0, 0x0

    new-instance v2, LX/07W;

    invoke-direct {v2, v1, v0}, LX/07W;-><init>(LX/0Kt;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, p0, v1}, LX/0eO;->A08(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Z
    ...
    invoke-static {v0, v2, p1}, LX/0eO;->A07(LX/0Kt;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    throw v0
    :try_end_1
    .catch LX/0Gh; {:try_start_1 .. :try_end_1} :catch_0

    :catch_0
    :try_start_2
    new-instance v0, LX/06n;

    invoke-direct {v0, p0, p1}, LX/06n;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    throw v0
    :try_end_2
    .catch LX/0Gh; {:try_start_2 .. :try_end_2} :catch_1
...
.method public static final A05(Landroid/credentials/GetCredentialException;)LX/0Go;
    .locals 3
    ...
    invoke-static {v2, v0}, LX/0eO;->A06(Ljava/lang/String;Ljava/lang/String;)LX/0Go;
    ...
    invoke-direct {v1, v0}, LX/070;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v0}, LX/072;-><init>(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v2, v0}, LX/06v;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
...
.method public static final A06(Ljava/lang/String;Ljava/lang/String;)LX/0Go;
    .locals 4

    :try_start_0
    const-string v0, "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION"

    invoke-static {p0, v0}, LX/6Bx;->A04(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {v2, v1, v0}, LX/07X;-><init>(LX/0Kt;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, p0, p1}, LX/06v;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;)V
...
.method public static final A07(LX/0Kt;Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-direct {v0, p0, p2}, LX/07W;-><init>(LX/0Kt;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, p0, p2}, LX/07X;-><init>(LX/0Kt;Ljava/lang/CharSequence;)V
...
# virtual methods
.method public final A09(Landroid/content/Context;LX/0M6;)Landroid/credentials/CreateCredentialRequest;
    .locals 6

    const-string v3, "androidx.credentials.TYPE_PUBLIC_KEY_CREDENTIAL"

    iget-object v2, p2, LX/0M6;->A01:Landroid/os/Bundle;

    iget-object v5, p2, LX/0M6;->A02:LX/0La;
    ...
    iget-object v0, v5, LX/0La;->A01:Ljava/lang/CharSequence;

    invoke-virtual {v4, v1, v0}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    iget-object v1, v5, LX/0La;->A00:Ljava/lang/CharSequence;
    ...
    iget-object v0, p2, LX/0M6;->A00:Landroid/os/Bundle;
...
.method public final A0A(LX/0Kr;)Landroid/credentials/GetCredentialRequest;
    .locals 8
    ...
    iget-object v0, p1, LX/0Kr;->A00:Ljava/util/List;
    ...
    iget-object v3, v4, LX/0Mk;->A02:Ljava/lang/String;

    iget-object v2, v4, LX/0Mk;->A01:Landroid/os/Bundle;

    iget-object v1, v4, LX/0Mk;->A00:Landroid/os/Bundle;

    new-instance v0, Landroid/credentials/CredentialOption$Builder;

    invoke-direct {v0, v3, v2, v1}, Landroid/credentials/CredentialOption$Builder;-><init>(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/Bundle;)V

    invoke-virtual {v0, v7}, Landroid/credentials/CredentialOption$Builder;->setIsSystemProviderRequired(Z)Landroid/credentials/CredentialOption$Builder;

    move-result-object v1

    iget-object v0, v4, LX/0Mk;->A03:Ljava/util/Set;
...
.method public final A0B(LX/8cU;)Z
    .locals 1

    iget-object v0, p0, LX/0eO;->A00:Landroid/credentials/CredentialManager;
...
.method public onCreateCredential(Landroid/content/Context;LX/0M6;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LX/0uu;)V
    ...
    invoke-direct {v0, p5}, LX/0pi;-><init>(LX/0uu;)V

    invoke-virtual {p0, v0}, LX/0eO;->A0B(LX/8cU;)Z
    ...
    invoke-direct {v5, p2, p5, p0}, LX/0a7;-><init>(LX/0M6;LX/0uu;LX/0eO;)V
    ...
    invoke-virtual {p0, p1, p2}, LX/0eO;->A09(Landroid/content/Context;LX/0M6;)Landroid/credentials/CreateCredentialRequest;
...
.method public onGetCredential(Landroid/content/Context;LX/0Kr;Landroid/os/CancellationSignal;Ljava/util/concurrent/Executor;LX/0uu;)V
    ...
    invoke-direct {v0, p5}, LX/0pj;-><init>(LX/0uu;)V
    ...
    new-instance v5, LX/0a6;

    invoke-direct {v5, p5, p0}, LX/0a6;-><init>(LX/0uu;LX/0eO;)V

    iget-object v0, p0, LX/0eO;->A00:Landroid/credentials/CredentialManager;

    invoke-static {v0}, LX/7cX;->A0G(Ljava/lang/Object;)V

    invoke-virtual {p0, p2}, LX/0eO;->A0A(LX/0Kr;)Landroid/credentials/GetCredentialRequest;
