...
.method public constructor <init>(LX/0Pc;)V
    ...
    iput-object p1, p0, LX/00b;->A00:LX/0Pc;
...
.method public onCaptureSharedElementSnapshot(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    ...
    iget-object v11, p0, LX/00b;->A00:LX/0Pc;
    ...
    iget-object v0, v11, LX/0Pc;->A00:Landroid/graphics/Matrix;
    ...
    iput-object v0, v11, LX/0Pc;->A00:Landroid/graphics/Matrix;

    :cond_3
    invoke-virtual {v0, p2}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v2, v11, LX/0Pc;->A00:Landroid/graphics/Matrix;
...
.method public onMapSharedElements(Ljava/util/List;Ljava/util/Map;)V
    ...
    iget-object v0, p0, LX/00b;->A00:LX/0Pc;

    invoke-virtual {v0, p1, p2}, LX/0Pc;->A03(Ljava/util/List;Ljava/util/Map;)V
...
.method public onSharedElementEnd(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LX/0Pc;->A02(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method public onSharedElementStart(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LX/0Pc;->A01(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
...
.method public onSharedElementsArrived(Ljava/util/List;Ljava/util/List;Landroid/app/SharedElementCallback$OnSharedElementsReadyListener;)V
    ...
    invoke-direct {v0, p3}, LX/0NO;-><init>(Landroid/app/SharedElementCallback$OnSharedElementsReadyListener;)V
