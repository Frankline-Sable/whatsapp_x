...
.method public constructor <init>(Landroid/content/Context;LX/0YL;)V
    ...
    iput-object v0, p0, LX/0o5;->A01:Landroid/content/Context;

    iput-object p2, p0, LX/0o5;->A02:LX/0YL;

    iget-object v0, p2, LX/0YL;->A05:LX/0L2;

    iput-object v0, p0, LX/0o5;->A03:LX/0L2;
...
.method public run()V
    ...
    :try_start_0
    iget-object v9, p0, LX/0o5;->A02:LX/0YL;

    iget-object v8, v9, LX/0YL;->A02:LX/0OP;
    ...
    sget-object v6, LX/0o5;->A05:Ljava/lang/String;

    const-string v0, "The default process name was not specified."

    invoke-virtual {v1, v6, v0}, LX/0Xh;->A04(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_0
    iget-object v0, p0, LX/0o5;->A01:Landroid/content/Context;

    invoke-static {v0, v8}, LX/0W3;->A01(Landroid/content/Context;LX/0OP;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {v9}, LX/0YL;->A05()V
    ...
    :goto_1
    :try_start_1
    iget-object v4, p0, LX/0o5;->A01:Landroid/content/Context;

    invoke-static {v4}, LX/0Y0;->A02(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-static {v4, v9}, LX/0gN;->A04(Landroid/content/Context;LX/0YL;)Z

    move-result v12

    :goto_2
    iget-object v3, v9, LX/0YL;->A04:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v3}, Landroidx/work/impl/WorkDatabase;->A0J()LX/0vf;
    ...
    :goto_3
    :try_start_4
    invoke-interface {v11}, LX/0vf;->B5o()Ljava/util/List;
    ...
    iget-object v2, v1, LX/0Xi;->A0J:Ljava/lang/String;

    invoke-interface {v11, v0, v2}, LX/0vf;->BfV(LX/0GZ;Ljava/lang/String;)I

    const-wide/16 v0, -0x1

    invoke-interface {v11, v2, v0, v1}, LX/0vf;->BDs(Ljava/lang/String;J)I
    ...
    iget-object v5, v10, LX/0gW;->A01:LX/0Rk;

    invoke-virtual {v5}, LX/0Rk;->A09()V

    iget-object v2, v10, LX/0gW;->A03:LX/0Qo;
    ...
    :try_start_5
    invoke-static {v5, v1}, LX/0A9;->A00(LX/0Rk;Ljava/lang/Object;)V
    :try_end_5
    ...
    :cond_6
    iget-object v0, v9, LX/0YL;->A05:LX/0L2;

    iget-object v7, v0, LX/0L2;->A00:Landroidx/work/impl/WorkDatabase;
    ...
    invoke-interface {v0, v5}, LX/0v7;->B2d(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-virtual {v9}, LX/0YL;->A06()V
    ...
    invoke-direct {v2, v5, v0}, LX/0Pt;-><init>(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-interface {v0, v2}, LX/0v7;->BA2(LX/0Pt;)V
    ...
    iget-object v0, p0, LX/0o5;->A03:LX/0L2;

    iget-object v0, v0, LX/0L2;->A00:Landroidx/work/impl/WorkDatabase;
    ...
    invoke-interface {v1, v0}, LX/0v7;->B2d(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v4}, LX/0o5;->A00(Landroid/content/Context;)V
    ...
    iget-object v4, p0, LX/0o5;->A03:LX/0L2;
    ...
    invoke-direct {v2, v1, v0}, LX/0Pt;-><init>(Ljava/lang/String;Ljava/lang/Long;)V

    iget-object v7, v4, LX/0L2;->A00:Landroidx/work/impl/WorkDatabase;
    ...
    invoke-static {v8, v3, v0}, LX/0W1;->A01(LX/0OP;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    iget-object v0, p0, LX/0o5;->A02:LX/0YL;

    invoke-virtual {v0}, LX/0YL;->A05()V
