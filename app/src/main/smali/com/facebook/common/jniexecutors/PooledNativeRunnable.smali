...
# static fields
.field public static final sPool:LX/7KY;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, LX/7AE;-><init>(LX/8RD;)V

    new-instance v2, LX/6Qj;

    invoke-direct {v2}, LX/6Qj;-><init>()V

    iput-object v2, v0, LX/7AE;->A00:LX/7Mu;

    iget-object v1, v0, LX/7AE;->A01:LX/8RD;

    if-eqz v1, :cond_0

    new-instance v0, LX/7KY;

    invoke-direct {v0, v2, v1}, LX/7KY;-><init>(LX/7Mu;LX/8RD;)V

    sput-object v0, Lcom/facebook/common/jniexecutors/PooledNativeRunnable;->sPool:LX/7KY;
...
.method public static allocate(Lcom/facebook/jni/HybridData;)Lcom/facebook/common/jniexecutors/PooledNativeRunnable;
    ...
    sget-object v4, Lcom/facebook/common/jniexecutors/PooledNativeRunnable;->sPool:LX/7KY;

    monitor-enter v4

    :try_start_0
    iget v0, v4, LX/7KY;->A00:I

    if-lez v0, :cond_0

    add-int/lit8 v3, v0, -0x1

    iput v3, v4, LX/7KY;->A00:I

    iget-object v1, v4, LX/7KY;->A02:[Ljava/lang/Object;
...
.method public run()V
    ...
    :goto_0
    sget-object v3, Lcom/facebook/common/jniexecutors/PooledNativeRunnable;->sPool:LX/7KY;

    monitor-enter v3

    :try_start_1
    iget-object v0, v3, LX/7KY;->A07:LX/8RD;

    invoke-interface {v0}, LX/8RD;->now()J

    move-result-wide v5

    iget v1, v3, LX/7KY;->A00:I

    iget v4, v3, LX/7KY;->A03:I

    mul-int/lit8 v0, v4, 0x2

    if-ge v1, v0, :cond_0

    iput-wide v5, v3, LX/7KY;->A01:J

    :cond_0
    iget-wide v0, v3, LX/7KY;->A01:J
    ...
    invoke-static {v1, v0}, LX/7cT;->A00(Ljava/lang/Class;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    iget-object v0, v3, LX/7KY;->A02:[Ljava/lang/Object;

    array-length v2, v0

    sub-int v1, v2, v4

    iget v0, v3, LX/7KY;->A05:I
    ...
    invoke-virtual {v3, v0}, LX/7KY;->A00(I)V
    ...
    iget v0, v3, LX/7KY;->A00:I

    iget v2, v3, LX/7KY;->A04:I
    ...
    :cond_2
    iget-object v2, v3, LX/7KY;->A02:[Ljava/lang/Object;
