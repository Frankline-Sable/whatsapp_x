...
.method public constructor <init>()V
    ...
    sget-object v2, LX/73d;->A00:Lcom/facebook/quicklog/reliability/UserFlowLogger;

    if-nez v2, :cond_0

    sget-object v1, LX/6xy;->A00:Lcom/facebook/quicklog/QuickPerformanceLogger;

    if-eqz v1, :cond_1

    const/4 v0, 0x1

    new-instance v2, LX/7lw;

    invoke-direct {v2, v1, v0}, LX/7lw;-><init>(Lcom/facebook/quicklog/LightweightQuickPerformanceLogger;Z)V

    sput-object v2, LX/73d;->A00:Lcom/facebook/quicklog/reliability/UserFlowLogger;
...
.method public static loadSoLibrary()V
    ...
    invoke-static {v1, v4, v0}, LX/7cT;->A02(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
...
.method public start(ILX/8NI;J)J
    .locals 1
...
.method public startWithFlowInstanceId(JLX/8NI;J)V
    .locals 1
