...
# instance fields
.field public mFbLocationCache:LX/7V3;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v5, p0, Lcom/facebook/native_bridge/NativeLocationManager;->mFbLocationCache:LX/7V3;

    if-eqz v4, :cond_0

    new-instance v3, LX/7TD;

    invoke-direct {v3, p1, v4}, LX/7TD;-><init>(Landroid/content/Context;Landroid/location/LocationManager;)V

    sget-object v2, LX/7ks;->A00:LX/7ks;
    ...
    invoke-direct {v0, v2, v1}, LX/7LY;-><init>(LX/8N9;LX/8RD;)V

    invoke-direct {p0, v3, v4, v0, v5}, Lcom/facebook/native_bridge/NativeLocationManager;->getFbLocationCache(LX/7TD;Landroid/location/LocationManager;LX/7LY;LX/8NH;)LX/7V3;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/native_bridge/NativeLocationManager;->mFbLocationCache:LX/7V3;
...
.method private declared-synchronized getFbLocationCache(LX/7TD;Landroid/location/LocationManager;LX/7LY;LX/8NH;)LX/7V3;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/facebook/native_bridge/NativeLocationManager;->mFbLocationCache:LX/7V3;

    if-nez v0, :cond_0

    new-instance v0, LX/7V3;

    invoke-direct {v0, p2, p1, p4, p3}, LX/7V3;-><init>(Landroid/location/LocationManager;LX/7TD;LX/8NH;LX/7LY;)V
...
.method public getCurrentPosition()[D
    ...
    invoke-virtual {v0}, LX/7V3;->A00()LX/7LB;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, v0, LX/7LB;->A00:Landroid/location/Location;
