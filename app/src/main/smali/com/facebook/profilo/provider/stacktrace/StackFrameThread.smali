...
.field public mSavedTraceContext:LX/7i1;
...
.method public static constructor <clinit>()V
    ...
    sget-object v1, Lcom/facebook/profilo/core/ProvidersRegistry;->A00:LX/7NH;

    invoke-virtual {v1, v0}, LX/7NH;->A02(Ljava/lang/Object;)I
...
.method public disable()V
    ...
    :cond_1
    iput-object v2, p0, Lcom/facebook/profilo/provider/stacktrace/StackFrameThread;->mSavedTraceContext:LX/7i1;
...
.method public enable()V
    ...
    iget-object v1, v0, LX/7X4;->A01:LX/7i1;

    iget v5, v1, LX/7i1;->A02:I
    ...
    :cond_3
    iget-object v2, v1, LX/7i1;->A08:LX/7hu;

    const-string v3, "provider.stack_trace.time_source"

    iget-object v2, v2, LX/7hu;->A04:Ljava/util/TreeMap;

    if-eqz v2, :cond_4

    invoke-static {v3, v2}, LX/0yL;->A0m(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/String;
    ...
    invoke-static {v2}, LX/6tX;->valueOf(Ljava/lang/String;)LX/6tX;
    ...
    :cond_4
    sget-object v9, LX/6tX;->A01:LX/6tX;
    ...
    :goto_0
    iget-object v8, v1, LX/7i1;->A08:LX/7hu;

    const-string v2, "provider.stack_trace.cpu_sampling_rate_ms"

    const/4 v11, 0x0

    invoke-virtual {v8, v2, v11}, LX/7hu;->A00(Ljava/lang/String;I)I

    move-result v2

    const-string v3, "provider.stack_trace.thread_detect_interval_ms"

    invoke-virtual {v8, v3, v11}, LX/7hu;->A00(Ljava/lang/String;I)I
    ...
    iget-object v6, v8, LX/7hu;->A00:Ljava/util/TreeMap;
    ...
    invoke-virtual {v8, v4, v3}, LX/7hu;->A00(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0}, LX/7X4;->A00()Lcom/facebook/profilo/logger/MultiBufferLogger;
    ...
    iput-object v1, v0, Lcom/facebook/profilo/provider/stacktrace/StackFrameThread;->mSavedTraceContext:LX/7i1;

    const/16 v1, 0x9

    new-instance v3, LX/80k;

    invoke-direct {v3, v0, v1}, LX/80k;-><init>(Ljava/lang/Object;I)V
...
.method public getTracingProviders()I
    ...
    iget-object v1, p0, Lcom/facebook/profilo/provider/stacktrace/StackFrameThread;->mSavedTraceContext:LX/7i1;
...
.method public final logAnnotation(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, LX/7X4;->A00()Lcom/facebook/profilo/logger/MultiBufferLogger;
...
.method public onTraceEnded(LX/7i1;LX/7lo;)V
    .locals 4

    iget v3, p1, LX/7i1;->A02:I
    ...
    :cond_2
    invoke-virtual {p0}, LX/7X4;->getSupportedProviders()I
...
.method public onTraceStarted(LX/7i1;LX/7lo;)V
    .locals 1
