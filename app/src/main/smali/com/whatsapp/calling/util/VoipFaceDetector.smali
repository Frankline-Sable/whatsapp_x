...
.field public final detector:LX/7N5;
...
# direct methods
.method public constructor <init>(LX/7N5;IZ)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/whatsapp/calling/util/VoipFaceDetector;->detector:LX/7N5;
...
.method public static create(Landroid/content/Context;IZ)Lcom/whatsapp/calling/util/VoipFaceDetector;
    ...
    invoke-direct {v3, p0}, LX/7BG;-><init>(Landroid/content/Context;)V

    const/4 v1, 0x1

    iput-boolean v1, v3, LX/7BG;->A00:Z

    new-instance v2, LX/6Xs;

    invoke-direct {v2}, LX/6Xs;-><init>()V

    const/4 v0, 0x0

    iput v0, v2, LX/6Xs;->A01:I

    iput v0, v2, LX/6Xs;->A02:I

    iput v0, v2, LX/6Xs;->A03:I

    iput-boolean v1, v2, LX/6Xs;->A04:Z

    iput-boolean v1, v2, LX/6Xs;->A05:Z

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, v2, LX/6Xs;->A00:F

    iget-object v1, v3, LX/7BG;->A01:Landroid/content/Context;

    new-instance v0, LX/6cx;

    invoke-direct {v0, v1, v2}, LX/6cx;-><init>(Landroid/content/Context;LX/6Xs;)V

    new-instance v1, LX/6d9;

    invoke-direct {v1, v0}, LX/6d9;-><init>(LX/6cx;)V

    new-instance v0, Lcom/whatsapp/calling/util/VoipFaceDetector;

    invoke-direct {v0, v1, p1, p2}, Lcom/whatsapp/calling/util/VoipFaceDetector;-><init>(LX/7N5;IZ)V
...
.method public declared-synchronized detect(Ljava/nio/ByteBuffer;IIII)Lcom/whatsapp/calling/util/VoipFaceDetector$DetectionResult;
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/util/VoipFaceDetector;->detector:LX/7N5;

    invoke-virtual {v0}, LX/7N5;->A02()Z
    ...
    invoke-direct {v4}, LX/7IY;-><init>()V
    ...
    iget-object v3, v4, LX/7IY;->A00:LX/7BE;

    iget-object v2, v3, LX/7BE;->A01:LX/7G7;

    iput v1, v2, LX/7G7;->A02:I

    iput v5, v2, LX/7G7;->A03:I

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v0

    iput-wide v0, v2, LX/7G7;->A04:J

    invoke-virtual {v4, p2, p3, p1, p4}, LX/7IY;->A00(IILjava/nio/ByteBuffer;I)V

    iget-object v0, v3, LX/7BE;->A00:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {v0, v3}, LX/7N5;->A00(LX/7BE;)Landroid/util/SparseArray;
    ...
    check-cast v3, LX/7GY;

    iget-object v1, v3, LX/7GY;->A03:Landroid/graphics/PointF;

    iget v8, v1, Landroid/graphics/PointF;->x:F

    iget v0, v3, LX/7GY;->A00:F
    ...
    :cond_a
    iget v4, v3, LX/7GY;->A01:F

    add-float/2addr v4, v1

    iget v3, v3, LX/7GY;->A00:F
    ...
    :goto_6
    iget v4, v3, LX/7GY;->A00:F

    add-float/2addr v4, v1

    iget v3, v3, LX/7GY;->A01:F
