...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A07:LX/35t;
    ...
    iput-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A03:LX/4Tf;
    ...
    invoke-direct {v0, p0}, LX/5iT;-><init>(Lcom/whatsapp/calling/callgrid/view/PipViewContainer;)V
...
.method public static synthetic A00(Lcom/whatsapp/calling/callgrid/view/PipViewContainer;Z)V
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A05:LX/8PE;

    if-eqz v0, :cond_0

    check-cast v0, LX/7v5;

    iget-object v0, v0, LX/7v5;->A00:Lcom/whatsapp/calling/callgrid/view/CallGrid;

    iget-object v0, v0, Lcom/whatsapp/calling/callgrid/view/CallGrid;->A06:LX/8PD;

    if-eqz v0, :cond_0

    check-cast v0, LX/7v4;

    iget-object p0, v0, LX/7v4;->A00:Lcom/whatsapp/voipcalling/VoipActivityV2;

    iput-boolean p1, p0, Lcom/whatsapp/voipcalling/VoipActivityV2;->A2E:Z
    ...
    invoke-virtual {p0}, Lcom/whatsapp/voipcalling/VoipActivityV2;->A6b()V
...
# virtual methods
.method public final A01(Landroid/graphics/Point;Landroid/graphics/Point;LX/5NF;)LX/7FR;
    .locals 6

    iget v5, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A0B:I

    iget v4, p3, LX/5NF;->A04:I

    add-int/2addr v4, v5

    iget v0, p3, LX/5NF;->A01:I
    ...
    invoke-direct {v0, v5, v2, v4, v1}, LX/7FR;-><init>(IIII)V
...
.method public final A02()V
    ...
    iget-object v10, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A06:LX/5NF;
    ...
    iget-object v1, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A06:LX/5NF;

    iget-boolean v0, v1, LX/5NF;->A06:Z
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04:LX/4Wj;

    if-eqz v0, :cond_2

    iget-object v0, v0, LX/4Wj;->A07:LX/5Vc;

    invoke-virtual {p0, v0}, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04(LX/5Vc;)V

    :cond_2
    return-void

    :cond_3
    invoke-virtual {p0, v2, v8, v1}, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A01(Landroid/graphics/Point;Landroid/graphics/Point;LX/5NF;)LX/7FR;
    ...
    iget v4, v2, LX/7FR;->A00:I

    iget v3, v2, LX/7FR;->A02:I
    ...
    iget v0, v2, LX/7FR;->A01:I

    goto :goto_1

    :cond_4
    iget v4, v2, LX/7FR;->A02:I

    iget v3, v2, LX/7FR;->A00:I

    goto :goto_2

    :cond_5
    iget v0, v2, LX/7FR;->A03:I

    goto :goto_1

    :cond_6
    iget v5, v10, LX/5NF;->A05:I

    if-lez v5, :cond_7

    iget v4, v10, LX/5NF;->A03:I
    ...
    iput v5, v10, LX/5NF;->A05:I

    iget v4, v0, Landroid/graphics/Point;->y:I

    iput v4, v10, LX/5NF;->A03:I
    ...
    invoke-static {v0, v3, v1}, LX/4E3;->A00(FFF)F
    ...
    invoke-static {v0, v2, v1}, LX/4E3;->A00(FFF)F
...
.method public final A03()V
    ...
    iget-object v1, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A05:LX/8PE;
    ...
    iget-object v0, v1, LX/7v5;->A00:Lcom/whatsapp/calling/callgrid/view/CallGrid;
    ...
    :cond_0
    iput-boolean v3, v1, LX/5NF;->A07:Z

    iput-boolean v4, v1, LX/5NF;->A08:Z
...
.method public final A04(LX/5Vc;)V
    .locals 3

    iget-object v1, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04:LX/4Wj;
    ...
    iput-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04:LX/4Wj;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->removeAllViews()V

    iget-object v2, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A03:LX/4Tf;
    ...
    :cond_1
    :goto_0
    invoke-virtual {v2, p0, v0}, LX/0Rl;->A04(Landroid/view/ViewGroup;I)LX/0VI;

    move-result-object v1

    check-cast v1, LX/4Wj;

    iput-object v1, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04:LX/4Wj;
    ...
    invoke-virtual {v0, p1}, LX/4Wj;->A0E(LX/5Vc;)V
    ...
    invoke-virtual {v1, v0}, LX/4Wj;->A09(I)V
...
.method public final generatedComponent()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A08:LX/3cT;
    ...
    iput-object v0, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A08:LX/3cT;
...
.method public getGlobalVisibleRect()Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A04:LX/4Wj;
...
.method public getPipViewHolder()LX/4Wj;
    .locals 1
...
.method public setPipListener(LX/8PE;)V
    .locals 0

    iput-object p1, p0, Lcom/whatsapp/calling/callgrid/view/PipViewContainer;->A05:LX/8PE;
