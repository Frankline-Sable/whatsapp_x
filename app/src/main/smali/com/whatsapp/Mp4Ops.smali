...
.method public constructor <init>(LX/2tK;)V
    ...
    iput-object p1, p0, Lcom/whatsapp/Mp4Ops;->A00:LX/2tK;

    return-void
.end method

.method public static A00(LX/7On;LX/2tK;Ljava/io/File;)V
    .locals 7
    ...
    iget v0, v0, LX/34c;->A00:I

    if-eqz v0, :cond_2

    invoke-virtual {p1, p2}, LX/2tK;->A04(Ljava/io/File;)Ljava/io/File;

    move-result-object v5

    invoke-virtual {p0, p2, v5}, LX/7On;->A02(Ljava/io/File;Ljava/io/File;)LX/6kp;
    ...
    invoke-virtual {p0, v2, v4, v5}, LX/7On;->A04(Lcom/whatsapp/Mp4Ops$LibMp4OperationResult;LX/6kp;Ljava/io/File;)V

    if-eqz v4, :cond_0

    iget-object v0, p0, LX/7On;->A02:LX/48z;
    ...
    invoke-static {p1, v5, p2}, LX/39Q;->A0W(LX/2tK;Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-direct {v0, v3, v6}, LX/1ye;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v2, v1}, LX/1ye;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v3, v1}, LX/1ye;-><init>(ILjava/lang/String;)V

    throw v0
.end method

.method public static A01(LX/7On;Ljava/io/File;Ljava/io/File;)V
    .locals 14
    ...
    invoke-virtual {p0, p1, p1}, LX/7On;->A01(Ljava/io/File;Ljava/io/File;)LX/6kp;
    ...
    invoke-virtual {v6, v2, v4, v5}, LX/7On;->A04(Lcom/whatsapp/Mp4Ops$LibMp4OperationResult;LX/6kp;Ljava/io/File;)V

    if-eqz v4, :cond_0

    iget-object v0, v6, LX/7On;->A02:LX/48z;
...
.method public static A02(LX/7On;Ljava/io/File;Ljava/io/File;Ljava/io/File;Ljava/io/File;IJJJJ)V
    .locals 14
    ...
    invoke-virtual {p0, v6, v5}, LX/7On;->A01(Ljava/io/File;Ljava/io/File;)LX/6kp;
    ...
    invoke-virtual {v4, v5, v3, v1}, LX/7On;->A04(Lcom/whatsapp/Mp4Ops$LibMp4OperationResult;LX/6kp;Ljava/io/File;)V
    ...
    invoke-direct {v0, v7, v1}, LX/1ye;-><init>(ILjava/lang/String;)V

    throw v0
.end method

.method public static A03(LX/7On;Ljava/io/File;Z)V
    .locals 7
    ...
    invoke-virtual {p0, p1, v0, p2}, LX/7On;->A03(Ljava/io/File;Ljava/lang/Integer;Z)LX/6kp;
    ...
    invoke-virtual {p0, v2, v6, v5}, LX/7On;->A04(Lcom/whatsapp/Mp4Ops$LibMp4OperationResult;LX/6kp;Ljava/io/File;)V
    ...
    invoke-direct {v0, v4, v1}, LX/1ye;-><init>(ILjava/lang/String;)V

    throw v0
.end method

.method public static A21()Lcom/whatsapp/Mp4Ops;
    .locals 2

    sget-object v1, Lcom/gbwhatsapp/yo/yo;->mSingletonC:LX/3H7;

    iget-object v0, v1, LX/3H7;->AL6:LX/45Q;
...
# virtual methods
.method public A04(LX/7On;Ljava/io/File;)Z
    .locals 8
    ...
    invoke-virtual {p1, p2, v0, v4}, LX/7On;->A03(Ljava/io/File;Ljava/lang/Integer;Z)LX/6kp;

    move-result-object v6

    iget-object v1, p0, Lcom/whatsapp/Mp4Ops;->A00:LX/2tK;

    invoke-virtual {v1, p2}, LX/2tK;->A04(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v6}, LX/6kp;->A01(LX/6kp;)V
    ...
    iput-object v0, v6, LX/6kp;->A0D:Ljava/lang/Long;
    ...
    iput-object v0, v6, LX/6kp;->A0C:Ljava/lang/Long;

    iget-object v4, v3, Lcom/whatsapp/Mp4Ops$LibMp4CheckAndRepairResult;->asi:Lcom/whatsapp/Mp4Ops$AudioStreamInfo;

    if-eqz v4, :cond_0

    invoke-static {v4, v6}, LX/6kp;->A00(Lcom/whatsapp/Mp4Ops$AudioStreamInfo;LX/6kp;)V

    invoke-static {}, LX/0yG;->A0S()Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v6, LX/6kp;->A09:Ljava/lang/Long;
    ...
    iput-object v0, v6, LX/6kp;->A01:Ljava/lang/Integer;

    :cond_0
    iget-object v0, v3, Lcom/whatsapp/Mp4Ops$LibMp4CheckAndRepairResult;->vsi:Lcom/whatsapp/Mp4Ops$VideoStreamInfo;

    invoke-static {v0, v6}, LX/6NE;->A10(Lcom/whatsapp/Mp4Ops$VideoStreamInfo;LX/6kp;)V

    iget-object v0, p1, LX/7On;->A02:LX/48z;
    ...
    invoke-static {p1, v2, p2}, Lcom/whatsapp/Mp4Ops;->A01(LX/7On;Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {p1, p2, v5}, Lcom/whatsapp/Mp4Ops;->A01(LX/7On;Ljava/io/File;Ljava/io/File;)V
