...
.field public A0A:LX/4F1;

.field public A0B:LX/5cw;
...
.field public final A0H:LX/0RY;

.field public final A0I:LX/5PJ;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, LX/5PJ;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;)V

    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0I:LX/5PJ;
    ...
    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0H:LX/0RY;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p0, v4}, LX/6Hg;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0H:LX/0RY;

    sget-object v0, LX/5HZ;->A0a:[I
    ...
    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0B:LX/5cw;
    ...
    invoke-static {v1}, LX/0YR;->A05(Landroid/view/View;)Z
    ...
    :cond_3
    iget-object v1, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0B:LX/5cw;
    ...
    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0A:LX/4F1;
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0A:LX/4F1;
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0C:LX/7Si;

    if-nez v0, :cond_5

    new-instance v0, LX/7Si;

    invoke-direct {v0, p0}, LX/7Si;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;)V

    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0C:LX/7Si;
    ...
    iget-object v1, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0A:LX/4F1;
...
.method public A07(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1, p0}, LX/4OR;-><init>(Landroid/os/Parcelable;Lcom/google/android/material/sidesheet/SideSheetBehavior;)V
...
.method public A08()V
    ...
    iput-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A09:LX/0X8;
...
.method public A0E(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    invoke-static {p2}, LX/0ZR;->A09(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A09:LX/0X8;
...
.method public A0F(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A09:LX/0X8;
...
.method public A0I(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;I)Z
    ...
    iget-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0A:LX/4F1;
    ...
    invoke-direct {v0, v2}, LX/0ww;-><init>(I)V

    invoke-virtual {v0, p1, v1}, LX/0R5;->A03(Landroid/view/View;Ljava/lang/Object;)V

    sget-object v4, LX/0ZR;->A08:LX/0bN;

    if-eqz v1, :cond_d

    iget-object v3, v4, LX/0bN;->A00:Ljava/util/WeakHashMap;
    ...
    invoke-static {p1}, LX/0YR;->A04(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_8

    invoke-static {p1, v4}, LX/4E0;->A1B(Landroid/view/View;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0H:LX/0RY;
    ...
    iget-object v0, v0, LX/7Si;->A00:Lcom/google/android/material/sidesheet/SideSheetBehavior;

    iget v1, v0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A05:I

    :goto_2
    invoke-static {p1, v1}, LX/0ZR;->A0I(Landroid/view/View;I)V
    ...
    :cond_d
    iget-object v0, v4, LX/0bN;->A00:Ljava/util/WeakHashMap;
    ...
    invoke-static {v4, v0}, LX/0ZL;->A0A(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;Landroid/view/ViewTreeObserver;)V
...
.method public A0J(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;IIII)Z
    ...
    invoke-static {v3, v0}, LX/4E3;->A0J(Landroid/view/ViewGroup$MarginLayoutParams;I)I
...
.method public final A0K()V
    ...
    invoke-static {v4, v0}, LX/0ZR;->A0K(Landroid/view/View;I)V
    ...
    invoke-direct {v0, p0, v3}, LX/5jV;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;I)V
...
.method public final A0M(Landroid/view/View;IZ)V
    ...
    iget-object v3, v0, LX/7Si;->A00:Lcom/google/android/material/sidesheet/SideSheetBehavior;
    ...
    iget-object v0, v3, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0C:LX/7Si;
    ...
    :goto_0
    iget-object v1, v3, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A09:LX/0X8;
    ...
    invoke-virtual {v1, v2, v0}, LX/0X8;->A0C(II)Z
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->A0I:LX/5PJ;

    invoke-virtual {v0, p2}, LX/5PJ;->A00(I)V

    return-void

    :cond_0
    invoke-virtual {v1, p1, v2, v0}, LX/0X8;->A0H(Landroid/view/View;II)Z
