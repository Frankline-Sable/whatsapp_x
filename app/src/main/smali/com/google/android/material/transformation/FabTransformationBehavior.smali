...
.method public static final A00(LX/5Zu;LX/77w;F)F
    .locals 8

    iget-wide v0, p0, LX/5Zu;->A02:J

    iget-wide v2, p0, LX/5Zu;->A03:J

    iget-object v5, p1, LX/77w;->A00:LX/5cC;

    const-string v4, "expansion"

    invoke-virtual {v5, v4}, LX/5cC;->A03(Ljava/lang/String;)LX/5Zu;

    move-result-object v6

    iget-wide v4, v6, LX/5Zu;->A02:J

    iget-wide v6, v6, LX/5Zu;->A03:J
    ...
    iget-object v0, p0, LX/5Zu;->A04:Landroid/animation/TimeInterpolator;
    ...
    invoke-static {v0, p2, v1}, LX/001;->A00(FFF)F
...
.method public static final A01(LX/77w;FFZ)Landroid/util/Pair;
    .locals 3
    ...
    :cond_0
    iget-object v1, p0, LX/77w;->A00:LX/5cC;

    const-string v0, "translationXCurveDownwards"

    invoke-virtual {v1, v0}, LX/5cC;->A03(Ljava/lang/String;)LX/5Zu;
...
.method public A0D(LX/02k;)V
    ...
    iget v0, p1, LX/02k;->A01:I

    if-nez v0, :cond_0

    const/16 v0, 0x50

    iput v0, p1, LX/02k;->A01:I
...
.method public A0L(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    :cond_0
    new-instance v11, LX/77w;

    invoke-direct {v11}, LX/77w;-><init>()V

    invoke-static {v1, v0}, LX/5cC;->A00(Landroid/content/Context;I)LX/5cC;

    move-result-object v0

    iput-object v0, v11, LX/77w;->A00:LX/5cC;
    ...
    invoke-static {v13}, LX/0ZN;->A00(Landroid/view/View;)F

    move-result v4

    invoke-static {v14}, LX/0ZN;->A00(Landroid/view/View;)F
    ...
    :goto_0
    invoke-static {v2, v13, v1, v0, v3}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;

    move-result-object v2

    iget-object v1, v11, LX/77w;->A00:LX/5cC;
    ...
    invoke-static {v8, v7, v14, v13, v10}, LX/4E2;->A0y(Landroid/graphics/RectF;Landroid/graphics/RectF;Landroid/view/View;Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior;)V
    ...
    invoke-static {v11, v6, v5, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A01(LX/77w;FFZ)Landroid/util/Pair;
    ...
    invoke-static {v0, v13, v4}, LX/4Dz;->A0A(Landroid/util/Property;Ljava/lang/Object;F)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v3, v11, v6}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A00(LX/5Zu;LX/77w;F)F

    move-result v16

    invoke-static {v2, v11, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A00(LX/5Zu;LX/77w;F)F
    ...
    :goto_1
    invoke-virtual {v3, v15}, LX/5Zu;->A00(Landroid/animation/Animator;)V

    invoke-virtual {v2, v0}, LX/5Zu;->A00(Landroid/animation/Animator;)V
    ...
    invoke-static {v11, v0, v7, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A01(LX/77w;FFZ)Landroid/util/Pair;
    ...
    :cond_4
    invoke-static {v8, v14, v2, v0, v1}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;
    ...
    :cond_5
    invoke-static {v8, v14, v0, v7, v1}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;

    move-result-object v0

    invoke-virtual {v5, v2}, LX/5Zu;->A00(Landroid/animation/Animator;)V

    invoke-virtual {v3, v0}, LX/5Zu;->A00(Landroid/animation/Animator;)V
    ...
    sget-object v2, LX/4GI;->A00:Landroid/util/Property;
    ...
    :cond_6
    sget-object v3, LX/4GI;->A00:Landroid/util/Property;

    new-array v2, v6, [F

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-static {v3, v5, v2, v0, v1}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v3, v9}, LX/5Ei;->A00(Landroid/animation/AnimatorSet;Ljava/util/List;)V

    new-instance v0, LX/4EE;

    invoke-direct {v0, v13, v14, v10, v12}, LX/4EE;-><init>(Landroid/view/View;Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior;Z)V
    ...
    :cond_8
    sget-object v0, LX/4GI;->A00:Landroid/util/Property;

    invoke-static {v0, v5, v4}, LX/4Dz;->A0A(Landroid/util/Property;Ljava/lang/Object;F)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v6, v13, v0, v15, v1}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v6, v13, v0, v5, v1}, LX/4E3;->A0P(Landroid/util/Property;Ljava/lang/Object;[FFI)Landroid/animation/ObjectAnimator;
