...
.method public final zza(Landroid/content/Intent;II)I
    ...
    :try_start_1
    sget-object v1, Lcom/google/android/gms/internal/gtm/zzfi;->zzb:LX/7Wi;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, LX/7Wi;->A04()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v1}, LX/7Wi;->A00()V
    ...
    :catch_0
    :goto_0
    invoke-static {p0}, LX/6NF;->A0Z(Lcom/google/android/gms/internal/gtm/zzfn;)Lcom/google/android/gms/internal/gtm/zzfb;
    ...
    invoke-direct {v2, p0, p3, v4, v0}, LX/3gU;-><init>(Ljava/lang/Object;ILjava/lang/Object;I)V
