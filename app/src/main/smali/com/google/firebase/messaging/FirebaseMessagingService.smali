...
.method public final A03(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, LX/0Us;->A00(Landroid/content/Context;)LX/0Us;

    move-result-object v0

    invoke-virtual {v0, v1}, LX/0Us;->A01(Landroid/os/Bundle;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {v5}, LX/0V9;->A01(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v2, v5}, LX/0V9;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0, v2, v1}, LX/0Nz;-><init>(Landroid/content/Context;LX/0V9;Ljava/util/concurrent/Executor;)V
    ...
    :goto_1
    :try_start_0
    invoke-virtual {v0}, LX/0Nz;->A00()Z
    ...
    invoke-direct {v0, v5}, LX/0Cy;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->A05(LX/0Cy;)V
