...
# static fields
.field public static A00:LX/0Zs;
...
.method public static A00(Landroid/content/BroadcastReceiver;Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :cond_4
    iget-object v0, v4, LX/0UL;->A03:Ljava/util/Queue;
    ...
    :try_start_0
    iget-object v5, v4, LX/0UL;->A02:Ljava/lang/String;
    ...
    :cond_5
    iput-object v1, v4, LX/0UL;->A02:Ljava/lang/String;
    ...
    invoke-static {v6, v0}, LX/000;->A0j(Ljava/lang/Object;I)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v5, v1}, LX/000;->A0T(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_a
    :try_start_1
    invoke-virtual {v4, p1}, LX/0UL;->A01(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-static {p1, v2}, LX/0WJ;->A00(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static A01(Landroid/content/BroadcastReceiver;Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :try_start_0
    sget-object v4, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A00:LX/0Zs;

    if-nez v4, :cond_2

    new-instance v4, LX/0Zs;

    invoke-direct {v4, p1}, LX/0Zs;-><init>(Landroid/content/Context;)V

    sput-object v4, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A00:LX/0Zs;
    :try_end_0
    ...
    :cond_3
    iget-object v2, v4, LX/0Zs;->A04:Ljava/util/Queue;

    iget-object v1, v4, LX/0Zs;->A05:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v0, LX/0O8;

    invoke-direct {v0, v3, p2, v1}, LX/0O8;-><init>(Landroid/content/BroadcastReceiver$PendingResult;Landroid/content/Intent;Ljava/util/concurrent/ScheduledExecutorService;)V

    invoke-interface {v2, v0}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, LX/0Zs;->A00()V
    :try_end_1
...
.method public final A02(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    sget-object v5, Lcom/google/firebase/iid/FirebaseInstanceId;->A08:LX/0Wd;
    ...
    iget-object v0, v5, LX/0Wd;->A01:Landroid/content/SharedPreferences;
