...
.method public static A00(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    invoke-direct {v4}, LX/0N3;-><init>()V
    ...
    :goto_1
    iput-object v9, v4, LX/0N3;->A03:Landroid/os/Bundle;

    if-eqz v5, :cond_3

    iput-object v5, v4, LX/0N3;->A02:Landroid/net/Uri;

    :cond_1
    :goto_2
    iget-object v1, v4, LX/0N3;->A07:Ljava/lang/String;

    iget-object v14, v4, LX/0N3;->A06:Ljava/lang/CharSequence;

    iget-object v15, v4, LX/0N3;->A05:Ljava/lang/CharSequence;

    iget-object v0, v4, LX/0N3;->A04:Ljava/lang/CharSequence;

    iget-object v10, v4, LX/0N3;->A00:Landroid/graphics/Bitmap;

    iget-object v11, v4, LX/0N3;->A01:Landroid/net/Uri;

    iget-object v13, v4, LX/0N3;->A03:Landroid/os/Bundle;

    iget-object v12, v4, LX/0N3;->A02:Landroid/net/Uri;
    ...
    invoke-direct/range {v9 .. v17}, Landroid/support/v4/media/MediaDescriptionCompat;-><init>(Landroid/graphics/Bitmap;Landroid/net/Uri;Landroid/net/Uri;Landroid/os/Bundle;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/String;)V

    iput-object v3, v9, Landroid/support/v4/media/MediaDescriptionCompat;->A00:Landroid/media/MediaDescription;
    ...
    iput-object v0, v4, LX/0N3;->A02:Landroid/net/Uri;
