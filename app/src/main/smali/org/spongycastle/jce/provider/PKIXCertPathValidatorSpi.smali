...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/spongycastle/jce/provider/PKIXCertPathValidatorSpi;->A00:LX/8Qp;
...
.method public engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    instance-of v0, v5, LX/870;

    if-eqz v0, :cond_0

    check-cast v5, LX/870;

    iget-boolean v0, v5, LX/870;->A09:Z

    iput-boolean v0, v1, LX/7UG;->A08:Z

    iget v0, v5, LX/870;->A00:I

    iput v0, v1, LX/7UG;->A00:I

    :cond_0
    new-instance v5, LX/814;

    invoke-direct {v5, v1}, LX/814;-><init>(LX/7UG;)V

    :goto_0
    iget-object v9, v5, LX/814;->A08:Ljava/util/Set;
    ...
    iget-object v0, v5, LX/814;->A03:Ljava/util/Date;
    ...
    :cond_1
    iget-object v8, v5, LX/814;->A01:Ljava/security/cert/PKIXParameters;
    ...
    :cond_2
    instance-of v0, v5, LX/813;

    if-eqz v0, :cond_3

    check-cast v5, LX/813;

    iget-object v5, v5, LX/813;->A02:LX/814;

    goto :goto_0

    :cond_3
    instance-of v0, v5, LX/814;

    if-eqz v0, :cond_1a

    check-cast v5, LX/814;
    ...
    invoke-static {v0, v3, v9}, LX/7cH;->A01(Ljava/lang/String;Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/security/cert/TrustAnchor;
    ...
    invoke-direct {v3, v5}, LX/7UG;-><init>(LX/814;)V

    invoke-static/range {v19 .. v19}, Ljava/util/Collections;->singleton(Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, v3, LX/7UG;->A05:Ljava/util/Set;

    new-instance v5, LX/814;

    invoke-direct {v5, v3}, LX/814;-><init>(LX/7UG;)V
    ...
    new-instance v18, LX/7PB;

    invoke-direct/range {v18 .. v18}, LX/7PB;-><init>()V

    invoke-static {}, LX/002;->A0Q()Ljava/util/HashSet;

    move-result-object v30

    iget-object v10, v5, LX/814;->A01:Ljava/security/cert/PKIXParameters;
    ...
    invoke-static {v8}, LX/7Zw;->A03(Ljavax/security/auth/x500/X500Principal;)LX/8KC;
    ...
    iget-object v2, v5, LX/814;->A09:LX/85Q;
    ...
    iget-object v2, v2, LX/85Q;->A00:Ljava/security/cert/CertSelector;
    ...
    invoke-static {v2, v1, v7, v0}, LX/86v;->A00(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)LX/86v;
    ...
    :cond_a
    iget-boolean v0, v5, LX/814;->A0A:Z
    ...
    iget-object v0, v0, Lorg/spongycastle/jce/provider/PKIXCertPathValidatorSpi;->A00:LX/8Qp;

    new-instance v14, LX/85F;

    invoke-direct {v14, v0}, LX/85F;-><init>(LX/8Qp;)V
    ...
    invoke-static {v7, v10, v8, v0}, LX/7cY;->A0I(Ljava/security/cert/CertPath;LX/7PB;IZ)V
    ...
    invoke-static {v7, v3, v11, v8, v4}, LX/7cY;->A09(Ljava/security/cert/CertPath;LX/815;[Ljava/util/List;II)LX/815;
    ...
    invoke-static {v7, v8, v4}, LX/6NE;->A07(Ljava/security/cert/CertPath;II)I

    move-result v4

    move/from16 v0, v17

    invoke-static {v7, v8, v0}, LX/6NE;->A07(Ljava/security/cert/CertPath;II)I
    ...
    invoke-static {v7, v8, v4}, LX/7cY;->A01(Ljava/security/cert/CertPath;II)I

    move-result v4

    invoke-static {v7, v8, v0}, LX/7cY;->A02(Ljava/security/cert/CertPath;II)I
    ...
    invoke-static {v0}, LX/6NG;->A1J(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v7, v0, v10, v8}, LX/7cY;->A0F(Ljava/security/cert/CertPath;Ljava/util/List;Ljava/util/Set;I)V

    invoke-static {v1}, LX/7Zw;->A02(Ljava/security/cert/X509Certificate;)LX/8KC;
    ...
    invoke-static {v10, v0, v8}, LX/7cH;->A00(Ljava/util/List;LX/8Qp;I)Ljava/security/PublicKey;
    ...
    :cond_13
    invoke-static {v1}, LX/6NG;->A1J(Ljava/security/cert/X509Certificate;)Z
    ...
    invoke-static {v7, v4, v9}, LX/7cY;->A04(Ljava/security/cert/CertPath;II)I
    ...
    sget-object v0, LX/8K5;->A0E:LX/8KR;
    ...
    invoke-static {v7, v0, v2, v4}, LX/7cY;->A0G(Ljava/security/cert/CertPath;Ljava/util/List;Ljava/util/Set;I)V
    ...
    invoke-static {v0, v1, v7, v2}, LX/86v;->A00(Ljava/lang/String;Ljava/lang/Throwable;Ljava/security/cert/CertPath;I)LX/86v;
