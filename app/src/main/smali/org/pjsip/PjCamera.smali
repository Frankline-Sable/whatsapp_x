...
.method public constructor <init>(Landroid/content/Context;LX/1QX;LX/8bd;LX/35r;LX/7KW;IIIII)V
    .locals 10

    invoke-direct {p0, p1, p2, p3, p5}, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;-><init>(Landroid/content/Context;LX/1QX;LX/8bd;LX/7KW;)V
    ...
    invoke-static {v0, v2, v5}, LX/000;->A1C(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
    ...
    iput-object p4, p0, Lorg/pjsip/PjCamera;->systemServices:LX/35r;
...
.method private synthetic lambda$startOnCameraThread$0(ILandroid/hardware/Camera;)V
    ...
    iget-object v3, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraEventsDispatcher:LX/7Nd;

    if-eq p1, v0, :cond_1

    invoke-virtual {v3}, LX/7Nd;->A01()V

    :cond_0
    return-void

    :cond_1
    iget-object v0, v3, LX/7Nd;->A00:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v0, v3, LX/7Nd;->A01:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;

    invoke-interface {v1, v0}, LX/8YJ;->BTp(Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;)V
    ...
    invoke-interface {v1, v0}, LX/8YJ;->BLT(Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;)V
...
.method private updateAdjustedPreviewSizeOnCameraThread()V
    ...
    iget-object v0, p0, Lorg/pjsip/PjCamera;->systemServices:LX/35r;
...
.method public disableAREffectOnCameraThread()I
    ...
    invoke-interface {v0, v1, v1}, LX/8YW;->BeW(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
...
.method public enableAREffectOnCameraThread(LX/7Wb;LX/8Pr;)I
    ...
    invoke-direct {v0, p0, v1}, LX/8dl;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v4, v0, v3}, LX/8YW;->BeW(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
...
.method public getLastCachedFrame()LX/2T6;
    ...
    invoke-direct/range {v1 .. v7}, LX/2T6;-><init>([BIIIIZ)V
...
.method public startOnCameraThread()I
    ...
    invoke-direct {v0, v3, v1}, LX/8eQ;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v5, v0}, LX/0yE;->A1D(Ljava/lang/StringBuilder;I)V
    ...
    invoke-static {v0, v12, v1, v14, v13}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V

    invoke-static {v10, v1, v9}, LX/0yE;->A0x(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
    ...
    iget-object v0, v3, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraProcessor:LX/8YW;
    ...
    iget-object v4, v3, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraEventsDispatcher:LX/7Nd;

    iget v3, v3, Lorg/pjsip/PjCamera;->camIdx:I

    iget-object v0, v4, LX/7Nd;->A00:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v0, v4, LX/7Nd;->A01:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;

    invoke-interface {v1, v0, v3}, LX/8YJ;->BHW(Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;I)V
