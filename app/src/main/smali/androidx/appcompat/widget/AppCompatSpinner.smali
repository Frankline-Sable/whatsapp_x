...
.field public A03:LX/0bJ;

.field public final A04:Landroid/content/Context;

.field public final A05:Landroid/graphics/Rect;

.field public final A06:LX/0RV;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    sget-object v7, LX/0Ka;->A0K:[I

    const/4 v2, 0x0

    invoke-static {p1, p2, v7, p3, v2}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A06:LX/0RV;

    if-eqz p5, :cond_0

    new-instance v1, LX/00s;

    invoke-direct {v1, p1, p5}, LX/00s;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v0, v4, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v6, v0, p2, p0, p3}, LX/04j;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Landroidx/appcompat/widget/AppCompatSpinner;I)V

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A04:Landroid/content/Context;

    invoke-static {v0, p2, v7, p3, v2}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;
    ...
    iget-object v2, v7, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v7, v3}, LX/0Uw;->A02(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {v6, v0}, LX/0c0;->Bds(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, v6, LX/04j;->A02:Ljava/lang/CharSequence;

    invoke-virtual {v2}, Landroid/content/res/TypedArray;->recycle()V

    iput-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;

    new-instance v0, LX/0wt;

    invoke-direct {v0, p0, p0, v6, v3}, LX/0wt;-><init>(Landroid/view/View;Ljava/lang/Object;Ljava/lang/Object;I)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A03:LX/0bJ;

    :cond_5
    :goto_6
    const/4 v0, 0x0

    iget-object v4, v4, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    :cond_7
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A06:LX/0RV;
    ...
    invoke-direct {v2, p0}, LX/0c2;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;
    ...
    iput-object v0, v2, LX/0c2;->A02:Ljava/lang/CharSequence;
...
.method public A00(Landroid/graphics/drawable/Drawable;Landroid/widget/SpinnerAdapter;)I
    ...
    invoke-static {v2, v0, v9}, LX/001;->A0C(III)I
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/0vh;->B1Z()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, LX/0vh;->B7f()I
...
.method public final getInternalPopup()LX/0vh;
    .locals 1
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, LX/0vh;->Axu()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, LX/0vh;->B1X()Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;

    if-eqz v1, :cond_0

    invoke-interface {v1}, LX/0vh;->BCF()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {v1}, LX/0vh;->dismiss()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-boolean v0, p1, LX/02X;->A00:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v2, v0}, LX/02X;-><init>(Landroid/os/Parcelable;)V

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/0vh;->BCF()Z
    ...
    :cond_1
    iput-boolean v0, v2, LX/02X;->A00:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A03:LX/0bJ;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, LX/0bJ;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public performClick()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/0vh;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v0, v1, p1}, LX/0bc;-><init>(Landroid/content/res/Resources$Theme;Landroid/widget/SpinnerAdapter;)V

    invoke-interface {v2, v0}, LX/0vh;->Bdj(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, LX/0vh;->BeV(I)V

    invoke-interface {v0, p1}, LX/0vh;->BeU(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, LX/0vh;->Bfp(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, LX/0vh;->Bds(Landroid/graphics/drawable/Drawable;)V
...
.method public setPopupBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, LX/0YF;->A01(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, LX/0vh;->BfD(Ljava/lang/CharSequence;)V
