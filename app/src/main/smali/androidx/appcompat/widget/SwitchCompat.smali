...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v2}, LX/0wr;-><init>(I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v12, LX/0Ka;->A0L:[I

    invoke-static {p1, v10, v12, v13, v4}, LX/0Uw;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[III)LX/0Uw;

    move-result-object v3

    iget-object v9, v3, LX/0Uw;->A02:Landroid/content/res/TypedArray;

    invoke-static/range {v8 .. v13}, LX/0ZR;->A0B(Landroid/content/Context;Landroid/content/res/TypedArray;Landroid/util/AttributeSet;Landroid/view/View;[II)V
    ...
    invoke-virtual {v3, v0}, LX/0Uw;->A01(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v0}, LX/0Xw;->A00(Landroid/graphics/PorterDuff$Mode;I)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {v1, p1, v0}, LX/0Uw;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/4 v0, 0x3

    invoke-virtual {v1, v0}, LX/0Uw;->A01(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v3, v1, LX/0Uw;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v0, v1}, LX/0aj;-><init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->A0a:LX/0X5;

    invoke-virtual {v0, v10, v13}, LX/0X5;->A0B(Landroid/util/AttributeSet;I)V
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, LX/0Xw;->A01(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v2, LX/0Xw;->A01:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v1, v5, v3, v4}, LX/0Z1;->A07(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v8}, LX/0Xw;->A01(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    invoke-static {v0, v2, v1}, LX/001;->A0B(III)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v3, v0}, LX/002;->A00(FF)F
