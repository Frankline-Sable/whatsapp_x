...
.method public static final synthetic access$cancelOrCallbackExceptionOrResult$s895630660(Landroid/os/CancellationSignal;LX/8cU;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->cancelOrCallbackExceptionOrResult(Landroid/os/CancellationSignal;LX/8cU;)V
...
.method public static final synthetic access$maybeReportErrorFromResultReceiver(Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;Landroid/os/Bundle;LX/8cW;Ljava/util/concurrent/Executor;LX/0uu;Landroid/os/CancellationSignal;)Z
    .locals 0

    invoke-virtual/range {p0 .. p5}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->maybeReportErrorFromResultReceiver(Landroid/os/Bundle;LX/8cW;Ljava/util/concurrent/Executor;LX/0uu;Landroid/os/CancellationSignal;)Z
...
.method private final createGoogleIdCredential(LX/6Xa;)LX/6Oo;
    .locals 2

    new-instance v1, LX/7Pc;

    invoke-direct {v1}, LX/7Pc;-><init>()V

    invoke-virtual {p1}, LX/6Xa;->A06()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, LX/7cX;->A0C(Ljava/lang/Object;)V

    invoke-virtual {v1, v0}, LX/7Pc;->A05(Ljava/lang/String;)V

    invoke-virtual {p1}, LX/6Xa;->A05()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, LX/7cX;->A0G(Ljava/lang/Object;)V

    invoke-virtual {v1, v0}, LX/7Pc;->A06(Ljava/lang/String;)V

    invoke-virtual {p1}, LX/6Xa;->A02()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v1, v0}, LX/7Pc;->A02(Ljava/lang/String;)V

    :cond_0
    invoke-virtual {p1}, LX/6Xa;->A04()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v1, v0}, LX/7Pc;->A04(Ljava/lang/String;)V

    :cond_1
    invoke-virtual {p1}, LX/6Xa;->A03()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v1, v0}, LX/7Pc;->A03(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {p1}, LX/6Xa;->A08()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual {v1, v0}, LX/7Pc;->A07(Ljava/lang/String;)V

    :cond_3
    invoke-virtual {p1}, LX/6Xa;->A00()Landroid/net/Uri;

    move-result-object v0

    if-eqz v0, :cond_4

    invoke-virtual {v1, v0}, LX/7Pc;->A01(Landroid/net/Uri;)V

    :cond_4
    invoke-virtual {v1}, LX/7Pc;->A00()LX/6Oo;
...
# virtual methods
.method public convertRequestToPlayServices(LX/0Kr;)LX/6XL;
    .locals 2
    ...
    invoke-virtual {v1, p1, v0}, Landroidx/credentials/playservices/controllers/BeginSignIn/BeginSignInControllerUtility$Companion;->constructBeginSignInRequest$credentials_play_services_auth_release(LX/0Kr;Landroid/content/Context;)LX/6XL;
...
.method public bridge synthetic convertRequestToPlayServices(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->convertRequestToPlayServices(LX/0Kr;)LX/6XL;
...
.method public convertResponseToCredentialManager(LX/6Xa;)LX/0Ks;
    .locals 5
    ...
    invoke-virtual {p1}, LX/6Xa;->A07()Ljava/lang/String;
    ...
    invoke-direct {v3, v4, v1}, LX/06i;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    :goto_0
    new-instance v0, LX/0Ks;

    invoke-direct {v0, v3}, LX/0Ks;-><init>(LX/0Kq;)V
    ...
    invoke-direct {p0, p1}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->createGoogleIdCredential(LX/6Xa;)LX/6Oo;
    ...
    :cond_1
    invoke-virtual {p1}, LX/6Xa;->A01()LX/6Y4;
    ...
    invoke-virtual {v0, p1}, Landroidx/credentials/playservices/controllers/CreatePublicKeyCredential/PublicKeyCredentialControllerUtility$Companion;->toAssertPasskeyResponse(LX/6Xa;)Ljava/lang/String;
    ...
    new-instance v3, LX/06h;

    invoke-direct {v3, v2, v1}, LX/06h;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public bridge synthetic convertResponseToCredentialManager(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->convertResponseToCredentialManager(LX/6Xa;)LX/0Ks;
...
.method public final handleResponse$credentials_play_services_auth_release(IILandroid/content/Intent;)V
    ...
    invoke-static {p2, v2, v1, v0}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->maybeReportErrorResultCodeGet(ILX/8cW;LX/8cV;Landroid/os/CancellationSignal;)Z
    ...
    invoke-interface {v0, p3}, LX/8bK;->B6R(Landroid/content/Intent;)LX/6Xa;

    move-result-object v0

    invoke-virtual {p0, v0}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->convertResponseToCredentialManager(LX/6Xa;)LX/0Ks;
    ...
    invoke-direct {v0, p0, v2}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController$handleResponse$3;-><init>(Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;LX/0Ks;)V

    invoke-static {v1, v0}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->cancelOrCallbackExceptionOrResult(Landroid/os/CancellationSignal;LX/8cU;)V

    return-void
    :try_end_0
    .catch Lcom/google/android/gms/common/api/ApiException; {:try_start_0 .. :try_end_0} :catch_1
    .catch LX/0Go; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p0, v0}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController$handleResponse$5;-><init>(Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;LX/0Go;)V
    ...
    invoke-direct {v1, p0, v0}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController$handleResponse$6;-><init>(Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;LX/070;)V

    :goto_0
    invoke-static {v2, v1}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->cancelOrCallbackExceptionOrResult(Landroid/os/CancellationSignal;LX/8cU;)V
    ...
    :goto_1
    iput-object v1, v3, LX/3d9;->element:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, v3}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController$handleResponse$4;-><init>(Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;LX/3d9;)V
...
.method public invokePlayServices(LX/0Kr;LX/0uu;Ljava/util/concurrent/Executor;Landroid/os/CancellationSignal;)V
    .locals 4
    ...
    invoke-static {p4, v0}, Landroidx/credentials/playservices/controllers/CredentialProviderController;->cancelOrCallbackExceptionOrResult(Landroid/os/CancellationSignal;LX/8cU;)V
...
.method public bridge synthetic invokePlayServices(Ljava/lang/Object;LX/0uu;Ljava/util/concurrent/Executor;Landroid/os/CancellationSignal;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;->invokePlayServices(LX/0Kr;LX/0uu;Ljava/util/concurrent/Executor;Landroid/os/CancellationSignal;)V
