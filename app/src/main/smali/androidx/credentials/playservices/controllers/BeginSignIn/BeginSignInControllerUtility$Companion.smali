...
.method private final convertToGoogleIdTokenOption(LX/6Op;)LX/6XK;
    .locals 1
...
# virtual methods
.method public final constructBeginSignInRequest$credentials_play_services_auth_release(LX/0Kr;Landroid/content/Context;)LX/6XL;
    .locals 6
    ...
    invoke-direct {v3}, LX/7PE;-><init>()V
    ...
    invoke-virtual {v0}, LX/7LI;->A01()V

    invoke-virtual {v0}, LX/7LI;->A00()LX/6Ws;

    move-result-object v0

    invoke-virtual {v3, v0}, LX/7PE;->A03(LX/6Ws;)V

    if-nez v4, :cond_1

    iget-boolean v0, v2, LX/0Mk;->A04:Z
    ...
    invoke-virtual {v0, v2}, Landroidx/credentials/playservices/controllers/CreatePublicKeyCredential/PublicKeyCredentialControllerUtility$Companion;->convertToPlayAuthPasskeyRequest(LX/06k;)LX/6XA;

    move-result-object v0

    invoke-virtual {v3, v0}, LX/7PE;->A02(LX/6XA;)V
    ...
    :cond_3
    invoke-virtual {v0, v2}, Landroidx/credentials/playservices/controllers/CreatePublicKeyCredential/PublicKeyCredentialControllerUtility$Companion;->convertToPlayAuthPasskeyJsonRequest(LX/06k;)LX/6X4;

    move-result-object v0

    invoke-virtual {v3, v0}, LX/7PE;->A01(LX/6X4;)V

    goto :goto_1

    :cond_4
    invoke-virtual {v3, v4}, LX/7PE;->A04(Z)V

    invoke-virtual {v3}, LX/7PE;->A00()LX/6XL;
