...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;LX/0eU;)V
    .locals 6
    ...
    invoke-virtual {p3, v1}, LX/0eU;->A0B(I)LX/0f4;
    ...
    :cond_2
    invoke-virtual {p3}, LX/0eU;->A0E()LX/0WW;

    move-result-object v0

    invoke-virtual {p1}, Landroid/content/Context;->getClassLoader()Ljava/lang/ClassLoader;

    invoke-virtual {v0, v4}, LX/0WW;->A00(Ljava/lang/String;)LX/0f4;

    move-result-object v2

    invoke-static {v2}, LX/7cX;->A0C(Ljava/lang/Object;)V

    iput-boolean v5, v2, LX/0f4;->A0X:Z
    ...
    iput-boolean v0, v2, LX/0f4;->A0X:Z
    ...
    invoke-direct {v1, p3}, LX/0eR;-><init>(LX/0eU;)V

    iput-boolean v5, v1, LX/0eR;->A0H:Z

    iput-object p0, v2, LX/0f4;->A0C:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Landroid/view/View;->getId()I

    move-result v0

    invoke-virtual {v1, v2, v3, v0}, LX/0eR;->A0D(LX/0f4;Ljava/lang/String;I)V

    invoke-virtual {v1}, LX/0eR;->A04()V

    :cond_4
    iget-object v0, p3, LX/0eU;->A0Y:LX/0RT;
    ...
    iget-object v2, v3, LX/0X0;->A02:LX/0f4;

    iget v1, v2, LX/0f4;->A01:I
    ...
    invoke-virtual {v3}, LX/0X0;->A02()V
...
.method public dispatchApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-direct {v1, p1}, LX/0YI;-><init>(Landroid/view/WindowInsets;)V
    ...
    invoke-static {v0, p0, p1}, LX/0In;->A00(Landroid/view/View$OnApplyWindowInsetsListener;Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;

    move-result-object v0

    new-instance v3, LX/0YI;

    invoke-direct {v3, v0}, LX/0YI;-><init>(Landroid/view/WindowInsets;)V

    :goto_0
    iget-object v0, v3, LX/0YI;->A00:LX/0VR;
    ...
    invoke-static {v0, v3}, LX/0ZR;->A07(Landroid/view/View;LX/0YI;)LX/0YI;
    ...
    :cond_0
    invoke-static {p0, v1}, LX/0ZR;->A08(Landroid/view/View;LX/0YI;)LX/0YI;
...
.method public final getFragment()LX/0f4;
    .locals 3
    ...
    invoke-static {v1}, LX/00M;->A01(LX/03u;)LX/0eU;
