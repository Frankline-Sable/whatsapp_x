...
.field public A04:LX/0bO;

.field public A05:LX/0tD;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, v4, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0C:LX/0O4;
    ...
    iput-object v0, v4, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0D:LX/0LZ;

    const/4 v9, 0x0

    sget-object v6, LX/0KH;->A00:[I
    ...
    invoke-direct {v0, v4}, LX/0bK;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V
    ...
    invoke-static {v4}, LX/0ZL;->A00(Landroid/view/View;)I
...
.method public static A01(Landroid/view/View;)LX/02k;
    .locals 7

    invoke-static {p0}, LX/001;->A0Z(Landroid/view/View;)LX/02k;

    move-result-object v5

    iget-boolean v0, v5, LX/02k;->A0B:Z
    ...
    check-cast p0, LX/0t2;

    invoke-interface {p0}, LX/0t2;->getBehavior()LX/0VQ;

    move-result-object v0

    invoke-virtual {v5, v0}, LX/02k;->A01(LX/0VQ;)V

    :cond_0
    :goto_0
    iput-boolean v4, v5, LX/02k;->A0B:Z
...
.method public static A02(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0, p0}, LX/0ur;->Bap(Ljava/lang/Object;)Z

    return-void
.end method

.method public static final A03(Landroid/graphics/Rect;Landroid/graphics/Rect;LX/02k;III)V
    .locals 9

    iget v0, p2, LX/02k;->A02:I
...
.method public A05(Landroid/view/View;)Ljava/util/List;
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0C:LX/0O4;

    iget-object v5, v0, LX/0O4;->A00:LX/0Xm;
    ...
    invoke-static {v5, v2}, LX/0Xm;->A00(LX/0Xm;I)Ljava/lang/Object;
...
.method public final A06()V
    ...
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0C:LX/0O4;

    iget-object v6, v7, LX/0O4;->A00:LX/0Xm;

    invoke-virtual {v6}, LX/0Xm;->size()I
    ...
    invoke-static {v6, v2}, LX/0Xm;->A00(LX/0Xm;I)Ljava/lang/Object;
    ...
    iget-object v0, v7, LX/0O4;->A01:LX/0ur;
    ...
    :cond_1
    invoke-virtual {v6}, LX/0Xm;->clear()V
    ...
    invoke-static {v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A01(Landroid/view/View;)LX/02k;

    move-result-object v4

    iget v1, v4, LX/02k;->A05:I
    ...
    iput-object v0, v4, LX/02k;->A08:Landroid/view/View;

    iput-object v0, v4, LX/02k;->A09:Landroid/view/View;

    :goto_2
    invoke-virtual {v6, v3}, LX/0Xm;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6, v3, v0}, LX/0Xm;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v4, LX/02k;->A08:Landroid/view/View;
    ...
    :cond_3
    :goto_4
    invoke-virtual {v6, v1}, LX/0Xm;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v6, v1, v0}, LX/0Xm;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v1}, LX/0Xm;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_8
    iget-object v0, v4, LX/02k;->A0A:LX/0VQ;

    if-eqz v0, :cond_7

    invoke-virtual {v0, v3, v1, p0}, LX/0VQ;->A05(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    :cond_a
    iget-object v0, v4, LX/02k;->A09:Landroid/view/View;
    ...
    iget-object v2, v4, LX/02k;->A09:Landroid/view/View;
    ...
    :cond_c
    iput-object v2, v4, LX/02k;->A08:Landroid/view/View;
    ...
    :cond_12
    iput-object v10, v4, LX/02k;->A08:Landroid/view/View;
    ...
    iput-object v2, v4, LX/02k;->A09:Landroid/view/View;
    ...
    :cond_16
    iget-object v5, v7, LX/0O4;->A02:Ljava/util/ArrayList;

    invoke-virtual {v5}, Ljava/util/AbstractCollection;->clear()V

    iget-object v4, v7, LX/0O4;->A03:Ljava/util/HashSet;
    ...
    iget-object v1, v6, LX/0Xm;->A02:[Ljava/lang/Object;

    shl-int/lit8 v0, v2, 0x1

    aget-object v0, v1, v0

    invoke-virtual {v7, v0, v5, v4}, LX/0O4;->A00(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
...
.method public final A07()V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A05:LX/0tD;
    ...
    invoke-direct {v1, p0, v0}, LX/0y1;-><init>(Ljava/lang/Object;I)V

    iput-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A05:LX/0tD;

    :cond_0
    invoke-static {p0, v1}, LX/0ZN;->A0E(Landroid/view/View;LX/0tD;)V
...
.method public final A08(I)V
    ...
    invoke-static {v9}, LX/0Z2;->A01(Landroid/view/View;)I
    ...
    invoke-static {v3}, LX/001;->A0Z(Landroid/view/View;)LX/02k;
    ...
    iget-object v0, v12, LX/02k;->A08:Landroid/view/View;
    ...
    iget-object v0, v11, LX/02k;->A09:Landroid/view/View;
    ...
    iget-object v14, v11, LX/02k;->A09:Landroid/view/View;

    move-object/from16 v0, v18

    invoke-static {v0, v14, v9}, LX/0W9;->A01(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    invoke-static/range {v21 .. v26}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A03(Landroid/graphics/Rect;Landroid/graphics/Rect;LX/02k;III)V
    ...
    invoke-virtual {v9, v1, v11, v14, v15}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A09(Landroid/graphics/Rect;LX/02k;II)V
    ...
    invoke-static {v3, v15}, LX/0ZR;->A0I(Landroid/view/View;I)V

    :cond_4
    if-eqz v14, :cond_5

    invoke-static {v3, v14}, LX/0ZR;->A0J(Landroid/view/View;I)V

    :cond_5
    if-eqz v17, :cond_6

    iget-object v14, v11, LX/02k;->A0A:LX/0VQ;

    if-eqz v14, :cond_6

    iget-object v0, v11, LX/02k;->A09:Landroid/view/View;

    invoke-virtual {v14, v3, v0, v9}, LX/0VQ;->A06(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    invoke-static {v6, v3, v9}, LX/0W9;->A01(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/ViewGroup;)V

    :goto_3
    iget v0, v12, LX/02k;->A03:I
    ...
    invoke-static {v2, v0, v11}, LX/001;->A0C(III)I
    ...
    iget-object v0, v11, LX/02k;->A0A:LX/0VQ;
    ...
    invoke-virtual {v0, v2, v3, v9}, LX/0VQ;->A03(Landroid/graphics/Rect;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    iget v0, v12, LX/02k;->A07:I

    if-eq v0, v13, :cond_11

    sub-int v0, v13, v0

    invoke-static {v3, v0}, LX/0ZR;->A0J(Landroid/view/View;I)V

    iput v13, v12, LX/02k;->A07:I
    ...
    iget v0, v12, LX/02k;->A06:I

    if-eq v0, v13, :cond_13

    sub-int v0, v13, v0

    invoke-static {v3, v0}, LX/0ZR;->A0I(Landroid/view/View;I)V

    iput v13, v12, LX/02k;->A06:I
    ...
    iget-object v0, v0, LX/02k;->A0F:Landroid/graphics/Rect;
    ...
    invoke-static {v14}, LX/001;->A0Z(Landroid/view/View;)LX/02k;

    move-result-object v13

    iget-object v2, v13, LX/02k;->A0A:LX/0VQ;

    if-eqz v2, :cond_17

    invoke-virtual {v2, v14, v3, v9}, LX/0VQ;->A05(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    iget-boolean v0, v13, LX/02k;->A0E:Z
    ...
    :goto_b
    iput-boolean v0, v13, LX/02k;->A0E:Z
    ...
    invoke-virtual {v2, v14, v3, v9}, LX/0VQ;->A02(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    goto :goto_c

    :cond_19
    invoke-virtual {v2, v14, v3, v9}, LX/0VQ;->A06(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
...
.method public final A09(Landroid/graphics/Rect;LX/02k;II)V
    .locals 5
    ...
    invoke-static {v1, v3, v2}, LX/001;->A0D(III)I
    ...
    invoke-static {v1, v4, v2}, LX/001;->A0D(III)I
...
.method public A0A(Landroid/view/View;)V
    ...
    iget-object v0, v0, LX/0O4;->A00:LX/0Xm;
    ...
    iget-object v0, v0, LX/02k;->A0A:LX/0VQ;

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1, p1, p0}, LX/0VQ;->A06(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
...
.method public A0B(Landroid/view/View;I)V
    ...
    iget-object v0, v2, LX/02k;->A09:Landroid/view/View;

    move v9, p2

    if-nez v0, :cond_b

    iget v1, v2, LX/02k;->A05:I
    ...
    invoke-static {v8, v2, v1}, LX/001;->A0D(III)I
    ...
    invoke-static {v7, v5, v1}, LX/001;->A0D(III)I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A06:LX/0YI;
    ...
    invoke-static {p1}, LX/0ZL;->A0B(Landroid/view/View;)Z
    ...
    invoke-virtual {v0}, LX/0YI;->A03()I
    ...
    invoke-virtual {v0}, LX/0YI;->A04()I
    ...
    invoke-static/range {v4 .. v9}, LX/0IR;->A00(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    :try_start_0
    invoke-static {v6, v0, p0}, LX/0W9;->A01(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    invoke-static/range {v6 .. v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A03(Landroid/graphics/Rect;Landroid/graphics/Rect;LX/02k;III)V

    invoke-virtual {p0, v7, v8, v10, v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A09(Landroid/graphics/Rect;LX/02k;II)V
...
.method public final A0D(Z)V
    ...
    iget-object v1, v0, LX/02k;->A0A:LX/0VQ;
    ...
    invoke-virtual {v1, v0, v2, p0}, LX/0VQ;->A0E(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    :cond_1
    invoke-virtual {v1, v0, v2, p0}, LX/0VQ;->A0F(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
...
.method public final A0E(Landroid/view/MotionEvent;I)Z
    ...
    invoke-virtual {v0, v8, v1, v7}, LX/0VQ;->A0F(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    :cond_3
    invoke-virtual {v0, v8, v1, v7}, LX/0VQ;->A0E(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
    ...
    invoke-virtual {v0, v4, v1, v7}, LX/0VQ;->A0F(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z

    goto :goto_4

    :cond_6
    invoke-virtual {v0, v4, v1, v7}, LX/0VQ;->A0E(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
...
.method public A0F(Landroid/view/View;II)Z
    ...
    invoke-static {v1, p1, p0}, LX/0W9;->A01(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/ViewGroup;)V
...
.method public BPa(Landroid/view/View;[IIII)V
    ...
    invoke-static {v10}, LX/001;->A0Z(Landroid/view/View;)LX/02k;
    ...
    iget-boolean v0, v1, LX/02k;->A0C:Z

    :goto_1
    if-eqz v0, :cond_0

    iget-object v9, v1, LX/02k;->A0A:LX/0VQ;
    ...
    invoke-virtual/range {v9 .. v16}, LX/0VQ;->A0B(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;[IIII)V
...
.method public BPb(Landroid/view/View;IIIII)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BPc(Landroid/view/View;[IIIIII)V
...
.method public BPc(Landroid/view/View;[IIIIII)V
    ...
    iget-boolean v0, v6, LX/02k;->A0C:Z

    :goto_1
    if-eqz v0, :cond_0

    iget-object v9, v6, LX/02k;->A0A:LX/0VQ;
    ...
    invoke-virtual/range {v9 .. v18}, LX/0VQ;->A0C(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;[IIIIII)V
    ...
    :cond_3
    iget-boolean v0, v6, LX/02k;->A0D:Z
...
.method public BPd(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0D:LX/0LZ;
...
.method public BUh(Landroid/view/View;Landroid/view/View;II)Z
    ...
    iget-object v5, v1, LX/02k;->A0A:LX/0VQ;
    ...
    invoke-virtual/range {v5 .. v11}, LX/0VQ;->A0G(Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;II)Z
...
.method public BVK(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, v2, p1, p0, p2}, LX/0VQ;->A0A(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;I)V

    :cond_0
    if-eqz p2, :cond_2

    iput-boolean v5, v1, LX/02k;->A0C:Z

    :goto_3
    iput-boolean v5, v1, LX/02k;->A0E:Z
    ...
    :cond_2
    iput-boolean v5, v1, LX/02k;->A0D:Z
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, LX/02k;-><init>(II)V
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, LX/02k;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, LX/02k;-><init>(LX/02k;)V
    ...
    invoke-direct {v0, p1}, LX/02k;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, LX/02k;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final getLastWindowInsets()LX/0YI;
    .locals 1
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0D:LX/0LZ;
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A04:LX/0bO;

    if-nez v0, :cond_0

    new-instance v0, LX/0bO;

    invoke-direct {v0, p0}, LX/0bO;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A04:LX/0bO;
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v2, p0, v6}, LX/0VQ;->A0I(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;I)Z
...
.method public onMeasure(II)V
    ...
    iget-object v0, v14, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A0C:LX/0O4;

    iget-object v3, v0, LX/0O4;->A00:LX/0Xm;

    invoke-virtual {v3}, LX/0Xm;->size()I
    ...
    invoke-static {v3, v1}, LX/0Xm;->A00(LX/0Xm;I)Ljava/lang/Object;
    ...
    iget-object v0, v14, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A04:LX/0bO;

    if-nez v0, :cond_1

    new-instance v0, LX/0bO;

    invoke-direct {v0, v14}, LX/0bO;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    iput-object v0, v14, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A04:LX/0bO;
    ...
    invoke-static {v14}, LX/0Z2;->A01(Landroid/view/View;)I
    ...
    iget-object v0, v14, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A06:LX/0YI;

    if-eqz v0, :cond_4

    invoke-static {v14}, LX/0ZL;->A0B(Landroid/view/View;)Z
    ...
    invoke-static {v5}, LX/001;->A0Z(Landroid/view/View;)LX/02k;
    ...
    invoke-static {v5}, LX/0ZL;->A0B(Landroid/view/View;)Z
    ...
    invoke-virtual/range {v24 .. v30}, LX/0VQ;->A0J(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;IIII)Z
    ...
    invoke-static {v1, v0, v11}, LX/001;->A0B(III)I
    ...
    invoke-static {v1, v0, v10}, LX/001;->A0B(III)I

    move-result v10

    invoke-static {v5, v7}, LX/001;->A0K(Landroid/view/View;I)I
...
.method public onNestedPreFling(Landroid/view/View;FF)Z
    ...
    invoke-virtual/range {v5 .. v10}, LX/0VQ;->A0H(Landroid/view/View;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;FF)Z
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BPa(Landroid/view/View;[IIII)V
...
.method public onNestedScroll(Landroid/view/View;IIII)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BPb(Landroid/view/View;IIIII)V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BPd(Landroid/view/View;Landroid/view/View;II)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v6, p1, LX/07f;->A00:Landroid/util/SparseArray;
    ...
    invoke-virtual {v1, v0, v3, p0}, LX/0VQ;->A09(Landroid/os/Parcelable;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    new-instance v7, LX/07f;

    invoke-direct {v7, v0}, LX/07f;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v1, v3, p0}, LX/0VQ;->A07(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Landroid/os/Parcelable;
    ...
    :cond_1
    iput-object v6, v7, LX/07f;->A00:Landroid/util/SparseArray;
...
.method public onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BUh(Landroid/view/View;Landroid/view/View;II)Z
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->BVK(Landroid/view/View;I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, p1, v0, p0}, LX/0VQ;->A0F(Landroid/view/MotionEvent;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)Z
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-virtual {v0, p2, p1, p0, p3}, LX/0VQ;->A04(Landroid/graphics/Rect;Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Z)Z
