...
.method public static asInterface(Landroid/os/IBinder;)Landroidx/car/app/model/IOnClickListener;
    ...
    instance-of v0, v1, Landroidx/car/app/model/IOnClickListener;

    if-eqz v0, :cond_1

    check-cast v1, Landroidx/car/app/model/IOnClickListener;

    return-object v1

    :cond_1
    new-instance v1, Landroidx/car/app/model/IOnClickListener$Stub$Proxy;

    invoke-direct {v1, p0}, Landroidx/car/app/model/IOnClickListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
