...
.method public A06(LX/0rb;)V
    ...
    iget-object v0, v7, LX/0dk;->A02:Landroid/app/Notification$Builder;

    invoke-static {v0}, LX/0Vc;->A02(Landroid/app/Notification$Builder;)Landroid/app/Notification$BigPictureStyle;

    move-result-object v1

    const/4 v0, 0x0

    invoke-static {v1, v0}, LX/0Vc;->A01(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)Landroid/app/Notification$BigPictureStyle;
    ...
    iget-object v0, v7, LX/0dk;->A03:Landroid/content/Context;
    ...
    invoke-static {v4, v0}, LX/0Vd;->A02(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_1
    iget-boolean v0, p0, LX/0RO;->A02:Z

    if-eqz v0, :cond_2

    iget-object v0, p0, LX/0RO;->A01:Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, LX/0Vd;->A01(Landroid/app/Notification$BigPictureStyle;)V

    invoke-static {v4}, LX/0Vd;->A00(Landroid/app/Notification$BigPictureStyle;)V
    ...
    invoke-static {v4, v0}, LX/0Vc;->A00(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/Bitmap;)Landroid/app/Notification$BigPictureStyle;
