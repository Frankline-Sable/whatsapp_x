...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-direct {p0}, LX/0PR;-><init>()V
    ...
    invoke-direct {v0, p0, v1}, LX/0nz;-><init>(Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;Ljava/io/File;)V
...
.method public bridge synthetic A00()Ljava/lang/Object;
    ...
    invoke-direct {v0, v2, p0}, LX/0lr;-><init>(LX/05L;Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;)V
...
.method public bridge synthetic A01(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v2, p0, v3}, LX/0n3;-><init>(LX/05L;Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;Ljava/util/List;)V
...
.method public A03(Landroid/graphics/Bitmap;Ljava/lang/String;)LX/4AB;
    .locals 4

    new-instance v3, LX/0n4;

    invoke-direct {v3, p1, p0, p2}, LX/0n4;-><init>(Landroid/graphics/Bitmap;Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v2, p0, v3}, LX/0n5;-><init>(LX/05L;Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;Ljava/lang/Runnable;)V
...
.method public A04(LX/05L;)V
    ...
    new-instance v3, LX/0o2;

    invoke-direct {v3, p0, v0}, LX/0o2;-><init>(Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;Ljava/util/List;)V
    ...
    invoke-direct {v1, p1, p0, v2}, LX/0n1;-><init>(LX/05L;Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;LX/4AB;)V

    iget-object v0, p0, Landroidx/sharetarget/ShortcutInfoCompatSaverImpl;->A05:Ljava/util/concurrent/ExecutorService;

    invoke-virtual {v2, v1, v0}, LX/0i8;->Aq2(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public A05(Ljava/util/List;)V
    ...
    iget-object v1, v0, LX/0M9;->A01:Ljava/lang/String;
