...
.method public A0p(Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v0}, LX/0tS;->Awa(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
...
.method public A1K(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-direct {v3, v1}, LX/0VT;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v0}, LX/0VT;->A0N(Landroid/graphics/drawable/Drawable;)LX/0VT;

    iget-object v0, p0, Landroidx/preference/PreferenceDialogFragmentCompat;->A07:Ljava/lang/CharSequence;

    invoke-virtual {v3, p0, v0}, LX/0VT;->A0H(Landroid/content/DialogInterface$OnClickListener;Ljava/lang/CharSequence;)LX/0VT;

    iget-object v0, p0, Landroidx/preference/PreferenceDialogFragmentCompat;->A06:Ljava/lang/CharSequence;

    invoke-virtual {v3, p0, v0}, LX/0VT;->A0F(Landroid/content/DialogInterface$OnClickListener;Ljava/lang/CharSequence;)LX/0VT;
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/PreferenceDialogFragmentCompat;->A1T(Landroid/view/View;)V

    invoke-virtual {v3, v0}, LX/0VT;->setView(Landroid/view/View;)LX/0VT;

    :goto_0
    invoke-virtual {p0, v3}, Landroidx/preference/PreferenceDialogFragmentCompat;->A1U(LX/0VT;)V

    invoke-virtual {v3}, LX/0VT;->create()LX/048;

    move-result-object v2

    invoke-virtual {p0}, Landroidx/preference/PreferenceDialogFragmentCompat;->A1W()Z
...
.method public A1S()Landroidx/preference/DialogPreference;
    .locals 2
    ...
    invoke-interface {v0, v1}, LX/0tS;->Awa(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
...
.method public A1T(Landroid/view/View;)V
    .locals 3
    ...
    :goto_0
    invoke-static {v2, v0}, LX/001;->A18(Landroid/view/View;I)V
...
.method public A1U(LX/0VT;)V
    .locals 0

    return-void
.end method

.method public abstract A1V(Z)V
.end method
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/PreferenceDialogFragmentCompat;->A1V(Z)V
