...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, v1, v0}, LX/0Vi;->A00(Landroid/content/Context;II)I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    :cond_0
    iput-object v0, p0, Landroidx/preference/ListPreference;->A03:[Ljava/lang/CharSequence;
    ...
    :cond_1
    iput-object v0, p0, Landroidx/preference/ListPreference;->A04:[Ljava/lang/CharSequence;
    ...
    sget-object v0, LX/0fK;->A00:LX/0fK;
    ...
    sput-object v0, LX/0fK;->A00:LX/0fK;

    :cond_2
    iput-object v0, p0, Landroidx/preference/Preference;->A0D:LX/0tV;
    ...
    invoke-static {v2, v1, v0}, LX/000;->A0L(Landroid/content/res/TypedArray;II)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroidx/preference/ListPreference;->A00:Ljava/lang/String;
...
.method public A03()Landroid/os/Parcelable;
    ...
    iget-object v0, p0, Landroidx/preference/ListPreference;->A01:Ljava/lang/String;
...
.method public A04()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/preference/Preference;->A0D:LX/0tV;

    if-eqz v0, :cond_0

    invoke-interface {v0, p0}, LX/0tV;->BZh(Landroidx/preference/Preference;)Ljava/lang/CharSequence;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/preference/ListPreference;->A0V()Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroidx/preference/ListPreference;->A00:Ljava/lang/String;
...
.method public A0G(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/ListPreference;->A0W(Ljava/lang/String;)V
...
.method public A0L(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, p1}, Landroidx/preference/Preference;->A0L(Ljava/lang/CharSequence;)V
...
.method public A0M(Ljava/lang/Object;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/preference/ListPreference;->A0W(Ljava/lang/String;)V

    return-void
.end method

.method public A0U(Ljava/lang/String;)I
    .locals 2

    if-eqz p1, :cond_1

    iget-object v0, p0, Landroidx/preference/ListPreference;->A04:[Ljava/lang/CharSequence;
...
.method public A0V()Ljava/lang/CharSequence;
    .locals 2

    iget-object v0, p0, Landroidx/preference/ListPreference;->A01:Ljava/lang/String;

    invoke-virtual {p0, v0}, Landroidx/preference/ListPreference;->A0U(Ljava/lang/String;)I

    move-result v1

    if-ltz v1, :cond_0

    iget-object v0, p0, Landroidx/preference/ListPreference;->A03:[Ljava/lang/CharSequence;
...
.method public A0W(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Landroidx/preference/ListPreference;->A02:Z

    if-nez v0, :cond_1

    :cond_0
    iput-object p1, p0, Landroidx/preference/ListPreference;->A01:Ljava/lang/String;

    iput-boolean v2, p0, Landroidx/preference/ListPreference;->A02:Z
