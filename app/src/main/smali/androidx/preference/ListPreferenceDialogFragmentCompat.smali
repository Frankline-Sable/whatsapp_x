...
.method public A0p(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Landroidx/preference/PreferenceDialogFragmentCompat;->A0p(Landroid/os/Bundle;)V

    if-nez p1, :cond_0

    invoke-virtual {p0}, Landroidx/preference/PreferenceDialogFragmentCompat;->A1S()Landroidx/preference/DialogPreference;
...
.method public A0q(Landroid/os/Bundle;)V
    ...
    invoke-super {p0, p1}, Landroidx/preference/PreferenceDialogFragmentCompat;->A0q(Landroid/os/Bundle;)V
...
.method public A1U(LX/0VT;)V
    ...
    invoke-virtual {p1, v0, v3, v2}, LX/0VT;->A0J(Landroid/content/DialogInterface$OnClickListener;[Ljava/lang/CharSequence;I)LX/0VT;

    const/4 v0, 0x0

    invoke-virtual {p1, v0, v0}, LX/0VT;->A0H(Landroid/content/DialogInterface$OnClickListener;Ljava/lang/CharSequence;)LX/0VT;

    return-void
.end method

.method public A1V(Z)V
    .locals 3
    ...
    invoke-interface {v0, v1, v2}, LX/0tT;->BRH(Landroidx/preference/Preference;Ljava/lang/Object;)Z
