...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {v3, v1, v0}, LX/000;->A0L(Landroid/content/res/TypedArray;II)Ljava/lang/String;
...
.method public A06()V
    ...
    iget-object v1, p0, Landroidx/preference/Preference;->A09:LX/0s2;

    if-eqz v1, :cond_0

    check-cast v1, LX/09L;

    iget-object v0, v1, LX/09L;->A05:Ljava/util/List;
    ...
    iget-object v1, v1, LX/0Rl;->A01:LX/00x;

    const/4 v0, 0x1

    invoke-virtual {v1, p0, v2, v0}, LX/00x;->A04(Ljava/lang/Object;II)V
...
.method public A07()V
    ...
    iget-object v0, p0, Landroidx/preference/Preference;->A09:LX/0s2;
...
.method public A08()V
    ...
    invoke-static {p0}, LX/001;->A1C(Landroidx/preference/Preference;)V
...
.method public A0H(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/preference/Preference;->A0B:LX/0tU;

    if-eqz v0, :cond_1

    invoke-interface {v0, p0}, LX/0tU;->BRI(Landroidx/preference/Preference;)Z
    ...
    iget-object v0, v0, LX/0QY;->A06:LX/0tW;

    if-eqz v0, :cond_2

    invoke-interface {v0, p0}, LX/0tW;->BRJ(Landroidx/preference/Preference;)Z
...
.method public A0O(Z)V
    ...
    invoke-static {v1}, LX/001;->A1C(Landroidx/preference/Preference;)V
...
.method public A0T(LX/09l;)V
    ...
    invoke-virtual {p1, v0}, LX/09l;->A07(I)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/preference/Preference;->A0C:LX/0au;

    if-nez v0, :cond_8

    new-instance v0, LX/0au;

    invoke-direct {v0, p0}, LX/0au;-><init>(Landroidx/preference/Preference;)V

    iput-object v0, p0, Landroidx/preference/Preference;->A0C:LX/0au;
    ...
    invoke-static {v3, v4}, LX/0ZL;->A04(Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
