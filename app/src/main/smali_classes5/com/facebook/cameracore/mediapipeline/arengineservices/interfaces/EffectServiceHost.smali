...
.field public final mServiceConfigurationHybridBuilder:LX/8wi;

.field public mServiceConfigurations:Ljava/util/List;

.field public final mServiceModules:Ljava/util/List;

.field public mServicesHostConfiguration:LX/96q;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHostConfig;LX/8wi;Ljava/util/Collection;Ljava/lang/String;LX/71x;)V
    .locals 2
    ...
    iput-object p3, p0, Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;->mServiceConfigurationHybridBuilder:LX/8wi;
    ...
    iput-object p6, p0, Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;->mArExperimentUtil:LX/71x;
...
.method public static newSingleBackgroundThreadScheduledExecutor(Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v0, p0}, LX/9Ls;-><init>(Ljava/lang/String;)V
...
.method public getFrameFormatForPostProcessing()LX/8uz;
    .locals 3
    ...
    :cond_1
    sget-object v0, LX/8uz;->A02:LX/8uz;
...
.method public setManifest(Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectManifest;)V
    ...
    invoke-direct/range {v1 .. v7}, LX/91V;-><init>(ZZZZZZ)V

    check-cast v0, Lcom/facebook/cameracore/mediapipeline/services/touch/implementation/TouchServiceImpl;

    iget-object v2, v0, Lcom/facebook/cameracore/mediapipeline/services/touch/implementation/TouchServiceImpl;->mGestureProcessor:LX/94b;

    if-eqz v2, :cond_5

    iput-object v1, v2, LX/94b;->A02:LX/91V;

    iget-object v1, v2, LX/94b;->A0F:Ljava/util/Set;

    invoke-interface {v1}, Ljava/util/Set;->clear()V

    iget-object v0, v2, LX/94b;->A02:LX/91V;

    iget-boolean v0, v0, LX/91V;->A05:Z
    ...
    iget-boolean v0, v0, LX/91V;->A01:Z
    ...
    iget-boolean v0, v0, LX/91V;->A02:Z
    ...
    iget-boolean v0, v0, LX/91V;->A04:Z
    ...
    iget-boolean v0, v0, LX/91V;->A00:Z
    ...
    iget-boolean v0, v0, LX/91V;->A03:Z
...
.method public updateFrame(LX/9Aa;IZ)V
    .locals 38

    move-object/from16 v10, p1

    invoke-virtual {v10}, LX/9Aa;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LX/94P;

    iget v0, v1, LX/94P;->A03:I

    move/from16 v37, v0

    iget v0, v1, LX/94P;->A01:I

    move/from16 v36, v0

    const/4 v0, 0x0

    iget-object v4, v1, LX/94P;->A05:[LX/90S;
    ...
    :cond_1
    iget v7, v0, LX/90S;->A00:I

    if-le v2, v3, :cond_9

    aget-object v0, v4, v3

    iget v6, v0, LX/90S;->A01:I
    ...
    :cond_2
    iget v5, v0, LX/90S;->A00:I

    :goto_0
    iget v0, v1, LX/94P;->A02:I

    move/from16 v17, v0

    iget-object v0, v12, LX/90S;->A02:Ljava/nio/ByteBuffer;
    ...
    iget-object v15, v0, LX/90S;->A02:Ljava/nio/ByteBuffer;

    if-le v2, v3, :cond_7

    aget-object v0, v4, v3

    iget-object v14, v0, LX/90S;->A02:Ljava/nio/ByteBuffer;

    :goto_1
    iget-wide v12, v1, LX/94P;->A04:J
    ...
    :cond_3
    iget-object v4, v10, LX/9Aa;->A02:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v0, v10}, LX/9AZ;-><init>(LX/9Aa;)V
