.class public abstract Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A02:Z
...
.method public A1E()Landroid/content/Context;
    ...
    iget-boolean v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A01:Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A1b()V

    iget-object v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A00:Landroid/content/ContextWrapper;
...
.method public A1S()V
    ...
    instance-of v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_BrazilReTosFragment;

    if-eqz v0, :cond_1

    move-object v3, p0

    check-cast v3, Lcom/gbwhatsapp/payments/ui/Hilt_BrazilReTosFragment;

    iget-boolean v0, v3, Lcom/gbwhatsapp/payments/ui/Hilt_BrazilReTosFragment;->A02:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, v3, Lcom/gbwhatsapp/payments/ui/Hilt_BrazilReTosFragment;->A02:Z

    invoke-static {v3}, LX/4E0;->A0X(Lcom/gbwhatsapp/wds/components/bottomsheet/Hilt_WDSBottomSheetDialogFragment;)LX/5mi;

    move-result-object v0

    check-cast v3, Lcom/gbwhatsapp/payments/ui/BrazilReTosFragment;
    ...
    iput-object v0, v3, Lcom/gbwhatsapp/payments/ui/ReTosFragment;->A02:LX/35r;

    invoke-static {v2}, LX/8fX;->A0I(LX/3H7;)LX/97r;

    move-result-object v0

    iput-object v0, v3, Lcom/gbwhatsapp/payments/ui/ReTosFragment;->A03:LX/97r;

    invoke-static {v1}, LX/39d;->A2Y(LX/39d;)LX/97k;

    move-result-object v0

    iput-object v0, v3, Lcom/gbwhatsapp/payments/ui/ReTosFragment;->A04:LX/97k;

    invoke-static {v1}, LX/8fX;->A0X(LX/39d;)LX/5cF;

    move-result-object v0

    iput-object v0, v3, Lcom/gbwhatsapp/payments/ui/BrazilReTosFragment;->A01:LX/5cF;

    invoke-static {v1}, LX/4Dy;->A0S(LX/39d;)LX/2zw;

    move-result-object v0

    iput-object v0, v3, Lcom/gbwhatsapp/payments/ui/BrazilReTosFragment;->A00:LX/2zw;

    :cond_0
    return-void

    :cond_1
    iget-boolean v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A02:Z
...
.method public final A1b()V
    ...
    iput-object v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A00:Landroid/content/ContextWrapper;
    ...
    iput-boolean v0, p0, Lcom/gbwhatsapp/payments/ui/Hilt_ReTosFragment;->A01:Z
