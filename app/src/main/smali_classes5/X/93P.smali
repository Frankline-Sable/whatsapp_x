...
.field public final A01:LX/912;

.field public final A02:LX/91I;
...
# direct methods
.method public constructor <init>(LX/2pP;LX/912;LX/91I;LX/8zy;LX/97m;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/93P;->A00:LX/2pP;

    iput-object p3, p0, LX/93P;->A02:LX/91I;

    iput-object p2, p0, LX/93P;->A01:LX/912;

    iput-object p4, p0, LX/93P;->A03:LX/8zy;

    iput-object p5, p0, LX/93P;->A04:LX/97m;
...
# virtual methods
.method public A00(LX/9Ob;Z)V
    .locals 23

    move-object/from16 v4, p0

    iget-object v3, v4, LX/93P;->A03:LX/8zy;
    ...
    iget-object v0, v3, LX/8zy;->A00:LX/35u;
    ...
    invoke-interface {v2, v0}, LX/9Ob;->onResult(Ljava/lang/Object;)V
    ...
    .catch LX/8w8; {:try_start_1 .. :try_end_1} :catch_d

    :try_start_2
    iget-object v5, v0, LX/92l;->A01:Ljava/security/KeyStore;
    ...
    .catch LX/8w8; {:try_start_2 .. :try_end_2} :catch_d
    ...
    .catch LX/8w8; {:try_start_3 .. :try_end_3} :catch_d
    ...
    .catch LX/8w8; {:try_start_4 .. :try_end_4} :catch_d
    ...
    .catch LX/8w8; {:try_start_5 .. :try_end_5} :catch_d
    ...
    .catch LX/8w8; {:try_start_6 .. :try_end_6} :catch_d
    ...
    .catch LX/8w8; {:try_start_7 .. :try_end_7} :catch_d
    ...
    .catch LX/8w8; {:try_start_8 .. :try_end_8} :catch_d
    ...
    .catch LX/8w8; {:try_start_9 .. :try_end_9} :catch_d
    ...
    .catch LX/8w8; {:try_start_a .. :try_end_a} :catch_d
    ...
    invoke-virtual {v0}, LX/92P;->A00()LX/0Pr;

    move-result-object v0

    iget-object v10, v0, LX/0Pr;->A00:Ljava/lang/Object;
    ...
    .catch LX/8w8; {:try_start_b .. :try_end_b} :catch_d

    :try_start_c
    iget-object v7, v3, LX/8zy;->A00:LX/35u;

    invoke-virtual {v7}, LX/35u;->A06()Ljava/lang/String;
    ...
    invoke-static {v7, v6}, LX/8fX;->A1F(LX/35u;Ljava/lang/Object;)V
    ...
    .catch LX/8w8; {:try_start_c .. :try_end_c} :catch_d
    ...
    .catch LX/8w8; {:try_start_d .. :try_end_d} :catch_d

    :cond_6
    :goto_4
    :try_start_e
    iget-object v6, v4, LX/93P;->A01:LX/912;

    iget-object v0, v4, LX/93P;->A00:LX/2pP;
    ...
    invoke-direct {v0, v3, v1}, LX/8zx;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, v5}, LX/8zx;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v8, v0}, Ljava/util/AbstractCollection;->add(Ljava/lang/Object;)Z

    iget-object v7, v6, LX/912;->A00:LX/3bD;

    iget-object v3, v6, LX/912;->A01:LX/1eW;

    iget-object v1, v6, LX/912;->A02:LX/2FW;

    iget-object v0, v6, LX/912;->A03:LX/97r;
    ...
    invoke-direct/range {v11 .. v18}, LX/91h;-><init>(Landroid/content/Context;LX/3bD;LX/1eW;LX/2FW;LX/97r;Ljava/util/List;Ljava/util/List;)V

    iget-object v8, v4, LX/93P;->A02:LX/91I;
    ...
    iget-object v1, v8, LX/91I;->A01:LX/2tS;

    iget-object v0, v8, LX/91I;->A00:LX/2tx;

    invoke-static {v0, v1}, LX/37P;->A03(LX/2tx;LX/2tS;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0, v5, v3}, LX/0yJ;->A0x(Ljava/lang/Object;Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    iget-object v0, v6, LX/91h;->A05:Ljava/util/List;
    ...
    iget-object v1, v0, LX/8zx;->A00:Ljava/lang/String;

    iget-object v0, v0, LX/8zx;->A01:Ljava/lang/String;
    ...
    :cond_7
    iget-object v1, v6, LX/91h;->A06:Ljava/util/List;
    ...
    iget-object v0, v8, LX/91I;->A03:LX/94O;
    ...
    invoke-direct {v9, v3}, LX/8mR;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {v9, v1}, LX/94C;->A00([Ljava/security/PublicKey;)LX/94C;
    :try_end_e
    ...
    .catch LX/8w8; {:try_start_e .. :try_end_e} :catch_d

    :try_start_f
    iget-object v1, v9, LX/94C;->A00:Ljava/util/List;
    ...
    invoke-static {v0}, LX/95w;->A00(Ljava/security/PublicKey;)Ljava/lang/String;
    ...
    .catch LX/8w6; {:try_start_f .. :try_end_f} :catch_b
    .catch Lorg/json/JSONException; {:try_start_f .. :try_end_f} :catch_d
    .catch LX/8w8; {:try_start_f .. :try_end_f} :catch_d

    :try_start_10
    invoke-virtual {v9}, LX/94C;->A01()Ljava/lang/String;
    ...
    invoke-static {v3}, LX/95w;->A00(Ljava/security/PublicKey;)Ljava/lang/String;

    move-result-object v0

    const-string v5, "kid"

    invoke-static {v0, v5, v1}, LX/0yK;->A0p(Ljava/lang/Object;Ljava/lang/String;Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {v3, v12, v0}, LX/0yH;->A18(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    .catch LX/8w6; {:try_start_10 .. :try_end_10} :catch_b
    .catch LX/8w8; {:try_start_10 .. :try_end_10} :catch_d
    ...
    .catch LX/8w6; {:try_start_11 .. :try_end_11} :catch_b
    .catch Lorg/json/JSONException; {:try_start_11 .. :try_end_11} :catch_d
    .catch LX/8w8; {:try_start_11 .. :try_end_11} :catch_d
    ...
    .catch LX/8w6; {:try_start_12 .. :try_end_12} :catch_b
    .catch Lorg/json/JSONException; {:try_start_12 .. :try_end_12} :catch_d
    .catch LX/8w8; {:try_start_12 .. :try_end_12} :catch_d
    ...
    invoke-static/range {v20 .. v20}, LX/95w;->A00(Ljava/security/PublicKey;)Ljava/lang/String;
    ...
    iget-object v5, v9, LX/94C;->A01:Lorg/json/JSONArray;
    ...
    .catch LX/8w6; {:try_start_13 .. :try_end_13} :catch_b
    .catch LX/8w8; {:try_start_13 .. :try_end_13} :catch_d
    ...
    invoke-static {v5, v0, v1}, LX/0yK;->A0p(Ljava/lang/Object;Ljava/lang/String;Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    .catch LX/8w8; {:try_start_14 .. :try_end_14} :catch_d
    ...
    invoke-direct {v0, v1}, LX/8w8;-><init>(Ljava/lang/Exception;)V
    ...
    .catch LX/8w8; {:try_start_15 .. :try_end_15} :catch_d
    ...
    .catch LX/8w6; {:try_start_16 .. :try_end_16} :catch_b
    .catch LX/8w8; {:try_start_16 .. :try_end_16} :catch_d
    ...
    .catch LX/8w6; {:try_start_17 .. :try_end_17} :catch_b
    .catch Lorg/json/JSONException; {:try_start_17 .. :try_end_17} :catch_d
    .catch LX/8w8; {:try_start_17 .. :try_end_17} :catch_d
    ...
    invoke-direct {v5, v1, v3, v0}, LX/38n;-><init>(Ljava/lang/String;Ljava/lang/String;[LX/3CP;)V

    new-instance v8, LX/8zw;

    invoke-direct {v8, v2, v4}, LX/8zw;-><init>(LX/9Ob;LX/93P;)V

    iget-object v7, v6, LX/91h;->A04:LX/97r;
    ...
    invoke-direct {v5, v0, v3, v1}, LX/38n;-><init>(Ljava/lang/String;[LX/3CP;[LX/38n;)V

    iget-object v4, v6, LX/91h;->A00:Landroid/content/Context;

    iget-object v3, v6, LX/91h;->A01:LX/3bD;

    iget-object v0, v6, LX/91h;->A03:LX/2FW;
    ...
    invoke-direct/range {v9 .. v15}, LX/9Pz;-><init>(Landroid/content/Context;LX/2FW;LX/44u;Ljava/lang/Object;Ljava/lang/Object;I)V

    const-string v0, "set"

    invoke-virtual {v7, v1, v5, v0}, LX/97r;->A0E(LX/480;LX/38n;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v0}, LX/96k;-><init>(I)V
    ...
    :goto_f
    invoke-interface {v2, v1}, LX/9Ob;->BL8(LX/96k;)V
    ...
    .catch LX/8w8; {:try_start_18 .. :try_end_18} :catch_d
