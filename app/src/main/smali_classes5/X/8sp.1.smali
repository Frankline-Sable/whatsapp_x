...
.field public final A06:LX/3CO;

.field public final A07:LX/371;
...
# direct methods
.method public constructor <init>(Landroid/os/Bundle;LX/4fS;LX/5Yg;LX/3Qm;LX/2t8;LX/35t;LX/3CO;LX/371;LX/2pJ;LX/2qY;Ljava/lang/String;)V
    .locals 3
    ...
    iput-object v0, p0, LX/8sp;->A0A:LX/35Z;

    invoke-static {p2}, LX/0yN;->A1A(Ljava/lang/Object;)Ljava/lang/ref/WeakReference;

    move-result-object v0

    iput-object v0, p0, LX/8sp;->A0C:Ljava/lang/ref/WeakReference;

    iput-object p5, p0, LX/8sp;->A04:LX/2t8;

    iput-object p4, p0, LX/8sp;->A03:LX/3Qm;

    iput-object p3, p0, LX/8sp;->A02:LX/5Yg;

    iput-object p6, p0, LX/8sp;->A05:LX/35t;

    iput-object p9, p0, LX/8sp;->A08:LX/2pJ;

    iput-object p10, p0, LX/8sp;->A09:LX/2qY;

    iput-object p11, p0, LX/8sp;->A0B:Ljava/lang/String;

    iput-object p7, p0, LX/8sp;->A06:LX/3CO;

    iput-object p8, p0, LX/8sp;->A07:LX/371;

    iput-object p1, p0, LX/8sp;->A01:Landroid/os/Bundle;
...
.method public bridge synthetic A06([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v2, LX/8sp;->A0C:Ljava/lang/ref/WeakReference;
    ...
    iget-object v1, v2, LX/8sp;->A09:LX/2qY;
    ...
    :cond_0
    iget-object v0, v2, LX/8sp;->A05:LX/35t;
    ...
    iget-object v0, v2, LX/8sp;->A0B:Ljava/lang/String;
    ...
    invoke-static {v0, v4, v5}, LX/0yJ;->A0x(Ljava/lang/Object;Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;

    move-result-object v3

    iget-object v6, v2, LX/8sp;->A07:LX/371;

    if-eqz v6, :cond_4

    iget-object v0, v6, LX/371;->A0J:Ljava/lang/String;
    ...
    iget-object v1, v6, LX/371;->A0J:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, v2, LX/8sp;->A06:LX/3CO;

    if-eqz v1, :cond_3

    iget-object v0, v1, LX/3CO;->A0B:Ljava/lang/String;
    ...
    iget-object v1, v1, LX/3CO;->A0B:Ljava/lang/String;
    ...
    iget-object v1, v2, LX/8sp;->A08:LX/2pJ;
    ...
    invoke-virtual/range {v18 .. v26}, LX/1ZN;->A04(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;ZZZ)LX/4A8;
    ...
    :goto_1
    :try_start_1
    iget-object v5, v2, LX/8sp;->A04:LX/2t8;
    ...
    invoke-interface {v3, v5, v0, v1}, LX/4A8;->AxQ(LX/2t8;Ljava/lang/Integer;Ljava/lang/Integer;)Ljava/io/InputStream;
    ...
    iget-object v6, v2, LX/8sp;->A0A:LX/35Z;
    ...
    invoke-virtual {v6, v0}, LX/35Z;->A07(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v13, v11, v4, v1}, LX/5gJ;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v12}, LX/8sp;->A0E(Lorg/json/JSONArray;I)Ljava/util/ArrayList;
    ...
    new-instance v7, LX/91L;

    move-object v9, v7

    invoke-direct/range {v9 .. v14}, LX/91L;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V

    :cond_b
    new-instance v0, LX/90j;

    invoke-direct {v0, v7, v6, v4}, LX/90j;-><init>(LX/91L;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    :goto_9
    iget-object v2, v2, LX/8sp;->A0A:LX/35Z;
...
.method public A08()V
    ...
    iget-object v0, p0, LX/8sp;->A0C:Ljava/lang/ref/WeakReference;
    ...
    iget-object v0, p0, LX/8sp;->A00:Landroid/app/ProgressDialog;
    ...
    iput-object v2, p0, LX/8sp;->A00:Landroid/app/ProgressDialog;
    ...
    iget-object v1, p0, LX/8sp;->A00:Landroid/app/ProgressDialog;
...
.method public bridge synthetic A0A(Ljava/lang/Object;)V
    ...
    check-cast v13, LX/4fS;

    if-eqz v13, :cond_1

    if-eqz v3, :cond_4

    iget-object v5, v3, LX/90j;->A00:LX/91L;

    const/16 v4, 0x30

    if-eqz v5, :cond_2

    iget-object v7, v2, LX/8sp;->A01:Landroid/os/Bundle;
    ...
    iget-object v12, v5, LX/91L;->A02:Ljava/lang/String;

    iget-object v11, v5, LX/91L;->A00:Ljava/lang/String;

    iget-object v10, v5, LX/91L;->A03:Ljava/lang/String;

    iget-object v9, v5, LX/91L;->A01:Ljava/lang/String;

    iget-boolean v6, v5, LX/91L;->A04:Z

    iget-object v8, v2, LX/8sp;->A0B:Ljava/lang/String;
    ...
    iget-object v0, v3, LX/90j;->A02:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-virtual {v13, v5, v4}, LX/4fS;->Bhe(Landroid/content/Intent;I)V
    ...
    :goto_0
    iget-object v0, v2, LX/8sp;->A00:Landroid/app/ProgressDialog;
    ...
    :cond_2
    iget-object v7, v3, LX/90j;->A01:Ljava/util/ArrayList;
    ...
    iget-object v1, v2, LX/8sp;->A0B:Ljava/lang/String;

    iget-object v6, v2, LX/8sp;->A01:Landroid/os/Bundle;

    iget-object v5, v3, LX/90j;->A02:Ljava/util/ArrayList;
    ...
    :goto_1
    invoke-virtual {v13, v3, v4}, LX/4fS;->Bhe(Landroid/content/Intent;I)V

    goto :goto_0

    :cond_3
    iget-object v1, v3, LX/90j;->A02:Ljava/util/ArrayList;
    ...
    iget-object v0, v2, LX/8sp;->A01:Landroid/os/Bundle;

    invoke-static {v13, v0, v1}, Lcom/gbwhatsapp/inappsupport/ui/SupportTopicsActivity;->A0D(Landroid/content/Context;Landroid/os/Bundle;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    :cond_4
    iget-object v1, v2, LX/8sp;->A03:LX/3Qm;
    ...
    invoke-virtual {v13, v0}, LX/4fS;->Bh0(I)V

    goto :goto_0

    :cond_5
    iget-object v12, v2, LX/8sp;->A02:LX/5Yg;
    ...
    iget-object v14, v2, LX/8sp;->A01:Landroid/os/Bundle;
    ...
    invoke-virtual/range {v12 .. v21}, LX/5Yg;->A00(Landroid/app/Activity;Landroid/os/Bundle;LX/3BG;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Z)Landroid/content/Intent;
    ...
    invoke-virtual {v13, v1, v0}, LX/4fS;->Bhe(Landroid/content/Intent;I)V

    goto/16 :goto_0
.end method

.method public final A0E(Lorg/json/JSONArray;I)Ljava/util/ArrayList;
    .locals 13
    ...
    invoke-virtual {p0, v0, p2}, LX/8sp;->A0E(Lorg/json/JSONArray;I)Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v10, v5}, LX/7he;-><init>(Ljava/util/ArrayList;Z)V
    ...
    invoke-direct {v6, v2, v5}, LX/7he;-><init>(Ljava/util/ArrayList;Z)V

    :goto_4
    new-instance v5, LX/5gf;

    invoke-direct/range {v5 .. v12}, LX/5gf;-><init>(LX/7he;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Z)V
