...
.method public constructor <init>(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iput-object p1, p0, LX/9BG;->A00:Landroid/hardware/camera2/CameraCaptureSession;

    return-void
.end method

.method public static A00(Landroid/hardware/camera2/CameraDevice;LX/9BN;Ljava/util/List;Ljava/util/concurrent/Executor;)V
    .locals 9

    new-instance v6, LX/8fh;

    invoke-direct {v6, p1}, LX/8fh;-><init>(LX/9BN;)V
...
.method public static A01(Landroid/hardware/camera2/CameraDevice;LX/9BN;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
    .locals 4
    ...
    iget-object v0, v0, LX/90a;->A02:Landroid/view/Surface;
    ...
    invoke-static {p0, p1, p2, p3}, LX/9BG;->A00(Landroid/hardware/camera2/CameraDevice;LX/9BN;Ljava/util/List;Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v1, p1}, LX/8fh;-><init>(LX/9BN;)V
...
.method public ApV()V
    ...
    iget-object v0, p0, LX/9BG;->A00:Landroid/hardware/camera2/CameraCaptureSession;
...
.method public As7(Landroid/hardware/camera2/CaptureRequest;Landroid/os/Handler;LX/9Ox;)I
    ...
    iget-object v1, p0, LX/9BG;->A00:Landroid/hardware/camera2/CameraCaptureSession;

    if-eqz p3, :cond_0

    new-instance v0, LX/8fg;

    invoke-direct {v0, p0, p3}, LX/8fg;-><init>(LX/9BG;LX/9Ox;)V
