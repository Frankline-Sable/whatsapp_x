...
.field public final A0A:LX/8wv;

.field public volatile A0B:Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;


# direct methods
.method public constructor <init>(Landroid/content/Context;LX/90s;LX/8wv;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/ScheduledExecutorService;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, LX/95N;->A0A:LX/8wv;

    iput-object p1, p0, LX/95N;->A06:Landroid/content/Context;
    ...
    iput-object v0, p0, LX/95N;->A07:Landroid/content/res/AssetManager;
    ...
    iput-object v0, p0, LX/95N;->A08:Lcom/facebook/common/jniexecutors/AndroidAsyncExecutorFactory;
    ...
    iput-object v0, p0, LX/95N;->A09:Lcom/facebook/common/jniexecutors/AndroidAsyncExecutorFactory;

    iput-object p2, p0, LX/95N;->A04:LX/90s;
...
.method public A00()Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;
    ...
    iget-object v0, p0, LX/95N;->A0B:Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;
    ...
    iget-object v4, p0, LX/95N;->A04:LX/90s;

    iget-object v0, p0, LX/95N;->A06:Landroid/content/Context;
    ...
    iget-object v2, v4, LX/90s;->A00:LX/8y9;
    ...
    iput-object v0, v2, LX/8y9;->A00:Lcom/facebook/cameracore/mediapipeline/dataproviders/facetracker/interfaces/FaceTrackerDataProviderConfig;

    new-instance v6, Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHostConfig;

    invoke-direct {v6, v2}, Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHostConfig;-><init>(LX/8y9;)V

    iget-object v7, v4, LX/90s;->A03:LX/71x;
...
.method public final declared-synchronized A01()Lcom/facebook/cameracore/mediapipeline/engine/AREngineController;
    ...
    :try_start_0
    iget-object v1, p0, LX/95N;->A05:Lcom/facebook/cameracore/mediapipeline/engine/AREngineController;

    if-nez v1, :cond_0

    iget-object v4, p0, LX/95N;->A07:Landroid/content/res/AssetManager;

    iget-object v3, p0, LX/95N;->A08:Lcom/facebook/common/jniexecutors/AndroidAsyncExecutorFactory;

    iget-object v2, p0, LX/95N;->A09:Lcom/facebook/common/jniexecutors/AndroidAsyncExecutorFactory;

    invoke-virtual {p0}, LX/95N;->A00()Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;
    ...
    iput-object v1, p0, LX/95N;->A05:Lcom/facebook/cameracore/mediapipeline/engine/AREngineController;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized A02()V
    ...
    iput-object v0, p0, LX/95N;->A0B:Lcom/facebook/cameracore/mediapipeline/arengineservices/interfaces/EffectServiceHost;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public finalize()V
    ...
    invoke-virtual {p0}, LX/95N;->A02()V
