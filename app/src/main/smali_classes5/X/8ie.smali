...
.method public constructor <init>(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-direct {v7}, LX/96d;-><init>()V
    ...
    iput-object v0, v7, LX/8ie;->A0J:Ljava/lang/Integer;
    ...
    iput-object v0, v7, LX/8ie;->A0K:Ljava/lang/Integer;
    ...
    iput-object v0, v7, LX/8ie;->A0E:Ljava/lang/Boolean;
    ...
    iput-object v5, v7, LX/8ie;->A0L:Ljava/lang/Integer;

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, v7, LX/8ie;->A0N:Ljava/lang/Integer;
    ...
    iput-object v0, v7, LX/8ie;->A0D:Ljava/lang/Boolean;
    ...
    :cond_2
    invoke-static {v2}, LX/96B;->A00(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, v7, LX/8ie;->A0d:Ljava/util/List;
    ...
    iput-object v0, v7, LX/8ie;->A0H:Ljava/lang/Float;
    ...
    iput-object v0, v7, LX/8ie;->A0G:Ljava/lang/Float;
    ...
    iput-object v0, v7, LX/8ie;->A0M:Ljava/lang/Integer;
    ...
    iput-object v0, v7, LX/8ie;->A0I:Ljava/lang/Integer;
    ...
    iput-object v0, v7, LX/8ie;->A05:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A0F:Ljava/lang/Float;
    ...
    iput-object v0, v7, LX/8ie;->A02:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A04:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A0B:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A0C:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A0Y:Ljava/util/List;
    ...
    invoke-static {v8, v2}, LX/001;->A0l(Ljava/util/List;I)Ljava/lang/String;
    ...
    invoke-static {v5, v1}, LX/0yF;->A1N(Ljava/util/AbstractCollection;I)V
    ...
    :cond_9
    sget-object v8, LX/96B;->A00:Ljava/util/List;

    goto :goto_5

    :cond_a
    invoke-static {v5}, LX/96B;->A00(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    :goto_5
    iput-object v8, v7, LX/8ie;->A0S:Ljava/util/List;
    ...
    invoke-static {v9, v2}, LX/001;->A0l(Ljava/util/List;I)Ljava/lang/String;
    ...
    :cond_c
    sget-object v0, LX/96B;->A00:Ljava/util/List;
    ...
    :goto_7
    iput-object v0, v7, LX/8ie;->A0P:Ljava/util/List;
    ...
    :goto_9
    iput-object v0, v7, LX/8ie;->A0Q:Ljava/util/List;
    ...
    :cond_12
    sget-object v9, LX/96B;->A00:Ljava/util/List;
    ...
    :goto_b
    iput-object v9, v7, LX/8ie;->A0R:Ljava/util/List;
    ...
    iput-object v0, v7, LX/8ie;->A0U:Ljava/util/List;
    ...
    invoke-static {v14, v6, v15}, LX/8fX;->A03(Ljava/lang/String;II)I
    ...
    invoke-static {v14, v15, v0}, LX/8fX;->A03(Ljava/lang/String;II)I
    ...
    invoke-static {v2, v14}, LX/000;->A0S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_17
    :goto_e
    invoke-static/range {v16 .. v16}, LX/96B;->A00(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, v7, LX/8ie;->A0X:Ljava/util/List;
    ...
    invoke-static {v10, v2}, LX/001;->A0l(Ljava/util/List;I)Ljava/lang/String;
    ...
    :cond_19
    sget-object v5, LX/96B;->A00:Ljava/util/List;
    ...
    :goto_10
    iput-object v5, v7, LX/8ie;->A0a:Ljava/util/List;
    ...
    iput-object v0, v7, LX/8ie;->A0W:Ljava/util/List;
    ...
    invoke-static {v12, v2}, LX/001;->A0l(Ljava/util/List;I)Ljava/lang/String;
    ...
    invoke-static {v10, v1}, LX/0yF;->A1N(Ljava/util/AbstractCollection;I)V
    ...
    :cond_1d
    invoke-static {v10}, LX/96B;->A00(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    :goto_12
    iput-object v0, v7, LX/8ie;->A0c:Ljava/util/List;
    ...
    :goto_13
    iput-object v0, v7, LX/8ie;->A0T:Ljava/util/List;
    ...
    invoke-static {v1, v3, v0}, LX/94n;->A01(Ljava/util/AbstractCollection;Ljava/util/List;I)V
    ...
    :cond_20
    sget-object v0, LX/96H;->A00:Ljava/util/HashMap;

    invoke-static {v0, v1}, LX/96H;->A01(Ljava/util/HashMap;Ljava/util/List;)Ljava/util/List;
    ...
    iput-object v3, v7, LX/8ie;->A0V:Ljava/util/List;
    ...
    :goto_16
    iput-object v0, v7, LX/8ie;->A0Z:Ljava/util/List;
    ...
    :goto_17
    iput-object v0, v7, LX/8ie;->A0b:Ljava/util/List;

    const/4 v0, 0x3

    invoke-static {v9, v0}, LX/0yK;->A1X(Ljava/util/List;I)Z
    ...
    iput-object v0, v7, LX/8ie;->A0A:Ljava/lang/Boolean;

    invoke-static {v8, v6}, LX/0yK;->A1X(Ljava/util/List;I)Z
    ...
    iput-object v0, v7, LX/8ie;->A03:Ljava/lang/Boolean;

    invoke-static/range {v17 .. v17}, LX/001;->A1U(I)Z
    ...
    iput-object v0, v7, LX/8ie;->A09:Ljava/lang/Boolean;

    invoke-static/range {v18 .. v18}, LX/001;->A1U(I)Z
    ...
    iput-object v0, v7, LX/8ie;->A08:Ljava/lang/Boolean;

    sget-object v0, LX/96H;->A04:Ljava/util/HashSet;
    ...
    invoke-static {v5, v0}, LX/0yK;->A1X(Ljava/util/List;I)Z
    ...
    iput-object v0, v7, LX/8ie;->A07:Ljava/lang/Boolean;
    ...
    iput-object v0, v7, LX/8ie;->A06:Ljava/lang/Boolean;
    ...
    invoke-static {v1}, LX/98M;->A01(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v10, v0}, LX/94n;->A01(Ljava/util/AbstractCollection;Ljava/util/List;I)V
    ...
    :cond_27
    sget-object v0, LX/96H;->A01:Ljava/util/HashMap;
    ...
    :goto_1d
    invoke-static {v11, v0, v1}, LX/98M;->A00(Landroid/hardware/Camera$Parameters;Ljava/lang/String;Ljava/lang/String;)LX/91G;

    move-result-object v0

    :goto_1e
    iput-object v0, v7, LX/8ie;->A00:LX/91G;

    const/4 v5, 0x0

    new-instance v4, LX/94n;

    invoke-direct {v4, v5, v5}, LX/94n;-><init>(II)V
    ...
    :cond_2e
    invoke-static {v11, v1, v2}, LX/98M;->A00(Landroid/hardware/Camera$Parameters;Ljava/lang/String;Ljava/lang/String;)LX/91G;
    ...
    :cond_2f
    iput-object v4, v7, LX/8ie;->A01:LX/94n;
    ...
    invoke-static {v1, v3, v0}, LX/001;->A1N([Ljava/lang/Object;FI)V

    invoke-static {v1, v2, v6}, LX/001;->A1N([Ljava/lang/Object;FI)V

    invoke-static {v1}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    iput-object v0, v7, LX/8ie;->A0O:Ljava/util/List;
