...
# direct methods
.method public constructor <init>(LX/2pP;LX/35u;)V
    .locals 3
    ...
    iput-object v0, p0, LX/97m;->A02:LX/35Z;

    iput-object p2, p0, LX/97m;->A01:LX/35u;

    iget-object v1, p1, LX/2pP;->A00:Landroid/content/Context;

    new-instance v0, LX/0Y9;

    invoke-direct {v0, v1}, LX/0Y9;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, LX/97m;->A00:LX/0Y9;
...
.method public static A00()LX/0WP;
    ...
    invoke-direct {v0, v1}, LX/0WP;-><init>(Ljava/security/Signature;)V
...
.method public declared-synchronized A01()I
    ...
    :try_start_0
    iget-object v0, p0, LX/97m;->A01:LX/35u;
    ...
    invoke-virtual {p0}, LX/97m;->A03()V
    :try_end_1
    ...
    :try_start_2
    iget-object v1, p0, LX/97m;->A02:LX/35Z;
...
.method public final declared-synchronized A02(I)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v7, p0, LX/97m;->A01:LX/35u;

    invoke-static {v7}, LX/8fX;->A0i(LX/35u;)Lorg/json/JSONObject;
...
.method public A03()V
    ...
    invoke-virtual {p0, v0}, LX/97m;->A02(I)Ljava/lang/String;
...
.method public A05()Z
    ...
    iget-object v1, p0, LX/97m;->A00:LX/0Y9;
