...
.method public constructor <init>(LX/9NC;)V
    ...
    iput-object p1, p0, LX/9AL;->A00:LX/9NC;
...
.method public static A00(LX/984;)Ljava/lang/String;
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, LX/984;->A09:Ljava/lang/String;

    if-nez v0, :cond_1

    iget-object v0, p0, LX/984;->A0A:Ljava/lang/String;
...
.method public AyL(LX/984;Lcom/facebook/cameracore/ardelivery/storage/interfaces/StorageCallback;)Ljava/io/File;
    ...
    iget-object v0, p0, LX/9AL;->A00:LX/9NC;

    check-cast v0, LX/9AN;

    invoke-static {p1}, LX/9AL;->A00(LX/984;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, LX/9AN;->A02:Lcom/facebook/stash/core/FileStash;
...
.method public BAS(LX/984;Z)Z
    ...
    invoke-interface {v0, v1}, LX/8Yd;->B8i(Ljava/lang/String;)Z
...
.method public Bb4(LX/984;)V
    ...
    iget-object v1, p0, LX/9AL;->A00:LX/9NC;
    ...
    iget-object v1, v1, LX/9AN;->A02:Lcom/facebook/stash/core/FileStash;

    invoke-static {p1}, LX/9AL;->A00(LX/984;)Ljava/lang/String;

    move-result-object v0

    invoke-interface {v1, v0}, LX/8Yd;->Bb5(Ljava/lang/String;)Z
...
.method public Bcn(LX/984;Lcom/facebook/cameracore/ardelivery/storage/interfaces/StorageCallback;Ljava/io/File;)Ljava/io/File;
    ...
    iget-object v3, v0, LX/9AN;->A02:Lcom/facebook/stash/core/FileStash;

    invoke-interface {v3, v5}, Lcom/facebook/stash/core/FileStash;->getFilePath(Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    invoke-static {v1}, LX/95p;->A01(Ljava/io/File;)Z
    ...
    invoke-static {p3, v1, v2}, LX/000;->A12(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V

    const-string v1, "StashDiskCacheWrapper"

    const-string v0, "Failed renaming file from %s to %s"

    invoke-static {v1, v0, v2}, LX/7cT;->A0B(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v3, v5}, LX/8Yd;->Bb5(Ljava/lang/String;)Z
