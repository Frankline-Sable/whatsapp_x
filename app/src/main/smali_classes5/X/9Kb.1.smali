...
# direct methods
.method public constructor <init>(LX/9AY;JZ)V
    .locals 0

    iput-object p1, p0, LX/9Kb;->A01:LX/9AY;

    iput-wide p2, p0, LX/9Kb;->A00:J

    iput-boolean p4, p0, LX/9Kb;->A02:Z
...
.method public run()V
    ...
    iget-object v0, p0, LX/9Kb;->A01:LX/9AY;

    iget-object v6, v0, LX/9AY;->A00:LX/94b;

    iget-wide v3, p0, LX/9Kb;->A00:J

    iget-boolean v2, p0, LX/9Kb;->A02:Z

    const/4 v1, 0x1

    iget v0, v6, LX/94b;->A01:I

    sub-int/2addr v0, v1

    iput v0, v6, LX/94b;->A01:I

    if-eqz v2, :cond_1

    iget v0, v6, LX/94b;->A00:I

    add-int/lit8 v0, v0, 0x1

    iput v0, v6, LX/94b;->A00:I

    iget-object v2, v6, LX/94b;->A0A:Ljava/util/Map;
    ...
    iget-object v0, v6, LX/94b;->A0B:Ljava/util/Map;
    ...
    iget-object v0, v6, LX/94b;->A05:Lcom/facebook/cameracore/mediapipeline/services/touch/implementation/TouchServiceImpl;
    ...
    :cond_0
    iget-object v1, v6, LX/94b;->A09:Ljava/util/Map;
    ...
    invoke-virtual {v6, v5}, LX/94b;->A00(Lcom/facebook/cameracore/mediapipeline/services/touch/implementation/Gesture$GestureType;)V
    ...
    invoke-virtual {v6, v0}, LX/94b;->A01(Ljava/lang/Long;)V
    ...
    iget-object v0, v6, LX/94b;->A07:Ljava/util/List;
    ...
    iget-object v0, v6, LX/94b;->A0C:Ljava/util/Set;
    ...
    :cond_4
    invoke-virtual {v6, v1}, LX/94b;->A00(Lcom/facebook/cameracore/mediapipeline/services/touch/implementation/Gesture$GestureType;)V
