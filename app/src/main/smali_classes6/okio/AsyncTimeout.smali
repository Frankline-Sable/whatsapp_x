...
.method static a()Lokio/AsyncTimeout;
    ...
    :cond_1
    invoke-direct {v0, v3, v4}, Lokio/AsyncTimeout;->e(J)J
...
.method private static declared-synchronized b(Lokio/AsyncTimeout;)Z
    .locals 3
    ...
    iget-object v2, v1, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    if-ne v2, p0, :cond_0

    iget-object v2, p0, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    iput-object v2, v1, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    const/4 v1, 0x0

    iput-object v1, p0, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;
    :try_end_0
...
.method private static declared-synchronized f(Lokio/AsyncTimeout;JZ)V
    .locals 6
    ...
    :goto_1
    invoke-direct {p0, v1, v2}, Lokio/AsyncTimeout;->e(J)J
    ...
    :goto_2
    iget-object v3, p3, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    if-eqz v3, :cond_4

    invoke-direct {v3, v1, v2}, Lokio/AsyncTimeout;->e(J)J
    ...
    :cond_3
    iget-object p3, p3, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    goto :goto_2

    :cond_4
    :goto_3
    iget-object p1, p3, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    iput-object p1, p0, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;

    iput-object p0, p3, Lokio/AsyncTimeout;->e:Lokio/AsyncTimeout;
...
# virtual methods
.method final c(Ljava/io/IOException;)Ljava/io/IOException;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final enter()V
    ...
    invoke-static {p0, v0, v1, v2}, Lokio/AsyncTimeout;->f(Lokio/AsyncTimeout;JZ)V
...
.method public final exit()Z
    ...
    invoke-static {p0}, Lokio/AsyncTimeout;->b(Lokio/AsyncTimeout;)Z
