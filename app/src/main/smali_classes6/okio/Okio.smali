...
.method private static b(Ljava/io/OutputStream;Lokio/Timeout;)Lokio/Sink;
    .locals 1
...
.method public static buffer(Lokio/Sink;)Lokio/BufferedSink;
    ...
    invoke-direct {v0, p0}, Lokio/b;-><init>(Lokio/Sink;)V
...
.method public static buffer(Lokio/Source;)Lokio/BufferedSource;
    ...
    invoke-direct {v0, p0}, Lokio/c;-><init>(Lokio/Source;)V

    return-object v0
.end method

.method private static c(Ljava/io/InputStream;Lokio/Timeout;)Lokio/Source;
    .locals 1
...
.method private static d(Ljava/net/Socket;)Lokio/AsyncTimeout;
    .locals 1
...
.method public static sink(Ljava/io/OutputStream;)Lokio/Sink;
    ...
    invoke-static {p0, v0}, Lokio/Okio;->b(Ljava/io/OutputStream;Lokio/Timeout;)Lokio/Sink;
...
.method public static sink(Ljava/net/Socket;)Lokio/Sink;
    ...
    invoke-static {p0}, Lokio/Okio;->d(Ljava/net/Socket;)Lokio/AsyncTimeout;
...
.method public static varargs sink(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Sink;
    ...
    invoke-static {p0, p1}, Lcom/gbwhatsapp/youbasha/task/j;->a(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/OutputStream;
...
.method public static source(Ljava/io/InputStream;)Lokio/Source;
    ...
    invoke-static {p0, v0}, Lokio/Okio;->c(Ljava/io/InputStream;Lokio/Timeout;)Lokio/Source;
...
.method public static varargs source(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lokio/Source;
    ...
    invoke-static {p0, p1}, Lcom/gbwhatsapp/youbasha/task/k;->a(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Ljava/io/InputStream;
