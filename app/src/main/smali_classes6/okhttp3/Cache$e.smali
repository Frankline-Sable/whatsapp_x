...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/Cache$e;->k:Ljava/lang/String;
    ...
    sput-object v0, Lokhttp3/Cache$e;->l:Ljava/lang/String;
...
.method constructor <init>(Lokhttp3/Response;)V
    ...
    iput-object v0, p0, Lokhttp3/Cache$e;->a:Ljava/lang/String;

    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->varyHeaders(Lokhttp3/Response;)Lokhttp3/Headers;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
    ...
    iput-object v0, p0, Lokhttp3/Cache$e;->c:Ljava/lang/String;

    invoke-virtual {p1}, Lokhttp3/Response;->protocol()Lokhttp3/Protocol;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$e;->d:Lokhttp3/Protocol;

    invoke-virtual {p1}, Lokhttp3/Response;->code()I

    move-result v0

    iput v0, p0, Lokhttp3/Cache$e;->e:I

    invoke-virtual {p1}, Lokhttp3/Response;->message()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$e;->f:Ljava/lang/String;

    invoke-virtual {p1}, Lokhttp3/Response;->headers()Lokhttp3/Headers;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;

    invoke-virtual {p1}, Lokhttp3/Response;->handshake()Lokhttp3/Handshake;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$e;->h:Lokhttp3/Handshake;

    invoke-virtual {p1}, Lokhttp3/Response;->sentRequestAtMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lokhttp3/Cache$e;->i:J

    invoke-virtual {p1}, Lokhttp3/Response;->receivedResponseAtMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lokhttp3/Cache$e;->j:J
...
.method constructor <init>(Lokio/Source;)V
    ...
    iput-object v1, p0, Lokhttp3/Cache$e;->a:Ljava/lang/String;

    invoke-interface {v0}, Lokio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lokhttp3/Cache$e;->c:Ljava/lang/String;

    new-instance v1, Lokhttp3/Headers$Builder;

    invoke-direct {v1}, Lokhttp3/Headers$Builder;-><init>()V

    invoke-static {v0}, Lokhttp3/Cache;->d(Lokio/BufferedSource;)I
    ...
    iput-object v1, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
    ...
    iput-object v2, p0, Lokhttp3/Cache$e;->d:Lokhttp3/Protocol;

    iget v2, v1, Lokhttp3/internal/http/StatusLine;->code:I

    iput v2, p0, Lokhttp3/Cache$e;->e:I

    iget-object v1, v1, Lokhttp3/internal/http/StatusLine;->message:Ljava/lang/String;

    iput-object v1, p0, Lokhttp3/Cache$e;->f:Ljava/lang/String;
    ...
    :cond_1
    sget-object v2, Lokhttp3/Cache$e;->k:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    sget-object v4, Lokhttp3/Cache$e;->l:Ljava/lang/String;
    ...
    :goto_2
    iput-wide v2, p0, Lokhttp3/Cache$e;->i:J
    ...
    :cond_3
    iput-wide v6, p0, Lokhttp3/Cache$e;->j:J

    invoke-virtual {v1}, Lokhttp3/Headers$Builder;->build()Lokhttp3/Headers;

    move-result-object v1

    iput-object v1, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;

    invoke-direct {p0}, Lokhttp3/Cache$e;->a()Z
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache$e;->c(Lokio/BufferedSource;)Ljava/util/List;
...
.method private a()Z
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/Cache$e;->a:Ljava/lang/String;
...
.method private c(Lokio/BufferedSource;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/Cache;->d(Lokio/BufferedSource;)I
...
.method public b(Lokhttp3/Request;Lokhttp3/Response;)Z
    ...
    iget-object v0, p0, Lokhttp3/Cache$e;->c:Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
...
.method public d(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;
    ...
    iget-object v1, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;
    ...
    iget-object v3, p0, Lokhttp3/Cache$e;->a:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lokhttp3/Request$Builder;->url(Ljava/lang/String;)Lokhttp3/Request$Builder;

    move-result-object v2

    iget-object v3, p0, Lokhttp3/Cache$e;->c:Ljava/lang/String;
    ...
    iget-object v3, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
    ...
    iget-object v3, p0, Lokhttp3/Cache$e;->d:Lokhttp3/Protocol;

    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->protocol(Lokhttp3/Protocol;)Lokhttp3/Response$Builder;

    move-result-object v2

    iget v3, p0, Lokhttp3/Cache$e;->e:I

    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->code(I)Lokhttp3/Response$Builder;

    move-result-object v2

    iget-object v3, p0, Lokhttp3/Cache$e;->f:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->message(Ljava/lang/String;)Lokhttp3/Response$Builder;

    move-result-object v2

    iget-object v3, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;

    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->headers(Lokhttp3/Headers;)Lokhttp3/Response$Builder;

    move-result-object v2

    new-instance v3, Lokhttp3/Cache$d;

    invoke-direct {v3, p1, v0, v1}, Lokhttp3/Cache$d;-><init>(Lokhttp3/internal/cache/DiskLruCache$Snapshot;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->body(Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;

    move-result-object p1

    iget-object v0, p0, Lokhttp3/Cache$e;->h:Lokhttp3/Handshake;

    invoke-virtual {p1, v0}, Lokhttp3/Response$Builder;->handshake(Lokhttp3/Handshake;)Lokhttp3/Response$Builder;

    move-result-object p1

    iget-wide v0, p0, Lokhttp3/Cache$e;->i:J

    invoke-virtual {p1, v0, v1}, Lokhttp3/Response$Builder;->sentRequestAtMillis(J)Lokhttp3/Response$Builder;

    move-result-object p1

    iget-wide v0, p0, Lokhttp3/Cache$e;->j:J
...
.method public f(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    iget-object v1, p0, Lokhttp3/Cache$e;->a:Ljava/lang/String;
    ...
    iget-object v1, p0, Lokhttp3/Cache$e;->c:Ljava/lang/String;
    ...
    iget-object v1, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
    ...
    iget-object v5, p0, Lokhttp3/Cache$e;->b:Lokhttp3/Headers;
    ...
    iget v5, p0, Lokhttp3/Cache$e;->e:I

    iget-object v6, p0, Lokhttp3/Cache$e;->f:Ljava/lang/String;
    ...
    iget-object v5, p0, Lokhttp3/Cache$e;->g:Lokhttp3/Headers;
    ...
    :cond_1
    sget-object v0, Lokhttp3/Cache$e;->k:Ljava/lang/String;
    ...
    iget-wide v5, p0, Lokhttp3/Cache$e;->i:J
    ...
    sget-object v0, Lokhttp3/Cache$e;->l:Ljava/lang/String;
    ...
    iget-wide v3, p0, Lokhttp3/Cache$e;->j:J
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$e;->e(Lokio/BufferedSink;Ljava/util/List;)V
