...
.method static d(Lokio/BufferedSource;)I
    .locals 5
...
# virtual methods
.method b(Lokhttp3/Request;)Lokhttp3/Response;
    .locals 4
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
    ...
    :cond_0
    :try_start_1
    new-instance v2, Lokhttp3/Cache$e;
    ...
    invoke-direct {v2, v3}, Lokhttp3/Cache$e;-><init>(Lokio/Source;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    invoke-virtual {v2, v0}, Lokhttp3/Cache$e;->d(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;

    move-result-object v0

    invoke-virtual {v2, p1, v0}, Lokhttp3/Cache$e;->b(Lokhttp3/Request;Lokhttp3/Response;)Z
...
.method c(Lokhttp3/Response;)Lokhttp3/internal/cache/CacheRequest;
    .locals 3
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
    ...
    invoke-virtual {p0, p1}, Lokhttp3/Cache;->e(Lokhttp3/Request;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    new-instance v0, Lokhttp3/Cache$e;

    invoke-direct {v0, p1}, Lokhttp3/Cache$e;-><init>(Lokhttp3/Response;)V
    ...
    :cond_3
    :try_start_2
    invoke-virtual {v0, p1}, Lokhttp3/Cache$e;->f(Lokhttp3/internal/cache/DiskLruCache$Editor;)V

    new-instance v0, Lokhttp3/Cache$c;

    invoke-direct {v0, p0, p1}, Lokhttp3/Cache$c;-><init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    :try_end_2
...
.method declared-synchronized g(Lokhttp3/internal/cache/CacheStrategy;)V
    .locals 1
...
.method h(Lokhttp3/Response;Lokhttp3/Response;)V
    .locals 1

    .line 1
    new-instance v0, Lokhttp3/Cache$e;

    invoke-direct {v0, p2}, Lokhttp3/Cache$e;-><init>(Lokhttp3/Response;)V

    invoke-virtual {p1}, Lokhttp3/Response;->body()Lokhttp3/ResponseBody;

    move-result-object p1

    check-cast p1, Lokhttp3/Cache$d;

    iget-object p1, p1, Lokhttp3/Cache$d;->b:Lokhttp3/internal/cache/DiskLruCache$Snapshot;
...
.method public urls()Ljava/util/Iterator;
    ...
    invoke-direct {v0, p0}, Lokhttp3/Cache$b;-><init>(Lokhttp3/Cache;)V
