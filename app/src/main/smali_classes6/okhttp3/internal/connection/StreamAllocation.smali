...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/Call;Lokhttp3/EventListener;Ljava/lang/Object;)V
    ...
    invoke-direct {p0}, Lokhttp3/internal/connection/StreamAllocation;->f()Lokhttp3/internal/connection/RouteDatabase;
...
.method private a(ZZZ)Ljava/net/Socket;
    ...
    :cond_3
    invoke-direct {p0, p2}, Lokhttp3/internal/connection/StreamAllocation;->d(Lokhttp3/internal/connection/RealConnection;)V
...
.method private b(IIIIZ)Lokhttp3/internal/connection/RealConnection;
    .locals 18
    ...
    invoke-direct/range {p0 .. p0}, Lokhttp3/internal/connection/StreamAllocation;->e()Ljava/net/Socket;
    ...
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->a:Lokhttp3/internal/connection/RouteSelector$Selection;
    ...
    :cond_7
    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->e:Lokhttp3/internal/connection/RouteSelector;

    invoke-virtual {v0}, Lokhttp3/internal/connection/RouteSelector;->next()Lokhttp3/internal/connection/RouteSelector$Selection;

    move-result-object v0

    iput-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->a:Lokhttp3/internal/connection/RouteSelector$Selection;
    ...
    :try_start_1
    iget-boolean v2, v1, Lokhttp3/internal/connection/StreamAllocation;->j:Z
    ...
    :cond_b
    iput-object v8, v1, Lokhttp3/internal/connection/StreamAllocation;->b:Lokhttp3/Route;

    iput v7, v1, Lokhttp3/internal/connection/StreamAllocation;->f:I

    new-instance v4, Lokhttp3/internal/connection/RealConnection;

    iget-object v0, v1, Lokhttp3/internal/connection/StreamAllocation;->c:Lokhttp3/ConnectionPool;
    ...
    invoke-direct/range {p0 .. p0}, Lokhttp3/internal/connection/StreamAllocation;->f()Lokhttp3/internal/connection/RouteDatabase;
...
.method private c(IIIIZZ)Lokhttp3/internal/connection/RealConnection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    :goto_0
    invoke-direct/range {p0 .. p5}, Lokhttp3/internal/connection/StreamAllocation;->b(IIIIZ)Lokhttp3/internal/connection/RealConnection;
...
.method private d(Lokhttp3/internal/connection/RealConnection;)V
    .locals 3
...
.method private f()Lokhttp3/internal/connection/RouteDatabase;
    .locals 2
...
.method public newStream(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Z)Lokhttp3/internal/http/HttpCodec;
    ...
    :try_start_0
    invoke-direct/range {v0 .. v6}, Lokhttp3/internal/connection/StreamAllocation;->c(IIIIZZ)Lokhttp3/internal/connection/RealConnection;
...
.method public streamFailed(Ljava/io/IOException;)V
    ...
    :cond_1
    :goto_0
    iput-object v2, p0, Lokhttp3/internal/connection/StreamAllocation;->b:Lokhttp3/Route;
    ...
    iget-object v5, p0, Lokhttp3/internal/connection/StreamAllocation;->e:Lokhttp3/internal/connection/RouteSelector;
    ...
    invoke-direct {p0, p1, v4, v3}, Lokhttp3/internal/connection/StreamAllocation;->a(ZZZ)Ljava/net/Socket;
    ...
    iget-boolean v3, p0, Lokhttp3/internal/connection/StreamAllocation;->h:Z
