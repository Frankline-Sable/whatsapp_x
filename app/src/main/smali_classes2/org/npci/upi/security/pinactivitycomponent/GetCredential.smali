...
.field public A0G:LX/2es;

.field public A0H:LX/2t4;
...
.method public static A0D(Landroid/view/View;FF)V
    .locals 9
...
.method public static synthetic A0M(Lorg/npci/upi/security/pinactivitycomponent/GetCredential;Z)V
    .locals 5
    ...
    invoke-static {v0, v4, v1}, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0D(Landroid/view/View;FF)V
    ...
    invoke-direct {v0, p0, v3, p1}, LX/0yR;-><init>(Lorg/npci/upi/security/pinactivitycomponent/GetCredential;IZ)V
    ...
    :cond_3
    invoke-static {v0, v1, v4}, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0D(Landroid/view/View;FF)V
...
# virtual methods
.method public A55(Ljava/lang/String;)V
    .locals 3
...
.method public attachBaseContext(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, LX/2HI;-><init>(Landroid/content/Context;)V

    const-string/jumbo v2, "org.npci.upi.language.pref"

    const-string v1, "en_US"

    iget-object v0, v0, LX/2HI;->A00:Landroid/content/SharedPreferences;
    ...
    invoke-static {p1, v2}, LX/24s;->A00(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Context;
    ...
    :cond_0
    invoke-static {v2}, LX/0yI;->A0x(Ljava/lang/String;)Ljava/util/Locale;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v1, p0, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;

    iget-object v0, v1, LX/2t4;->A05:Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;

    invoke-virtual {v0}, LX/2t4;->A02()V
    ...
    invoke-virtual {v1, v0}, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A55(Ljava/lang/String;)V
...
.method public onBackPressed()V
    ...
    invoke-direct {v2, p0, v0}, LX/3du;-><init>(Ljava/lang/Object;I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v13}, LX/0yL;->A0I(Landroid/app/Activity;)Landroid/os/Bundle;

    move-result-object v0

    new-instance v3, LX/2es;

    invoke-direct {v3, v0}, LX/2es;-><init>(Landroid/os/Bundle;)V

    iput-object v3, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0G:LX/2es;

    :try_start_0
    new-instance v1, LX/2Ud;

    invoke-direct {v1}, LX/2Ud;-><init>()V

    iput-object v1, v3, LX/2es;->A0H:LX/2Ud;
    :try_end_0
    ...
    invoke-direct {v0, v13, v1}, LX/2jY;-><init>(Landroid/content/Context;LX/2Ud;)V

    iput-object v0, v3, LX/2es;->A0G:LX/2jY;

    iget-object v2, v3, LX/2es;->A0H:LX/2Ud;

    iget-object v5, v3, LX/2es;->A01:Landroid/os/Bundle;

    const-string v18, "l09.message"

    const-string v4, "L09"

    const-string v7, "l07.message"
    ...
    invoke-direct {v1, v13}, LX/2gk;-><init>(Landroid/content/Context;)V

    iput-object v1, v2, LX/2Ud;->A0A:LX/2gk;
    :try_end_1
    .catch LX/1z8; {:try_start_1 .. :try_end_1} :catch_e
    .catch LX/1z7; {:try_start_1 .. :try_end_1} :catch_17
    ...
    iput-object v3, v2, LX/2Ud;->A06:Lorg/json/JSONArray;

    const-string/jumbo v1, "setMpin"

    invoke-virtual {v3, v1}, Lorg/json/JSONArray;->put(Ljava/lang/Object;)Lorg/json/JSONArray;

    iget-object v1, v2, LX/2Ud;->A06:Lorg/json/JSONArray;
    ...
    iget-object v3, v2, LX/2Ud;->A06:Lorg/json/JSONArray;
    ...
    .catch LX/1z8; {:try_start_2 .. :try_end_2} :catch_e
    .catch LX/1z7; {:try_start_2 .. :try_end_2} :catch_17
    ...
    iput-object v1, v2, LX/2Ud;->A01:Ljava/lang/String;
    ...
    if-nez v1, :cond_26
    :try_end_3
    .catch LX/1z8; {:try_start_3 .. :try_end_3} :catch_b
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_a
    .catch LX/1z7; {:try_start_3 .. :try_end_3} :catch_17
    ...
    invoke-direct {v1, v3}, LX/2iG;-><init>(Ljava/lang/String;)V

    iput-object v1, v2, LX/2Ud;->A00:LX/2iG;
    :try_end_4
    .catch LX/1z7; {:try_start_4 .. :try_end_4} :catch_9
    .catch LX/1z8; {:try_start_4 .. :try_end_4} :catch_b
    ...
    invoke-direct {v0, v13, v2, v1}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v1, v2, LX/2Ud;->A07:Lorg/json/JSONObject;
    ...
    iput-object v3, v2, LX/2Ud;->A07:Lorg/json/JSONObject;
    ...
    :try_end_5
    .catch LX/1z8; {:try_start_5 .. :try_end_5} :catch_b
    .catch Ljava/lang/Exception; {:try_start_5 .. :try_end_5} :catch_7
    .catch LX/1z7; {:try_start_5 .. :try_end_5} :catch_17
    ...
    iput-object v1, v2, LX/2Ud;->A08:Lorg/json/JSONObject;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_6} :catch_6
    .catch LX/1z8; {:try_start_6 .. :try_end_6} :catch_e
    .catch LX/1z7; {:try_start_6 .. :try_end_6} :catch_17
    ...
    invoke-static/range {v16 .. v16}, LX/0yN;->A1N(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    move-result v1
    :try_end_7
    .catch LX/1z8; {:try_start_7 .. :try_end_7} :catch_b
    .catch Ljava/lang/Exception; {:try_start_7 .. :try_end_7} :catch_5
    .catch LX/1z7; {:try_start_7 .. :try_end_7} :catch_17
    ...
    if-eqz v1, :cond_22
    :try_end_8
    .catch LX/1z8; {:try_start_8 .. :try_end_8} :catch_e
    .catch LX/1z7; {:try_start_8 .. :try_end_8} :catch_17
    ...
    :try_end_9
    .catch LX/1z8; {:try_start_9 .. :try_end_9} :catch_b
    .catch Ljava/lang/Exception; {:try_start_9 .. :try_end_9} :catch_5
    .catch LX/1z7; {:try_start_9 .. :try_end_9} :catch_17

    :try_start_a
    const-string v6, "l27.message"

    const-string v1, "L27"

    if-eqz v3, :cond_21
    :try_end_a
    .catch LX/1z8; {:try_start_a .. :try_end_a} :catch_e
    .catch LX/1z7; {:try_start_a .. :try_end_a} :catch_17
    ...
    iput-object v0, v2, LX/2Ud;->A05:Lorg/json/JSONArray;
    ...
    iget-object v0, v2, LX/2Ud;->A05:Lorg/json/JSONArray;
    ...
    :goto_2
    iget-object v0, v2, LX/2Ud;->A06:Lorg/json/JSONArray;
    ...
    invoke-direct {v2, v13, v1, v0}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, v2, LX/2Ud;->A04:Lorg/json/JSONArray;
    ...
    iget-object v0, v2, LX/2Ud;->A04:Lorg/json/JSONArray;
    ...
    iget-object v1, v2, LX/2Ud;->A04:Lorg/json/JSONArray;
    ...
    iput-object v0, v2, LX/2Ud;->A09:Lorg/json/JSONObject;
    :try_end_b
    .catch LX/1z8; {:try_start_b .. :try_end_b} :catch_b
    .catch Ljava/lang/Exception; {:try_start_b .. :try_end_b} :catch_5
    .catch LX/1z7; {:try_start_b .. :try_end_b} :catch_17
    ...
    iget-object v1, v2, LX/2Ud;->A09:Lorg/json/JSONObject;
    ...
    iget-object v3, v2, LX/2Ud;->A09:Lorg/json/JSONObject;
    ...
    move-result-object v3
    :try_end_c
    .catch LX/1z8; {:try_start_c .. :try_end_c} :catch_b
    .catch LX/1z7; {:try_start_c .. :try_end_c} :catch_b
    ...
    .catch LX/1z8; {:try_start_d .. :try_end_d} :catch_b
    .catch LX/1z7; {:try_start_d .. :try_end_d} :catch_b
    ...
    if-eqz v14, :cond_d
    :try_end_e
    .catch LX/1z8; {:try_start_e .. :try_end_e} :catch_b
    .catch LX/1z7; {:try_start_e .. :try_end_e} :catch_b
    .catch Ljava/lang/Exception; {:try_start_e .. :try_end_e} :catch_4

    :try_start_f
    invoke-static {v7, v14}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_d
    if-eqz v12, :cond_e

    invoke-static {v7, v12}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_e
    if-eqz v11, :cond_f

    invoke-static {v7, v11}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_f
    if-eqz v9, :cond_10

    invoke-static {v7, v9}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_10
    if-eqz v10, :cond_11

    invoke-static {v7, v10}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_11
    if-eqz v8, :cond_12

    invoke-static {v7, v8}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_12
    if-eqz v1, :cond_13

    invoke-static {v7, v1}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_13
    if-eqz v15, :cond_14

    invoke-static {v7, v15}, LX/0yG;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    :cond_15
    iget-object v0, v2, LX/2Ud;->A0A:LX/2gk;
    ...
    iget-object v11, v0, LX/2xM;->A01:Ljava/lang/String;
    ...
    .catch LX/1z8; {:try_start_f .. :try_end_f} :catch_b
    .catch LX/1z7; {:try_start_f .. :try_end_f} :catch_b
    ...
    invoke-static {v0}, LX/2vE;->A01([B)[B

    move-result-object v10

    invoke-static {v1, v3}, LX/36U;->A00(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    invoke-static {v11, v1, v0}, LX/0yL;->A1L(Ljava/lang/String;[BI)V
    ...
    invoke-static {v10}, LX/0yM;->A13([B)Ljavax/crypto/spec/GCMParameterSpec;

    move-result-object v0

    invoke-static {v3, v0, v1, v7, v9}, LX/0yJ;->A1Z(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljavax/crypto/Cipher;[BI)[B
    ...
    :cond_17
    sget-object v1, LX/1vA;->A05:LX/1vA;
    ...
    .catch LX/1z8; {:try_start_10 .. :try_end_10} :catch_b
    .catch LX/1z7; {:try_start_10 .. :try_end_10} :catch_b
    ...
    invoke-direct {v1, v0}, LX/1z7;-><init>(LX/1vA;)V
    ...
    .catch LX/1z8; {:try_start_11 .. :try_end_11} :catch_b
    .catch LX/1z7; {:try_start_11 .. :try_end_11} :catch_b
    ...
    iput-object v0, v2, LX/2Ud;->A03:Lorg/json/JSONArray;
    :try_end_12
    .catch Ljava/lang/Exception; {:try_start_12 .. :try_end_12} :catch_d
    .catch LX/1z8; {:try_start_12 .. :try_end_12} :catch_e
    .catch LX/1z7; {:try_start_12 .. :try_end_12} :catch_17
    ...
    iput-object v0, v2, LX/2Ud;->A02:Ljava/util/Locale;
    ...
    .catch LX/1z8; {:try_start_13 .. :try_end_13} :catch_e
    .catch LX/1z7; {:try_start_13 .. :try_end_13} :catch_17
    ...
    invoke-direct {v3, v13, v1, v0}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_b
    :try_end_14
    .catch LX/1z8; {:try_start_14 .. :try_end_14} :catch_e
    .catch LX/1z7; {:try_start_14 .. :try_end_14} :catch_17
    ...
    invoke-direct {v2, v0}, LX/1z7;-><init>(LX/1vA;)V

    :goto_9
    throw v2
    :try_end_15
    .catch LX/1z8; {:try_start_15 .. :try_end_15} :catch_b
    .catch LX/1z7; {:try_start_15 .. :try_end_15} :catch_b
    ...
    invoke-direct {v3, v13, v4, v0, v1}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    goto/16 :goto_b
    :try_end_16
    .catch LX/1z8; {:try_start_16 .. :try_end_16} :catch_e
    .catch LX/1z7; {:try_start_16 .. :try_end_16} :catch_17
    ...
    invoke-direct {v2, v13, v1, v6}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v13, v9, v14}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    throw v2
    :try_end_17
    .catch LX/1z8; {:try_start_17 .. :try_end_17} :catch_b
    .catch Ljava/lang/Exception; {:try_start_17 .. :try_end_17} :catch_5
    .catch LX/1z7; {:try_start_17 .. :try_end_17} :catch_17
    ...
    invoke-direct {v3, v13, v1, v0, v2}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    goto :goto_b
    :try_end_18
    .catch LX/1z8; {:try_start_18 .. :try_end_18} :catch_e
    .catch LX/1z7; {:try_start_18 .. :try_end_18} :catch_17
    ...
    throw v0
    :try_end_19
    .catch LX/1z7; {:try_start_19 .. :try_end_19} :catch_9
    .catch LX/1z8; {:try_start_19 .. :try_end_19} :catch_b
    ...
    goto :goto_b
    :try_end_1a
    .catch LX/1z8; {:try_start_1a .. :try_end_1a} :catch_e
    .catch LX/1z7; {:try_start_1a .. :try_end_1a} :catch_17
    ...
    throw v0
    :try_end_1b
    .catch LX/1z8; {:try_start_1b .. :try_end_1b} :catch_b
    .catch Ljava/lang/Exception; {:try_start_1b .. :try_end_1b} :catch_a
    .catch LX/1z7; {:try_start_1b .. :try_end_1b} :catch_17
    ...
    invoke-direct {v3, v13, v6, v7, v0}, LX/1z8;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    throw v3
    :try_end_1c
    .catch LX/1z8; {:try_start_1c .. :try_end_1c} :catch_e
    .catch LX/1z7; {:try_start_1c .. :try_end_1c} :catch_17
    ...
    :try_start_1d
    iget-object v0, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0G:LX/2es;

    iget-object v0, v0, LX/2es;->A0C:Lorg/json/JSONObject;
    ...
    iget-object v0, v0, LX/2es;->A04:Ljava/lang/String;

    invoke-static {v0}, LX/0yI;->A0x(Ljava/lang/String;)Ljava/util/Locale;
    ...
    iget-object v4, v0, LX/2es;->A0E:Lorg/json/JSONObject;

    iget-object v3, v0, LX/2es;->A08:Lorg/json/JSONArray;

    iget-object v0, v0, LX/2es;->A0C:Lorg/json/JSONObject;

    new-instance v1, LX/2t4;

    invoke-direct {v1, v5, v3, v4, v0}, LX/2t4;-><init>(Landroid/content/Context;Lorg/json/JSONArray;Lorg/json/JSONObject;Lorg/json/JSONObject;)V

    iput-object v1, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;

    iget-object v0, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0G:LX/2es;

    iget-object v0, v0, LX/2es;->A02:Ljava/lang/Boolean;
    ...
    sget-object v0, LX/26U;->A01:Ljava/lang/Integer;

    invoke-virtual {v1, v0}, LX/2t4;->A07(Ljava/lang/Integer;)Z
    ...
    :cond_2a
    sget-object v0, LX/26U;->A00:Ljava/lang/Integer;
    ...
    :cond_2e
    iget-object v1, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0G:LX/2es;

    iget-boolean v0, v1, LX/2es;->A0L:Z
    ...
    :try_start_1f
    iget-object v0, v1, LX/2es;->A08:Lorg/json/JSONArray;
    ...
    iget-object v7, v0, LX/2es;->A0C:Lorg/json/JSONObject;
    ...
    invoke-direct {v4, v3, v0, v1, v7}, LX/2t4;-><init>(Landroid/content/Context;Lorg/json/JSONArray;Lorg/json/JSONObject;Lorg/json/JSONObject;)V

    iput-object v4, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;
    ...
    iget-object v1, v4, LX/2t4;->A0C:Lorg/json/JSONObject;
    ...
    invoke-static {v0}, LX/38Z;->A03(Ljava/lang/String;)[B
    ...
    iput-object v1, v4, LX/2t4;->A09:Ljava/lang/String;

    iget-object v0, v4, LX/2t4;->A03:Landroid/content/Context;

    invoke-static {v0, v1}, LX/30n;->A00(Landroid/content/Context;Ljava/lang/String;)LX/30n;

    move-result-object v0

    iput-object v0, v4, LX/2t4;->A0I:LX/30n;
    :try_end_1f
    .catch Ljava/lang/Exception; {:try_start_1f .. :try_end_1f} :catch_12

    :try_start_20
    invoke-virtual {v0, v3}, LX/30n;->A01(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v0, v4, LX/2t4;->A0E:Lorg/json/JSONObject;
    ...
    :goto_10
    iget-object v0, v4, LX/2t4;->A0I:LX/30n;

    invoke-virtual {v0}, LX/30n;->A02()V

    iget-object v1, v4, LX/2t4;->A0I:LX/30n;

    iget-object v0, v4, LX/2t4;->A0E:Lorg/json/JSONObject;

    invoke-virtual {v0}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0, v3}, LX/30n;->A03(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;

    iget-object v0, v0, LX/2t4;->A09:Ljava/lang/String;

    invoke-static {v2, v0}, LX/38Z;->A00(Ljava/lang/Boolean;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;
    ...
    iget-object v0, v7, LX/2t4;->A0I:LX/30n;

    invoke-virtual {v0, v3, v2}, LX/30n;->A03(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0H:LX/2t4;
    ...
    iget-object v0, v2, LX/2t4;->A09:Ljava/lang/String;
    ...
    invoke-static {v3, v6, v4, v0}, LX/000;->A1B(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    invoke-static {v6, v2, v0}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, LX/2t4;->A06([Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v0}, LX/07w;->setContentView(I)V
    ...
    invoke-direct {v1, v13, v0}, LX/0zk;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v1, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0F:LX/0zk;
    ...
    iget-object v1, v0, LX/2es;->A0C:Lorg/json/JSONObject;
    ...
    iget-object v14, v0, LX/2es;->A09:Lorg/json/JSONArray;
    ...
    iget-object v0, v0, LX/2es;->A09:Lorg/json/JSONArray;
    ...
    iput-object v0, v1, LX/2es;->A0A:Lorg/json/JSONArray;
    ...
    :try_start_23
    invoke-static {v6, v14, v3}, LX/0yH;->A0g(Ljava/lang/String;Lorg/json/JSONArray;I)Ljava/lang/String;
    ...
    invoke-static {v14, v3}, LX/0yN;->A1O(Lorg/json/JSONArray;I)Lorg/json/JSONObject;
    ...
    :try_start_24
    invoke-static {v6, v14, v1}, LX/0yH;->A0g(Ljava/lang/String;Lorg/json/JSONArray;I)Ljava/lang/String;
    ...
    invoke-static {v14, v1}, LX/0yN;->A1O(Lorg/json/JSONArray;I)Lorg/json/JSONObject;
    ...
    invoke-static {v11, v14, v1}, LX/0yH;->A0g(Ljava/lang/String;Lorg/json/JSONArray;I)Ljava/lang/String;
    ...
    invoke-static {v0, v13, v1}, LX/3Ca;->A00(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, v13, v12}, LX/23m;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, v13, v15}, LX/23m;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v13}, LX/000;->A09(Landroid/content/Context;)Landroid/util/DisplayMetrics;
    ...
    invoke-direct {v0, v13}, LX/3hw;-><init>(Lorg/npci/upi/security/pinactivitycomponent/GetCredential;)V

    iput-object v0, v5, Lorg/npci/upi/security/pinactivitycomponent/Keypad;->A04:LX/6FC;
    ...
    iput-object v2, v13, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A08:LX/0f4;
    ...
    :goto_25
    :try_start_26
    invoke-virtual {v13}, LX/03u;->getSupportFragmentManager()LX/0eU;
    ...
    iget-object v1, v4, LX/1z7;->b:Ljava/lang/String;
    ...
    invoke-static {v1, v13, v0}, LX/3Ca;->A00(Landroid/view/View;Ljava/lang/Object;I)V
...
.method public onPause()V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0E:LX/0yn;
    ...
    iput-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0E:LX/0yn;
    :try_end_0
...
.method public onResume()V
    ...
    invoke-direct {v0, p0}, LX/0yn;-><init>(Lorg/npci/upi/security/pinactivitycomponent/GetCredential;)V
