...
.method public A0w(Landroid/os/Bundle;Landroid/view/View;)V
    ...
    iget-object v0, v1, Lorg/npci/upi/security/pinactivitycomponent/GetCredential;->A0G:LX/2es;
...
.method public A1H(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1}, LX/2gk;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/s;->A09:LX/2gk;

    return-void
.end method

.method public A1I(Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)LX/10m;
    .locals 9
    ...
    invoke-virtual {v2, v5}, LX/10m;->setActionBarPositionTop(Z)V
    ...
    invoke-virtual {v2, p6}, LX/10m;->setInputLength(I)V

    iput-object p0, v2, LX/10m;->A0H:LX/41x;

    invoke-virtual {v2, p2}, LX/10m;->setTitle(Ljava/lang/String;)V

    iput p5, v2, LX/10m;->A01:I

    invoke-virtual {v2, p3}, LX/10m;->setEducationalText(Ljava/lang/String;)V

    iput-object p4, v2, LX/10m;->A0F:Ljava/lang/String;
    ...
    iget-boolean v0, v0, LX/2es;->A0K:Z

    if-eqz v0, :cond_0

    invoke-virtual {v2, p1}, LX/10m;->setForgotUpi(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {v2, v0}, LX/10m;->setForgotUpi(Ljava/lang/Boolean;)V
...
.method public A1J(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4, v1, p0}, LX/5hi;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-direct {v2, p0, v0, v4}, LX/3e7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public A1K(LX/2bo;)V
    ...
    :cond_0
    invoke-static {v7, v1}, LX/0yK;->A13(Ljava/util/AbstractList;I)LX/10m;
    ...
    :cond_2
    :goto_0
    invoke-static {v7, v0}, LX/0yK;->A13(Ljava/util/AbstractList;I)LX/10m;
    ...
    :try_start_1
    iget-object v0, v5, LX/10m;->A0F:Ljava/lang/String;
    ...
    iget-object v0, p0, Lorg/npci/upi/security/pinactivitycomponent/s;->A09:LX/2gk;
    :try_end_1
    ...
    invoke-virtual {v5, v3}, LX/10m;->setText(Ljava/lang/String;)V
    ...
    :cond_3
    iget-object v3, v5, LX/10m;->A0F:Ljava/lang/String;
    ...
    invoke-interface {v0, v3}, LX/49G;->setText(Ljava/lang/String;)V
...
.method public A1L(LX/10m;)V
    ...
    invoke-virtual/range {v1 .. v7}, LX/10m;->ApT(Landroid/graphics/drawable/Drawable;Landroid/view/View$OnClickListener;Ljava/lang/String;IZZ)V

    iget-object v0, p1, LX/10m;->A05:Landroid/widget/ImageView;

    invoke-virtual {p1, v0, v5}, LX/10m;->A00(Landroid/view/View;Z)LX/0Rb;

    new-instance v0, LX/4AI;

    invoke-direct {v0, p0, p1}, LX/4AI;-><init>(Lorg/npci/upi/security/pinactivitycomponent/s;LX/10m;)V
    ...
    invoke-virtual {p1}, LX/10m;->A01()V
