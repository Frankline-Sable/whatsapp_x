...
.field public static errorCallback:LX/41z;
...
.field public textureListener:LX/2Oy;
...
.method private MaybeRenderDecodedTextureBuffer()V
    ...
    iget-object v0, p0, Lorg/wawebrtc/MediaCodecVideoDecoder;->textureListener:LX/2Oy;

    iget-object v1, v0, LX/2Oy;->A01:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v0, v0, LX/2Oy;->A00:Lorg/wawebrtc/MediaCodecVideoDecoder$BufferInfo;
    :try_end_0
    ...
    iget-object v1, p0, Lorg/wawebrtc/MediaCodecVideoDecoder;->textureListener:LX/2Oy;

    iget-object v0, v1, LX/2Oy;->A00:Lorg/wawebrtc/MediaCodecVideoDecoder$BufferInfo;

    if-nez v0, :cond_1

    iput-object v3, v1, LX/2Oy;->A00:Lorg/wawebrtc/MediaCodecVideoDecoder$BufferInfo;
...
.method private dequeueOutputBuffer(I)Lorg/wawebrtc/MediaCodecVideoDecoder$BufferInfo;
    ...
    invoke-static {v4, v2}, LX/0yE;->A0O(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/Buffer;)V
    ...
    iget-wide v11, v0, LX/2xN;->A03:J

    iget-wide v13, v0, LX/2xN;->A02:J

    iget v15, v0, LX/2xN;->A00:I
    ...
    invoke-static {v2, v0, v6}, LX/0yE;->A1J(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v0, v1, Lorg/wawebrtc/MediaCodecVideoDecoder;->codecName:Ljava/lang/String;

    invoke-static {v6, v5, v0}, LX/3UU;->A02(Landroid/media/MediaFormat;LX/34E;Ljava/lang/String;)LX/2xk;

    move-result-object v7

    iget v6, v7, LX/2xk;->A09:I

    iput v6, v1, Lorg/wawebrtc/MediaCodecVideoDecoder;->width:I

    iget v2, v7, LX/2xk;->A06:I

    iput v2, v1, Lorg/wawebrtc/MediaCodecVideoDecoder;->height:I

    iget v0, v7, LX/2xk;->A08:I
    ...
    iget v3, v7, LX/2xk;->A02:I

    if-ltz v3, :cond_2

    iget v2, v7, LX/2xk;->A08:I

    if-ge v3, v2, :cond_2

    iget v0, v7, LX/2xk;->A03:I
    ...
    invoke-static {v0, v2, v3}, LX/0yE;->A0y(Ljava/lang/String;Ljava/lang/StringBuilder;I)V

    :cond_2
    iget v3, v7, LX/2xk;->A01:I

    if-ltz v3, :cond_0

    iget v2, v7, LX/2xk;->A07:I

    if-ge v3, v2, :cond_0

    iget v0, v7, LX/2xk;->A04:I
...
.method private dequeueTextureBuffer(I)Lorg/wawebrtc/MediaCodecVideoDecoder$DecodedTextureBuffer;
    ...
    iget-object v2, v0, LX/2Oy;->A01:Ljava/lang/Object;
...
.method public static findDecoder(Ljava/lang/String;[Ljava/lang/String;IZ)Ljava/util/List;
    ...
    invoke-static {v1, v14}, LX/0yE;->A1G(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v9, v0}, LX/3UU;->A0C(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v9, v1}, LX/3UU;->A0C(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v0, v9, v1, v2}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v9}, LX/0yE;->A0B(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_9
    invoke-static {v9, v7}, LX/3UU;->A0D(Ljava/lang/String;I)[I
    ...
    invoke-static {v0, v2, v3}, LX/000;->A1C(Ljava/lang/String;Ljava/lang/StringBuilder;I)V

    const-string v0, ". Adaptive Playback: "

    move/from16 v1, v16

    invoke-static {v0, v2, v1}, LX/0yE;->A1B(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V
    ...
    invoke-direct {v1, v8, v9, v3, v0}, LX/2Qt;-><init>(Landroid/media/MediaCodecInfo$CodecCapabilities;Ljava/lang/String;IZ)V
    ...
    iget-boolean v0, v1, LX/2Qt;->A03:Z
...
.method private initDecode(LX/1vw;IILX/1zZ;[B[BZ)Z
    .locals 10
    ...
    :cond_0
    sget-object v0, LX/1vw;->A04:LX/1vw;
    ...
    iget-object v6, v4, LX/2Qt;->A02:Ljava/lang/String;

    invoke-static {v5, v6}, LX/0yE;->A1G(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p4}, LX/2Oy;-><init>(LX/1zZ;)V
    ...
    invoke-static {v5, v1, v0}, LX/3UU;->A02(Landroid/media/MediaFormat;LX/34E;Ljava/lang/String;)LX/2xk;
    ...
    invoke-direct {p0, v4}, Lorg/wawebrtc/MediaCodecVideoDecoder;->setDecoderFlags(LX/2Qt;)V
...
.method private initH264Decoder(II[B[BZ)Z
    ...
    invoke-direct/range {v0 .. v7}, Lorg/wawebrtc/MediaCodecVideoDecoder;->initDecode(LX/1vw;IILX/1zZ;[B[BZ)Z
...
.method private queueInputBuffer(IIJJI)Z
    ...
    invoke-direct/range {v4 .. v11}, LX/2xN;-><init>(IJJJ)V
    ...
    iput-wide v6, v4, LX/2xN;->A01:J

    iput-wide p3, v4, LX/2xN;->A03:J

    iput-wide v10, v4, LX/2xN;->A02:J

    iput v5, v4, LX/2xN;->A00:I
...
.method private setDecoderFlags(LX/2Qt;)V
    .locals 8
    ...
    iget-object v1, p1, LX/2Qt;->A02:Ljava/lang/String;
    ...
    iget-object v1, p1, LX/2Qt;->A01:Landroid/media/MediaCodecInfo$CodecCapabilities;
    ...
    invoke-static {v0}, LX/37L;->A03(Ljava/lang/String;)Z
...
.method public static setErrorCallback(LX/41z;)V
    .locals 1
    ...
    sput-object p0, Lorg/wawebrtc/MediaCodecVideoDecoder;->errorCallback:LX/41z;
