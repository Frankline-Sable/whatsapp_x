...
.field public static errorCallback:LX/420;
...
.field public drawer:LX/343;

.field public eglBase:LX/40L;
...
.method public constructor <init>(LX/31z;)V
    ...
    iput-object p1, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->voipSharedPreferences:LX/31z;
...
.method public static findHwEncoder(Ljava/lang/String;[Ljava/lang/String;[IIZ)Ljava/util/List;
    ...
    :goto_4
    invoke-static {v1, v0}, LX/3UU;->A0C(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v7, v0}, LX/3UU;->A0C(Ljava/lang/String;[Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_9

    invoke-static {v2, v7}, LX/0yE;->A0B(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v0}, LX/39B;->A0E(Ljava/lang/String;Z)Z
    ...
    :goto_11
    invoke-static {v7, v5}, LX/3UU;->A0D(Ljava/lang/String;I)[I
    ...
    invoke-static {v0, v14, v1}, LX/000;->A1C(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
    ...
    invoke-static {v14, v0}, LX/0yE;->A1G(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3, v7, v14, v1}, LX/2Qu;-><init>(Landroid/media/MediaCodecInfo$VideoCapabilities;Ljava/lang/String;[Landroid/media/MediaCodecInfo$CodecProfileLevel;I)V
    ...
    invoke-static {v0, v7, v1, v2}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
...
.method private getDequeueOutputTimeout()I
    ...
    invoke-static {v2, v0}, LX/3UU;->A0C(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method public static isH264HwSupported()Z
    ...
    invoke-static {v2, v0, v1}, LX/0yI;->A1W(Ljava/lang/String;[I[Ljava/lang/String;)Z
...
.method public static setErrorCallback(LX/420;)V
    .locals 1
    ...
    sput-object p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->errorCallback:LX/420;
...
.method public dequeueOutputBuffer(I)Lorg/wawebrtc/MediaCodecVideoEncoder$BufferInfo;
    ...
    invoke-static {v4, v3}, LX/0yE;->A0O(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/Buffer;)V
    ...
    iget-wide v0, v2, LX/2x3;->A01:J

    sub-long/2addr v10, v0

    iget v12, v2, LX/2x3;->A00:I
...
.method public encodeBuffer(ZIIJJI)Z
    ...
    invoke-direct/range {v9 .. v14}, LX/2x3;-><init>(IJJ)V
    ...
    check-cast v9, LX/2x3;

    iput-wide v11, v9, LX/2x3;->A01:J

    iput-wide v13, v9, LX/2x3;->A02:J

    iput v10, v9, LX/2x3;->A00:I
...
.method public encodeTexture(ZI[FJ)Z
    ...
    :cond_0
    iget-object v0, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->eglBase:LX/40L;
    ...
    iget-object v0, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->drawer:LX/343;
    ...
    iget-object v1, v0, LX/343;->A00:Ljava/util/Map;
    ...
    :goto_0
    iget-object v0, v3, LX/2Lp;->A01:LX/2zS;
    ...
    invoke-static {v0}, LX/24u;->A00(Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->eglBase:LX/40L;
    ...
    invoke-virtual {v5}, LX/40L;->A05()V

    iget-object v3, v5, LX/40L;->A03:Landroid/opengl/EGLSurface;

    sget-object v0, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    if-eq v3, v0, :cond_2

    iget-object v0, v5, LX/40L;->A02:Landroid/opengl/EGLDisplay;
    ...
    iget-object v1, v5, LX/40L;->A02:Landroid/opengl/EGLDisplay;

    iget-object v0, v5, LX/40L;->A03:Landroid/opengl/EGLSurface;
    ...
    iget-object v2, v3, LX/2Lp;->A01:LX/2zS;
    ...
    invoke-virtual {v2, v0}, LX/2zS;->A01(Ljava/lang/String;)I
    ...
    sget-object v0, LX/343;->A01:Ljava/nio/FloatBuffer;

    invoke-virtual {v2, v1, v0}, LX/2zS;->A02(Ljava/lang/String;Ljava/nio/FloatBuffer;)V

    const-string v1, "in_tc"

    sget-object v0, LX/343;->A02:Ljava/nio/FloatBuffer;
...
.method public initEncode(LX/1vx;IIIIILX/1zY;)Z
    .locals 31
    ...
    invoke-static/range {v28 .. v28}, LX/000;->A1W(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v1, v10}, LX/0yE;->A1B(Ljava/lang/String;Ljava/lang/StringBuilder;Z)V

    iget-object v0, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->mediaCodecThread:Ljava/lang/Thread;

    if-nez v0, :cond_21

    const-string/jumbo v19, "vid_driver.encoder_name"
    ...
    invoke-static {v15}, LX/0yF;->A1b(Ljava/lang/Object;)[Ljava/lang/String;
    ...
    iget-object v1, v7, LX/2Qu;->A01:Landroid/media/MediaCodecInfo$VideoCapabilities;
    ...
    invoke-static/range {v20 .. v27}, LX/3UU;->A03(LX/34E;Ljava/lang/String;IIIIII)LX/2xk;

    move-result-object v14

    iget v1, v14, LX/2xk;->A09:I

    iput v1, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->width:I

    iget v1, v14, LX/2xk;->A06:I

    iput v1, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->height:I

    iget v1, v14, LX/2xk;->A00:I

    iput v1, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->colorFormat:I

    iget v1, v14, LX/2xk;->A05:I
    ...
    :cond_14
    iget-object v1, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->voipSharedPreferences:LX/31z;
    ...
    invoke-static {v13, v1, v15}, LX/0yF;->A0v(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;I)V

    iget v1, v14, LX/2xk;->A08:I

    move/from16 v16, v1

    iget v14, v14, LX/2xk;->A07:I
    ...
    iget-object v14, v7, LX/2Qu;->A03:[Landroid/media/MediaCodecInfo$CodecProfileLevel;
    ...
    invoke-static {v2, v1, v13}, LX/0yE;->A1N(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iput-object v12, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->type:LX/1vx;
    ...
    sget-object v2, LX/31F;->A01:[I

    new-instance v1, LX/40L;

    move-object/from16 v0, v28

    invoke-direct {v1, v0, v2}, LX/40L;-><init>(LX/1zY;[I)V

    iput-object v1, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->eglBase:LX/40L;
    ...
    iget-object v0, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->eglBase:LX/40L;

    invoke-virtual {v0, v1}, LX/40L;->A06(Ljava/lang/Object;)V

    new-instance v0, LX/343;

    invoke-direct {v0}, LX/343;-><init>()V

    iput-object v0, v9, Lorg/wawebrtc/MediaCodecVideoEncoder;->drawer:LX/343;
...
.method public initH264Encoder(IIIII)Z
    ...
    sget-object v1, LX/1vx;->A01:LX/1vx;
    ...
    invoke-virtual/range {v0 .. v7}, Lorg/wawebrtc/MediaCodecVideoEncoder;->initEncode(LX/1vx;IIIIILX/1zY;)Z
...
.method public release()V
    ...
    invoke-direct {v2, v10, v0, p0}, LX/3e7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v4, v0, LX/343;->A00:Ljava/util/Map;
    ...
    iget-object v2, v0, LX/2Lp;->A01:LX/2zS;
    ...
    iput-object v5, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->drawer:LX/343;
    ...
    iput-object v5, p0, Lorg/wawebrtc/MediaCodecVideoEncoder;->eglBase:LX/40L;
