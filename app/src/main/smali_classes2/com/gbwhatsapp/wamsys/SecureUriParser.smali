.class public Lcom/gbwhatsapp/wamsys/SecureUriParser;
...
.method public static createHierAndroidUriFromJavaUri(Ljava/net/URI;)Landroid/net/Uri;
    ...
    invoke-static {p0}, LX/0yG;->A0D(Ljava/net/URI;)Landroid/net/Uri;
...
.method public static createHierJavaUriFromAndroidUri(Ljava/lang/String;Landroid/net/Uri;)Ljava/net/URI;
    ...
    invoke-static {p1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->createHierJavaUriFromAndroidUriSecondTry(Landroid/net/Uri;)Ljava/net/URI;

    move-result-object v1

    if-nez v1, :cond_0

    invoke-static {p0, v0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->createOnParsingJavaUriFailException(Ljava/lang/String;Ljava/net/URISyntaxException;)Ljava/lang/SecurityException;
...
.method public static createHierJavaUriFromAndroidUriSecondTry(Landroid/net/Uri;)Ljava/net/URI;
    ...
    invoke-static {v1, p0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->shouldSkipAuthority(Ljava/net/URI;Landroid/net/Uri;)Z
...
.method public static parseEncodedRFC2396(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->validateScheme(Landroid/net/Uri;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->parseEncodedRFC2396Reverse(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :cond_0
    invoke-static {p0, v1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->validateMightThrow(Ljava/lang/String;Landroid/net/Uri;)V
...
.method public static parseEncodedRFC2396Reverse(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v2}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->createOpaqueAndroidUriFromJavaUri(Ljava/net/URI;)Landroid/net/Uri;

    move-result-object v1

    invoke-static {p0, v2, v1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->urisMatchMightThrowOnOpaque(Ljava/lang/String;Ljava/net/URI;Landroid/net/Uri;)V

    return-object v1

    :cond_0
    invoke-static {v2}, LX/0yG;->A0D(Ljava/net/URI;)Landroid/net/Uri;

    move-result-object v1

    const/4 v0, 0x0

    invoke-static {p0, v2, v1, v0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->urisMatchMightThrowOnHier(Ljava/lang/String;Ljava/net/URI;Landroid/net/Uri;Z)V
...
.method public static urisMatchMightThrowOnHier(Ljava/lang/String;Ljava/net/URI;Landroid/net/Uri;Z)V
    ...
    invoke-static {v1, v0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->stringEquals(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v1, v5}, LX/0yM;->A1P(Ljava/lang/Object;[Ljava/lang/Object;I)V

    invoke-static {p2, v1, v6}, LX/0yM;->A1P(Ljava/lang/Object;[Ljava/lang/Object;I)V
...
.method public static validateMightThrow(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->createOpaqueJavaUriFromAndroidUri(Ljava/lang/String;Landroid/net/Uri;)Ljava/net/URI;

    move-result-object v0

    invoke-static {p0, v0, p1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->urisMatchMightThrowOnOpaque(Ljava/lang/String;Ljava/net/URI;Landroid/net/Uri;)V

    return-void

    :cond_0
    invoke-static {p0, p1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->createHierJavaUriFromAndroidUri(Ljava/lang/String;Landroid/net/Uri;)Ljava/net/URI;

    move-result-object v1

    invoke-static {v1, p1}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->shouldSkipAuthority(Ljava/net/URI;Landroid/net/Uri;)Z

    move-result v0

    invoke-static {p0, v1, p1, v0}, Lcom/gbwhatsapp/wamsys/SecureUriParser;->urisMatchMightThrowOnHier(Ljava/lang/String;Ljava/net/URI;Landroid/net/Uri;Z)V
