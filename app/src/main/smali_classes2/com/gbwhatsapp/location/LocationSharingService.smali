...
.field public volatile A0F:LX/3cR;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0B:Landroid/os/Handler;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0C:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0A:Z
...
.method public static A01(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, v3, v0}, LX/0yM;->A19(Landroid/content/Context;LX/0VP;I)V
    ...
    invoke-static {p0, v0, v2, v0}, LX/37u;->A00(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public static A02(Landroid/content/Context;LX/35y;)V
    .locals 2
    ...
    invoke-virtual {p1}, LX/35y;->A0b()Z
    ...
    invoke-static {p0, v0}, Lcom/gbwhatsapp/location/LocationSharingService;->A01(Landroid/content/Context;Landroid/content/Intent;)V

    :cond_0
    return-void

    :cond_1
    sget-boolean v0, Lcom/gbwhatsapp/location/LocationSharingService;->A0I:Z
...
.method public final A03()V
    ...
    iget-boolean v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0H:Z
    ...
    iget-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A08:LX/35y;
...
.method public final generatedComponent()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0F:LX/3cR;

    if-nez v0, :cond_1

    iget-object v1, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0C:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0F:LX/3cR;
...
.method public onCreate()V
    ...
    iget-boolean v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0A:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0A:Z

    invoke-virtual {v6}, Lcom/gbwhatsapp/location/LocationSharingService;->generatedComponent()Ljava/lang/Object;
    ...
    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A05:LX/2tS;

    invoke-static {v1}, LX/3H7;->A2a(LX/3H7;)LX/35r;

    move-result-object v0

    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A04:LX/35r;

    invoke-static {v1}, LX/3H7;->A2i(LX/3H7;)LX/35z;

    move-result-object v0

    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A07:LX/35z;

    invoke-static {v1}, LX/3H7;->A2h(LX/3H7;)LX/35o;

    move-result-object v0

    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A06:LX/35o;
    ...
    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A02:LX/1eR;
    ...
    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A01:LX/7Ws;
    ...
    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A08:LX/35y;

    iget-object v0, v1, LX/3H7;->AOt:LX/45Q;
    ...
    iput-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A03:LX/1eH;

    :cond_0
    invoke-super {v6}, Landroid/app/Service;->onCreate()V

    iget-object v3, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A05:LX/2tS;

    iget-object v2, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A04:LX/35r;

    iget-object v1, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A07:LX/35z;

    iget-object v15, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A02:LX/1eR;

    iget-object v14, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A01:LX/7Ws;

    iget-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A03:LX/1eH;
    ...
    invoke-direct/range {v13 .. v20}, LX/3A4;-><init>(LX/7Ws;LX/1eR;LX/1eH;LX/35r;LX/2tS;LX/35z;LX/41T;)V

    iput-object v13, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A09:LX/3A4;

    :try_start_0
    iget-object v0, v13, LX/3A4;->A08:LX/35r;
    ...
    :cond_1
    iget-object v0, v13, LX/3A4;->A03:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, v13, LX/3A4;->A03:Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v2, v13, LX/3A4;->A03:Landroid/os/PowerManager$WakeLock;
    ...
    :cond_3
    :goto_0
    iget-object v0, v13, LX/3A4;->A0A:LX/35z;
    ...
    invoke-static {v10, v7}, LX/0yN;->A05([Ljava/lang/String;I)I
    ...
    invoke-static {v10, v0}, LX/0yN;->A05([Ljava/lang/String;I)I

    move-result v1

    iget-object v0, v13, LX/3A4;->A04:Landroid/util/SparseIntArray;
    ...
    :cond_5
    iget-object v3, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0B:Landroid/os/Handler;
...
.method public onDestroy()V
    ...
    iget-object v2, v0, LX/35y;->A0O:Ljava/lang/Object;
    ...
    sput-boolean v1, Lcom/gbwhatsapp/location/LocationSharingService;->A0I:Z

    iget-object v0, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A01:LX/7Ws;

    iput-boolean v1, v0, LX/7Ws;->A08:Z

    iget-object v1, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A0B:Landroid/os/Handler;
    ...
    iget-object v1, p0, Lcom/gbwhatsapp/location/LocationSharingService;->A09:LX/3A4;

    iget-object v0, v1, LX/3A4;->A05:LX/7Ws;

    invoke-virtual {v0, v1}, LX/7Ws;->A04(Landroid/location/LocationListener;)V

    invoke-virtual {v1}, LX/3A4;->A00()V

    iget-object v0, v1, LX/3A4;->A03:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v0, v1, LX/3A4;->A03:Landroid/os/PowerManager$WakeLock;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A06:LX/35o;
    ...
    invoke-static {v6, v4, v1}, LX/0yJ;->A10(Landroid/content/Context;LX/0VP;I)V
    ...
    invoke-static {v6, v2, v3, v2}, LX/37u;->A00(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v0

    iput-object v0, v4, LX/0VP;->A0A:Landroid/app/PendingIntent;
    ...
    invoke-static {v6, v4, v0}, LX/0yM;->A19(Landroid/content/Context;LX/0VP;I)V
    ...
    sput-boolean v5, Lcom/gbwhatsapp/location/LocationSharingService;->A0I:Z

    iget-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A01:LX/7Ws;

    iput-boolean v5, v0, LX/7Ws;->A08:Z

    if-eqz p1, :cond_1

    const-string v0, "com.gbwhatsapp.ShareLocationService.ACTION_SEND_LOCATION_WEB_RESPONSE"

    invoke-static {v7, v0}, LX/0yH;->A1S(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    iput-boolean v2, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0G:Z

    :cond_0
    :goto_2
    invoke-virtual {v6}, Lcom/gbwhatsapp/location/LocationSharingService;->A03()V
    ...
    iget-object v1, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0B:Landroid/os/Handler;
    ...
    iput-boolean v5, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0H:Z
    ...
    iget-object v7, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A09:LX/3A4;

    const-string/jumbo v6, "web-client-updates"

    :goto_3
    iget-object v0, v7, LX/3A4;->A02:Landroid/location/Location;
    ...
    :cond_2
    iget-object v0, v7, LX/3A4;->A05:LX/7Ws;

    invoke-virtual {v0, v6}, LX/7Ws;->A01(Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-virtual {v7, v8}, LX/3A4;->A01(Landroid/location/Location;)V

    :cond_4
    iget-wide v3, v7, LX/3A4;->A00:J
    ...
    invoke-virtual {v7}, LX/3A4;->A00()V
    ...
    :goto_5
    iget-object v8, v7, LX/3A4;->A04:Landroid/util/SparseIntArray;
    ...
    :cond_6
    invoke-static {v13, v14}, LX/0yF;->A1N(Ljava/util/AbstractCollection;I)V
    ...
    iput-boolean v2, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A0H:Z
    ...
    iget-object v0, v6, Lcom/gbwhatsapp/location/LocationSharingService;->A05:LX/2tS;
    ...
    :cond_e
    iget-object v0, v7, LX/3A4;->A07:LX/1eH;

    invoke-virtual {v0}, LX/1eH;->A06()Z

    move-result v9

    iget-object v0, v7, LX/3A4;->A06:LX/1eR;

    iget-object v10, v0, LX/1eR;->A00:LX/321;

    iget v8, v10, LX/321;->A02:I
    ...
    :cond_10
    invoke-virtual {v10}, LX/321;->A00()D
    ...
    :goto_8
    iget-object v10, v7, LX/3A4;->A05:LX/7Ws;

    invoke-virtual {v10, v7}, LX/7Ws;->A04(Landroid/location/LocationListener;)V
    ...
    invoke-static {v2, v8, v0, v1}, LX/0yE;->A10(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
