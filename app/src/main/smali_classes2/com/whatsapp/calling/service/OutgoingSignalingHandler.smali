...
.field public final callSendMethods:LX/2g7;

.field public final companionModeSharedPreferences:LX/2r5;

.field public final encryptionHelper:LX/2sK;

.field public final meManager:LX/2tx;

.field public outgoingCallOfferKey:Ljava/lang/String;

.field public volatile pendingCallOfferStanza:LX/2dA;

.field public final time:LX/2tS;

.field public final voiceChatAcceptPingManager:LX/2dD;
...
# direct methods
.method public static synthetic $r8$lambda$DUA8S85picHhePAIIQbW23ZXGsE(Lcom/whatsapp/calling/service/OutgoingSignalingHandler;ZLcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/util/Map;LX/2dA;Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)V
    .locals 0

    invoke-direct/range {p0 .. p7}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->lambda$sendOfferStanza$1(ZLcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/util/Map;LX/2dA;Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)V
...
.method public constructor <init>(LX/2tS;LX/1QX;LX/2tx;LX/49C;LX/38o;LX/2g7;LX/2sK;LX/2r5;LX/2dD;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->time:LX/2tS;

    iput-object p2, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->abProps:LX/1QX;

    iput-object p3, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->meManager:LX/2tx;

    iput-object p4, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->waWorkers:LX/49C;

    iput-object p5, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    iput-object p6, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->callSendMethods:LX/2g7;

    iput-object p7, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->encryptionHelper:LX/2sK;

    iput-object p8, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->companionModeSharedPreferences:LX/2r5;

    iput-object p9, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceChatAcceptPingManager:LX/2dD;

    return-void
.end method

.method public static A00(LX/2bJ;Lcom/whatsapp/protocol/VoipStanzaChildNode;B)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    .locals 8
    ...
    invoke-virtual {p1}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->getAttributesCopy()[LX/3CP;

    move-result-object v0

    invoke-virtual {v7, v0}, Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;->addAttributes([LX/3CP;)Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;

    if-eqz p0, :cond_2

    invoke-static {p0, p2}, LX/37I;->A00(LX/2bJ;I)LX/38n;

    move-result-object v0

    invoke-static {v0}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->fromProtocolTreeNode(LX/38n;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
...
.method public static A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;[B)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-virtual {p0}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->getAttributesCopy()[LX/3CP;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;->addAttributes([LX/3CP;)Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;
...
.method public static A02(Lcom/whatsapp/protocol/VoipStanzaChildNode;[Lcom/whatsapp/protocol/VoipStanzaChildNode;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-virtual {v6, v0}, Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;->addAttributes([LX/3CP;)Lcom/whatsapp/protocol/VoipStanzaChildNode$Builder;
...
.method public static A03(Lcom/whatsapp/protocol/VoipStanzaChildNode;)Z
    ...
    invoke-static {p0, v4}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v5}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->hasAttribute(LX/3CP;)Z
    ...
    invoke-static {p0, v0}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-static {v0, v4}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
...
.method public static A04(Ljava/util/Map;Ljava/util/Set;)[Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-static/range {v3 .. v15}, LX/38M;->A02(LX/2hG;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;IZZZZ)Ljava/util/List;
...
.method private getEncryptedE2EKey([BLcom/whatsapp/jid/DeviceJid;)LX/2bJ;
    .locals 3
...
.method private synthetic lambda$sendCallStanza$0(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->sendReKeyFanoutStanza(Ljava/lang/String;LX/1aU;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V

    return-void

    :cond_0
    invoke-static {p1}, LX/0yM;->A0P(Lcom/whatsapp/jid/Jid;)Lcom/whatsapp/jid/DeviceJid;
...
.method private synthetic lambda$sendOfferStanza$1(ZLcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/util/Map;LX/2dA;Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)V
    .locals 4

    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    iget v1, v0, LX/38o;->A3J:I

    const/16 v0, 0xe

    if-eq v1, v0, :cond_2

    iget-object v1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    const/4 v0, 0x0

    iput-boolean v0, v1, LX/38o;->A3M:Z
    ...
    iget-object v0, p5, LX/2dA;->A02:Lcom/whatsapp/protocol/VoipStanzaChildNode;

    if-eqz v0, :cond_3

    iget-object v0, p5, LX/2dA;->A05:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->keySet()Ljava/util/Set;

    move-result-object v0

    iget-object v1, p5, LX/2dA;->A03:Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    :goto_0
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->meManager:LX/2tx;
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->companionModeSharedPreferences:LX/2r5;
    ...
    iget-object v3, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    iget-object v0, v3, LX/38o;->A0V:LX/2Md;
    ...
    invoke-direct {v2, p7, v0, v1}, LX/2Md;-><init>(Ljava/lang/String;J)V

    iput-object v2, v3, LX/38o;->A0V:LX/2Md;

    :cond_1
    iget-object v1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->callSendMethods:LX/2g7;

    new-instance v0, LX/2QW;

    invoke-direct {v0, p2, p7, p3, p6}, LX/2QW;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V

    invoke-virtual {v1, v0}, LX/2g7;->A00(LX/2QW;)V
    ...
    iget-object v0, p5, LX/2dA;->A01:Lcom/whatsapp/jid/Jid;

    invoke-static {v0}, LX/0yM;->A0P(Lcom/whatsapp/jid/Jid;)Lcom/whatsapp/jid/DeviceJid;

    move-result-object v0

    invoke-static {v3, v0}, LX/0yM;->A0d(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-byte v0, p5, LX/2dA;->A00:B

    invoke-static {v2, v1, v0}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->A00(LX/2bJ;Lcom/whatsapp/protocol/VoipStanzaChildNode;B)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    :cond_7
    iput-object p5, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;
...
.method private rekeyEncryptionTask([BLcom/whatsapp/jid/DeviceJid;Ljava/lang/String;B)LX/2bJ;
    .locals 3

    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    iget-object v1, v0, LX/38o;->A3E:Ljava/util/Map;
    ...
    invoke-direct {p0, p1, p2}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->getEncryptedE2EKey([BLcom/whatsapp/jid/DeviceJid;)LX/2bJ;
    ...
    invoke-static {p3}, LX/0yJ;->A1W(Ljava/lang/String;)Z
    ...
    invoke-static {v1, p3}, LX/0yH;->A1I(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    iget-object v0, v0, LX/38o;->A3E:Ljava/util/Map;
...
.method public clearPendingCallOfferStanza()V
    ...
    iput-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;
...
.method public getBulkEncryptedE2EKeys(Ljava/util/Map;IZ)Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->encryptionHelper:LX/2sK;
    ...
    iget-object v4, v3, LX/2sK;->A04:LX/2hm;
    ...
    invoke-virtual {v4, v1, v0}, LX/2hm;->A00(Ljava/util/Collection;Z)Ljava/util/Set;
    ...
    iget-object v0, v0, LX/1FR;->call_:LX/1Dm;
    ...
    invoke-static {v7, v1, v0}, LX/0yJ;->A0L(LX/6fq;[BI)LX/7zi;
    ...
    iput-object v9, v1, LX/1Dm;->callKey_:LX/7zi;

    if-nez p2, :cond_5

    iget-object v9, v3, LX/2sK;->A0F:LX/1QX;
    ...
    iget-object v1, v3, LX/2sK;->A0A:LX/1Na;

    iget-object v0, v6, Lcom/whatsapp/jid/DeviceJid;->userJid:Lcom/whatsapp/jid/UserJid;

    invoke-virtual {v1, v0}, LX/2ro;->A00(Lcom/whatsapp/jid/UserJid;)LX/2fQ;

    move-result-object v0

    invoke-virtual {v1, v0, v7}, LX/2ro;->A04(LX/2fQ;LX/17P;)V

    :cond_5
    invoke-static {v8}, LX/0yI;->A0N(LX/6fq;)LX/1FR;
    ...
    iput-object v0, v1, LX/1FR;->call_:LX/1Dm;
    ...
    iget-object v1, v3, LX/2sK;->A0E:LX/35h;

    iget-object v0, v6, Lcom/whatsapp/jid/DeviceJid;->userJid:Lcom/whatsapp/jid/UserJid;

    invoke-virtual {v1, v0}, LX/35h;->A05(Lcom/whatsapp/jid/UserJid;)LX/2RR;
    ...
    invoke-static {v7, v0}, LX/1nB;->A02(LX/2RR;LX/1B3;)V
    ...
    iget-object v8, v3, LX/2sK;->A07:LX/35x;

    invoke-virtual {v8}, LX/35x;->A0X()Z

    move-result v0

    if-nez v0, :cond_6

    iget-object v0, v8, LX/35x;->A0J:LX/32d;

    iget-object v9, v0, LX/32d;->A04:LX/1QX;
    ...
    :try_start_0
    iget-object v0, v3, LX/2sK;->A08:LX/2h2;

    new-instance v1, LX/4BU;

    invoke-direct {v1, v6, v3, v7, v10}, LX/4BU;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    iput-object v0, v3, LX/2sK;->A0H:Ljava/util/concurrent/Future;

    iget-object v0, v3, LX/2sK;->A0H:Ljava/util/concurrent/Future;
    ...
    iput-object v2, v3, LX/2sK;->A0H:Ljava/util/concurrent/Future;
    ...
    invoke-virtual {v8, v0}, LX/35x;->A0Z(LX/2pp;)Z
    ...
    invoke-static {v1, v8, v0}, LX/21I;->A01(LX/2pp;LX/35x;[B)LX/2bJ;
...
.method public maybeSendPendingOffer(Lcom/whatsapp/jid/DeviceJid;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;

    if-eqz v4, :cond_3

    iget-object v3, v4, LX/2dA;->A04:Ljava/lang/String;
    ...
    iget-object v0, v4, LX/2dA;->A05:Ljava/util/Map;
    ...
    iget-object v0, v4, LX/2dA;->A02:Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-virtual {v2}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->getAttributesCopy()[LX/3CP;
    ...
    iget-object v13, v1, LX/3CP;->A02:Ljava/lang/String;
    ...
    iget-object v0, v1, LX/3CP;->A01:Lcom/whatsapp/jid/Jid;
    ...
    iget-object v0, v4, LX/2dA;->A03:Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    iget-object v1, v4, LX/2dA;->A01:Lcom/whatsapp/jid/Jid;

    new-instance v0, LX/2dA;

    invoke-direct {v0, v1, v3, v2}, LX/2dA;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V

    invoke-virtual {p0, v0}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->sendOfferStanza(LX/2dA;)V
...
.method public preSendTerminate(Lcom/whatsapp/jid/Jid;Ljava/lang/String;)Z
    ...
    iget-object v2, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->abProps:LX/1QX;
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->callSendMethods:LX/2g7;

    iget-object v0, v0, LX/2g7;->A01:LX/32u;

    iget-object v0, v0, LX/32u;->A06:LX/2fj;

    iget-object v1, v0, LX/2fj;->A00:Ljava/util/LinkedHashMap;
...
.method public sendCallStanza(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    iget-object v2, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->time:LX/2tS;
    ...
    invoke-direct {v3, p1, v7, p2, p3}, LX/2QW;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    sput-object v7, LX/38o;->A3O:Ljava/lang/String;
    ...
    iget-object v0, v3, LX/38o;->A0T:LX/2Md;
    ...
    invoke-direct {v2, v7, v0, v1}, LX/2Md;-><init>(Ljava/lang/String;J)V

    iput-object v2, v3, LX/38o;->A0T:LX/2Md;
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->waWorkers:LX/49C;
    ...
    invoke-direct {v0, p1, p2, p3}, LX/2dA;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    iget-object v0, v0, LX/38o;->A0U:LX/2Md;
    ...
    iput-object v2, v3, LX/38o;->A0U:LX/2Md;
    ...
    invoke-direct {v0, p1, v7, p2, p3}, LX/2QW;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    iget-object v0, v3, LX/38o;->A0R:LX/2Md;
    ...
    iput-object v2, v3, LX/38o;->A0R:LX/2Md;
    ...
    iget-object v1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceChatAcceptPingManager:LX/2dD;

    const/4 v0, 0x0

    invoke-static {p2, v0}, LX/7cX;->A0I(Ljava/lang/Object;I)V

    iget-object v0, v1, LX/2dD;->A04:Ljava/util/Set;
    ...
    iget-object v0, v1, LX/2dD;->A05:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, v3, LX/38o;->A0S:LX/2Md;
    ...
    iput-object v2, v3, LX/38o;->A0S:LX/2Md;
...
.method public sendOfferEncryptionTask(Ljava/lang/String;Lcom/whatsapp/jid/UserJid;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v1, p1}, LX/0yH;->A1I(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method public sendOfferStanza(LX/2dA;)V
    .locals 14

    move-object v11, p1

    iget-object v8, p1, LX/2dA;->A01:Lcom/whatsapp/jid/Jid;

    iget-object v9, p1, LX/2dA;->A04:Ljava/lang/String;

    iget-object v12, p1, LX/2dA;->A03:Lcom/whatsapp/protocol/VoipStanzaChildNode;

    move-object v6, p0

    iget-object v1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->time:LX/2tS;
    ...
    iget-object v0, p1, LX/2dA;->A05:Ljava/util/Map;
    ...
    invoke-static {v1, v10, v2}, LX/0yM;->A1O(Ljava/lang/Object;Ljava/util/AbstractMap;Ljava/util/Map$Entry;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->encryptionHelper:LX/2sK;

    iget-object v1, v0, LX/2sK;->A04:LX/2hm;

    const/4 v0, 0x0

    invoke-static {v3, v0}, LX/7cX;->A0I(Ljava/lang/Object;I)V

    iget-object v0, v1, LX/2hm;->A03:Ljava/util/Set;
    ...
    iput-object p1, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;
    ...
    invoke-direct/range {v5 .. v13}, LX/3fT;-><init>(Lcom/whatsapp/calling/service/OutgoingSignalingHandler;ZLcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/util/Map;LX/2dA;Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)V

    if-eqz v7, :cond_5

    iget-object v4, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->voiceService:LX/38o;

    iget-object v3, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->abProps:LX/1QX;
    ...
    iput-boolean v2, v0, LX/38o;->A3M:Z
    ...
    iget-object v0, v0, LX/38o;->A0z:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :cond_5
    invoke-virtual {v5}, LX/3fT;->run()V
...
.method public sendPendingCallOfferStanza(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;
    ...
    :cond_0
    iget-object v5, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;

    if-eqz v5, :cond_4

    iget-object v3, v5, LX/2dA;->A04:Ljava/lang/String;
    ...
    iget-object v1, v5, LX/2dA;->A01:Lcom/whatsapp/jid/Jid;
    ...
    iget-object v0, v5, LX/2dA;->A02:Lcom/whatsapp/protocol/VoipStanzaChildNode;

    if-eqz v0, :cond_5

    iget-object v0, v5, LX/2dA;->A05:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->keySet()Ljava/util/Set;

    move-result-object v0

    iget-object v1, v5, LX/2dA;->A03:Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    :goto_0
    new-instance v5, LX/2dA;

    invoke-direct {v5, v4, v3, v0}, LX/2dA;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V

    :cond_3
    iput-object v2, p0, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->pendingCallOfferStanza:LX/2dA;

    invoke-virtual {p0, v5}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->sendOfferStanza(LX/2dA;)V
...
.method public sendPendingRekeyRequest(Lcom/whatsapp/jid/DeviceJid;)V
    ...
    invoke-static {p1, v2, v0}, LX/3g0;->A00(Ljava/lang/Object;Ljava/lang/Object;I)LX/3g0;
...
.method public sendReKeyFanoutStanza(Ljava/lang/String;LX/1aU;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    .locals 13
    ...
    invoke-static {v4, v0}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-virtual {v8}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->getAttributesCopy()[LX/3CP;
    ...
    iget-object v0, v2, LX/3CP;->A01:Lcom/whatsapp/jid/Jid;
    ...
    invoke-static {v8, v0}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-direct {v0, p2, p1, v3, v2}, LX/2QW;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
...
.method public sendReKeyStanza(Ljava/lang/String;Lcom/whatsapp/jid/DeviceJid;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
    ...
    invoke-static {p4, v0}, LX/39O;->A01(Lcom/whatsapp/protocol/VoipStanzaChildNode;Ljava/lang/String;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    :cond_1
    invoke-static {v0}, LX/39O;->A05(Lcom/whatsapp/protocol/VoipStanzaChildNode;)Ljava/lang/Byte;
    ...
    invoke-direct {p0, v0, p2, p3, v1}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->rekeyEncryptionTask([BLcom/whatsapp/jid/DeviceJid;Ljava/lang/String;B)LX/2bJ;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {v0, p4, v1}, Lcom/whatsapp/calling/service/OutgoingSignalingHandler;->A00(LX/2bJ;Lcom/whatsapp/protocol/VoipStanzaChildNode;B)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    ...
    invoke-direct {v0, p2, p1, p3, v2}, LX/2QW;-><init>(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/String;Lcom/whatsapp/protocol/VoipStanzaChildNode;)V
