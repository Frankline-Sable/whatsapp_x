...
# instance fields
.field public final attributes:[LX/3CP;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;[LX/3CP;[Lcom/whatsapp/protocol/VoipStanzaChildNode;[B)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/whatsapp/protocol/VoipStanzaChildNode;->attributes:[LX/3CP;
...
.method public synthetic constructor <init>(Ljava/lang/String;[LX/3CP;[Lcom/whatsapp/protocol/VoipStanzaChildNode;[BLX/1zT;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/whatsapp/protocol/VoipStanzaChildNode;-><init>(Ljava/lang/String;[LX/3CP;[Lcom/whatsapp/protocol/VoipStanzaChildNode;[B)V

    return-void
.end method

.method public static fromProtocolTreeNode(LX/38n;)Lcom/whatsapp/protocol/VoipStanzaChildNode;
    .locals 7

    iget-object v6, p0, LX/38n;->A03:[LX/38n;
    ...
    :cond_1
    iget-object v3, p0, LX/38n;->A00:Ljava/lang/String;
    ...
    invoke-direct {v0, v3, v2, v4, v1}, Lcom/whatsapp/protocol/VoipStanzaChildNode;-><init>(Ljava/lang/String;[LX/3CP;[Lcom/whatsapp/protocol/VoipStanzaChildNode;[B)V
...
# virtual methods
.method public getAttributesCopy()[LX/3CP;
    .locals 2

    iget-object v1, p0, Lcom/whatsapp/protocol/VoipStanzaChildNode;->attributes:[LX/3CP;
...
.method public getAttributesFlattedCopy()[Ljava/lang/Object;
    ...
    iget-object v7, p0, Lcom/whatsapp/protocol/VoipStanzaChildNode;->attributes:[LX/3CP;
...
.method public getFirstAttributeByName(Ljava/lang/String;)LX/3CP;
    .locals 5

    iget-object v4, p0, Lcom/whatsapp/protocol/VoipStanzaChildNode;->attributes:[LX/3CP;
...
.method public hasAttribute(LX/3CP;)Z
    .locals 5
...
.method public toProtocolTreeNode()LX/38n;
    .locals 7
    ...
    invoke-direct {v0, v2, v3, v1}, LX/38n;-><init>(Ljava/lang/String;[B[LX/3CP;)V
    ...
    invoke-virtual {v0}, Lcom/whatsapp/protocol/VoipStanzaChildNode;->toProtocolTreeNode()LX/38n;
    ...
    iget-object v0, p0, Lcom/whatsapp/protocol/VoipStanzaChildNode;->attributes:[LX/3CP;
