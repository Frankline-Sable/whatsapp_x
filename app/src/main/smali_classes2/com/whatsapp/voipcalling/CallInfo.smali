...
.field public callWaitingInfo:LX/2UX;
...
.method private addParticipantInfo(LX/2VC;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/whatsapp/voipcalling/CallInfo;->self:LX/2VC;
...
.method private addParticipantInfo(Lcom/whatsapp/jid/UserJid;IZZZZZIZZZZIIIZZZZZZIIZIZ)V
    ...
    invoke-direct/range {v2 .. v27}, LX/2VC;-><init>(Lcom/whatsapp/jid/UserJid;IIIIIIIIZZZZZZZZZZZZZZZZ)V
    ...
    iput-object v2, v1, Lcom/whatsapp/voipcalling/CallInfo;->self:LX/2VC;
...
.method public static convertCallLinkInfoToCallInfo(Lcom/whatsapp/voipcalling/CallLinkInfo;)Lcom/whatsapp/voipcalling/CallInfo;
    ...
    iget-object v3, v4, Lcom/whatsapp/voipcalling/CallLinkInfo;->self:LX/2VC;
    ...
    iget-boolean v1, v3, LX/2VC;->A0O:Z
    ...
    invoke-direct {v5, v3}, Lcom/whatsapp/voipcalling/CallInfo;->addParticipantInfo(LX/2VC;)V
...
.method public static convertCallWaitingInfoToCallInfo(Lcom/whatsapp/voipcalling/CallInfo;)Lcom/whatsapp/voipcalling/CallInfo;
    ...
    iget-object v0, v9, Lcom/whatsapp/voipcalling/CallInfo;->callWaitingInfo:LX/2UX;

    iget v1, v0, LX/2UX;->A01:I
    ...
    :goto_0
    iget-object v1, v0, LX/2UX;->A03:Lcom/whatsapp/voipcalling/CallLogInfo;
    ...
    iget-object v10, v0, LX/2UX;->A04:Ljava/lang/String;

    const/16 v19, 0x0

    iget-object v7, v0, LX/2UX;->A06:Ljava/util/List;
    ...
    iget-object v4, v0, LX/2UX;->A02:Lcom/whatsapp/jid/GroupJid;

    iget v1, v0, LX/2UX;->A00:I
    ...
    iget-boolean v1, v0, LX/2UX;->A08:Z
    ...
    iget-boolean v1, v0, LX/2UX;->A07:Z

    iget-object v0, v0, LX/2UX;->A05:Ljava/lang/String;
    ...
    iget-object v0, v9, Lcom/whatsapp/voipcalling/CallInfo;->self:LX/2VC;

    iget-object v1, v0, LX/2VC;->A08:Lcom/whatsapp/jid/UserJid;

    move-object/from16 v17, v1

    iget v15, v0, LX/2VC;->A02:I

    const/16 v23, 0x1

    iget-boolean v14, v0, LX/2VC;->A0C:Z

    iget-boolean v13, v0, LX/2VC;->A0G:Z

    iget-boolean v12, v0, LX/2VC;->A0D:Z

    iget-boolean v11, v0, LX/2VC;->A0O:Z

    iget-boolean v10, v0, LX/2VC;->A0N:Z

    iget-boolean v9, v0, LX/2VC;->A0M:Z

    iget-boolean v8, v0, LX/2VC;->A0L:Z

    iget v6, v0, LX/2VC;->A07:I

    iget v5, v0, LX/2VC;->A04:I

    iget v1, v0, LX/2VC;->A05:I

    mul-int/lit8 v35, v1, 0x5a

    iget-boolean v4, v0, LX/2VC;->A09:Z

    iget-boolean v3, v0, LX/2VC;->A0A:Z

    iget-boolean v1, v0, LX/2VC;->A0K:Z

    iget v0, v0, LX/2VC;->A03:I
...
.method private setCallWaitingInfo(ILjava/lang/String;I[Ljava/lang/String;Lcom/whatsapp/jid/GroupJid;ZZIZLcom/whatsapp/voipcalling/CallLogInfo;ZLjava/lang/String;Z)V
    ...
    invoke-direct/range {v0 .. v10}, LX/2UX;-><init>(Lcom/whatsapp/jid/GroupJid;Lcom/whatsapp/voipcalling/CallLogInfo;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;IIZZZ)V

    iput-object v0, p0, Lcom/whatsapp/voipcalling/CallInfo;->callWaitingInfo:LX/2UX;
...
.method public enableAudioVideoSwitch()Z
    ...
    iget-object v0, p0, Lcom/whatsapp/voipcalling/CallInfo;->self:LX/2VC;
...
.method public getCallWaitingInfo()LX/2UX;
    .locals 1

    iget-object v0, p0, Lcom/whatsapp/voipcalling/CallInfo;->callWaitingInfo:LX/2UX;
...
.method public getDefaultPeerInfo()LX/2VC;
    .locals 5
    ...
    iget-object v1, v2, LX/2VC;->A08:Lcom/whatsapp/jid/UserJid;
...
.method public getInfoByJid(Lcom/whatsapp/jid/UserJid;)LX/2VC;
    .locals 1
...
.method public getSelfInfo()LX/2VC;
    .locals 1
...
.method public hasOutgoingParticipantInActiveOneToOneCall()Z
    ...
    invoke-virtual {p0}, Lcom/whatsapp/voipcalling/CallInfo;->getDefaultPeerInfo()LX/2VC;
...
.method public isCallOnHold()Z
    ...
    iget-boolean v0, v1, LX/2VC;->A0C:Z
...
.method public isSelfRequestingUpgrade()Z
    ...
    iget-object v2, p0, Lcom/whatsapp/voipcalling/CallInfo;->self:LX/2VC;
