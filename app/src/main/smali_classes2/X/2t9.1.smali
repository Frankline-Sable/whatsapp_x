...
.method public constructor <init>()V
    ...
    iput v0, p0, LX/2t9;->A01:I

    iput v0, p0, LX/2t9;->A00:I

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, LX/2t9;->A07:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/2t9;->A05:Ljava/util/ArrayList;

    invoke-static {}, LX/002;->A0P()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, LX/2t9;->A06:Ljava/util/HashMap;
...
.method public A00(Ljava/lang/String;)I
    ...
    iget-object v0, p0, LX/2t9;->A06:Ljava/util/HashMap;
...
.method public declared-synchronized A01(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, p0, LX/2t9;->A03:LX/444;

    if-eqz v1, :cond_0

    const/16 v0, 0x7b

    invoke-interface {v1, p1, v0}, LX/444;->BE2(Ljava/lang/String;I)V

    :cond_0
    iget-object v0, p0, LX/2t9;->A07:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public declared-synchronized A04(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, LX/2t9;->A05:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, Ljava/util/AbstractCollection;->add(Ljava/lang/Object;)Z

    iget-object v2, p0, LX/2t9;->A07:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public declared-synchronized A05(Ljava/lang/String;I)V
    ...
    :try_start_0
    iget-object v1, p0, LX/2t9;->A06:Ljava/util/HashMap;

    invoke-static {p1, v1}, LX/0yN;->A0s(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/Integer;
    ...
    iput p2, p0, LX/2t9;->A00:I

    iput-object p1, p0, LX/2t9;->A04:Ljava/lang/String;
