...
.field public final A02:LX/2i3;


# direct methods
.method public constructor <init>(LX/2ty;LX/32Z;LX/2i3;)V
    .locals 0
    ...
    iput-object p1, p0, LX/2hM;->A00:LX/2ty;

    iput-object p2, p0, LX/2hM;->A01:LX/32Z;

    iput-object p3, p0, LX/2hM;->A02:LX/2i3;
...
# virtual methods
.method public final A00(LX/1aK;Ljava/util/List;)V
    .locals 7
    ...
    iget-object v0, p0, LX/2hM;->A00:LX/2ty;
    ...
    :cond_0
    iget-object v0, p0, LX/2hM;->A02:LX/2i3;

    invoke-virtual {v0, v1}, LX/2i3;->A00(LX/32q;)Ljava/util/List;
    ...
    :cond_4
    invoke-virtual {p0, p1, p2, v6}, LX/2hM;->A01(LX/1aK;Ljava/util/List;Ljava/util/List;)V

    return-void
.end method

.method public final A01(LX/1aK;Ljava/util/List;Ljava/util/List;)V
    .locals 12
    ...
    iget-object v8, p0, LX/2hM;->A02:LX/2i3;

    invoke-static {v9, v4}, LX/7cX;->A0I(Ljava/lang/Object;I)V

    :try_start_0
    iget-object v0, v8, LX/2i3;->A02:LX/3hX;
    ...
    invoke-static {v9, v1, v4}, LX/373;->A0b(LX/373;[Ljava/lang/Object;I)V

    const-string v0, "NewsletterMessageEnforcementsStore/removeMessageEnforcement"

    invoke-virtual {v7, v6, v2, v0, v1}, LX/2tm;->A07(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_1
    ...
    iget-object v0, v8, LX/2i3;->A00:LX/2ik;
    ...
    invoke-direct {v0, v8, v1, v9}, LX/3e3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :cond_3
    iget-object v6, p0, LX/2hM;->A02:LX/2i3;

    invoke-virtual {v6, v3}, LX/2i3;->A00(LX/32q;)Ljava/util/List;
    ...
    iget-object v2, v9, LX/373;->A1I:LX/30h;
    ...
    :cond_6
    :try_start_5
    iget-object v0, v6, LX/2i3;->A02:LX/3hX;
    ...
    invoke-static {v7, v9}, LX/373;->A0K(Landroid/content/ContentValues;LX/373;)V
    ...
    invoke-virtual {v2, v1, v0, v7}, LX/2tm;->A09(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    :try_end_6
    ...
    iget-object v0, v6, LX/2i3;->A00:LX/2ik;
    ...
    invoke-direct {v0, v6, v1, v9}, LX/3e3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, LX/2hM;->A01:LX/32Z;

    invoke-virtual {v0, p1, v5}, LX/32Z;->A03(LX/1aK;Z)I
    ...
    invoke-virtual {v0, p1, v4}, LX/32Z;->A03(LX/1aK;Z)I
