...
.method public constructor <init>(Landroid/content/Context;LX/2cW;)V
    ...
    iput-object v2, p0, LX/3jU;->A03:Ljavax/net/ssl/SSLContext;

    iput-object p2, p0, LX/3jU;->A02:LX/2cW;
    ...
    :catch_0
    :cond_0
    iput-object v2, p0, LX/3jU;->A01:Landroid/net/SSLSessionCache;
...
.method public final declared-synchronized A01()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    iget-object v1, p0, LX/3jU;->A00:Ljavax/net/ssl/SSLSocketFactory;

    if-nez v1, :cond_5

    iget-object v4, p0, LX/3jU;->A03:Ljavax/net/ssl/SSLContext;

    iget-object v3, p0, LX/3jU;->A01:Landroid/net/SSLSessionCache;
    ...
    :try_start_1
    sget-object v1, LX/1mN;->A02:[Ljavax/net/ssl/TrustManager;
    ...
    invoke-static {v3, v4}, LX/33m;->A01(Landroid/net/SSLSessionCache;Ljavax/net/ssl/SSLContext;)V
    ...
    invoke-direct {v1, v3, v2, v4, v0}, LX/3jT;-><init>(Landroid/net/SSLSessionCache;LX/1mN;Ljavax/net/ssl/SSLContext;Ljavax/net/ssl/SSLSocketFactory;)V
    ...
    :try_start_3
    sget-object v1, LX/1mM;->A00:[Ljavax/net/ssl/TrustManager;
    ...
    :try_start_5
    sget-object v1, LX/1mO;->A02:[Ljavax/net/ssl/TrustManager;
    ...
    :try_start_7
    iget-object v1, v2, LX/1mL;->A01:[Ljavax/net/ssl/TrustManager;
    ...
    :goto_0
    :try_start_8
    iput-object v1, p0, LX/3jU;->A00:Ljavax/net/ssl/SSLSocketFactory;
...
.method public A02(Ljava/net/Socket;)V
    ...
    iget-object v1, p0, LX/3jU;->A04:[Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v5, v4}, LX/0yH;->A1b(Ljava/util/AbstractCollection;I)[Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, LX/3jU;->A04:[Ljava/lang/String;
...
.method public createSocket()Ljava/net/Socket;
    ...
    invoke-virtual {p0}, LX/3jU;->A01()Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {p0, v0}, LX/3jU;->A02(Ljava/net/Socket;)V
...
.method public createSocket(Ljava/lang/String;I)Ljava/net/Socket;
    ...
    invoke-virtual {p0, v1}, LX/3jU;->A02(Ljava/net/Socket;)V

    instance-of v0, v1, Ljavax/net/ssl/SSLSocket;

    if-eqz v0, :cond_0

    iget-object v0, p0, LX/3jU;->A02:LX/2cW;

    invoke-virtual {v0, p1, v1}, LX/2cW;->A00(Ljava/lang/String;Ljava/net/Socket;)V
...
.method public createSocket(Ljava/net/InetAddress;I)Ljava/net/Socket;
    ...
    invoke-virtual {p0, v2}, LX/3jU;->A02(Ljava/net/Socket;)V

    instance-of v0, v2, Ljavax/net/ssl/SSLSocket;

    if-eqz v0, :cond_0

    iget-object v1, p0, LX/3jU;->A02:LX/2cW;

    invoke-virtual {p1}, Ljava/net/InetAddress;->getHostName()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0, v2}, LX/2cW;->A00(Ljava/lang/String;Ljava/net/Socket;)V
...
.method public createSocket(Ljava/net/Socket;Ljava/lang/String;IZ)Ljava/net/Socket;
    ...
    invoke-virtual {v0, p2, v1}, LX/2cW;->A00(Ljava/lang/String;Ljava/net/Socket;)V
