...
.method public A00(Landroid/content/Context;)Ljava/util/List;
    ...
    iget-object v2, v5, LX/1d1;->A00:LX/1QX;
    ...
    invoke-virtual {v0, p1}, LX/1d3;->A03(Landroid/content/Context;)F
    ...
    iget-object v2, v0, LX/1d0;->A00:LX/1QX;
...
.method public A01(ILandroid/app/Notification;)V
    ...
    invoke-static {v0, p1, v2}, LX/000;->A1P([Ljava/lang/Object;II)V
...
.method public A02(Landroid/content/Context;LX/35r;I)V
    ...
    :try_start_3
    invoke-static/range {p2 .. p2}, LX/35r;->A02(LX/35r;)LX/2sU;

    move-result-object v0

    sget-object v2, LX/1d4;->A01:Landroid/net/Uri;
    ...
    sget-object v2, LX/1d4;->A00:Landroid/net/Uri;
    ...
    invoke-static {v9, v5}, LX/36G;->A00(Landroid/content/Context;Ljava/lang/String;)J
    ...
    invoke-virtual {v2, v9}, LX/1d3;->A03(Landroid/content/Context;)F
    ...
    iget-object v2, v2, LX/1d0;->A00:LX/1QX;
    ...
    invoke-static {v3, v0, v8}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V
    ...
    invoke-virtual/range {p2 .. p2}, LX/35r;->A0Q()LX/2sU;
    ...
    invoke-virtual {v2}, LX/2sU;->A02()Landroid/content/ContentResolver;
    ...
    invoke-static {v4, v3}, LX/2sU;->A00(LX/2sU;Ljava/lang/Object;)Landroid/content/ContentResolver;
    ...
    invoke-static {v2, v3}, LX/0yG;->A17(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {v15}, LX/002;->A05(Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {v2, v3, v10}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v11, v0}, LX/0yF;->A1N(Ljava/util/AbstractCollection;I)V
    ...
    invoke-static {v12}, LX/0yN;->A0y(Ljava/util/Iterator;)Ljava/lang/Number;
