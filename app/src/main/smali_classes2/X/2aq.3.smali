...
# direct methods
.method public constructor <init>(LX/3dM;LX/2pP;LX/2hC;)V
    .locals 1
    ...
    iput-object p2, p0, LX/2aq;->A01:LX/2pP;

    iput-object p3, p0, LX/2aq;->A02:LX/2hC;

    iput-object p1, p0, LX/2aq;->A00:LX/3dM;
...
# virtual methods
.method public final A00()LX/1w4;
    .locals 6

    iget-object v3, p0, LX/2aq;->A02:LX/2hC;

    iget-object v4, v3, LX/2hC;->A02:LX/35z;

    iget-object v1, v4, LX/35z;->A01:LX/8VC;
    ...
    :cond_0
    :try_start_0
    iget-object v1, v3, LX/2hC;->A01:Landroid/content/pm/PackageManager;
    ...
    :cond_2
    invoke-static {v4, v2, v1}, LX/0yF;->A13(LX/35z;Ljava/lang/String;Z)V
    ...
    :cond_4
    invoke-virtual {v3}, LX/2hC;->A01()Z

    move-result v0

    if-eqz v0, :cond_5

    sget-object v0, LX/1w4;->A04:LX/1w4;
    ...
    :cond_6
    :goto_0
    sget-object v0, LX/1w4;->A06:LX/1w4;
    ...
    :cond_8
    :goto_1
    sget-object v0, LX/1w4;->A05:LX/1w4;
    ...
    :cond_10
    iget-object v0, p0, LX/2aq;->A01:LX/2pP;

    iget-object v5, v0, LX/2pP;->A00:Landroid/content/Context;

    invoke-static {v5}, LX/7cX;->A0C(Ljava/lang/Object;)V

    invoke-static {v5}, LX/33I;->A02(Landroid/content/Context;)LX/2mF;

    move-result-object v4

    if-eqz v4, :cond_12

    invoke-static {v5}, LX/21j;->A00(Landroid/content/Context;)Landroid/content/Context;
