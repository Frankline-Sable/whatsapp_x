...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/39Q;->A04:[B

    new-instance v1, Landroid/graphics/BitmapFactory$Options;

    invoke-direct {v1}, Landroid/graphics/BitmapFactory$Options;-><init>()V

    sput-object v1, LX/39Q;->A02:Landroid/graphics/BitmapFactory$Options;
    ...
    sput-object v0, LX/39Q;->A03:Ljava/text/DecimalFormat;
...
.method public static A07(Ljava/lang/String;)B
    .locals 1
...
.method public static A08(Landroid/net/Uri;LX/2sU;)I
    .locals 10

    invoke-static {p0}, LX/39T;->A05(Landroid/net/Uri;)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {p0, p1}, LX/39Q;->A09(Landroid/net/Uri;LX/2sU;)I
    ...
    :try_start_3
    invoke-static {v7, v6}, LX/39Q;->A09(Landroid/net/Uri;LX/2sU;)I
    ...
    :cond_1
    invoke-static {v2, v3}, LX/0yG;->A02(Landroid/database/Cursor;Ljava/lang/String;)I
...
.method public static A09(Landroid/net/Uri;LX/2sU;)I
    .locals 1

    const-string/jumbo v0, "r"

    invoke-virtual {p1, p0, v0}, LX/2sU;->A04(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    new-instance p0, LX/0Z7;

    invoke-direct {p0, v0}, LX/0Z7;-><init>(Ljava/io/FileDescriptor;)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, LX/0Z7;->A0E(I)I
...
.method public static A0A(LX/3HE;LX/3BX;III)I
    .locals 1

    sput p2, LX/39Q;->A00:I

    sget-object v0, LX/39Q;->A01:Ljava/lang/String;

    invoke-static {p0, p1, v0, p3, p4}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
...
.method public static A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    .locals 8

    iget-byte v0, p1, LX/3BX;->A00:B

    invoke-virtual {p0, v0, p3, p4}, LX/3HE;->A0G(BII)Ljava/io/File;
    ...
    iget-object v0, p1, LX/3BX;->A01:Ljava/lang/String;
...
.method public static A0C(Ljava/io/File;)I
    .locals 5

    invoke-static {p0}, LX/39Q;->A0D(Ljava/io/File;)J

    move-result-wide v4

    invoke-static {v4, p0}, LX/0yI;->A09(J)J
...
.method public static A0D(Ljava/io/File;)J
    .locals 5
    ...
    invoke-static {v1, v1, v1, p0, v0}, LX/5bf;->A00(LX/2pP;LX/1QX;LX/794;Ljava/io/File;I)LX/5bf;
    ...
    invoke-virtual {v1}, LX/5bf;->A06()V
    ...
    :try_start_3
    invoke-static {v4, p0}, LX/0yL;->A16(Landroid/media/MediaMetadataRetriever;Ljava/io/File;)V
    ...
    :try_start_4
    invoke-virtual {v4}, LX/0zg;->close()V
...
.method public static A0E(Landroid/graphics/Bitmap;FI)Landroid/graphics/Bitmap;
    .locals 13
...
.method public static A0F(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;II)Landroid/graphics/Bitmap;
    .locals 12
    ...
    invoke-static {v6, v0, v1}, LX/0yI;->A17(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v6}, LX/0yK;->A0F(Landroid/graphics/Bitmap;)Landroid/graphics/Rect;
...
.method public static A0G(I)Landroid/graphics/Matrix;
    .locals 1
...
.method public static A0H(Landroid/net/Uri;LX/2sU;)Landroid/graphics/Matrix;
    .locals 4
    ...
    invoke-static {p0, p1}, LX/39Q;->A08(Landroid/net/Uri;LX/2sU;)I
    ...
    invoke-static {p0, v0, v1}, LX/0yF;->A0D(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/io/FileNotFoundException;
...
.method public static A0I(Ljava/io/File;)Landroid/util/Pair;
    .locals 3
...
.method public static A0J(Ljava/io/File;)Landroid/util/Pair;
    ...
    new-instance v5, LX/0zg;

    invoke-direct {v5}, LX/0zg;-><init>()V

    const/4 v6, 0x0

    :try_start_0
    invoke-static {v5, p0}, LX/0yL;->A16(Landroid/media/MediaMetadataRetriever;Ljava/io/File;)V
    :try_end_0
    ...
    :goto_2
    invoke-virtual {v5}, LX/0zg;->close()V
...
.method public static A0K(LX/3HE;LX/2zt;LX/3BX;LX/1va;Ljava/lang/String;Ljava/lang/String;IIZZZ)Ljava/io/File;
    .locals 10
    ...
    invoke-static {v0, v1, p5, v2}, LX/000;->A1B(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v2, v0}, LX/3HE;->A00(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v4

    const-string v0, "HIST_SYNC"

    invoke-static {v4, v0}, LX/3HE;->A05(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v1, p5}, LX/0yE;->A06(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, v0, LX/2VF;->A08:Ljava/io/File;

    iget-object v2, p2, LX/3BX;->A01:Ljava/lang/String;
    ...
    invoke-static {v4, v2}, LX/3HE;->A05(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {p2}, LX/35N;->A01(LX/3BX;)Z
    ...
    invoke-static {v1, v3}, LX/000;->A0S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v5 .. v10}, LX/39Q;->A0M(LX/3HE;LX/2zt;LX/3BX;Ljava/lang/String;II)Ljava/io/File;
    ...
    :goto_5
    invoke-static {v0, v8, v2}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v1

    iget-byte v0, p2, LX/3BX;->A00:B

    invoke-virtual {v5, v0, v9, p0}, LX/3HE;->A0G(BII)Ljava/io/File;
...
.method public static A0L(LX/3HE;LX/2zt;LX/3BX;Ljava/io/File;I)Ljava/io/File;
    .locals 6
    ...
    invoke-static/range {v0 .. v5}, LX/39Q;->A0M(LX/3HE;LX/2zt;LX/3BX;Ljava/lang/String;II)Ljava/io/File;
...
.method public static A0M(LX/3HE;LX/2zt;LX/3BX;Ljava/lang/String;II)Ljava/io/File;
    .locals 8
    ...
    const-class v7, LX/39Q;

    monitor-enter v7

    :try_start_0
    invoke-static {p0, p1}, LX/39Q;->A0V(LX/3HE;LX/2zt;)V
    ...
    sput v0, LX/39Q;->A00:I

    sput-object v1, LX/39Q;->A01:Ljava/lang/String;
    ...
    iget-object v0, p2, LX/3BX;->A01:Ljava/lang/String;

    invoke-static {v6, v0}, LX/0yI;->A1P(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    sget-object v3, LX/39Q;->A03:Ljava/text/DecimalFormat;

    sget v0, LX/39Q;->A00:I
    ...
    invoke-static {v3, p3, v4}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v1

    iget-byte v0, p2, LX/3BX;->A00:B

    invoke-virtual {p0, v0, p4, p5}, LX/3HE;->A0G(BII)Ljava/io/File;
...
.method public static A0N(LX/3HE;Ljava/lang/String;)Ljava/io/File;
    .locals 2
...
.method public static A0O(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    .locals 3
    ...
    invoke-static {p1, v0}, LX/0yE;->A0B(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p0, v0, v1}, LX/0yE;->A01(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/io/File;
...
.method public static A0P(Ljava/io/File;)Ljava/io/FileInputStream;
    .locals 4
...
.method public static A0R(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v1, p0}, LX/0yM;->A0e(ILjava/lang/String;)Ljava/lang/String;
...
.method public static A0S(Landroid/net/Uri;LX/2sU;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    invoke-static {p0}, LX/39Q;->A0R(Landroid/net/Uri;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, LX/39Q;->A0T(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {p1, p0}, LX/2sU;->A00(LX/2sU;Ljava/lang/Object;)Landroid/content/ContentResolver;
...
.method public static A0U(Landroid/content/Context;Landroid/net/Uri;)V
    .locals 1
...
.method public static declared-synchronized A0V(LX/3HE;LX/2zt;)V
    .locals 13

    const-class v12, LX/39Q;
    ...
    invoke-static {v7, v5}, LX/0yH;->A0b(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, LX/39Q;->A01:Ljava/lang/String;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    sput v3, LX/39Q;->A00:I
    ...
    invoke-static {p0, v4, v0, v9, v11}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v4, v0, v9, v10}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v4, v0, v9, v8}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    ...
    sput v4, LX/39Q;->A00:I

    sget-object v0, LX/39Q;->A01:Ljava/lang/String;

    sget-object v3, LX/3BX;->A0J:LX/3BX;

    invoke-static {p0, v3, v0, v11, v11}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v3, v0, v11, v10}, LX/39Q;->A0A(LX/3HE;LX/3BX;III)I

    move-result v0

    invoke-static {p0, v3, v0, v11, v8}, LX/39Q;->A0A(LX/3HE;LX/3BX;III)I
    ...
    sget-object v3, LX/3BX;->A0i:LX/3BX;

    invoke-static {p0, v3, v0, v9, v11}, LX/39Q;->A0B(LX/3HE;LX/3BX;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v3, v0, v9, v10}, LX/39Q;->A0A(LX/3HE;LX/3BX;III)I

    move-result v0

    invoke-static {p0, v3, v0, v9, v8}, LX/39Q;->A0A(LX/3HE;LX/3BX;III)I
...
.method public static A0W(LX/2tK;Ljava/io/File;Ljava/io/File;)Z
    .locals 3

    invoke-virtual {p0, p1}, LX/2tK;->A04(Ljava/io/File;)Ljava/io/File;
