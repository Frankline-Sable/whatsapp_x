...
# direct methods
.method public constructor <init>(LX/3HE;LX/35r;LX/31l;LX/49C;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p4, p0, LX/35N;->A04:LX/49C;

    iput-object p1, p0, LX/35N;->A01:LX/3HE;

    iput-object p2, p0, LX/35N;->A02:LX/35r;

    iput-object p3, p0, LX/35N;->A03:LX/31l;
...
.method public static A00(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, LX/39G;->A09(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, LX/0yM;->A14(Ljava/lang/Object;Ljava/lang/String;)S
...
.method public static A01(LX/3BX;)Z
    .locals 2
    ...
    sget-object v1, LX/3BX;->A0e:LX/3BX;
...
# virtual methods
.method public final A02(Landroid/graphics/BitmapFactory$Options;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    .locals 3

    invoke-virtual {p0, p2, p3}, LX/35N;->A05(Landroid/net/Uri;Z)Ljava/io/InputStream;
...
.method public A03(Landroid/net/Uri;IIZZ)Landroid/graphics/Bitmap;
    .locals 6
    ...
    iget-object v0, p0, LX/35N;->A02:LX/35r;
    ...
    invoke-virtual {p0, p1, p2, p4, p5}, LX/35N;->A04(Landroid/net/Uri;IZZ)Landroid/graphics/BitmapFactory$Options;

    move-result-object v4

    :try_start_0
    invoke-virtual {p0, v4, p1, p4}, LX/35N;->A02(Landroid/graphics/BitmapFactory$Options;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
...
.method public A04(Landroid/net/Uri;IZZ)Landroid/graphics/BitmapFactory$Options;
    .locals 7
    ...
    invoke-virtual {p0, p1, p3}, LX/35N;->A05(Landroid/net/Uri;Z)Ljava/io/InputStream;
...
.method public A05(Landroid/net/Uri;Z)Ljava/io/InputStream;
    .locals 4
    ...
    iget-object v1, p0, LX/35N;->A03:LX/31l;
...
.method public A06(Ljava/io/File;B)V
    .locals 4
    ...
    :goto_1
    :try_start_0
    iget-object v2, p0, LX/35N;->A00:LX/3hF;

    if-nez v2, :cond_3

    iget-object v0, p0, LX/35N;->A04:LX/49C;

    invoke-static {v0}, LX/3hF;->A00(LX/49C;)LX/3hF;

    move-result-object v2

    iput-object v2, p0, LX/35N;->A00:LX/3hF;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v0, p0, v3, p1, v1}, LX/3eR;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
