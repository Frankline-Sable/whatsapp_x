...
.method public constructor <init>(LX/1Nx;)V
    ...
    iput-object p1, p0, LX/2XQ;->A00:LX/1Nx;
...
.method public declared-synchronized A00(IJ)Z
    ...
    :try_start_0
    const-string/jumbo v3, "users_participated"

    goto :goto_0

    :cond_0
    const-string/jumbo v3, "poll_vote_deletes"

    goto :goto_0

    :cond_1
    const-string/jumbo v3, "poll_votes_changed"

    goto :goto_0

    :cond_2
    const-string/jumbo v3, "poll_votes"

    goto :goto_0

    :cond_3
    const-string/jumbo v3, "option_count"

    :goto_0
    iget-object v0, p0, LX/2XQ;->A00:LX/1Nx;
    ...
    :try_start_2
    const-string/jumbo v1, "poll_event_logging"

    iget-object v2, v4, LX/3cx;->A02:LX/2tm;

    invoke-static {v2, v1}, LX/38C;->A04(LX/2tm;Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v0, v1, v2}, LX/2tX;->A06(IJ)V

    const/4 v0, 0x2

    invoke-virtual {v3, v0, p2, p3}, LX/2tX;->A06(IJ)V
