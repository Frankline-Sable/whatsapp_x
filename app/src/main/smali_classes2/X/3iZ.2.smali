...
.method public constructor <init>(LX/2oK;)V
    ...
    iput-object p1, p0, LX/3iZ;->A01:LX/2oK;
    ...
    iput-object v0, p0, LX/3iZ;->A00:Landroid/os/ConditionVariable;
...
.method public run()V
    ...
    :cond_0
    :goto_0
    iget-object v6, p0, LX/3iZ;->A00:Landroid/os/ConditionVariable;

    invoke-virtual {v6}, Landroid/os/ConditionVariable;->block()V

    invoke-virtual {v6}, Landroid/os/ConditionVariable;->close()V

    iget-object v5, p0, LX/3iZ;->A01:LX/2oK;

    monitor-enter v5

    :try_start_0
    iget-object v1, v5, LX/2oK;->A01:Ljava/util/LinkedList;
    ...
    iget-object v0, v5, LX/2oK;->A03:Ljava/util/Set;
    ...
    :cond_2
    invoke-virtual {v1}, Lorg/whispersystems/jobqueue/Job;->A04()Z

    move-result v0

    if-eqz v0, :cond_7

    iget-boolean v0, v5, LX/2oK;->A06:Z
    ...
    invoke-virtual {v8}, Lorg/whispersystems/jobqueue/Job;->A04()Z

    move-result v0

    if-eqz v0, :cond_5

    iget-object v0, v5, LX/2oK;->A00:LX/2Bn;

    if-eqz v0, :cond_3

    const-string v7, "JobQueue/DeterministicJobSelection/Fixed"

    iget-object v0, v0, LX/2Bn;->A00:LX/2iJ;

    iget-object v0, v0, LX/2iJ;->A01:LX/2rn;

    invoke-virtual {v0, v7, v4, v3}, LX/2rn;->A0B(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    const-string v7, "JobQueue/DeterministicJobSelection/Broken"
    ...
    invoke-virtual {v5, v9}, LX/2oK;->A00(Ljava/lang/String;)I
    ...
    iget-object v0, v5, LX/2oK;->A02:Ljava/util/Map;
    ...
    :cond_8
    iget-object v7, v5, LX/2oK;->A02:Ljava/util/Map;

    add-int/lit8 v0, v8, -0x1

    invoke-static {v9, v7, v0}, LX/0yG;->A1A(Ljava/lang/Object;Ljava/util/Map;I)V

    :cond_9
    :goto_4
    iget-object v0, v5, LX/2oK;->A04:Ljava/util/concurrent/SynchronousQueue;
