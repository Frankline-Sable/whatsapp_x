...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/2zt;->A04:Ljava/util/Set;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;LX/2Rw;)V
    .locals 1
    ...
    iput-object v0, p0, LX/2zt;->A02:Ljava/util/Map;

    invoke-static {}, LX/0yO;->A06()Ljava/util/concurrent/atomic/AtomicInteger;

    move-result-object v0

    iput-object v0, p0, LX/2zt;->A03:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p1, p0, LX/2zt;->A00:Landroid/content/Context;

    iput-object p2, p0, LX/2zt;->A01:LX/2Rw;

    return-void
.end method

.method public static A00(LX/2zt;Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;
    .locals 0

    invoke-virtual {p0, p1}, LX/2zt;->A03(Ljava/lang/String;)Landroid/content/SharedPreferences;
...
.method public static A01(LX/32r;)Landroid/content/SharedPreferences;
    .locals 1

    iget-object p0, p0, LX/32r;->A0D:LX/2zt;

    const-string v0, "keystore"

    invoke-virtual {p0, v0}, LX/2zt;->A03(Ljava/lang/String;)Landroid/content/SharedPreferences;
...
.method public static A02(LX/2zt;Ljava/lang/String;)Landroid/content/SharedPreferences;
    .locals 0
...
.method public static A21()LX/2zt;
    .locals 2
...
.method public declared-synchronized A03(Ljava/lang/String;)Landroid/content/SharedPreferences;
    ...
    :try_start_0
    sget-object v0, LX/2zt;->A04:Ljava/util/Set;
    ...
    :goto_0
    :try_start_1
    iget-object v3, p0, LX/2zt;->A02:Ljava/util/Map;
    ...
    sget-object v1, LX/2w1;->A09:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/2zt;->A00:Landroid/content/Context;
    ...
    :cond_1
    iget-object v5, p0, LX/2zt;->A00:Landroid/content/Context;
    ...
    invoke-static {v2, v1}, LX/0yM;->A1H(Ljava/io/File;Ljava/lang/StringBuilder;)V
    ...
    invoke-direct {v2, v0}, LX/2OJ;-><init>(Ljava/io/File;)V

    iget-object v1, p0, LX/2zt;->A01:LX/2Rw;

    iget-object v0, p0, LX/2zt;->A03:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, v2, v1, v0, v4}, LX/39t;-><init>(LX/2OJ;LX/2Rw;IZ)V
    ...
    invoke-static {v1, v4}, LX/0yG;->A17(Ljava/lang/Object;Ljava/lang/Throwable;)V
