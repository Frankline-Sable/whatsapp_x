...
.method public constructor <init>(LX/3hX;)V
    ...
    iput-object p1, p0, LX/2fe;->A00:LX/3hX;
...
# virtual methods
.method public A00(LX/2zk;J)V
    .locals 6

    :try_start_0
    iget-object v0, p0, LX/2fe;->A00:LX/3hX;
    ...
    iget-object v0, p1, LX/2zk;->A02:[B
...
.method public A01(LX/1hI;)V
    ...
    iget-object v2, p0, LX/2fe;->A00:LX/3hX;
    ...
    const-string v2, "SELECT message_row_id, waveform, background_color FROM audio_data WHERE message_row_id = ?"
    ...
    :goto_0
    invoke-virtual {p1, v0}, LX/1hZ;->A2F(LX/2zk;)V
