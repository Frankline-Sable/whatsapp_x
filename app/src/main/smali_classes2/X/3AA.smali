...
.method public synthetic constructor <init>(LX/304;)V
    ...
    iput-object p1, p0, LX/3AA;->A00:LX/304;
...
.method public final onChannelDisconnected()V
    ...
    iget-object v0, p0, LX/3AA;->A00:LX/304;

    const-string/jumbo v2, "onChannelDisconnected"

    iget-object v1, v0, LX/304;->A03:LX/48R;

    if-eqz v1, :cond_0

    const/16 v0, 0x25a

    invoke-interface {v1, v0, v2}, LX/48R;->BL0(ILjava/lang/String;)V
