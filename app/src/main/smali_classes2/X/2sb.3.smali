...
.method public constructor <init>(LX/2tS;LX/2zt;)V
    ...
    iput-object v0, p0, LX/2sb;->A02:LX/48z;

    iput-object v0, p0, LX/2sb;->A03:Ljava/util/HashMap;

    iput-object p1, p0, LX/2sb;->A04:LX/2tS;

    iput-object p2, p0, LX/2sb;->A05:LX/2zt;
...
.method public final declared-synchronized A00()Landroid/content/SharedPreferences;
    ...
    iget-object v1, p0, LX/2sb;->A05:LX/2zt;
...
.method public final declared-synchronized A01()Landroid/content/SharedPreferences;
    ...
    :try_start_0
    iget-object v0, p0, LX/2sb;->A01:Landroid/content/SharedPreferences;
    ...
    iput-object v0, p0, LX/2sb;->A01:Landroid/content/SharedPreferences;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized A02(I)Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LX/2sb;->A03:Ljava/util/HashMap;

    if-nez v0, :cond_1

    invoke-virtual {p0}, LX/2sb;->A03()Ljava/util/HashMap;
    ...
    iget v6, v7, LX/2RW;->A04:I

    const/4 v0, -0x1

    if-ne v6, v0, :cond_2

    iget-object v0, v7, LX/2RW;->A03:Ljava/lang/String;

    goto :goto_0

    :cond_2
    iget-object v0, p0, LX/2sb;->A04:LX/2tS;
    ...
    iget-object v1, v7, LX/2RW;->A03:Ljava/lang/String;

    invoke-static {}, LX/0yG;->A0V()Ljava/lang/String;

    move-result-object v0

    iput-object v0, v7, LX/2RW;->A03:Ljava/lang/String;

    iput-wide v2, v7, LX/2RW;->A02:J

    const/4 v0, 0x0

    iput v0, v7, LX/2RW;->A00:I

    iput-wide v2, v7, LX/2RW;->A01:J

    iget-object v0, p0, LX/2sb;->A03:Ljava/util/HashMap;

    invoke-virtual {v0, v8, v7}, Ljava/util/AbstractMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0, v7, v8}, LX/2sb;->A05(LX/2RW;Ljava/lang/Integer;)V

    invoke-virtual {p0}, LX/2sb;->A00()Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v0, p1, v6}, LX/2sb;->A04(III)V
...
.method public declared-synchronized A03()Ljava/util/HashMap;
    ...
    :try_start_0
    invoke-virtual {p0}, LX/2sb;->A01()Landroid/content/SharedPreferences;
    ...
    invoke-direct/range {v7 .. v14}, LX/2RW;-><init>(Ljava/lang/String;IIJJ)V
...
.method public final A04(III)V
    ...
    iget-object v0, p0, LX/2sb;->A02:LX/48z;
    ...
    iput-object v0, v1, LX/1TV;->A00:Ljava/lang/Integer;

    invoke-static {p2}, LX/0yN;->A0t(I)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, LX/1TV;->A01:Ljava/lang/Long;

    invoke-static {p3}, LX/0yN;->A0t(I)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, LX/1TV;->A02:Ljava/lang/Long;
...
.method public declared-synchronized A05(LX/2RW;Ljava/lang/Integer;)V
    .locals 4
...
.method public declared-synchronized A06(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    :try_start_0
    iget-object v0, v3, LX/2sb;->A03:Ljava/util/HashMap;

    if-nez v0, :cond_0

    invoke-virtual {v3}, LX/2sb;->A03()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, v3, LX/2sb;->A03:Ljava/util/HashMap;
    ...
    iget v6, v0, LX/2RW;->A04:I

    iget-object v5, v0, LX/2RW;->A03:Ljava/lang/String;

    invoke-virtual {v3}, LX/2sb;->A00()Landroid/content/SharedPreferences;

    move-result-object v0

    invoke-static {v0, v5}, LX/0yE;->A0M(Landroid/content/SharedPreferences;Ljava/lang/String;)V

    :goto_3
    const/4 v0, 0x0

    invoke-virtual {v3, v0, v7}, LX/2sb;->A05(LX/2RW;Ljava/lang/Integer;)V
    ...
    invoke-virtual {v3, v0, v5, v6}, LX/2sb;->A04(III)V
    ...
    :cond_5
    iget-object v0, v3, LX/2sb;->A04:LX/2tS;
    ...
    iget-object v5, v3, LX/2sb;->A03:Ljava/util/HashMap;

    iget v0, v6, LX/2JT;->A00:I
    ...
    iget v0, v6, LX/2JT;->A01:I

    invoke-virtual {v3, v2, v5, v0}, LX/2sb;->A04(III)V

    :goto_5
    iget v13, v6, LX/2JT;->A01:I
    ...
    invoke-direct/range {v11 .. v18}, LX/2RW;-><init>(Ljava/lang/String;IIJJ)V

    iget-object v5, v3, LX/2sb;->A03:Ljava/util/HashMap;

    iget v0, v6, LX/2JT;->A00:I

    invoke-static {v11, v5, v0}, LX/000;->A18(Ljava/lang/Object;Ljava/util/AbstractMap;I)V
    ...
    invoke-virtual {v3, v11, v0}, LX/2sb;->A05(LX/2RW;Ljava/lang/Integer;)V
