...
# direct methods
.method public constructor <init>(LX/2iJ;LX/2tS;LX/1QX;LX/48z;)V
    .locals 6
    ...
    iput-object v0, p0, LX/2rS;->A08:Ljava/util/Map;

    invoke-static {}, LX/002;->A0P()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, LX/2rS;->A09:Ljava/util/Map;
    ...
    iput-object v4, p0, LX/2rS;->A07:LX/2qH;

    iput-object p2, p0, LX/2rS;->A04:LX/2tS;

    iput-object p3, p0, LX/2rS;->A05:LX/1QX;

    iput-object v5, p0, LX/2rS;->A02:Landroid/os/Handler;

    iput-object p4, p0, LX/2rS;->A06:LX/48z;

    iput-object p1, p0, LX/2rS;->A03:LX/2iJ;
...
.method public declared-synchronized A00()V
    ...
    :try_start_0
    iget-boolean v0, p0, LX/2rS;->A01:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/2rS;->A01:Z

    iput-boolean v0, p0, LX/2rS;->A00:Z

    iget-object v0, p0, LX/2rS;->A07:LX/2qH;

    invoke-virtual {v0}, LX/2qH;->A02()V

    invoke-virtual {p0}, LX/2rS;->A01()V
    :try_end_0
...
.method public declared-synchronized A01()V
    ...
    :try_start_0
    iget-object v6, p0, LX/2rS;->A09:Ljava/util/Map;
    ...
    invoke-static {v6}, LX/0yJ;->A0s(Ljava/util/Map;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, LX/2rS;->A08:Ljava/util/Map;
    ...
    iget-boolean v14, v2, LX/2R0;->A04:Z
    ...
    :cond_1
    iget v9, v2, LX/2R0;->A00:I

    iget v10, v2, LX/2R0;->A02:I

    iget v11, v2, LX/2R0;->A01:I

    new-instance v8, LX/2R0;

    invoke-direct/range {v8 .. v14}, LX/2R0;-><init>(IIIJZ)V
    ...
    invoke-virtual {p0, v5, v4, v0}, LX/2rS;->A02(Ljava/util/List;Ljava/util/List;I)V
...
.method public A02(Ljava/util/List;Ljava/util/List;I)V
    ...
    :goto_1
    :try_start_0
    iget-object v3, p0, LX/2rS;->A05:LX/1QX;
    ...
    invoke-direct {v3, v0, v1}, LX/3gu;-><init>([Ljava/lang/Object;I)V
    ...
    iget-object v2, p0, LX/2rS;->A03:LX/2iJ;

    invoke-virtual {v3}, LX/3gu;->next()Ljava/lang/Object;
...
.method public declared-synchronized A03([Lcom/whatsapp/jid/DeviceJid;IIIZ)V
    ...
    iget-object v8, v5, LX/2rS;->A08:Ljava/util/Map;
    ...
    invoke-direct/range {v9 .. v15}, LX/2R0;-><init>(IIIJZ)V
    ...
    :cond_3
    invoke-virtual {v5, v6, v4, v10}, LX/2rS;->A02(Ljava/util/List;Ljava/util/List;I)V
...
.method public declared-synchronized A04([Lcom/whatsapp/jid/DeviceJid;IZ)V
    ...
    invoke-virtual/range {v1 .. v6}, LX/2rS;->A03([Lcom/whatsapp/jid/DeviceJid;IIIZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
