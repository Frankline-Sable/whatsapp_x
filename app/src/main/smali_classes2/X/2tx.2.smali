...
.field public final A08:LX/1d5;

.field public final A09:LX/2Z3;

.field public final A0A:LX/2sQ;

.field public final A0B:LX/2pP;

.field public final A0C:LX/35z;

.field public final A0D:LX/2pb;

.field public final A0E:Ljava/util/List;


# direct methods
.method public constructor <init>(LX/1d5;LX/2Z3;LX/2pP;LX/35z;LX/2pb;)V
    .locals 1
    ...
    iput-object v0, p0, LX/2tx;->A0E:Ljava/util/List;

    new-instance v0, LX/2sQ;

    invoke-direct {v0}, LX/2sQ;-><init>()V

    iput-object v0, p0, LX/2tx;->A0A:LX/2sQ;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/2tx;->A07:Z

    iput-object p3, p0, LX/2tx;->A0B:LX/2pP;

    iput-object p1, p0, LX/2tx;->A08:LX/1d5;

    iput-object p4, p0, LX/2tx;->A0C:LX/35z;

    iput-object p2, p0, LX/2tx;->A09:LX/2Z3;

    iput-object p5, p0, LX/2tx;->A0D:LX/2pb;

    return-void
.end method

.method public static A00(LX/2tx;)Lcom/gbwhatsapp/Me;
    .locals 0

    invoke-virtual {p0}, LX/2tx;->A0P()V

    iget-object p0, p0, LX/2tx;->A00:Lcom/gbwhatsapp/Me;

    return-object p0
.end method

.method public static A01(LX/4fQ;)Lcom/gbwhatsapp/Me;
    .locals 0
...
.method public static A02(LX/2tx;)LX/1OB;
    .locals 0
...
.method public static A03(LX/2tx;)LX/1OB;
    .locals 0
...
.method public static A04(LX/2tx;)LX/1aN;
    .locals 0

    invoke-virtual {p0}, LX/2tx;->A0P()V

    iget-object p0, p0, LX/2tx;->A04:LX/1aN;
...
.method public static A05(LX/2tx;)LX/1aN;
    .locals 0
...
.method public static A06(LX/2tx;)Lcom/whatsapp/jid/PhoneUserJid;
    .locals 0
...
.method public static A07(LX/2tx;)Lcom/whatsapp/jid/PhoneUserJid;
    .locals 0
...
.method public static A08(LX/2tx;)Ljava/lang/String;
    .locals 0
...
.method public static A09(LX/2tx;)V
    .locals 0
    ...
    invoke-static {p0}, LX/39J;->A0B(Z)V

    return-void
.end method

.method public static A0A(LX/2tx;)Z
    .locals 0
...
.method public static A0B(LX/2tx;LX/3dS;)Z
    .locals 1
...
.method public static A0C(LX/2tx;Lcom/whatsapp/jid/DeviceJid;)Z
    .locals 1
...
.method public static A0D(LX/2tx;LX/373;)Z
    .locals 1
...
.method public static A0E(LX/2tx;Ljava/util/List;)Z
    .locals 1
...
.method public A0F()I
    ...
    iget-object v0, p0, LX/2tx;->A09:LX/2Z3;
...
.method public A0G()Lcom/gbwhatsapp/Me;
    .locals 5
    ...
    invoke-static {v0, v1}, LX/0yH;->A1V(Ljava/io/File;Ljava/lang/String;)Z
...
.method public A0H()Lcom/gbwhatsapp/Me;
    .locals 1
...
.method public declared-synchronized A0I()LX/1aD;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-virtual {p0}, LX/2tx;->A0Q()V

    iget-object v0, p0, LX/2tx;->A02:LX/1aD;
    :try_end_0
...
.method public declared-synchronized A0J()LX/1aF;
    .locals 1
    ...
    iget-object v0, p0, LX/2tx;->A03:LX/1aF;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized A0K()LX/1aF;
    .locals 1
...
.method public A0L()Lcom/whatsapp/jid/PhoneUserJid;
    .locals 1
...
.method public declared-synchronized A0M()Ljava/lang/String;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, LX/2tx;->A0C:LX/35z;
...
.method public A0P()V
    ...
    iget-object v2, p0, LX/2tx;->A0A:LX/2sQ;
...
.method public final declared-synchronized A0Q()V
    ...
    :try_start_0
    iget-boolean v0, p0, LX/2tx;->A07:Z
    ...
    invoke-virtual {p0, v0}, LX/2tx;->A0T(Lcom/whatsapp/jid/Jid;)V
...
.method public final A0R(Lcom/gbwhatsapp/Me;)V
    .locals 5

    iput-object p1, p0, LX/2tx;->A00:Lcom/gbwhatsapp/Me;
    ...
    :goto_1
    iput-object v3, p0, LX/2tx;->A05:Lcom/whatsapp/jid/PhoneUserJid;
    ...
    invoke-virtual {v0, v3, v1}, LX/34k;->A01(Lcom/whatsapp/jid/UserJid;I)Lcom/whatsapp/jid/DeviceJid;

    move-result-object v0

    check-cast v0, LX/1aN;

    iput-object v0, p0, LX/2tx;->A04:LX/1aN;

    goto :goto_2

    :cond_1
    iput-object v2, p0, LX/2tx;->A04:LX/1aN;
    ...
    iput-object v2, p0, LX/2tx;->A05:Lcom/whatsapp/jid/PhoneUserJid;
    ...
    :goto_2
    iget-object v0, p0, LX/2tx;->A05:Lcom/whatsapp/jid/PhoneUserJid;

    if-nez v0, :cond_2

    iput-object v2, p0, LX/2tx;->A01:LX/1OB;
    ...
    iget-object v0, p0, LX/2tx;->A00:Lcom/gbwhatsapp/Me;
    ...
    iget-object v0, p0, LX/2tx;->A04:LX/1aN;

    invoke-static {v0, v1}, LX/0yE;->A0r(Ljava/lang/Object;Ljava/lang/StringBuilder;)V

    iget-object v0, p0, LX/2tx;->A0E:Ljava/util/List;
    ...
    invoke-direct {v1, v0}, LX/1OB;-><init>(Lcom/whatsapp/jid/UserJid;)V

    iput-object v1, p0, LX/2tx;->A01:LX/1OB;

    iget-object v3, p0, LX/2tx;->A0D:LX/2pb;

    iget-object v2, v3, LX/2pb;->A01:Landroid/content/SharedPreferences;
    ...
    iput v0, v1, LX/3dS;->A07:I

    iget-object v1, p0, LX/2tx;->A01:LX/1OB;
    ...
    iput v0, v1, LX/3dS;->A06:I

    iget-object v1, p0, LX/2tx;->A01:LX/1OB;

    invoke-virtual {v3}, LX/2pb;->A03()Ljava/lang/String;
...
.method public declared-synchronized A0S(Lcom/whatsapp/jid/Jid;)V
    ...
    invoke-virtual {p0, p1}, LX/2tx;->A0T(Lcom/whatsapp/jid/Jid;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized A0T(Lcom/whatsapp/jid/Jid;)V
    ...
    iput-object p1, p0, LX/2tx;->A03:LX/1aF;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v0, p1, v1}, LX/1aD;-><init>(Lcom/whatsapp/jid/UserJid;I)V

    iput-object v0, p0, LX/2tx;->A02:LX/1aD;
    ...
    iput-object v1, p0, LX/2tx;->A03:LX/1aF;

    iput-object p1, p0, LX/2tx;->A02:LX/1aD;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public A0U(Ljava/lang/String;)V
    ...
    iget-object v4, p0, LX/2tx;->A06:Ljava/lang/String;
    ...
    invoke-static {v0, v1, p1}, LX/0yF;->A0x(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, LX/2tx;->A06:Ljava/lang/String;

    iget-object v0, p0, LX/2tx;->A08:LX/1d5;
...
.method public A0V(Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/2tx;->A0D:LX/2pb;
    ...
    invoke-static {p0}, LX/2tx;->A03(LX/2tx;)LX/1OB;

    move-result-object v0

    if-eqz v0, :cond_0

    iput-object p1, v0, LX/3dS;->A0c:Ljava/lang/String;
...
.method public final A0Y(Lcom/gbwhatsapp/Me;Ljava/lang/String;)Z
    .locals 4
...
.method public A0b(Lcom/whatsapp/jid/DeviceJid;)Z
    ...
    invoke-static {p0}, LX/2tx;->A05(LX/2tx;)LX/1aN;
    ...
    invoke-virtual {p0}, LX/2tx;->A0I()LX/1aD;
