...
.method public A03(Landroid/os/StrictMode$ThreadPolicy;Ljava/lang/String;I)I
    ...
    instance-of v0, v8, LX/16A;

    if-eqz v0, :cond_1

    check-cast v8, LX/16A;

    iget-object v2, v8, LX/16A;->A04:Ljava/util/Map;
    ...
    :try_start_1
    iget-object v0, v8, LX/16C;->A01:Ljava/io/File;

    invoke-virtual {v8, v7, v0, v6, v5}, LX/16C;->A05(Landroid/os/StrictMode$ThreadPolicy;Ljava/io/File;Ljava/lang/String;I)I
    ...
    iget-object v0, v8, LX/16D;->A02:Ljava/util/Set;
    ...
    iget-object v0, v8, LX/16D;->A01:Ljava/util/Map;
    ...
    iget-object v0, v8, LX/16D;->A00:Ljava/io/File;
    ...
    invoke-static {v15, v6}, LX/000;->A0S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v13, LX/3Do;

    invoke-direct {v13, v2, v11}, LX/3Do;-><init>(Ljava/util/zip/ZipEntry;Ljava/util/zip/ZipFile;)V
    :try_end_3
    ...
    :try_start_5
    invoke-static {v13}, LX/361;->A03(LX/4AA;)[Ljava/lang/String;
    ...
    :cond_5
    :try_start_7
    invoke-virtual {v13}, LX/3Do;->close()V
    :try_end_7
    ...
    invoke-interface {v0, v1, v5}, LX/45X;->BD6(Ljava/lang/String;I)V
    ...
    invoke-static {v6, v9, v4, v1}, LX/000;->A1B(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_7
    invoke-static {v6, v9, v4}, LX/0yE;->A06(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_a
    check-cast v8, LX/16B;

    iget-object v0, v8, LX/16B;->A02:LX/16C;

    invoke-virtual {v0, v7, v6, v5}, LX/2f3;->A03(Landroid/os/StrictMode$ThreadPolicy;Ljava/lang/String;I)I
...
.method public A04(I)V
    ...
    iget-object v0, v5, LX/16D;->A02:Ljava/util/Set;
    ...
    iget-object v0, v5, LX/16D;->A00:Ljava/io/File;
    ...
    :try_start_1
    iget-object v1, v5, LX/16D;->A01:Ljava/util/Map;
    ...
    iget-object v0, v0, LX/16B;->A02:LX/16C;

    invoke-virtual {v0, p1}, LX/2f3;->A04(I)V
