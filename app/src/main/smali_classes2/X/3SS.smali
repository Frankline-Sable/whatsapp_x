...
.method public constructor <init>(LX/2Yg;LX/43T;)V
    ...
    iput-object p2, p0, LX/3SS;->A01:LX/43T;

    iput-object p1, p0, LX/3SS;->A00:LX/2Yg;
...
.method public bridge synthetic At5(Lorg/json/JSONObject;J)Ljava/lang/Object;
    ...
    invoke-static {v5, v0}, LX/2uc;->A03(Lorg/json/JSONObject;[Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, v3, v4}, LX/2Hx;-><init>(LX/3HV;Z)V
    ...
    iget-object v0, p0, LX/3SS;->A01:LX/43T;
    ...
    invoke-direct {v7, v4, v3}, LX/2Ht;-><init>(ZLjava/lang/String;)V

    :goto_1
    const-string v0, "cart_enabled"

    invoke-static {v0, v5}, LX/2uc;->A00(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-direct {v1, v7, v6}, LX/3HV;-><init>(LX/2Ht;Ljava/util/List;)V

    iget-object v0, p0, LX/3SS;->A00:LX/2Yg;

    invoke-virtual {v0, v1, v5}, LX/2Yg;->A00(LX/42O;Lorg/json/JSONObject;)V

    new-instance v0, LX/2Hx;

    invoke-direct {v0, v1, v2}, LX/2Hx;-><init>(LX/3HV;Z)V
    ...
    invoke-direct {v7, v8, v1}, LX/2Ht;-><init>(ZLjava/lang/String;)V
