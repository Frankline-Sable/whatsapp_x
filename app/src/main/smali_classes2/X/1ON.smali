...
# direct methods
.method public constructor <init>(LX/2tv;LX/2Uu;)V
    .locals 2
    ...
    iput-object p1, p0, LX/1ON;->A00:LX/2tv;
...
.method public A0V(LX/2X4;)Z
    ...
    iget-object v1, v0, LX/35w;->A01:LX/2rn;
    ...
    invoke-virtual {v1, v0, v6, v7}, LX/2rn;->A0B(Ljava/lang/String;ZLjava/lang/String;)V

    move-object/from16 v0, v44

    iget-object v5, v0, LX/1ON;->A00:LX/2tv;
    ...
    invoke-virtual/range {v43 .. v43}, LX/3hX;->A07()V
    ...
    invoke-static {v0, v1, v11, v12}, LX/0yE;->A10(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    ...
    :try_start_0
    invoke-virtual/range {v43 .. v43}, LX/3hX;->A05()LX/3cx;
    ...
    :try_start_2
    iget-object v0, v5, LX/2tv;->A07:LX/2sa;
    ...
    invoke-virtual {v1, v0, v6}, LX/2sa;->A01(Ljava/lang/String;I)I
    ...
    :try_start_3
    iget-object v0, v5, LX/2tv;->A09:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->clear()V

    iget-object v0, v5, LX/2tv;->A0A:Ljava/util/Map;
    ...
    :try_start_6
    invoke-static {v9, v13}, LX/0yH;->A0M(Landroid/database/Cursor;I)LX/1af;
    ...
    :cond_2
    iget-object v0, v5, LX/2tv;->A04:LX/36x;

    invoke-virtual {v0, v8}, LX/36x;->A06(Lcom/whatsapp/jid/Jid;)J
    ...
    invoke-static {v9, v14}, LX/0yG;->A0X(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v10, v9, v1, v0}, LX/35w;->A05(Landroid/content/ContentValues;Landroid/database/Cursor;Ljava/lang/String;I)V
    ...
    invoke-static {v10, v0, v1}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V
    ...
    invoke-static {v10, v9, v0, v1}, LX/35w;->A05(Landroid/content/ContentValues;Landroid/database/Cursor;Ljava/lang/String;I)V

    move-object/from16 v0, v25

    invoke-static {v9, v0}, LX/0yJ;->A00(Landroid/database/Cursor;Ljava/lang/String;)D

    move-result-wide v0

    move-object/from16 v15, v25

    invoke-static {v10, v15, v0, v1}, LX/0yJ;->A0z(Landroid/content/ContentValues;Ljava/lang/String;D)V
    ...
    invoke-static {v10, v0, v6}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v6, v2, v3}, LX/0yH;->A1Q([Ljava/lang/Object;IJ)V
    ...
    invoke-virtual/range {v35 .. v40}, LX/2tm;->A06(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v15, v1, v10}, LX/2tm;->A08(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    :cond_4
    invoke-virtual {v5, v8}, LX/2tv;->A09(LX/1af;)J

    move-result-wide v0

    :cond_5
    iget-object v2, v5, LX/2tv;->A02:LX/2ty;

    invoke-virtual {v2, v8, v6}, LX/2ty;->A0A(LX/1af;Z)LX/32q;
    ...
    invoke-virtual {v5, v8, v0, v1}, LX/2tv;->A0M(LX/1af;J)V
    ...
    invoke-static {v3, v6}, LX/379;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    :cond_7
    invoke-virtual {v5, v2}, LX/2tv;->A0A(LX/1af;)J

    move-result-wide v0

    invoke-virtual {v5, v2, v0, v1}, LX/2tv;->A0M(LX/1af;J)V
    ...
    invoke-virtual {v4, v0, v1, v7}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {v4, v7, v0, v2}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v10, v0}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J
    ...
    invoke-virtual {v5, v9}, LX/2tv;->A0A(LX/1af;)J

    move-result-wide v0

    invoke-virtual {v5, v9, v0, v1}, LX/2tv;->A0M(LX/1af;J)V
    :try_end_f
    ...
    invoke-virtual {v1, v0, v2}, LX/2sa;->A05(Ljava/lang/String;I)V
    ...
    iget-object v3, v5, LX/2tv;->A00:LX/2rn;
    ...
    invoke-virtual/range {v44 .. v44}, LX/35w;->A0O()Z
