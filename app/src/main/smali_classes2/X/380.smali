...
.method public constructor <init>(LX/35N;)V
    ...
    iput-object p1, p0, LX/380;->A00:LX/35N;

    return-void
.end method

.method public static A00(LX/43i;IJZZ)Landroid/graphics/Bitmap;
    .locals 9
    ...
    invoke-direct {v6}, LX/0zg;-><init>()V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    invoke-interface {p0, v6}, LX/43i;->Asi(LX/0zg;)Ljava/io/Closeable;
    ...
    invoke-virtual {v6, v7, v8, v0}, Landroid/media/MediaMetadataRetriever;->getFrameAtTime(JI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v5, v2, p1, p1}, LX/39Q;->A0F(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;II)Landroid/graphics/Bitmap;
    ...
    :cond_7
    :try_start_2
    invoke-virtual {v6}, LX/0zg;->close()V
...
.method public static A02(Ljava/io/File;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, LX/380;->A01(Ljava/io/File;)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v0, p0}, LX/0yL;->A16(Landroid/media/MediaMetadataRetriever;Ljava/io/File;)V
...
.method public static A03(Landroid/graphics/Bitmap;I)[B
    ...
    invoke-static {p0, v0, v1}, LX/0yI;->A17(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {p0}, LX/0yK;->A0F(Landroid/graphics/Bitmap;)Landroid/graphics/Rect;
    ...
    invoke-static {p0, v0}, LX/0yI;->A1Y(Landroid/graphics/Bitmap;Ljava/io/ByteArrayOutputStream;)[B
...
.method public static A04(Ljava/io/File;)[B
    ...
    invoke-static {p0, v0}, LX/380;->A03(Landroid/graphics/Bitmap;I)[B
...
# virtual methods
.method public A05(Landroid/net/Uri;II)[B
    .locals 11
    ...
    move-result-object v3
    :try_end_0
    .catch LX/1yJ; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/lang/OutOfMemoryError; {:try_start_0 .. :try_end_0} :catch_0

    :try_start_1
    iget-object v5, p0, LX/380;->A00:LX/35N;
    ...
    invoke-virtual/range {v5 .. v10}, LX/35N;->A03(Landroid/net/Uri;IIZZ)Landroid/graphics/Bitmap;
