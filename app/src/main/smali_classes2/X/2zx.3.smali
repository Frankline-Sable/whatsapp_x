...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/2zx;->A05:Ljava/net/Socket;
...
.method public constructor <init>(LX/2ql;LX/49C;)V
    ...
    iput-object p2, p0, LX/2zx;->A04:LX/49C;

    iput-object p1, p0, LX/2zx;->A03:LX/2ql;
...
.method public final declared-synchronized A00()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    :try_start_0
    iget-object v1, p0, LX/2zx;->A00:Ljava/util/concurrent/ThreadPoolExecutor;

    if-nez v1, :cond_0

    iget-object v2, p0, LX/2zx;->A04:LX/49C;
    ...
    invoke-direct {v4, v0, v1}, LX/3hQ;-><init>(ILjava/lang/String;)V
    ...
    iput-object v1, p0, LX/2zx;->A00:Ljava/util/concurrent/ThreadPoolExecutor;
    :try_end_0
...
.method public final A01(LX/2hZ;Ljava/net/InetSocketAddress;Z)V
    .locals 7
    ...
    iget-object v6, p0, LX/2zx;->A01:Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-static {v1, p3}, LX/0yE;->A0A(Ljava/lang/StringBuilder;Z)Ljava/lang/String;
    ...
    invoke-direct {v1, v2}, LX/2pT;-><init>(Ljava/net/Socket;)V

    iget-object v0, v1, LX/2pT;->A00:Ljava/net/Socket;

    invoke-virtual {p1, v0}, LX/2hZ;->A01(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1}, LX/2pT;->A01()V
    ...
    :cond_1
    invoke-static {p2, v4}, LX/000;->A0k(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :try_start_2
    iget-boolean v0, p0, LX/2zx;->A02:Z
    ...
    :cond_2
    iput-boolean v3, p0, LX/2zx;->A02:Z
