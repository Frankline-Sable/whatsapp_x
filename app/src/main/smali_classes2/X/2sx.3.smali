...
# direct methods
.method public constructor <init>(LX/2tS;LX/2tv;LX/2ty;LX/2ht;LX/2r6;LX/3hX;LX/2st;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/2sx;->A00:LX/2tS;

    iput-object p4, p0, LX/2sx;->A03:LX/2ht;

    iput-object p2, p0, LX/2sx;->A01:LX/2tv;

    iput-object p7, p0, LX/2sx;->A06:LX/2st;

    iput-object p3, p0, LX/2sx;->A02:LX/2ty;

    iput-object p6, p0, LX/2sx;->A05:LX/3hX;

    iput-object p5, p0, LX/2sx;->A04:LX/2r6;
...
.method public A00(JJ)I
    ...
    invoke-static {v5, v0, p3, p4}, LX/0yH;->A1Q([Ljava/lang/Object;IJ)V

    iget-object v0, p0, LX/2sx;->A05:LX/3hX;
...
.method public A02(LX/1af;)J
    ...
    iget-object v0, p0, LX/2sx;->A01:LX/2tv;

    invoke-static {v0, p1, v4}, LX/2tv;->A01(LX/2tv;LX/1af;[Ljava/lang/Object;)V
    ...
    const-string v1, "   SELECT _id FROM available_message_view WHERE chat_row_id = ? ORDER BY sort_id DESC LIMIT 1"

    const-string v0, "LAST_CHAT_MESSAGE_ID_SQL"
...
.method public A03(LX/1af;I)J
    ...
    invoke-static {v4, v0, v1}, LX/0yH;->A1P([Ljava/lang/Object;II)V
...
.method public A04(LX/1af;IJJ)J
    .locals 17
    ...
    iget-object v0, v3, LX/2sx;->A02:LX/2ty;
    ...
    :cond_3
    invoke-static {v2, v1}, LX/37O;->A01(Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    iget-object v0, v3, LX/2sx;->A01:LX/2tv;

    invoke-static {v0, v7, v8, v12}, LX/2tv;->A02(LX/2tv;LX/1af;[Ljava/lang/Object;I)V

    invoke-static {v8, v13, v1, v2}, LX/0yG;->A1Q([Ljava/lang/Object;IJ)V

    iget-object v0, v3, LX/2sx;->A06:LX/2st;

    invoke-virtual {v0, v4, v5}, LX/2st;->A04(J)J

    move-result-wide v0

    invoke-static {v8, v6, v0, v1}, LX/0yG;->A1Q([Ljava/lang/Object;IJ)V

    invoke-static {v8, v10, v11}, LX/0yH;->A1P([Ljava/lang/Object;II)V
    ...
    invoke-static {v8, v10, v6}, LX/0yH;->A1P([Ljava/lang/Object;II)V

    :goto_0
    :try_start_0
    iget-object v0, v3, LX/2sx;->A05:LX/3hX;
    ...
    :try_start_1
    iget-object v1, v6, LX/3cx;->A02:LX/2tm;

    const-string v0, "ROW_ID_STORE_GET_START_REF"

    invoke-virtual {v1, v9, v0, v8}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v0, v3, LX/2sx;->A04:LX/2r6;

    invoke-virtual {v0}, LX/2r6;->A03()V

    :goto_5
    iget-object v3, v3, LX/2sx;->A03:LX/2ht;
...
.method public A05(LX/1af;[IJ)J
    ...
    invoke-direct {v5, v4}, LX/35O;-><init>(Z)V
    ...
    invoke-static {p2}, LX/37O;->A00([I)Ljava/lang/String;
    ...
    invoke-static {v0, p1, v1, v4}, LX/2tv;->A02(LX/2tv;LX/1af;[Ljava/lang/Object;I)V

    invoke-static {v1, p3, p4}, LX/0yH;->A1R([Ljava/lang/Object;J)V
...
.method public A07(LX/1af;)Z
    .locals 5

    iget-object v1, p0, LX/2sx;->A02:LX/2ty;
    ...
    invoke-static {v1, p1}, LX/2ty;->A01(LX/2ty;Ljava/lang/Object;)LX/32q;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-wide v3, v0, LX/32q;->A0N:J
    ...
    :cond_0
    iget-object v1, p0, LX/2sx;->A01:LX/2tv;
    ...
    invoke-virtual {p0, p1}, LX/2sx;->A02(LX/1af;)J
