...
# direct methods
.method public static A00(LX/0R4;Ljava/io/File;)J
    .locals 8

    if-eqz p0, :cond_0

    invoke-virtual {p0}, LX/0R4;->A02()V
...
.method public static A02(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    .locals 2
...
.method public static A03(LX/2fd;Ljava/io/File;II)Landroid/util/Pair;
    .locals 14
    ...
    invoke-static {v0, p1}, LX/0yN;->A0F(Ljava/lang/Object;Ljava/lang/Object;)Landroid/util/Pair;
    ...
    invoke-virtual {p0, v2}, LX/2fd;->A01(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v9, v0, v1}, LX/001;->A0h(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static A05(Landroid/net/Uri;)Ljava/io/File;
    .locals 3
...
.method public static A06(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    .locals 13
    ...
    invoke-static {v0, v3, v1}, LX/0yE;->A1I(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static A07(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    .locals 3
...
.method public static A08(Ljava/io/File;)Ljava/lang/String;
    .locals 0
    ...
    invoke-static {p0}, LX/39T;->A0A(Ljava/lang/String;)Ljava/lang/String;
...
.method public static A09(Ljava/io/File;Ljava/security/MessageDigest;J)Ljava/lang/String;
    .locals 11
...
.method public static A0C(LX/6fI;Ljava/io/File;)V
    .locals 5
    ...
    invoke-direct {v1, v3, v2}, LX/6fX;-><init>(Ljava/io/OutputStream;I)V

    invoke-virtual {p0, v1}, LX/6fI;->Bke(Lcom/google/protobuf/CodedOutputStream;)V
...
.method public static A0D(LX/31E;Ljava/io/File;)V
    .locals 24
    ...
    invoke-static {v4}, LX/0yG;->A0e([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-virtual/range {p0 .. p0}, LX/31E;->A02()J
    ...
    invoke-static {v13}, LX/0yN;->A0l(Ljava/util/Iterator;)Ljava/io/File;
    ...
    invoke-static {v11, v0, v12}, LX/0yF;->A17(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v0, v12, v3, v4}, LX/0yE;->A10(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    ...
    invoke-static {v11, v0, v7}, LX/0yJ;->A0j(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static A0E(LX/31l;Ljava/io/File;Ljava/io/File;)V
    .locals 1
    ...
    :try_start_0
    invoke-virtual {p0, p1}, LX/31l;->A05(Ljava/io/FileInputStream;)V

    invoke-static {p2}, LX/0yL;->A1E(Ljava/io/File;)V
...
.method public static A0F(LX/31l;Ljava/io/File;Ljava/io/File;)V
    .locals 1
    ...
    invoke-static {p0, p1, p2}, LX/39T;->A0E(LX/31l;Ljava/io/File;Ljava/io/File;)V
...
.method public static A0G(Ljava/io/File;J)V
    ...
    invoke-static {v6, v0, v2}, LX/0yF;->A17(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v0, ":"

    invoke-static {v2, v0}, LX/0yH;->A1F(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v6, v0, v1}, LX/0yJ;->A0j(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static A0H(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v5, p1, v4}, LX/0yF;->A17(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v0, " "

    invoke-static {v5, v0, v4}, LX/0yH;->A13(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)V
...
.method public static A0I(Ljava/io/File;Ljava/util/Set;)V
    .locals 5
    ...
    invoke-static {p0}, LX/39T;->A0Q(Ljava/io/File;)Z
...
.method public static A0J(Ljava/io/File;[B)V
    ...
    invoke-static {p0}, LX/0yK;->A0a(Ljava/io/File;)Ljava/io/BufferedOutputStream;
...
.method public static A0K(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    .locals 3
...
.method public static A0L(Ljava/nio/channels/FileChannel;Ljava/nio/channels/WritableByteChannel;)V
    .locals 10
...
.method public static A0M(Landroid/net/Uri;LX/35r;LX/35o;Z)Z
    .locals 5
    ...
    :cond_1
    invoke-virtual {v0, p0}, LX/2sU;->A05(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-virtual {p2}, LX/35o;->A0E()Z
...
.method public static A0N(LX/2tK;Ljava/io/File;Ljava/io/File;)Z
    .locals 3
    ...
    :try_start_1
    invoke-virtual {p0, p2}, LX/2tK;->A00(Ljava/io/File;)LX/1v0;
...
.method public static A0O(LX/2tK;Ljava/io/File;Ljava/io/File;)Z
    .locals 1
    ...
    invoke-static {p0, p1, p2}, LX/39T;->A0N(LX/2tK;Ljava/io/File;Ljava/io/File;)Z
...
.method public static A0P(LX/2fd;Ljava/io/File;Ljava/io/File;)Z
    .locals 3
    ...
    invoke-direct {p0, v0, p2}, LX/1v0;-><init>(LX/2iD;Ljava/io/File;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2
...
.method public static A0S(Ljava/io/File;)Z
    ...
    invoke-static {p0, v0, v1}, LX/39T;->A0G(Ljava/io/File;J)V
...
.method public static A0U(Ljava/io/File;Ljava/io/InputStream;J)Z
    ...
    invoke-static {v0, v4, p2, p3}, LX/000;->A0Y(Ljava/lang/String;Ljava/lang/StringBuilder;J)Ljava/lang/String;
