...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/36e;->A04:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/36e;->A01:Ljava/util/List;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/36e;->A03:Ljava/util/List;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/36e;->A00:Ljava/util/List;

    invoke-static {}, LX/001;->A0p()Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, LX/36e;->A02:Ljava/util/List;
...
.method public constructor <init>(LX/38n;)V
    ...
    invoke-virtual {v5, v0, v4}, LX/38n;->A0s(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, LX/36e;->A00(LX/38n;)LX/2PO;

    move-result-object v4

    :goto_1
    iget-object v8, p0, LX/36e;->A01:Ljava/util/List;

    invoke-virtual {p0, v5}, LX/36e;->A01(LX/38n;)Ljava/lang/String;

    move-result-object v0

    new-instance v1, LX/2c3;

    invoke-direct {v1, v4, v6, v0, v7}, LX/2c3;-><init>(LX/2PO;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {v5, v0, v4}, LX/38n;->A0Y(LX/38n;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-object v1, LX/36e;->A04:Ljava/util/List;

    const/4 v0, 0x0

    new-instance v4, LX/2PO;

    invoke-direct {v4, v0, v2, v1, v3}, LX/2PO;-><init>(LX/1ET;Ljava/lang/String;Ljava/util/List;Z)V
    ...
    invoke-virtual {v5, v2, v4}, LX/38n;->A0s(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v2, v6, v7}, LX/38n;->A0f(Ljava/lang/String;J)J
    ...
    iget-object v8, p0, LX/36e;->A03:Ljava/util/List;
    ...
    invoke-direct {v1, v2, v3, v0}, LX/2Ia;-><init>(JLjava/lang/String;)V
    ...
    :cond_3
    iget-object v1, p0, LX/36e;->A02:Ljava/util/List;
    ...
    iget-object v1, p0, LX/36e;->A00:Ljava/util/List;
    ...
    invoke-direct {v1, v0, v2}, LX/1PW;-><init>(ZLjava/lang/String;)V

    throw v1

    :cond_5
    invoke-static {v5, v1}, LX/000;->A0k(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v1, v4, v0}, LX/1PW;-><init>(ZLjava/lang/String;)V
...
# virtual methods
.method public final A00(LX/38n;)LX/2PO;
    .locals 8

    const-string/jumbo v4, "snapshot"

    invoke-virtual {p1, v4}, LX/38n;->A0m(Ljava/lang/String;)LX/38n;
    ...
    invoke-direct {v0, v1, v2}, LX/1PW;-><init>(ZLjava/lang/String;)V
    ...
    invoke-static {v2, v5}, LX/38n;->A0O(LX/38n;Ljava/lang/String;)Ljava/util/Iterator;
    ...
    iget v1, v6, LX/1Ej;->bitField0_:I

    and-int/lit8 v0, v1, 0x20

    if-eqz v0, :cond_c

    iget-object v0, v6, LX/1Ej;->exitCode_:LX/1Ca;
    ...
    :cond_7
    iget v0, v0, LX/1Ca;->bitField0_:I
    ...
    sget-object v1, LX/1Ca;->DEFAULT_INSTANCE:LX/1Ca;

    :cond_8
    iget-wide v5, v1, LX/1Ca;->code_:J
    ...
    iget-object v0, v6, LX/1Ej;->version_:LX/1Bc;
    ...
    iget-object v0, v6, LX/1Ej;->mutations_:LX/8c9;
    ...
    :cond_f
    iget-wide v0, v0, LX/1Bc;->version_:J
    ...
    invoke-virtual {p0, p1}, LX/36e;->A01(LX/38n;)Ljava/lang/String;

    move-result-object v1

    new-instance v0, LX/2PO;

    invoke-direct {v0, v4, v1, v3, v2}, LX/2PO;-><init>(LX/1ET;Ljava/lang/String;Ljava/util/List;Z)V

    return-object v0
.end method

.method public final A01(LX/38n;)Ljava/lang/String;
    .locals 3
