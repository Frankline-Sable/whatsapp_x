...
.method public static final A01(Ljava/lang/String;IIIZ)Landroid/graphics/Bitmap;
    ...
    sget-object v9, LX/385;->A05:Ljava/lang/Object;
...
.method public static final A02(Landroid/net/Uri;LX/35r;)Ljava/lang/String;
    .locals 7
    ...
    invoke-virtual/range {v3 .. v8}, LX/2sU;->A03(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
...
.method public static final A03(LX/35t;Ljava/lang/String;I)Ljava/lang/String;
    .locals 5
    ...
    invoke-static {v0, p2, v4}, LX/000;->A1P([Ljava/lang/Object;II)V

    invoke-virtual {p0, v0, v3, v1, v2}, LX/35t;->A0O([Ljava/lang/Object;IJ)Ljava/lang/String;
...
.method public static final A04(Landroid/content/Context;LX/3Fb;LX/2rn;LX/3bD;LX/2fZ;LX/1hc;LX/49C;)V
    .locals 7
    ...
    invoke-virtual {p3, v1, v0}, LX/3bD;->A0H(II)V
    ...
    invoke-direct/range {v2 .. v7}, LX/4D5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance v1, LX/1HR;

    invoke-direct {v1, p2, p4, p5}, LX/1HR;-><init>(LX/2rn;LX/2fZ;LX/1gr;)V

    iget-object v0, p3, LX/3bD;->A08:Ljava/util/concurrent/Executor;

    invoke-virtual {v1, v2, v0}, LX/3bh;->A05(LX/44w;Ljava/util/concurrent/Executor;)V

    invoke-interface {p6, v1}, LX/49C;->BcS(Ljava/lang/Runnable;)V

    return-void
.end method

.method public static final A05(LX/2t1;LX/1af;I)Z
    .locals 2
...
.method public static final A07(Landroid/graphics/Bitmap;)[B
    .locals 5
    ...
    invoke-static {v2, v4}, LX/0yE;->A1D(Ljava/lang/StringBuilder;I)V
...
# virtual methods
.method public final A08(Ljava/lang/String;Ljava/io/File;)I
    .locals 7
    ...
    invoke-direct {v0, p2}, LX/37Y;-><init>(Ljava/io/File;)V

    invoke-virtual {v0}, LX/37Y;->A04()V

    iget v5, v0, LX/37Y;->A00:I
    ...
    .catch LX/1yY; {:try_start_0 .. :try_end_0} :catch_7
    ...
    .catch LX/1yY; {:try_start_1 .. :try_end_1} :catch_7
    ...
    invoke-static {v0, v4}, LX/38m;->A00(Ljava/lang/String;Ljava/util/zip/ZipFile;)I
    ...
    .catch LX/1yY; {:try_start_5 .. :try_end_5} :catch_7
    ...
    invoke-static {p2, v0, v1}, LX/0yJ;->A0j(Ljava/io/File;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    .catch LX/1yY; {:try_start_8 .. :try_end_8} :catch_7
    .catch LX/1yV; {:try_start_8 .. :try_end_8} :catch_6
    ...
    .catch LX/1yY; {:try_start_9 .. :try_end_9} :catch_7
    ...
    .catch LX/1yY; {:try_start_a .. :try_end_a} :catch_7
    ...
    .catch LX/1yY; {:try_start_c .. :try_end_c} :catch_7
    .catch LX/1yV; {:try_start_c .. :try_end_c} :catch_6
    ...
    .catch LX/1yY; {:try_start_f .. :try_end_f} :catch_7
    .catch LX/1yV; {:try_start_f .. :try_end_f} :catch_6
    ...
    .catch LX/1yY; {:try_start_10 .. :try_end_10} :catch_7
    .catch LX/1yV; {:try_start_10 .. :try_end_10} :catch_6
    ...
    .catch LX/1yY; {:try_start_11 .. :try_end_11} :catch_7
    ...
    invoke-static {v0, v3}, LX/38m;->A00(Ljava/lang/String;Ljava/util/zip/ZipFile;)I
    ...
    .catch LX/1yY; {:try_start_15 .. :try_end_15} :catch_7
    .catch LX/1yV; {:try_start_15 .. :try_end_15} :catch_6
    ...
    .catch LX/1yY; {:try_start_18 .. :try_end_18} :catch_7
    .catch LX/1yV; {:try_start_18 .. :try_end_18} :catch_6
    ...
    .catch LX/1yY; {:try_start_19 .. :try_end_19} :catch_7
    .catch LX/1yV; {:try_start_19 .. :try_end_19} :catch_6
