...
.method public static A02(LX/2xR;II)I
    .locals 11
    ...
    :cond_2
    iget-object v0, p0, LX/2xR;->A02:Landroid/graphics/BitmapFactory$Options;

    iget v8, v0, Landroid/graphics/BitmapFactory$Options;->inSampleSize:I

    iget-object v7, p0, LX/2xR;->A03:Ljava/lang/Long;
    ...
    :cond_3
    iget-boolean v0, p0, LX/2xR;->A04:Z
    ...
    invoke-static {p1, p2, v1, v0, v2}, LX/38h;->A00(IIIII)I
...
.method public static A04(LX/2hg;LX/2xR;Ljava/io/InputStream;Z)LX/2MB;
    .locals 1

    new-instance v0, LX/2Bv;

    invoke-direct {v0, p2}, LX/2Bv;-><init>(Ljava/io/InputStream;)V

    :try_start_0
    iget-object v0, v0, LX/2Bv;->A00:Ljava/io/InputStream;
    ...
    invoke-static {p0, p1, v0, p3}, LX/38h;->A05(LX/2hg;LX/2xR;[BZ)LX/2MB;
    ...
    new-instance p1, LX/2MB;

    invoke-direct {p1, v0, v0, p0}, LX/2MB;-><init>(IILandroid/graphics/Bitmap;)V

    return-object p1
.end method

.method public static A05(LX/2hg;LX/2xR;[BZ)LX/2MB;
    .locals 12

    iget-object v9, p1, LX/2xR;->A02:Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-static {p1, v6, v5}, LX/38h;->A02(LX/2xR;II)I
    ...
    invoke-direct {v0, v6, v5, v2}, LX/2MB;-><init>(IILandroid/graphics/Bitmap;)V
    ...
    iget-object v7, p0, LX/2hg;->A00:LX/0Rc;
    ...
    invoke-static {v0, v3, v1}, LX/38h;->A01(Landroid/graphics/Bitmap$Config;II)I
    ...
    iget-object v11, p0, LX/2hg;->A02:Ljava/util/TreeSet;

    const/4 v10, 0x0

    invoke-static {v11, v0}, LX/3jY;->A0P(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, LX/2hg;->A01:Ljava/util/HashMap;
    ...
    invoke-static {v3}, LX/3jY;->A02(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    :cond_3
    invoke-virtual {v7, v1}, LX/0Rc;->A05(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, v10, LX/5tu;->first:Ljava/lang/Object;

    check-cast v3, Landroid/graphics/Bitmap;

    iget-object v2, v10, LX/5tu;->second:Ljava/lang/Object;
    ...
    :try_start_2
    invoke-virtual {v7, v2, v3}, LX/0Rc;->A08(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v1, v0, v2}, LX/2hg;->A00(IILjava/lang/String;)V
    :try_end_2
...
.method public static A06(LX/2xR;Ljava/io/File;)LX/2MB;
    .locals 5

    iget-object v1, p0, LX/2xR;->A02:Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-static {p0, v4, v3}, LX/38h;->A02(LX/2xR;II)I
    ...
    invoke-direct {v0, v4, v3, v2}, LX/2MB;-><init>(IILandroid/graphics/Bitmap;)V

    return-object v0
.end method

.method public static A07(LX/2xR;Ljava/io/InputStream;)LX/2MB;
    .locals 2
    ...
    invoke-static {v1, p0, p1, v0}, LX/38h;->A04(LX/2hg;LX/2xR;Ljava/io/InputStream;Z)LX/2MB;
...
.method public static A08(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {p0}, LX/0yJ;->A0Y(Landroid/graphics/Bitmap;)Ljava/io/ByteArrayOutputStream;
