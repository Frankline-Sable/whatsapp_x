...
.method public constructor <init>(LX/2zt;)V
    ...
    iput-object p1, p0, LX/2ZS;->A01:LX/2zt;
...
.method public A00(III)Ljava/util/List;
    ...
    :try_start_0
    iget-object v4, p0, LX/2ZS;->A00:Landroid/content/SharedPreferences;

    if-nez v4, :cond_0

    iget-object v1, p0, LX/2ZS;->A01:LX/2zt;
    ...
    iput-object v4, p0, LX/2ZS;->A00:Landroid/content/SharedPreferences;
    :try_end_0
    ...
    invoke-static {v2, p3, v0}, LX/000;->A1P([Ljava/lang/Object;II)V
    ...
    invoke-static {v4, v0}, LX/0yN;->A11(Landroid/content/SharedPreferences;Ljava/lang/String;)Ljava/lang/String;
