...
.method public static constructor <clinit>()V
    ...
    sput-object v1, LX/38a;->A04:Ljava/util/Set;
    ...
    sput-object v2, LX/38a;->A02:Ljava/util/Map;
    ...
    sput-object v1, LX/38a;->A06:Ljava/util/Set;
    ...
    sput-object v1, LX/38a;->A03:Ljava/util/Set;
    ...
    sput-object v1, LX/38a;->A05:Ljava/util/Set;
    ...
    sput-object v1, LX/38a;->A01:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    sget-object v0, LX/2vM;->A00:LX/2vM;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, LX/38a;->A00:LX/2vM;
...
.method public static A01(Landroid/media/MediaCodec;Landroid/media/MediaFormat;Landroid/view/Surface;)LX/2qV;
    .locals 9
    ...
    invoke-static {v4, v0}, LX/7cT;->A00(Ljava/lang/Class;Ljava/lang/String;)V
    ...
    invoke-static {v5, p1}, LX/38a;->A04(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)Ljava/lang/String;
    ...
    :cond_2
    sget-object v7, LX/1wE;->A01:LX/1wE;

    const/4 v6, 0x0

    new-instance v4, LX/2qV;

    invoke-direct/range {v4 .. v9}, LX/2qV;-><init>(Landroid/media/MediaCodec;Landroid/view/Surface;LX/1wE;Ljava/lang/String;Z)V
...
.method public static A02(Landroid/media/MediaFormat;LX/1vM;Ljava/lang/String;)LX/2qV;
    .locals 13
    ...
    sget-object v5, LX/1vM;->A02:LX/1vM;

    const/4 v7, 0x1

    const/4 v9, 0x0

    const-class v6, LX/38a;

    invoke-virtual {v8}, Landroid/media/MediaCodec;->getName()Ljava/lang/String;

    move-result-object v4

    const-string v3, "config video encoder (%s) with format: %s"
    ...
    invoke-static {v3, v4, p0}, Lcom/facebook/common/stringformat/StringFormatUtil;->formatStrLocaleSafe(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v6, v0}, LX/7cT;->A00(Ljava/lang/Class;Ljava/lang/String;)V

    :cond_1
    invoke-virtual {v8, p0, v1, v1, v7}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    const-string v3, "media codec:%s, format:%s, input type:%s"

    new-array v2, v2, [Ljava/lang/Object;

    invoke-static {v8, p0}, LX/38a;->A04(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)Ljava/lang/String;

    move-result-object v0

    aput-object v0, v2, v12

    invoke-static {p0, p1, v2}, LX/0yJ;->A1E(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    :cond_2
    sget-object v10, LX/1wE;->A02:LX/1wE;

    new-instance v7, LX/2qV;

    invoke-direct/range {v7 .. v12}, LX/2qV;-><init>(Landroid/media/MediaCodec;Landroid/view/Surface;LX/1wE;Ljava/lang/String;Z)V
    ...
    :goto_1
    invoke-static {v0, p0, p1, v3}, LX/0yE;->A0l(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    invoke-static {v0}, LX/333;->A00(Landroid/media/MediaCodec$CodecException;)Ljava/lang/String;
    ...
    invoke-direct {v1, v0, v4}, LX/16P;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static final A03(Ljava/lang/String;Ljava/util/List;)LX/278;
    .locals 4
    ...
    sget-object v0, LX/38a;->A03:Ljava/util/Set;
...
.method public static A04(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, LX/0yE;->A13(Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {p1, v0}, LX/38a;->A00(Landroid/media/MediaFormat;Ljava/lang/String;)I
    ...
    invoke-static {v0, v1, v3}, LX/000;->A0a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Ljava/lang/String;
    ...
    invoke-static {v3, v2}, LX/000;->A17(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v0, v3, v4}, LX/000;->A0a(Ljava/lang/String;Ljava/lang/StringBuilder;Z)Ljava/lang/String;
...
.method public static A05(Ljava/lang/String;)Z
    ...
    sget-object v0, LX/1wn;->A09:LX/1wn;
    ...
    sget-object v0, LX/1wn;->A0C:LX/1wn;
    ...
    sget-object v0, LX/1wn;->A0D:LX/1wn;
    ...
    sget-object v0, LX/1wn;->A07:LX/1wn;
