...
# direct methods
.method public constructor <init>(LX/2tx;LX/2tS;LX/2yy;LX/2rx;LX/2q4;LX/1pQ;Ljava/security/SecureRandom;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LX/2rP;->A01:LX/2tS;

    iput-object p1, p0, LX/2rP;->A00:LX/2tx;

    iput-object p4, p0, LX/2rP;->A03:LX/2rx;

    iput-object p6, p0, LX/2rP;->A05:LX/1pQ;

    iput-object p7, p0, LX/2rP;->A06:Ljava/security/SecureRandom;

    iput-object p3, p0, LX/2rP;->A02:LX/2yy;

    iput-object p5, p0, LX/2rP;->A04:LX/2q4;
...
.method public A00()V
    ...
    iget-object v1, p0, LX/2rP;->A03:LX/2rx;
    ...
    iget-object v0, v1, LX/2rx;->A02:LX/8VC;

    invoke-static {v0}, LX/0yG;->A0B(LX/8VC;)Landroid/content/SharedPreferences$Editor;

    move-result-object v2

    iget-object v0, v4, LX/2Sr;->A01:Lcom/whatsapp/jid/UserJid;
    ...
    iget-object v0, v4, LX/2Sr;->A05:Ljava/lang/String;
    ...
    iget-object v0, v4, LX/2Sr;->A02:Ljava/lang/String;
    ...
    iget-object v0, v4, LX/2Sr;->A04:Ljava/lang/String;
    ...
    iget-object v0, v4, LX/2Sr;->A03:Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1}, LX/1c1;-><init>(ILjava/lang/String;)V
...
.method public A01()V
    ...
    iget-object v1, p0, LX/2rP;->A00:LX/2tx;
    ...
    :try_start_0
    iget-object v0, p0, LX/2rP;->A03:LX/2rx;

    invoke-virtual {v0}, LX/2rx;->A01()LX/2Sr;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v1, v0}, LX/2rP;->A04(Lcom/whatsapp/jid/UserJid;LX/2Sr;)Z
    ...
    invoke-virtual {v0, v2}, LX/0RU;->A04(LX/0YB;)V

    invoke-static {v0}, LX/0yN;->A0K(LX/0RU;)LX/0B0;

    move-result-object v3

    iget-object v0, p0, LX/2rP;->A05:LX/1pQ;
...
.method public A02(Landroid/os/CancellationSignal;)V
    ...
    const-string v15, "ExportEncryptionManager/maybeGenerateEncryptionKey(); "

    move-object/from16 v4, p0

    iget-object v3, v4, LX/2rP;->A00:LX/2tx;
    ...
    :try_start_0
    iget-object v6, v4, LX/2rP;->A03:LX/2rx;

    invoke-virtual {v6}, LX/2rx;->A01()LX/2Sr;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v4, v1, v0}, LX/2rP;->A04(Lcom/whatsapp/jid/UserJid;LX/2Sr;)Z
    ...
    const-string/jumbo v0, "reset prefetched key, a different user is now logged in or key is older"

    invoke-static {v1, v0}, LX/0yE;->A1G(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    invoke-virtual {v6}, LX/2rx;->A04()V

    iget-object v0, v4, LX/2rP;->A02:LX/2yy;
    ...
    iget-object v0, v4, LX/2rP;->A06:Ljava/security/SecureRandom;
    ...
    iget-object v1, v4, LX/2rP;->A02:LX/2yy;

    iget-object v14, v1, LX/2yy;->A00:LX/2tx;
    ...
    iget-object v9, v1, LX/2yy;->A02:LX/0Y6;

    const/4 v5, 0x0

    invoke-static {v10, v5}, LX/3dn;->A00(Ljava/lang/Object;I)LX/3dn;

    move-result-object v0

    invoke-virtual {v9, v0, v7, v11, v12}, LX/0Y6;->A05(Ljava/lang/Runnable;[B[BI)Z
    ...
    invoke-static {v0, v10}, LX/2yy;->A00(Landroid/os/CancellationSignal;Ljava/util/concurrent/CountDownLatch;)V
    :try_end_1
    ...
    iget-object v0, v1, LX/2yy;->A04:LX/2XB;
    ...
    check-cast v11, LX/2am;

    iget-object v0, v11, LX/2am;->A01:[B
    ...
    iget-object v1, v9, LX/2gK;->A00:Ljava/lang/String;

    iget-object v9, v9, LX/2gK;->A01:[B
    ...
    :goto_2
    iget-object v9, v11, LX/2am;->A02:[B
    ...
    invoke-direct/range {v16 .. v23}, LX/2Sr;-><init>(Lcom/whatsapp/jid/UserJid;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    :cond_7
    iget-object v1, v5, LX/2Sr;->A01:Lcom/whatsapp/jid/UserJid;

    invoke-virtual {v1}, Lcom/whatsapp/jid/Jid;->getRawString()Ljava/lang/String;

    iget-object v9, v5, LX/2Sr;->A05:Ljava/lang/String;

    iget-object v8, v5, LX/2Sr;->A02:Ljava/lang/String;

    iget-object v7, v5, LX/2Sr;->A04:Ljava/lang/String;

    iget-wide v2, v5, LX/2Sr;->A00:J

    iget-object v0, v6, LX/2rx;->A02:LX/8VC;
    ...
    iget-object v0, v5, LX/2Sr;->A03:Ljava/lang/String;
    ...
    invoke-direct {v0, v13, v1}, LX/1c1;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v2}, LX/1c1;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public A03(Landroid/os/CancellationSignal;Ljava/util/zip/ZipOutputStream;Z)V
    ...
    :goto_0
    invoke-virtual {v1}, LX/2tx;->A0G()Lcom/gbwhatsapp/Me;
    ...
    iget-object v5, v6, LX/2Sr;->A01:Lcom/whatsapp/jid/UserJid;
    ...
    iget-object v7, v6, LX/2Sr;->A05:Ljava/lang/String;
    ...
    iget-object v4, v6, LX/2Sr;->A02:Ljava/lang/String;
    ...
    iget-object v2, v6, LX/2Sr;->A04:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, p2}, LX/3cr;-><init>(Ljava/util/Map;Ljava/util/zip/ZipOutputStream;)V

    :try_start_1
    new-instance v0, LX/2bB;

    invoke-direct {v0, v7, v4, v2}, LX/2bB;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v4, "AES-GCM-v1"

    new-instance v2, LX/2yn;

    invoke-direct {v2, v0, v4, v6, v5}, LX/2yn;-><init>(LX/2bB;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v6, v3, LX/3cr;->A01:Landroid/util/JsonWriter;

    const-string v0, "data_id"

    invoke-virtual {v6, v0}, Landroid/util/JsonWriter;->name(Ljava/lang/String;)Landroid/util/JsonWriter;

    iget-object v0, v2, LX/2yn;->A01:Ljava/lang/String;

    invoke-virtual {v6, v0}, Landroid/util/JsonWriter;->value(Ljava/lang/String;)Landroid/util/JsonWriter;

    iget-object v1, v2, LX/2yn;->A03:Ljava/lang/String;
    ...
    iget-object v2, v2, LX/2yn;->A00:LX/2bB;

    iget-object v0, v2, LX/2bB;->A02:Ljava/lang/String;
    ...
    iget-object v0, v2, LX/2bB;->A00:Ljava/lang/String;
    ...
    iget-object v0, v2, LX/2bB;->A01:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/2rP;->A04:LX/2q4;
    ...
    invoke-direct {v5, v1, v0}, LX/3gx;-><init>(Landroid/database/Cursor;LX/43G;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    :goto_2
    :try_start_5
    invoke-virtual {v5}, LX/3gx;->hasNext()Z
    ...
    invoke-virtual {v5}, LX/3gx;->next()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LX/2Ss;

    iget-object v2, v1, LX/2Ss;->A03:Ljava/lang/String;
    ...
    iget-object v1, v1, LX/2Ss;->A04:Ljava/lang/String;
    ...
    :cond_5
    :try_start_6
    invoke-virtual {v5}, LX/3gx;->close()V
    ...
    :cond_6
    :goto_5
    invoke-virtual {v3}, LX/3cr;->close()V
    ...
    new-instance v2, LX/1c1;

    invoke-direct {v2, v1, v0}, LX/1c1;-><init>(ILjava/lang/String;)V

    throw v2
.end method

.method public A04(Lcom/whatsapp/jid/UserJid;LX/2Sr;)Z
    .locals 7
    ...
    iget-object v0, p2, LX/2Sr;->A01:Lcom/whatsapp/jid/UserJid;
