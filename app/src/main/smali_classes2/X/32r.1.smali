...
# direct methods
.method public constructor <init>(LX/2rn;LX/3Qm;LX/2tS;LX/35z;LX/2sc;LX/2uM;LX/2jv;LX/1QX;LX/48z;LX/2zt;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, LX/32r;->A06:LX/2tS;

    iput-object p8, p0, LX/32r;->A0B:LX/1QX;

    iput-object p1, p0, LX/32r;->A04:LX/2rn;

    iput-object p9, p0, LX/32r;->A0C:LX/48z;

    iput-object p2, p0, LX/32r;->A05:LX/3Qm;

    iput-object p6, p0, LX/32r;->A09:LX/2uM;

    iput-object p4, p0, LX/32r;->A07:LX/35z;

    iput-object p10, p0, LX/32r;->A0D:LX/2zt;

    iput-object p5, p0, LX/32r;->A08:LX/2sc;

    new-instance v0, LX/1Pl;

    invoke-direct {v0, p1, p2, p7, p10}, LX/1Pl;-><init>(LX/2rn;LX/3Qm;LX/2jv;LX/2zt;)V

    iput-object v0, p0, LX/32r;->A0A:LX/31O;

    return-void
.end method

.method public static A00([B)LX/3hm;
    .locals 3
    ...
    invoke-static {p0, v0, v0}, LX/38W;->A06([BII)[[B
    ...
    invoke-direct {v1, v0}, LX/3hk;-><init>([B)V
...
# virtual methods
.method public final A02(Landroid/content/SharedPreferences;LX/3hm;LX/3hm;I)I
    .locals 3
    ...
    iget-object v2, p0, LX/32r;->A0B:LX/1QX;
    ...
    invoke-virtual {p3}, LX/3hm;->A01()[B

    move-result-object v0

    invoke-virtual {p0, p1, v0}, LX/32r;->A0D(Landroid/content/SharedPreferences;[B)V

    invoke-virtual {p0, p1}, LX/32r;->A06(Landroid/content/SharedPreferences;)LX/3hm;
...
.method public declared-synchronized A03()LX/2JP;
    .locals 1

    monitor-enter p0

    :try_start_0
    invoke-virtual {p0}, LX/32r;->A04()LX/2JP;
...
.method public final declared-synchronized A04()LX/2JP;
    .locals 25
    ...
    :try_start_0
    invoke-virtual {v9}, LX/32r;->A0A()V

    iget-object v1, v9, LX/32r;->A00:LX/2JP;

    if-eqz v1, :cond_0

    iget-object v0, v1, LX/2JP;->A01:LX/3hm;

    if-nez v0, :cond_19

    :cond_0
    invoke-static {v9}, LX/2zt;->A01(LX/32r;)Landroid/content/SharedPreferences;

    move-result-object v8

    invoke-virtual {v9, v8}, LX/32r;->A06(Landroid/content/SharedPreferences;)LX/3hm;
    ...
    :cond_1
    iget-object v0, v9, LX/32r;->A01:LX/31O;
    ...
    iget-object v13, v9, LX/32r;->A0B:LX/1QX;
    ...
    invoke-virtual {v7}, LX/3hm;->A01()[B

    move-result-object v0

    invoke-virtual {v9, v0}, LX/32r;->A0J([B)Z
    ...
    :try_start_1
    invoke-virtual {v9, v0}, LX/32r;->A07(LX/1vC;)LX/3hm;
    ...
    invoke-static {v0, v2, v1, v3}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v9, v8, v7, v6, v15}, LX/32r;->A02(Landroid/content/SharedPreferences;LX/3hm;LX/3hm;I)I
    ...
    invoke-static {v1, v11, v0}, LX/0yF;->A0y(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;Z)V
    ...
    invoke-static {v8, v0, v4, v5}, LX/0yF;->A10(Landroid/content/SharedPreferences;Ljava/lang/String;J)V

    new-instance v10, LX/1T1;

    invoke-direct {v10}, LX/1T1;-><init>()V

    invoke-static {v2, v3}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v10, LX/1T1;->A01:Ljava/lang/Long;

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v10, LX/1T1;->A02:Ljava/lang/Long;
    ...
    invoke-static {v8, v0, v2, v3}, LX/0yF;->A10(Landroid/content/SharedPreferences;Ljava/lang/String;J)V
    ...
    iput-object v0, v1, LX/1T0;->A01:Ljava/lang/Long;

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v1, LX/1T0;->A02:Ljava/lang/Long;
    ...
    iput-object v0, v1, LX/1T0;->A00:Ljava/lang/Integer;

    iget-object v0, v9, LX/32r;->A0C:LX/48z;
    ...
    :goto_4
    invoke-virtual {v9, v10}, LX/32r;->A08(Z)LX/3hm;
    ...
    invoke-virtual {v13, v12, v2}, LX/2tw;->A0L(LX/2wY;I)I
    ...
    invoke-virtual {v9}, LX/32r;->A0B()V

    move-object/from16 v0, v21

    invoke-static {v8, v0}, LX/0yK;->A0C(Landroid/content/SharedPreferences;Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;
    ...
    invoke-virtual {v9, v0}, LX/32r;->A08(Z)LX/3hm;
    ...
    :cond_11
    invoke-static {v8, v4, v0, v1}, LX/0yF;->A10(Landroid/content/SharedPreferences;Ljava/lang/String;J)V
    ...
    invoke-virtual {v9, v2}, LX/32r;->A08(Z)LX/3hm;
    ...
    iput-object v0, v10, LX/1T1;->A00:Ljava/lang/Integer;
    ...
    invoke-static {v8, v1}, LX/0yE;->A0M(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v7, v2}, LX/2JP;-><init>(LX/3hm;I)V

    iput-object v1, v9, LX/32r;->A00:LX/2JP;
    :try_end_3
...
.method public declared-synchronized A05()LX/3hm;
    .locals 1
    ...
    iget-object v0, v0, LX/2JP;->A01:LX/3hm;
...
.method public final A06(Landroid/content/SharedPreferences;)LX/3hm;
    .locals 4
    ...
    :cond_0
    iget-object v1, p0, LX/32r;->A0A:LX/31O;

    sget-object v0, LX/1vC;->A01:LX/1vC;

    invoke-virtual {v1, v0, v2}, LX/31O;->A04(LX/1vC;LX/2ct;)[B
    ...
    :cond_1
    invoke-static {v1}, LX/32r;->A00([B)LX/3hm;
...
.method public final A07(LX/1vC;)LX/3hm;
    .locals 5

    invoke-static {p0}, LX/2zt;->A01(LX/32r;)Landroid/content/SharedPreferences;
    ...
    iget-object v0, p0, LX/32r;->A01:LX/31O;

    if-eqz v0, :cond_1

    invoke-virtual {v0, p1, v2}, LX/31O;->A04(LX/1vC;LX/2ct;)[B
    ...
    invoke-static {v4}, LX/32r;->A01(Landroid/content/SharedPreferences;)V
...
.method public final A08(Z)LX/3hm;
    .locals 4
    ...
    invoke-virtual {v3}, LX/3hm;->A01()[B

    move-result-object v1

    if-eqz p1, :cond_0

    invoke-virtual {p0, v1}, LX/32r;->A0J([B)Z
    ...
    :cond_0
    invoke-virtual {p0, v2, v1}, LX/32r;->A0D(Landroid/content/SharedPreferences;[B)V

    :cond_1
    iget-object v0, p0, LX/32r;->A07:LX/35z;
...
.method public declared-synchronized A09()LX/3hl;
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v2, p0, LX/32r;->A02:LX/3hl;
    ...
    :try_start_1
    iget-boolean v0, p0, LX/32r;->A03:Z
    ...
    invoke-direct {v0, v1}, LX/3hl;-><init>([B)V
    ...
    :cond_0
    :goto_0
    iput-object v2, p0, LX/32r;->A02:LX/3hl;

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/32r;->A03:Z
...
.method public final A0A()V
    ...
    iget-object v4, p0, LX/32r;->A0D:LX/2zt;
    ...
    iget-object v3, p0, LX/32r;->A0B:LX/1QX;
    ...
    :cond_0
    iget-object v2, p0, LX/32r;->A04:LX/2rn;

    iget-object v1, p0, LX/32r;->A05:LX/3Qm;

    new-instance v0, LX/1Pm;

    invoke-direct {v0, v2, v1, v3, v4}, LX/1Pm;-><init>(LX/2rn;LX/3Qm;LX/1QX;LX/2zt;)V

    :goto_0
    iput-object v0, p0, LX/32r;->A01:LX/31O;
...
.method public declared-synchronized A0B()V
    ...
    :try_start_0
    invoke-virtual {p0}, LX/32r;->A0A()V

    const-string v0, "clearing client static key pair"

    invoke-static {v0}, Lcom/whatsapp/util/Log;->i(Ljava/lang/String;)V

    iget-object v1, p0, LX/32r;->A0D:LX/2zt;
    ...
    invoke-virtual {v0}, LX/31O;->A03()V

    :cond_0
    iget-object v0, p0, LX/32r;->A08:LX/2sc;

    invoke-virtual {v0}, LX/2sc;->A02()V

    iget-object v0, p0, LX/32r;->A0A:LX/31O;

    invoke-virtual {v0}, LX/31O;->A03()V

    const/4 v0, 0x0

    iput-object v0, p0, LX/32r;->A00:LX/2JP;
...
.method public final A0D(Landroid/content/SharedPreferences;[B)V
    ...
    invoke-virtual {p0, p1, p2}, LX/32r;->A0G(Landroid/content/SharedPreferences;[B)Z
...
.method public declared-synchronized A0E(LX/3hl;)V
    .locals 4
    ...
    iget-object v1, p1, LX/3hl;->A01:[B
    ...
    iput-object p1, p0, LX/32r;->A02:LX/3hl;
...
.method public final A0F(Landroid/content/SharedPreferences;LX/31O;[B)Z
    .locals 4

    invoke-virtual {p2, p3}, LX/31O;->A02([B)LX/2ct;

    move-result-object v1

    const-string v0, "client_static_keypair_enc"

    invoke-virtual {p0, v1, v0}, LX/32r;->A0H(LX/2ct;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {p0, v1}, LX/32r;->A07(LX/1vC;)LX/3hm;
    ...
    :cond_0
    invoke-virtual {v0}, LX/3hm;->A01()[B
    ...
    invoke-static {p1}, LX/32r;->A01(Landroid/content/SharedPreferences;)V
...
.method public final A0G(Landroid/content/SharedPreferences;[B)Z
    ...
    invoke-virtual {v0, p2}, LX/31O;->A02([B)LX/2ct;
...
.method public final A0H(LX/2ct;Ljava/lang/String;)Z
    .locals 2
    ...
    invoke-virtual {p1}, LX/2ct;->A00()Ljava/lang/String;
...
.method public final A0I(LX/3hm;)Z
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p1}, LX/3hm;->A01()[B

    move-result-object v0

    invoke-virtual {p0, v1, v0}, LX/32r;->A0D(Landroid/content/SharedPreferences;[B)V
...
.method public final A0J([B)Z
    ...
    invoke-virtual {p0, v2, v0, p1}, LX/32r;->A0F(Landroid/content/SharedPreferences;LX/31O;[B)Z
