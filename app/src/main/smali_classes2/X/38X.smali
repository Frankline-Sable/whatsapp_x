...
.method public static A00(Landroid/os/CancellationSignal;Ljava/io/InputStream;)LX/34r;
    .locals 5
    ...
    invoke-direct {v0, v4, v2, v3, v1}, LX/34r;-><init>(IJI)V
...
.method public static A01(Landroid/os/CancellationSignal;LX/34r;Ljava/io/OutputStream;)V
    .locals 0

    :try_start_0
    invoke-virtual {p1, p0, p2}, LX/34r;->A00(Landroid/os/CancellationSignal;Ljava/io/OutputStream;)V
...
.method public static A02(Landroid/os/CancellationSignal;Ljava/io/File;Ljava/io/InputStream;[BJ)V
    ...
    invoke-direct {p0, p2, p4, p5}, LX/1up;-><init>(Ljava/io/InputStream;J)V
    ...
    :try_start_1
    invoke-static {p0, v0, p3}, LX/38X;->A04(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    :try_end_1
    ...
    :cond_0
    invoke-static {p1, p0, p4, p5}, LX/39T;->A0U(Ljava/io/File;Ljava/io/InputStream;J)Z
...
.method public static A03(LX/1da;Ljava/lang/Exception;)V
    .locals 3
    ...
    invoke-virtual {p0, v2}, LX/1da;->A07(I)V
...
.method public static A04(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    ...
    invoke-static {v2}, LX/0yO;->A07([B)Ljavax/crypto/spec/IvParameterSpec;
    ...
    :try_start_1
    invoke-static {p0, v0}, LX/39T;->A0K(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static A05(Ljava/io/InputStream;Ljava/io/OutputStream;[B)V
    ...
    invoke-static {v3}, LX/0yO;->A07([B)Ljavax/crypto/spec/IvParameterSpec;
    ...
    invoke-static {v0, p1}, LX/39T;->A0K(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {v0, v1, v2, v4}, LX/1uk;-><init>(Ljava/lang/String;Ljava/lang/Throwable;I)V
