...
.field public static final A04:LX/8VC;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/39L;->A04:LX/8VC;
...
.method public static A01(LX/2sU;)Ljava/lang/String;
    .locals 1

    invoke-static {p0}, LX/39J;->A06(Ljava/lang/Object;)V

    iget-object p0, p0, LX/2sU;->A00:Landroid/content/ContentResolver;
...
.method public static A09([B[BII)Ljavax/crypto/SecretKey;
    ...
    :cond_0
    invoke-static {v4, p1, v2, p2, p3}, LX/39L;->A08(Ljava/lang/String;[B[CII)Ljavax/crypto/SecretKey;
...
.method public static A0A(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, LX/0yI;->A1J(Ljava/io/File;Ljava/lang/String;)V

    return-void
.end method

.method public static A0B(Ljava/io/File;[B)V
    .locals 2

    invoke-static {p0}, LX/0yN;->A0n(Ljava/io/File;)Ljava/io/FileOutputStream;
...
.method public static A0C()Z
    ...
    sget-object v1, LX/39L;->A03:Ljava/lang/String;
    ...
    invoke-static {v7, v6, v8}, LX/0yK;->A1T(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/Locale;)Z

    move-result v0

    if-nez v0, :cond_21

    invoke-static {v7, v2, v8}, LX/0yK;->A1T(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/Locale;)Z

    move-result v0

    if-nez v0, :cond_21

    invoke-static {v7, v4, v8}, LX/0yK;->A1T(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/Locale;)Z

    move-result v0

    if-nez v0, :cond_21

    invoke-static {v7, v3, v8}, LX/0yK;->A1T(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/Locale;)Z
    ...
    sput-object v1, LX/39L;->A03:Ljava/lang/String;
...
.method public static A0D(Landroid/content/Context;Ljava/lang/String;[B)Z
    .locals 10
    ...
    invoke-static {p0, v2}, LX/39L;->A0L([BLjava/lang/String;)[B
    ...
    invoke-static {v9}, LX/0yO;->A07([B)Ljavax/crypto/spec/IvParameterSpec;

    move-result-object v0

    const/4 v3, 0x1

    invoke-static {v2, v0, v1, p2, v3}, LX/0yJ;->A1Z(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljavax/crypto/Cipher;[BI)[B
    ...
    invoke-static {v9, v2, v4}, LX/001;->A1I(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    invoke-static {v7, v6}, LX/39L;->A0B(Ljava/io/File;[B)V

    invoke-static {v7}, LX/39L;->A0K(Ljava/io/File;)[B
...
.method public static A0E(LX/35r;)Z
    .locals 9
    ...
    sget-object v0, LX/39L;->A02:Ljava/lang/Boolean;
    ...
    sput-object v0, LX/39L;->A02:Ljava/lang/Boolean;
    ...
    invoke-static {v2, v1, v5}, LX/0yK;->A1T(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/Locale;)Z
    ...
    invoke-virtual {p0}, LX/35r;->A0G()Landroid/net/ConnectivityManager;
...
.method public static A0I(I)[B
    .locals 0

    invoke-static {p0}, LX/24G;->A01(I)[B
...
.method public static A0J(Landroid/content/Context;Ljava/lang/String;)[B
    .locals 11
    ...
    invoke-static {v3}, LX/39L;->A0K(Ljava/io/File;)[B
    ...
    invoke-static {v0, p0}, LX/39L;->A0L([BLjava/lang/String;)[B
    ...
    invoke-static {v3, v1}, LX/000;->A17(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    :cond_2
    invoke-static {v1}, LX/0yN;->A0z(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    ...
    return-object v0
    :try_end_2
    .catch LX/1yc; {:try_start_2 .. :try_end_2} :catch_1
...
.method public static A0K(Ljava/io/File;)[B
    .locals 5
...
.method public static A0L([BLjava/lang/String;)[B
    .locals 8
    ...
    :cond_0
    invoke-static {v6, p0, v2, v5, v4}, LX/39L;->A08(Ljava/lang/String;[B[CII)Ljavax/crypto/SecretKey;
...
.method public static varargs A0M([B[[B)[B
    .locals 3

    const-string v0, "HmacSHA1"

    :try_start_0
    invoke-static {v0, p0}, LX/0yG;->A0h(Ljava/lang/String;[B)Ljavax/crypto/Mac;
