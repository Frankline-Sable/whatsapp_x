...
# direct methods
.method public constructor <init>(LX/2tx;LX/2Yw;LX/35r;LX/35z;LX/35t;LX/2zt;LX/49C;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/359;->A00:LX/2tx;

    iput-object p7, p0, LX/359;->A06:LX/49C;

    iput-object p3, p0, LX/359;->A02:LX/35r;

    iput-object p5, p0, LX/359;->A04:LX/35t;

    iput-object p2, p0, LX/359;->A01:LX/2Yw;

    iput-object p4, p0, LX/359;->A03:LX/35z;

    iput-object p6, p0, LX/359;->A05:LX/2zt;

    return-void
.end method

.method public static final A00(LX/2sU;Ljava/lang/String;Ljava/util/ArrayList;)Z
    .locals 2

    :try_start_0
    const-string v1, "com.android.contacts"

    invoke-virtual {p0}, LX/2sU;->A02()Landroid/content/ContentResolver;
    ...
    invoke-static {v0, p1, v1, p0}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
    :try_end_1
...
.method public final A01(Landroid/accounts/AccountManager;Landroid/content/Context;)Landroid/accounts/Account;
    ...
    iget-object v0, p0, LX/359;->A00:LX/2tx;
...
.method public A02(Landroid/content/Context;)Landroid/accounts/Account;
    ...
    invoke-virtual {p0, v5, p1}, LX/359;->A01(Landroid/accounts/AccountManager;Landroid/content/Context;)Landroid/accounts/Account;
...
.method public final declared-synchronized A03(Landroid/accounts/Account;Landroid/content/Context;)V
    ...
    invoke-static {v0, v2, v1}, LX/0yJ;->A0H(Landroid/net/Uri$Builder;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v4, v3, LX/359;->A02:LX/35r;
    ...
    invoke-virtual/range {v16 .. v21}, LX/2sU;->A03(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v11, v8}, LX/0yK;->A0Q(Landroid/database/Cursor;I)Lcom/whatsapp/jid/UserJid;
    ...
    invoke-direct {v0, v2, v1, v5, v6}, LX/2aS;-><init>(Lcom/whatsapp/jid/UserJid;Ljava/lang/String;J)V
    ...
    invoke-static {v1, v0, v5}, LX/359;->A00(LX/2sU;Ljava/lang/String;Ljava/util/ArrayList;)Z

    :cond_3
    iget-object v2, v3, LX/359;->A04:LX/35t;

    iget-object v0, v6, LX/2aS;->A01:Lcom/whatsapp/jid/UserJid;
    ...
    invoke-static {v9, v8, v7, v0}, LX/0yG;->A0W(Landroid/content/Context;Ljava/lang/Object;II)Ljava/lang/String;
    ...
    invoke-static {v1, v0, v6, v5}, LX/0yF;->A0o(Landroid/content/ContentProviderOperation$Builder;Ljava/lang/Object;Ljava/lang/String;Ljava/util/AbstractCollection;)V
