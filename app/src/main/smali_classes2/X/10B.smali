...
# direct methods
.method public constructor <init>(Landroid/os/Looper;LX/2pP;LX/2fd;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;)V

    iput-object p2, p0, LX/10B;->A01:LX/2pP;

    iput-object p3, p0, LX/10B;->A02:LX/2fd;
...
.method public final declared-synchronized A00()V
    ...
    :try_start_0
    iget-object v0, p0, LX/10B;->A00:Ljava/io/File;

    if-nez v0, :cond_1

    iget-object v0, p0, LX/10B;->A01:LX/2pP;
    ...
    iput-object v2, p0, LX/10B;->A00:Ljava/io/File;
    ...
    :try_start_1
    invoke-static {v2}, LX/21w;->A00(Ljava/io/File;)[B
    ...
    sget-object v4, LX/2vu;->A00:Ljava/util/HashMap;
    ...
    invoke-static {v0, v4, v1, v2}, LX/0yG;->A19(Ljava/lang/Object;Ljava/util/AbstractMap;J)V

    goto :goto_0

    :cond_0
    sget-object v4, LX/2vu;->A01:Ljava/util/HashMap;
...
.method public declared-synchronized handleMessage(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-virtual {p0}, LX/10B;->A00()V
    ...
    :goto_1
    sget-object v3, LX/2vu;->A00:Ljava/util/HashMap;
    ...
    :goto_2
    sget-object v3, LX/2vu;->A01:Ljava/util/HashMap;
    ...
    iget-object v2, p0, LX/10B;->A00:Ljava/io/File;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2

    :try_start_2
    iget-object v0, p0, LX/10B;->A02:LX/2fd;

    iget-object v1, v0, LX/2fd;->A00:LX/2iD;

    new-instance v0, LX/1v0;

    invoke-direct {v0, v1, v2}, LX/1v0;-><init>(LX/2iD;Ljava/io/File;)V
    :try_end_2
    ...
    :try_start_3
    invoke-static {v3, v0}, LX/0yG;->A1D(Ljava/lang/String;Ljava/io/OutputStream;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
