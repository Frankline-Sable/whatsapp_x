...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/1ki;->A05:Ljava/util/Set;

    invoke-static {}, LX/6e6;->create()LX/6e6;

    move-result-object v0

    iput-object v0, p0, LX/1ki;->A03:LX/8c1;

    const/4 v0, -0x1

    iput v0, p0, LX/1ki;->A00:I

    iput-object v1, p0, LX/1ki;->A04:Ljava/lang/String;
...
.method public final A00()V
    ...
    :try_start_0
    iget-object v0, p0, LX/1ki;->A03:LX/8c1;
    ...
    iget-object v0, p0, LX/1ki;->A05:Ljava/util/Set;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iput v12, p0, LX/1ki;->A00:I

    :cond_0
    iget-object v3, p0, LX/1ki;->A05:Ljava/util/Set;
    ...
    iget-object v5, v9, Lcom/gbwhatsapp/migration/export/service/MessagesExporterService;->A00:LX/2tP;

    monitor-enter v5

    :try_start_1
    iget-object v0, v5, LX/2tP;->A00:Landroid/os/CancellationSignal;

    if-nez v0, :cond_4

    iget-object v1, v5, LX/2tP;->A01:Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v0, v9, Lcom/gbwhatsapp/migration/export/service/MessagesExporterService;->A00:LX/2tP;
    ...
    iget-object v4, v9, LX/1ki;->A01:LX/2rn;
    ...
    :goto_2
    invoke-virtual {v4, v1, v6, v0}, LX/2rn;->A0B(Ljava/lang/String;ZLjava/lang/String;)V

    goto :goto_0

    :cond_7
    invoke-static {p1, v4}, LX/0yH;->A1S(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    iget-object v0, v9, Lcom/gbwhatsapp/migration/export/service/MessagesExporterService;->A01:LX/2mT;

    invoke-virtual {v0}, LX/2mT;->A00()LX/0VP;

    move-result-object v4

    iget-object v0, v0, LX/2mT;->A00:LX/2pP;
    ...
    invoke-virtual {v4, v0}, LX/0VP;->A0B(Ljava/lang/CharSequence;)V
    ...
    new-instance v10, LX/3e2;

    invoke-direct {v10, v9, v0, p1}, LX/3e2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v1, v9, Lcom/gbwhatsapp/migration/export/service/MessagesExporterService;->A00:LX/2tP;
    ...
    invoke-direct {v10, v1, v0}, LX/3dr;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, v9, LX/1ki;->A04:Ljava/lang/String;
    ...
    iget-object v0, v9, LX/1ki;->A02:LX/49C;

    const/4 v13, 0x6

    new-instance v8, LX/3ef;

    invoke-direct/range {v8 .. v13}, LX/3ef;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;II)V
    ...
    :try_start_2
    iget-object v0, v9, LX/1ki;->A03:LX/8c1;

    invoke-interface {v0, v2}, LX/8c1;->add(Ljava/lang/Object;)Z
