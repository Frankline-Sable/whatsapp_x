...
.field public final A03:LX/2aO;


# direct methods
.method public constructor <init>(LX/2rn;LX/1QX;LX/2VV;LX/2aO;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LX/38J;->A01:LX/1QX;

    iput-object p1, p0, LX/38J;->A00:LX/2rn;

    iput-object p4, p0, LX/38J;->A03:LX/2aO;

    iput-object p3, p0, LX/38J;->A02:LX/2VV;
...
.method public static A00(Lcom/whatsapp/jid/Jid;Ljava/io/OutputStream;)V
    ...
    invoke-static {p1, v0, v2, v2}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V
    ...
    invoke-static {p1, v0, v1, v2}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V
    ...
    :cond_5
    invoke-static {p1, v1}, LX/38J;->A02(Ljava/io/OutputStream;I)V

    invoke-virtual {p0}, Lcom/whatsapp/jid/Jid;->getDevice()I

    move-result v0

    invoke-static {p1, v0}, LX/38J;->A02(Ljava/io/OutputStream;I)V

    iget-object v1, p0, Lcom/whatsapp/jid/Jid;->user:Ljava/lang/String;

    const/4 v0, 0x1

    invoke-static {p1, v1, v0, v2}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V

    return-void
.end method

.method public static A01(LX/38n;Ljava/io/OutputStream;)V
    .locals 10
    ...
    :cond_1
    iget-object v8, p0, LX/38n;->A01:[B
    ...
    invoke-static {p1, v0}, LX/38J;->A03(Ljava/io/OutputStream;I)V

    iget-object v0, p0, LX/38n;->A00:Ljava/lang/String;

    invoke-static {p1, v0, v6, v9}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V
    ...
    invoke-static {p1, v0, v6, v6}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V

    iget-object v1, v2, LX/3CP;->A01:Lcom/whatsapp/jid/Jid;

    iget-byte v0, v2, LX/3CP;->A00:B
    ...
    invoke-static {v1, p1}, LX/38J;->A00(Lcom/whatsapp/jid/Jid;Ljava/io/OutputStream;)V
    ...
    invoke-static {p1, v0, v9, v9}, LX/38J;->A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V
    ...
    invoke-static {p1, v8, v6}, LX/38J;->A05(Ljava/io/OutputStream;[BZ)V
    ...
    invoke-static {p1, v1}, LX/38J;->A03(Ljava/io/OutputStream;I)V

    :goto_3
    aget-object v0, v7, v6

    invoke-static {v0, p1}, LX/38J;->A01(LX/38n;Ljava/io/OutputStream;)V
...
.method public static A02(Ljava/io/OutputStream;I)V
    ...
    invoke-static {v0, p0, p1}, LX/000;->A0X(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/String;
...
.method public static A03(Ljava/io/OutputStream;I)V
    ...
    invoke-static {p0, p1}, LX/38J;->A02(Ljava/io/OutputStream;I)V
...
.method public static A04(Ljava/io/OutputStream;Ljava/lang/String;ZZ)V
    ...
    sget-object v0, LX/25j;->A00:Ljava/util/Map;

    if-nez v0, :cond_6

    const-class v8, LX/25j;
    ...
    invoke-direct {v0, v3, v2, v3}, LX/2OP;-><init>(IIZ)V
    ...
    invoke-direct {v0, v2, v4, v1}, LX/2OP;-><init>(IIZ)V
    ...
    :cond_4
    sput-object v7, LX/25j;->A00:Ljava/util/Map;
    ...
    invoke-static {v1, p0}, LX/38J;->A00(Lcom/whatsapp/jid/Jid;Ljava/io/OutputStream;)V
    ...
    :goto_5
    invoke-static {p0, v0, p2}, LX/38J;->A05(Ljava/io/OutputStream;[BZ)V

    return-void

    :cond_b
    iget-boolean v0, v2, LX/2OP;->A02:Z

    if-eqz v0, :cond_c

    iget-short v1, v2, LX/2OP;->A01:S
...
.method public static A05(Ljava/io/OutputStream;[BZ)V
    ...
    invoke-static {p0, v5}, LX/38J;->A02(Ljava/io/OutputStream;I)V
...
.method public A06(LX/38n;)V
    ...
    iget-object v1, p0, LX/38J;->A03:LX/2aO;

    array-length v0, v2

    invoke-virtual {v1, v2, v0}, LX/2aO;->A00([BI)V
