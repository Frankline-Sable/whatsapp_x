...
.method public constructor <init>(Lcom/whatsapp/jid/UserJid;IZZZ)V
    ...
    invoke-static {p1}, LX/34k;->A00(Lcom/whatsapp/jid/UserJid;)Lcom/whatsapp/jid/DeviceJid;
    ...
    invoke-direct {v0, v1, p4, p5}, LX/2lv;-><init>(Lcom/whatsapp/jid/DeviceJid;ZZ)V

    invoke-static {v0}, Ljava/util/Collections;->singleton(Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v0

    invoke-direct {p0, p1, v0, p2, p3}, LX/30t;-><init>(Lcom/whatsapp/jid/UserJid;Ljava/util/Set;IZ)V
...
.method public constructor <init>(Lcom/whatsapp/jid/UserJid;Ljava/util/Set;IZ)V
    ...
    iput-object v0, p0, LX/30t;->A04:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, LX/30t;->A03:Lcom/whatsapp/jid/UserJid;
    ...
    iget-object v1, p0, LX/30t;->A04:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    iput p3, p0, LX/30t;->A01:I

    iput-boolean p4, p0, LX/30t;->A02:Z

    return-void
.end method

.method public static A00(LX/30t;)LX/81a;
    .locals 0

    iget-object p0, p0, LX/30t;->A04:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget v1, p0, LX/30t;->A01:I

    iget v0, p1, LX/30t;->A01:I

    if-ne v1, v0, :cond_1

    iget-boolean v1, p0, LX/30t;->A02:Z

    iget-boolean v0, p1, LX/30t;->A02:Z

    if-ne v1, v0, :cond_1

    iget-object v1, p0, LX/30t;->A03:Lcom/whatsapp/jid/UserJid;
...
.method public hashCode()I
    ...
    iget-object v0, p0, LX/30t;->A03:Lcom/whatsapp/jid/UserJid;

    invoke-static {v0}, LX/0yK;->A03(Ljava/lang/Object;)I

    move-result v1

    iget-object v0, p0, LX/30t;->A04:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-static {v0, v1}, LX/000;->A07(Ljava/lang/Object;I)I

    move-result v1

    iget v0, p0, LX/30t;->A01:I

    add-int/2addr v1, v0

    mul-int/lit8 v1, v1, 0x1f

    iget-boolean v0, p0, LX/30t;->A02:Z
