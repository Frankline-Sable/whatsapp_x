...
.method public constructor <init>(LX/2tS;LX/1O1;)V
    ...
    iput-object p1, p0, LX/2yI;->A00:LX/2tS;

    iput-object p2, p0, LX/2yI;->A01:LX/1O1;
...
# virtual methods
.method public A01(LX/2pc;)LX/2Hl;
    .locals 13
    ...
    invoke-static {v3, v0, p1}, LX/0yE;->A1N(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v0, p0, LX/2yI;->A01:LX/1O1;
    ...
    :cond_0
    :try_start_3
    invoke-static {v5, v2}, LX/0yG;->A1Z(Landroid/database/Cursor;Ljava/lang/String;)[B

    move-result-object v4

    invoke-static {v5, v1}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J

    move-result-wide v1

    new-instance v0, LX/2Hl;

    invoke-direct {v0, v4, v1, v2}, LX/2Hl;-><init>([BJ)V
    :try_end_3
