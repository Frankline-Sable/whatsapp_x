...
.field public final A01:LX/20D;

.field public final A02:LX/2iS;


# direct methods
.method public constructor <init>(LX/20D;LX/2iS;)V
    .locals 1
    ...
    iput-object p2, p0, LX/2so;->A02:LX/2iS;

    iput-object p1, p0, LX/2so;->A01:LX/20D;
...
# virtual methods
.method public final A00(LX/2lx;LX/3cx;Lcom/whatsapp/jid/Jid;)I
    .locals 8

    iget-object v2, p2, LX/3cx;->A02:LX/2tm;

    const-string v4, "cart_item"

    invoke-virtual {p0, p1, p3}, LX/2so;->A01(LX/2lx;Lcom/whatsapp/jid/Jid;)Landroid/content/ContentValues;
    ...
    invoke-static {p3, v7, v0}, LX/0yH;->A11(Lcom/whatsapp/jid/Jid;[Ljava/lang/Object;I)V
    ...
    invoke-virtual/range {v2 .. v7}, LX/2tm;->A06(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public final A01(LX/2lx;Lcom/whatsapp/jid/Jid;)Landroid/content/ContentValues;
    .locals 9

    iget-object v2, p1, LX/2lx;->A02:LX/3CR;

    iget-object v4, v2, LX/3CR;->A06:Ljava/math/BigDecimal;
    ...
    invoke-static {v3}, LX/0yI;->A0b(Ljava/lang/Number;)Ljava/lang/Long;

    move-result-object v8

    :goto_0
    iget-object v6, v2, LX/3CR;->A02:LX/3BS;

    if-eqz v6, :cond_4

    iget-object v4, v6, LX/3BS;->A01:Ljava/math/BigDecimal;
    ...
    iget-object v0, v6, LX/3BS;->A03:Ljava/util/Date;
    ...
    :goto_1
    iget-object v0, v6, LX/3BS;->A02:Ljava/util/Date;
    ...
    :goto_2
    iget-object v0, v2, LX/3CR;->A04:LX/35K;

    if-eqz v0, :cond_0

    iget-object v7, v0, LX/35K;->A00:Ljava/lang/String;
    ...
    invoke-static {v6, p2, v0}, LX/0yG;->A0k(Landroid/content/ContentValues;Lcom/whatsapp/jid/Jid;Ljava/lang/String;)V

    iget-object v1, v2, LX/3CR;->A0F:Ljava/lang/String;

    const-string/jumbo v0, "product_id"

    invoke-virtual {v6, v0, v1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, LX/3CR;->A05:Ljava/lang/String;

    const-string/jumbo v0, "product_title"
    ...
    const-string/jumbo v0, "product_currency_code"

    invoke-virtual {v6, v0, v7}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v1, 0x0

    iget-object v0, v2, LX/3CR;->A07:Ljava/util/List;
    ...
    :goto_3
    const-string/jumbo v0, "product_image_id"

    invoke-virtual {v6, v0, v1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v0, p1, LX/2lx;->A00:J

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    const-string/jumbo v0, "product_quantity"
    ...
    iget-object v0, v2, LX/3CR;->A0B:LX/5gE;
    ...
    iget-object v0, v3, LX/5fu;->A01:Ljava/lang/String;
...
.method public final A02(Landroid/database/Cursor;)LX/2lx;
    .locals 35
    ...
    const-string/jumbo v1, "product_price_1000"
    ...
    :goto_0
    const-string/jumbo v1, "product_currency_code"

    invoke-static {v0, v1}, LX/0yG;->A0X(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v1, "product_quantity"

    invoke-static {v0, v1}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J

    move-result-wide v31

    const-string/jumbo v1, "product_total_variant_quantity"

    invoke-static {v0, v1}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J

    move-result-wide v33

    const-string/jumbo v1, "product_image_id"

    invoke-static {v0, v1}, LX/0yG;->A0X(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v26

    const-string/jumbo v1, "product_sale_price_1000"
    ...
    :goto_1
    const-string/jumbo v1, "product_sale_start_date"
    ...
    :goto_2
    const-string/jumbo v1, "product_sale_end_date"
    ...
    :goto_3
    const-string/jumbo v1, "product_max_available"
    ...
    invoke-direct {v13, v3}, LX/35K;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v13, v1, v2}, LX/2vn;->A00(LX/35K;J)Ljava/math/BigDecimal;
    ...
    new-instance v11, LX/3BS;

    invoke-direct {v11, v13, v5, v4, v3}, LX/3BS;-><init>(LX/35K;Ljava/math/BigDecimal;Ljava/util/Date;Ljava/util/Date;)V
    ...
    invoke-direct/range {v25 .. v30}, LX/3BY;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct {v1, v13, v5, v11, v11}, LX/3BS;-><init>(LX/35K;Ljava/math/BigDecimal;Ljava/util/Date;Ljava/util/Date;)V
    ...
    :cond_8
    invoke-static {v0, v2}, LX/0yH;->A0W(Landroid/database/Cursor;I)Ljava/lang/Long;
    ...
    invoke-direct {v0, v5, v4}, LX/5fu;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v12, v9, v9, v9, v2}, LX/5gE;-><init>(LX/5fs;LX/5g2;Ljava/util/List;Ljava/util/List;)V
    ...
    new-instance v29, LX/2lx;

    move-object/from16 v30, v8

    invoke-direct/range {v29 .. v34}, LX/2lx;-><init>(LX/3CR;JJ)V

    return-object v29
.end method

.method public final A03(Lcom/whatsapp/jid/Jid;Ljava/lang/String;)LX/2lx;
    .locals 7
    ...
    iget-object v0, p0, LX/2so;->A02:LX/2iS;
    ...
    invoke-virtual {p0, v2}, LX/2so;->A02(Landroid/database/Cursor;)LX/2lx;
...
.method public final A04(Lcom/whatsapp/jid/Jid;)Ljava/util/concurrent/Future;
    ...
    const-string v2, "SELECT product_id, product_title, product_price_1000, product_currency_code, product_image_id, product_quantity, product_sale_price_1000, product_sale_start_date, product_sale_end_date, product_max_available, product_variant_props, product_total_variant_quantity FROM cart_item WHERE business_id=?"
    ...
    invoke-virtual {v4, v0}, LX/3hG;->BJr(Ljava/lang/Exception;)V

    return-object v4
.end method

.method public final A05(LX/2lx;Lcom/whatsapp/jid/Jid;)V
    .locals 8
    ...
    invoke-static {v0, v1, v2}, LX/0yH;->A18(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v7, v0, v1, v2}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {p0, p1, v5, p2}, LX/2so;->A00(LX/2lx;LX/3cx;Lcom/whatsapp/jid/Jid;)I

    goto :goto_1

    :cond_2
    invoke-virtual {p0, p1, p2}, LX/2so;->A01(LX/2lx;Lcom/whatsapp/jid/Jid;)Landroid/content/ContentValues;
    ...
    invoke-virtual {v7, v0, v1, v2}, LX/2tm;->A08(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
