...
# direct methods
.method public constructor <init>(LX/2rn;LX/3Qm;LX/1QX;LX/2zt;)V
    .locals 0

    invoke-direct {p0, p1, p2, p4}, LX/31O;-><init>(LX/2rn;LX/3Qm;LX/2zt;)V

    iput-object p3, p0, LX/1Pm;->A01:LX/1QX;
...
.method public A02([B)LX/2ct;
    ...
    :try_start_0
    invoke-virtual {p0}, LX/1Pm;->A05()Ljava/security/KeyStore;
    ...
    invoke-virtual {p0}, LX/1Pm;->A06()Ljavax/crypto/SecretKey;
    ...
    invoke-direct/range {v4 .. v9}, LX/2ct;-><init>(Ljava/lang/String;[B[B[BI)V
    ...
    invoke-static {}, LX/1Pm;->A00()Ljava/lang/StringBuilder;
    ...
    :cond_3
    invoke-virtual {p0, v3, v2}, LX/31O;->A01(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public A04(LX/1vC;LX/2ct;)[B
    ...
    iget-object v0, p2, LX/2ct;->A03:[B
    ...
    iget-object v0, p2, LX/2ct;->A02:[B
    ...
    :cond_2
    invoke-virtual {p0, v1, v3}, LX/31O;->A01(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final A05()Ljava/security/KeyStore;
    ...
    iget-object v0, p0, LX/1Pm;->A00:Ljava/security/KeyStore;

    if-eqz v0, :cond_0

    iget-object v2, p0, LX/1Pm;->A01:LX/1QX;
    ...
    iput-object v1, p0, LX/1Pm;->A00:Ljava/security/KeyStore;
...
.method public final A06()Ljavax/crypto/SecretKey;
    ...
    invoke-virtual {p0, v0}, LX/1Pm;->A07(Ljava/security/KeyStore;)Ljavax/crypto/SecretKey;
    ...
    invoke-virtual {p0, v0, v2}, LX/31O;->A01(Ljava/lang/String;Ljava/lang/Throwable;)V
