...
# direct methods
.method public constructor <init>(LX/1da;Ljava/lang/String;Ljava/lang/String;Ljava/net/Socket;)V
    .locals 1
    ...
    iput-object p4, p0, LX/1pM;->A03:Ljava/net/Socket;

    iput-object p1, p0, LX/1pM;->A00:LX/1da;
...
.method public run()V
    ...
    iget-object v3, p0, LX/1pM;->A03:Ljava/net/Socket;
    ...
    iget-object v1, p0, LX/1pM;->A01:Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v5, v1}, LX/1cA;-><init>([B[BI)V

    invoke-static {v5, v0, v3}, LX/38X;->A01(Landroid/os/CancellationSignal;LX/34r;Ljava/io/OutputStream;)V

    iget-object v0, p0, LX/1pM;->A00:LX/1da;

    invoke-virtual {v0, v4, v3}, LX/1da;->A09(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    iget-object v1, p0, LX/1pM;->A00:LX/1da;

    const/16 v0, 0x25c

    invoke-virtual {v1, v0}, LX/1da;->A07(I)V

    iget-object v0, p0, LX/1pM;->A03:Ljava/net/Socket;
