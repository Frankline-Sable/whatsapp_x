...
# direct methods
.method public constructor <init>(LX/2rn;LX/2tS;LX/3QF;LX/36x;LX/3hX;LX/36z;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LX/356;->A01:LX/2tS;

    iput-object p4, p0, LX/356;->A03:LX/36x;

    iput-object p1, p0, LX/356;->A00:LX/2rn;

    iput-object p3, p0, LX/356;->A02:LX/3QF;

    iput-object p5, p0, LX/356;->A04:LX/3hX;

    iput-object p6, p0, LX/356;->A05:LX/36z;
...
.method public static A00(JJ)J
    ...
    invoke-static {v0, v1, p2, p3}, LX/0yE;->A11(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    ...
    invoke-static {p0, p1}, LX/0yI;->A09(J)J
...
.method public static A01(Landroid/database/Cursor;Z)J
    ...
    :cond_2
    invoke-static {p0, v5}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J
...
# virtual methods
.method public A02(Landroid/database/Cursor;LX/3cx;LX/1af;)LX/2q9;
    .locals 12
    ...
    invoke-static {p1, v11}, LX/356;->A01(Landroid/database/Cursor;Z)J

    move-result-wide v9

    move-object v6, p3

    invoke-static {p3}, LX/39K;->A0J(Lcom/whatsapp/jid/Jid;)Z
    ...
    iget-object v0, p0, LX/356;->A04:LX/3hX;

    invoke-static {p2, v0}, LX/0zb;->A01(LX/3cx;LX/3hX;)Z
    ...
    iget-object v2, p0, LX/356;->A03:LX/36x;
    ...
    invoke-direct/range {v5 .. v11}, LX/2q9;-><init>(LX/1af;Lcom/whatsapp/jid/UserJid;Ljava/lang/String;JZ)V

    return-object v5
.end method

.method public A03(LX/1af;)LX/37W;
    .locals 17
    ...
    iget-object v2, v3, LX/356;->A05:LX/36z;

    const/4 v0, 0x0

    move-object/from16 v6, p1

    invoke-virtual {v2, v6, v5, v0}, LX/36z;->A09(LX/1af;Ljava/util/Set;Z)Ljava/util/List;
    ...
    invoke-virtual {v2, v6, v5, v1}, LX/36z;->A09(LX/1af;Ljava/util/Set;Z)Ljava/util/List;

    move-result-object v0

    invoke-virtual {v4, v0}, Ljava/util/AbstractCollection;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v3, v6, v1}, LX/356;->A04(LX/1af;Z)LX/37W;
    ...
    instance-of v0, v6, LX/43B;

    if-eqz v0, :cond_1

    check-cast v6, LX/43B;

    invoke-interface {v6}, LX/43B;->B30()LX/37W;

    move-result-object v0

    invoke-static {v3, v0}, LX/37W;->A01(LX/37W;LX/37W;)LX/37W;
    ...
    iget-wide v0, v6, LX/35c;->A04:J

    invoke-static {v4, v5, v0, v1}, LX/356;->A00(JJ)J

    move-result-wide v14

    iget-object v0, v6, LX/1PR;->A02:LX/30h;
    ...
    iget-object v0, v6, LX/1PR;->A01:LX/1af;
    ...
    :goto_1
    new-instance v10, LX/2q9;

    move/from16 v16, v1

    invoke-direct/range {v10 .. v16}, LX/2q9;-><init>(LX/1af;Lcom/whatsapp/jid/UserJid;Ljava/lang/String;JZ)V
    ...
    invoke-virtual {v6}, LX/35c;->A09()Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v10}, LX/37W;-><init>(Ljava/util/Set;Ljava/util/Set;JJ)V

    invoke-static {v3, v4}, LX/37W;->A01(LX/37W;LX/37W;)LX/37W;
...
.method public A04(LX/1af;Z)LX/37W;
    .locals 18

    move-object/from16 v12, p0

    iget-object v3, v12, LX/356;->A02:LX/3QF;
    ...
    iget-object v6, v3, LX/3QF;->A0Z:LX/2tv;

    move-object/from16 v13, p1

    invoke-static {v6, v13, v4}, LX/2tv;->A01(LX/2tv;LX/1af;[Ljava/lang/Object;)V

    iget-object v7, v3, LX/3QF;->A0O:LX/2tS;
    ...
    iget-object v8, v3, LX/3QF;->A1B:LX/3hX;

    invoke-virtual {v8}, LX/3hX;->A04()LX/3cx;
    ...
    invoke-static {v6, v13, v9}, LX/2tv;->A01(LX/2tv;LX/1af;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v4, v2, v9}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v9, v12, LX/356;->A04:LX/3hX;
    ...
    invoke-static {v6, v13, v11}, LX/2tv;->A01(LX/2tv;LX/1af;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v8, v7, v6, v11}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {v12, v11, v10, v13}, LX/356;->A02(Landroid/database/Cursor;LX/3cx;LX/1af;)LX/2q9;

    move-result-object v9

    if-eqz v9, :cond_4

    iget-wide v7, v9, LX/2q9;->A00:J
    ...
    invoke-direct/range {v5 .. v11}, LX/37W;-><init>(Ljava/util/Set;Ljava/util/Set;JJ)V
