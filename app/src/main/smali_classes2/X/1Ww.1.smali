...
# direct methods
.method public constructor <init>(LX/21A;LX/35z;LX/2sb;LX/2Sf;LX/1Wp;Ljava/io/RandomAccessFile;Ljava/lang/String;I)V
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, LX/2sz;-><init>(LX/21A;LX/2Sf;LX/1Wp;Ljava/io/RandomAccessFile;II)V
    ...
    invoke-direct {v0, p2, p3, p5}, LX/2oS;-><init>(LX/35z;LX/2sb;LX/1Wp;)V

    iput-object v0, p0, LX/1Ww;->A01:LX/2oS;

    iput-object p7, p0, LX/1Ww;->A02:Ljava/lang/String;
...
.method public A02()V
    ...
    invoke-super {p0}, LX/2sz;->A02()V

    iget-object v1, p0, LX/1Ww;->A01:LX/2oS;

    iget-object v0, p0, LX/1Ww;->A02:Ljava/lang/String;

    invoke-virtual {v1, v0}, LX/2oS;->A00(Ljava/lang/String;)V
...
.method public A04(Ljava/util/List;)V
    ...
    iget-object v7, p0, LX/1Ww;->A01:LX/2oS;
    ...
    iget-object v0, v7, LX/2oS;->A02:Ljava/util/HashMap;
    ...
    check-cast v2, LX/307;

    iget v0, v2, LX/307;->A05:I

    if-ne v3, v0, :cond_1

    iget-object v1, v2, LX/307;->A04:Ljava/util/ArrayList;

    invoke-static {v1, v5}, LX/0yN;->A0S(Ljava/util/AbstractList;I)LX/2NO;

    move-result-object v0

    const/16 v4, 0x8

    iput v4, v0, LX/2NO;->A01:I
    ...
    iput-boolean v3, v0, LX/2NO;->A02:Z

    :try_start_0
    iget-object v2, v2, LX/307;->A07:Ljava/io/RandomAccessFile;
    ...
    :cond_3
    iget-object v8, v7, LX/2oS;->A04:[Z

    aget-boolean v0, v8, v6

    if-eqz v0, :cond_7

    iget-object v5, v7, LX/2oS;->A02:Ljava/util/HashMap;
    ...
    check-cast v10, LX/307;

    invoke-interface {v0}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;

    move-result-object v4

    iget v0, v10, LX/307;->A05:I
    ...
    :goto_1
    iget v0, v10, LX/307;->A01:I

    if-ge v9, v0, :cond_6

    iget-object v0, v10, LX/307;->A04:Ljava/util/ArrayList;

    invoke-static {v0, v9}, LX/0yN;->A0S(Ljava/util/AbstractList;I)LX/2NO;
    ...
    :try_start_1
    iget-object v0, v10, LX/307;->A07:Ljava/io/RandomAccessFile;
    ...
    iget-object v0, v7, LX/2oS;->A01:Ljava/lang/String;
    ...
    iget-object v0, v7, LX/2oS;->A05:LX/35z;
    ...
    invoke-virtual {p0, v0}, LX/2sz;->A01(I)LX/2se;
    ...
    invoke-virtual {p0, v1, v3}, LX/1Ww;->A07(Ljava/nio/ByteBuffer;Z)V

    :cond_8
    iput-boolean v3, p0, LX/1Ww;->A00:Z
...
.method public A07(Ljava/nio/ByteBuffer;Z)V
    ...
    iget-object v8, v9, LX/1Ww;->A01:LX/2oS;

    const/16 v0, 0x2800

    new-array v0, v0, [B

    iput-object v0, v8, LX/2oS;->A03:[B

    const/4 v0, 0x0

    iput v0, v8, LX/2oS;->A00:I

    const/4 v7, 0x0

    invoke-virtual {v11, v0}, Ljava/nio/Buffer;->position(I)Ljava/nio/Buffer;

    sget-object v0, LX/2z1;->A06:[B
    ...
    invoke-static {v11}, LX/384;->A03(Ljava/nio/ByteBuffer;)LX/2NP;

    move-result-object v14

    iget v1, v14, LX/2NP;->A01:I

    if-nez v1, :cond_4

    iget v1, v14, LX/2NP;->A00:I

    const/16 v0, 0x1775

    if-ne v1, v0, :cond_0

    iget-object v2, v14, LX/2NP;->A02:Ljava/lang/Object;
    ...
    invoke-virtual {v8, v2, v5, v0}, LX/2oS;->A02(Ljava/lang/String;[BI)Z
    ...
    iget-object v0, v8, LX/2oS;->A02:Ljava/util/HashMap;
    ...
    invoke-static {v13}, LX/0yF;->A0X(Ljava/util/Iterator;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LX/307;

    invoke-virtual {v0, v5, v1}, LX/307;->A01([BI)Z
    ...
    :cond_3
    iget-object v0, v8, LX/2oS;->A03:[B
    ...
    invoke-virtual {v8, v2, v0, v12}, LX/2oS;->A02(Ljava/lang/String;[BI)Z
    ...
    invoke-virtual {v8, v2, v5, v12}, LX/2oS;->A02(Ljava/lang/String;[BI)Z
    ...
    if-nez p2, :cond_b
    :try_end_0
    .catch LX/1yD; {:try_start_0 .. :try_end_0} :catch_3
    ...
    :goto_7
    iput-boolean v7, v9, LX/1Ww;->A00:Z

    return-void

    :cond_b
    invoke-virtual {v9, v3}, LX/2sz;->A01(I)LX/2se;
    ...
    invoke-virtual {v4, v0, v1}, LX/2se;->A04([BI)V
    ...
    invoke-virtual {v4, v5, v1}, LX/2se;->A04([BI)V
    ...
    :goto_8
    :try_start_2
    invoke-virtual {v4}, LX/2se;->A02()V

    iput-boolean v3, v9, LX/1Ww;->A00:Z
    ...
    :try_start_4
    invoke-virtual {v4}, LX/2se;->A01()V
