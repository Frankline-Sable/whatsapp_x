...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/2gk;->A01:Landroid/content/SharedPreferences;

    iput-object p1, p0, LX/2gk;->A00:Landroid/content/Context;
...
.method public A00()Ljava/util/List;
    ...
    iget-object v1, v0, LX/2gk;->A01:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {v3, v11}, Ljava/security/KeyStore;->containsAlias(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {v3, v11, v1}, Ljava/security/KeyStore;->getEntry(Ljava/lang/String;Ljava/security/KeyStore$ProtectionParameter;)Ljava/security/KeyStore$Entry;
    ...
    invoke-direct {v0, v14, v11, v3, v1}, Ljavax/crypto/spec/OAEPParameterSpec;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;Ljavax/crypto/spec/PSource;)V
    ...
    invoke-static {v12}, LX/0yO;->A00([B)Ljava/io/ByteArrayInputStream;
    ...
    invoke-static {v11, v0}, LX/001;->A1M(Ljava/util/AbstractCollection;B)V
    ...
    invoke-static {v0, v6, v7}, LX/38Z;->A05([B[B[B)[B
    ...
    iput v4, v0, LX/2xM;->A00:I

    iput-object v3, v0, LX/2xM;->A02:Ljava/lang/String;

    iput-object v2, v0, LX/2xM;->A01:Ljava/lang/String;

    iput-object v1, v0, LX/2xM;->A03:Ljava/lang/String;
...
.method public A01(LX/2xM;)V
    ...
    :cond_0
    :try_start_2
    iget-object v1, p0, LX/2gk;->A00:Landroid/content/Context;
    ...
    invoke-virtual {v0, v8}, Landroid/security/KeyPairGeneratorSpec$Builder;->setAlias(Ljava/lang/String;)Landroid/security/KeyPairGeneratorSpec$Builder;

    move-result-object v1

    new-instance v0, Ljavax/security/auth/x500/X500Principal;

    invoke-direct {v0, v12}, Ljavax/security/auth/x500/X500Principal;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v5, v8, v0}, Landroid/security/keystore/KeyGenParameterSpec$Builder;-><init>(Ljava/lang/String;I)V
    ...
    invoke-virtual {v5, v0}, Landroid/security/keystore/KeyGenParameterSpec$Builder;->setEncryptionPaddings([Ljava/lang/String;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    ...
    invoke-virtual {v3, v0}, Landroid/security/keystore/KeyGenParameterSpec$Builder;->setCertificateSubject(Ljavax/security/auth/x500/X500Principal;)Landroid/security/keystore/KeyGenParameterSpec$Builder;

    move-result-object v3

    sget-object v0, Ljava/math/BigInteger;->ONE:Ljava/math/BigInteger;

    invoke-virtual {v3, v0}, Landroid/security/keystore/KeyGenParameterSpec$Builder;->setCertificateSerialNumber(Ljava/math/BigInteger;)Landroid/security/keystore/KeyGenParameterSpec$Builder;
    ...
    :cond_1
    invoke-virtual {v6, v8, v4}, Ljava/security/KeyStore;->getEntry(Ljava/lang/String;Ljava/security/KeyStore$ProtectionParameter;)Ljava/security/KeyStore$Entry;
    ...
    invoke-direct {v0, v9, v3, v2, v1}, Ljavax/crypto/spec/OAEPParameterSpec;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/security/spec/AlgorithmParameterSpec;Ljavax/crypto/spec/PSource;)V
    ...
    invoke-static {v0, v8, v1}, LX/38Z;->A04([B[B[B)[B
    ...
    iget-object v0, p1, LX/2xM;->A02:Ljava/lang/String;
    ...
    iget-object v0, p1, LX/2xM;->A03:Ljava/lang/String;
    ...
    iget-object v0, p1, LX/2xM;->A01:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/2gk;->A01:Landroid/content/SharedPreferences;
