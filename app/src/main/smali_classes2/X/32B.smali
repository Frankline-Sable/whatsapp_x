...
# direct methods
.method public constructor <init>(LX/2tv;LX/35Y;LX/3hX;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/32B;->A00:LX/2tv;

    iput-object p3, p0, LX/32B;->A02:LX/3hX;

    iput-object p2, p0, LX/32B;->A01:LX/35Y;
...
.method public final A01(J[B)V
    ...
    iget-object v0, p0, LX/32B;->A02:LX/3hX;
    ...
    invoke-static {v5, p1, p2}, LX/0yE;->A0I(Landroid/content/ContentValues;J)V
...
.method public A02(LX/373;)V
    ...
    iget-object v6, p1, LX/1gr;->A05:Ljava/lang/String;
    ...
    iget-object v4, p0, LX/32B;->A01:LX/35Y;
    ...
    :goto_0
    iget-object v0, v4, LX/35Y;->A02:LX/3hX;
    ...
    :cond_0
    const-string v2, "SELECT COUNT(1) as count FROM messages WHERE media_hash = ? AND _id != ?"

    const-string v1, "SELECT_REFERENCED_FILE_HASH_WITH_MESSAGE_ROW_ID_SQL_DEPRECATED"

    goto :goto_0

    :goto_1
    :try_start_0
    invoke-static {v7, v2, v1, v3}, LX/2tm;->A01(LX/3cx;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {v6}, LX/0yF;->A1b(Ljava/lang/Object;)[Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, LX/32B;->A00(LX/373;)V
...
.method public A03(LX/373;[B)V
    ...
    invoke-virtual {p0, v1}, LX/32B;->A06(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, v0, v1, p2}, LX/32B;->A01(J[B)V
...
.method public A04(Ljava/util/Collection;)V
    ...
    invoke-static {v8, v9}, LX/0yJ;->A1b(Ljava/lang/Object;I)[Ljava/lang/String;
    ...
    :cond_2
    const-string v2, "SELECT COUNT(1) as count FROM messages WHERE media_hash = ?"

    const-string v1, "SELECT_REFERENCED_FILE_HASH_SQL_DEPRECATED"
...
.method public A05(LX/373;)[B
    ...
    invoke-virtual {p0, v0}, LX/32B;->A06(Ljava/lang/String;)[B
    ...
    invoke-static {p1, v1}, LX/373;->A0a(LX/373;[Ljava/lang/Object;)V
