...
.method public constructor <init>(Lcom/whatsapp/jid/GroupJid;Lcom/whatsapp/jid/UserJid;Lcom/whatsapp/voipcalling/CallState;Ljava/lang/String;Ljava/util/List;IJZZZZZZZZZ)V
    ...
    iput-object p4, p0, LX/2xp;->A05:Ljava/lang/String;

    iput-object p3, p0, LX/2xp;->A04:Lcom/whatsapp/voipcalling/CallState;

    iput-boolean p9, p0, LX/2xp;->A08:Z

    iput-boolean p10, p0, LX/2xp;->A09:Z

    iput-boolean p11, p0, LX/2xp;->A0F:Z

    iput-boolean p12, p0, LX/2xp;->A0D:Z

    iput-boolean p13, p0, LX/2xp;->A0C:Z

    iput-wide p7, p0, LX/2xp;->A01:J

    iput-object p2, p0, LX/2xp;->A03:Lcom/whatsapp/jid/UserJid;

    iput-object p5, p0, LX/2xp;->A06:Ljava/util/List;

    iput-boolean p14, p0, LX/2xp;->A0E:Z

    iput-object p1, p0, LX/2xp;->A02:Lcom/whatsapp/jid/GroupJid;

    move/from16 v0, p15

    iput-boolean v0, p0, LX/2xp;->A0B:Z

    move/from16 v0, p16

    iput-boolean v0, p0, LX/2xp;->A0A:Z

    iput p6, p0, LX/2xp;->A00:I

    move/from16 v0, p17

    iput-boolean v0, p0, LX/2xp;->A07:Z

    return-void
.end method

.method public static A00(Lcom/whatsapp/voipcalling/CallInfo;IZ)LX/2xp;
    .locals 20

    move-object/from16 v1, p0

    iget-object v3, v1, Lcom/whatsapp/voipcalling/CallInfo;->callWaitingInfo:LX/2UX;

    iget v0, v3, LX/2UX;->A01:I

    const/4 v2, 0x1

    if-ne v0, v2, :cond_1

    iget-object v0, v3, LX/2UX;->A03:Lcom/whatsapp/voipcalling/CallLogInfo;

    iget-object v5, v0, Lcom/whatsapp/voipcalling/CallLogInfo;->initialPeerJid:Lcom/whatsapp/jid/UserJid;

    invoke-static {v5}, LX/39J;->A06(Ljava/lang/Object;)V

    iget-object v7, v3, LX/2UX;->A04:Ljava/lang/String;

    sget-object v6, Lcom/whatsapp/voipcalling/CallState;->RECEIVED_CALL:Lcom/whatsapp/voipcalling/CallState;

    const/4 v12, 0x0

    iget v0, v3, LX/2UX;->A00:I
    ...
    :cond_0
    iget-boolean v14, v3, LX/2UX;->A08:Z

    const-wide/16 v10, 0x0

    iget-object v8, v3, LX/2UX;->A06:Ljava/util/List;

    iget-object v4, v3, LX/2UX;->A02:Lcom/whatsapp/jid/GroupJid;

    iget-boolean v1, v3, LX/2UX;->A07:Z

    const/4 v9, -0x1

    iget-boolean v0, v3, LX/2UX;->A09:Z
    ...
    invoke-direct/range {v3 .. v20}, LX/2xp;-><init>(Lcom/whatsapp/jid/GroupJid;Lcom/whatsapp/jid/UserJid;Lcom/whatsapp/voipcalling/CallState;Ljava/lang/String;Ljava/util/List;IJZZZZZZZZZ)V
