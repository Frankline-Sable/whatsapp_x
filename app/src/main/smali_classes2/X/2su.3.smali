...
.method public constructor <init>(LX/2tS;LX/2zt;)V
    ...
    iput-object v0, p0, LX/2su;->A04:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, LX/2su;->A02:LX/2tS;

    iput-object p2, p0, LX/2su;->A03:LX/2zt;
...
.method public A00(I)I
    ...
    invoke-virtual {p0}, LX/2su;->A03()V

    iget-object v0, p0, LX/2su;->A04:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized A01()Landroid/content/SharedPreferences$Editor;
    ...
    :try_start_0
    invoke-virtual {p0}, LX/2su;->A02()Landroid/content/SharedPreferences;
...
.method public final declared-synchronized A02()Landroid/content/SharedPreferences;
    ...
    :try_start_0
    iget-object v0, p0, LX/2su;->A00:Landroid/content/SharedPreferences;

    if-nez v0, :cond_0

    iget-object v1, p0, LX/2su;->A03:LX/2zt;
    ...
    iput-object v0, p0, LX/2su;->A00:Landroid/content/SharedPreferences;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final A03()V
    ...
    iget-object v3, v2, LX/2su;->A04:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :try_start_0
    invoke-virtual {v2}, LX/2su;->A02()Landroid/content/SharedPreferences;
    ...
    :try_start_2
    invoke-static {v6}, LX/0yL;->A0o(Ljava/util/Map$Entry;)Ljava/lang/String;
    ...
    invoke-direct/range {v8 .. v18}, LX/2UE;-><init>(Ljava/lang/String;Ljava/lang/String;IIIIJJ)V
    ...
    invoke-virtual {v2}, LX/2su;->A01()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-static {v1, v0, v4}, LX/0yE;->A1I(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public A04(IIIII)V
    ...
    iget-object v0, p0, LX/2su;->A02:LX/2tS;
    ...
    invoke-direct/range {v0 .. v10}, LX/2UE;-><init>(Ljava/lang/String;Ljava/lang/String;IIIIJJ)V

    invoke-virtual {p0, v0, p1}, LX/2su;->A06(LX/2UE;I)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object v2, p0, LX/2su;->A01:LX/2sJ;

    if-eqz v2, :cond_2

    iget-object v1, v2, LX/2sJ;->A01:Ljava/lang/Object;
    ...
    :goto_1
    :try_start_0
    iget-boolean v0, v2, LX/2sJ;->A0E:Z

    if-eqz v0, :cond_1

    iget v0, v2, LX/2sJ;->A0B:I

    if-ne p1, v0, :cond_1

    const/4 v0, 0x0

    iput-boolean v0, v2, LX/2sJ;->A0E:Z

    iput v0, v2, LX/2sJ;->A0B:I

    iget-object v0, v2, LX/2sJ;->A01:Ljava/lang/Object;
...
.method public A05(Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;IIIZ)V
    ...
    invoke-static {v0, p4}, LX/0yH;->A0Y(Ljava/util/AbstractMap;I)Ljava/lang/Object;
    ...
    iput-object p2, v2, LX/2UE;->A07:Ljava/lang/String;

    :cond_3
    if-eqz p3, :cond_4

    iput-object p3, v2, LX/2UE;->A06:Ljava/lang/String;
    ...
    iput v0, v2, LX/2UE;->A00:I

    :cond_6
    invoke-virtual {p0, v2, p4}, LX/2su;->A06(LX/2UE;I)Z

    iget-object v2, p0, LX/2su;->A01:LX/2sJ;

    if-eqz v2, :cond_0

    iget-object v1, v2, LX/2sJ;->A00:Ljava/lang/Object;
    ...
    iput-wide v0, v2, LX/2UE;->A05:J

    goto :goto_0

    :goto_2
    :try_start_0
    iget-boolean v0, v2, LX/2sJ;->A0D:Z

    if-eqz v0, :cond_b

    iget v0, v2, LX/2sJ;->A0A:I

    if-ne p4, v0, :cond_b

    const/4 v0, 0x0

    iput-boolean v0, v2, LX/2sJ;->A0D:Z

    iput v0, v2, LX/2sJ;->A0A:I

    iget-object v0, v2, LX/2sJ;->A00:Ljava/lang/Object;
...
.method public A06(LX/2UE;I)Z
    ...
    invoke-static {p1, v0, p2}, LX/000;->A18(Ljava/lang/Object;Ljava/util/AbstractMap;I)V
    ...
    iget-wide v0, p1, LX/2UE;->A05:J

    invoke-virtual {v3, v2, v0, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    const-string v2, "acceptedTimeInSecond"

    iget-wide v0, p1, LX/2UE;->A04:J

    invoke-virtual {v3, v2, v0, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    const-string v1, "deepLink"

    iget-object v0, p1, LX/2UE;->A07:Ljava/lang/String;

    invoke-virtual {v3, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v1, "content"

    iget-object v0, p1, LX/2UE;->A06:Ljava/lang/String;

    invoke-virtual {v3, v1, v0}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    invoke-virtual {p0}, LX/2su;->A01()Landroid/content/SharedPreferences$Editor;
