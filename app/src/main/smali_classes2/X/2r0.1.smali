...
.method public constructor <init>(Ljava/util/concurrent/TimeUnit;JJ)V
    ...
    invoke-static {v0, v1, p4, p5}, LX/000;->A0Y(Ljava/lang/String;Ljava/lang/StringBuilder;J)Ljava/lang/String;

    move-result-object v0

    if-eqz v2, :cond_2

    iput-wide p2, p0, LX/2r0;->A01:J

    iput-wide p4, p0, LX/2r0;->A00:J

    iput-object p1, p0, LX/2r0;->A02:Ljava/util/concurrent/TimeUnit;
...
.method public A00()Lorg/json/JSONObject;
    ...
    iget-wide v0, p0, LX/2r0;->A01:J

    invoke-virtual {v3, v2, v0, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    const-string v2, "mEndTime"

    iget-wide v0, p0, LX/2r0;->A00:J

    invoke-virtual {v3, v2, v0, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;J)Lorg/json/JSONObject;

    iget-object v0, p0, LX/2r0;->A02:Ljava/util/concurrent/TimeUnit;
...
.method public A01(JLjava/util/concurrent/TimeUnit;)Z
    ...
    iget-wide v1, p0, LX/2r0;->A01:J

    iget-object v5, p0, LX/2r0;->A02:Ljava/util/concurrent/TimeUnit;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v7, p0, LX/2r0;->A02:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v6, v0, v1, v7}, Ljava/util/concurrent/TimeUnit;->convert(JLjava/util/concurrent/TimeUnit;)J

    move-result-wide v3

    iget-wide v0, p1, LX/2r0;->A01:J

    iget-object v5, p1, LX/2r0;->A02:Ljava/util/concurrent/TimeUnit;
...
.method public toString()Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {p0}, LX/2r0;->A00()Lorg/json/JSONObject;
