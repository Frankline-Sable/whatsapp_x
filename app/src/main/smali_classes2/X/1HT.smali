...
.field public final A03:LX/2Qn;


# direct methods
.method public constructor <init>(LX/3HE;LX/31E;LX/2Qn;)V
    .locals 0

    invoke-direct {p0}, LX/1HY;-><init>()V

    iput-object p3, p0, LX/1HT;->A03:LX/2Qn;

    iput-object p2, p0, LX/1HT;->A02:LX/31E;

    iput-object p1, p0, LX/1HT;->A01:LX/3HE;
...
.method public bridge synthetic A08()Ljava/lang/Object;
    ...
    iget-object v9, v7, LX/1HT;->A03:LX/2Qn;

    iget-object v3, v9, LX/2Qn;->A02:Ljava/io/File;
    ...
    .catch LX/1n6; {:try_start_0 .. :try_end_0} :catch_4
    ...
    .catch LX/1n6; {:try_start_1 .. :try_end_1} :catch_4
    .catch Ljava/io/FileNotFoundException; {:try_start_1 .. :try_end_1} :catch_2
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_5

    :try_start_2
    invoke-static {v2, v3}, LX/0yL;->A16(Landroid/media/MediaMetadataRetriever;Ljava/io/File;)V
    ...
    .catch LX/1n6; {:try_start_3 .. :try_end_3} :catch_4
    ...
    iget-object v0, v7, LX/1HT;->A02:LX/31E;
    ...
    iget-object v0, v7, LX/1HT;->A01:LX/3HE;
    ...
    invoke-static {v1, v6}, LX/3HE;->A02(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, v8, v1, v2}, LX/0yE;->A11(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    ...
    invoke-static {v0, v6}, LX/3HE;->A02(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v0

    :goto_0
    iput-object v0, v7, LX/1HT;->A00:Ljava/io/File;
    ...
    iget-object v0, v7, LX/1HT;->A00:Ljava/io/File;
    ...
    invoke-static {v3, v2, v12}, LX/0yE;->A1J(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .catch LX/1n6; {:try_start_4 .. :try_end_4} :catch_4
    ...
    .catch LX/1n6; {:try_start_5 .. :try_end_5} :catch_4
    ...
    .catch LX/1n6; {:try_start_6 .. :try_end_6} :catch_4
    .catch Ljava/io/FileNotFoundException; {:try_start_6 .. :try_end_6} :catch_2
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_5

    :goto_5
    :try_start_7
    invoke-static {v7}, LX/1HY;->A01(LX/1HY;)Z
    ...
    invoke-static {v4, v0}, LX/0yE;->A0O(Landroid/media/MediaCodec$BufferInfo;Ljava/nio/Buffer;)V
    ...
    invoke-static {v0, v8, v4}, LX/0yE;->A1P(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, v4, v0, v1}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
    ...
    iput-object v0, v9, LX/2Qn;->A00:Ljava/io/File;

    goto :goto_11
    :try_end_8
    .catch Ljava/lang/IllegalStateException; {:try_start_8 .. :try_end_8} :catch_3
    .catch LX/1n6; {:try_start_8 .. :try_end_8} :catch_4
    ...
    .catch LX/1n6; {:try_start_a .. :try_end_a} :catch_4
    ...
    .catch LX/1n6; {:try_start_b .. :try_end_b} :catch_4
    ...
    :cond_f
    :goto_11
    iget-object v0, v7, LX/1HT;->A03:LX/2Qn;
