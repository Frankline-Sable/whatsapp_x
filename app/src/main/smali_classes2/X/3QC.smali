...
.field public A09:LX/5Kv;

.field public A0A:LX/4yz;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/3QC;->A0a:Ljava/util/Set;
    ...
    sput-object v0, LX/3QC;->A0c:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0g:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0b:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0i:Ljava/util/regex/Pattern;
    ...
    sput-object v0, LX/3QC;->A0h:Ljava/util/regex/Pattern;

    return-void
.end method

.method public constructor <init>(LX/2t8;LX/5cD;Ljava/lang/String;)V
    .locals 1
    ...
    iput-boolean v0, p0, LX/3QC;->A0Q:Z

    iput-boolean v0, p0, LX/3QC;->A0S:Z

    iput-boolean v0, p0, LX/3QC;->A0T:Z

    const/4 v0, 0x0

    iput-object v0, p0, LX/3QC;->A0B:Ljava/lang/Integer;

    iput-object v0, p0, LX/3QC;->A0E:Ljava/lang/String;

    invoke-static {}, LX/0yN;->A1D()Ljava/util/LinkedHashSet;

    move-result-object v0

    iput-object v0, p0, LX/3QC;->A0O:Ljava/util/LinkedHashSet;

    iput-object p2, p0, LX/3QC;->A0Y:LX/5cD;

    iput-object p1, p0, LX/3QC;->A0X:LX/2t8;

    iput-object p3, p0, LX/3QC;->A0Z:Ljava/lang/String;
...
.method public static varargs A00(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, LX/0yL;->A0m(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/String;
...
.method public static final varargs A01(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/net/URL;
    ...
    :try_start_0
    invoke-static {p0, p1}, LX/3QC;->A00(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p0}, LX/0yE;->A14(Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
...
.method public static A02(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    sget-object v0, LX/3QC;->A0d:Ljava/util/regex/Pattern;
...
.method public A03()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, LX/3QC;->A0W:[B
    ...
    :cond_0
    iget-object v0, p0, LX/3QC;->A08:Landroid/graphics/Bitmap;
    ...
    iget-object v2, p0, LX/3QC;->A0W:[B
    ...
    iput-object v0, p0, LX/3QC;->A08:Landroid/graphics/Bitmap;
...
.method public final A04(LX/1QX;Ljava/lang/String;Ljava/lang/String;I)LX/5Kv;
    .locals 4
    ...
    invoke-static {p2, v0}, LX/0yJ;->A0l(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {p2}, LX/0yO;->A05(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v0

    invoke-virtual {p0, p1, v2, v0}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v3, p2, v0, v1}, LX/5Kv;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-virtual {p0, v2}, LX/3QC;->A0E(Ljava/net/HttpURLConnection;)V
    ...
    invoke-direct {v3, p2, p4, p3}, LX/5Kv;-><init>(Ljava/lang/String;ILjava/lang/String;)V
...
.method public final varargs A05(LX/1QX;Ljava/util/Map;[Ljava/lang/String;)LX/5Kv;
    .locals 7
    ...
    :try_start_0
    invoke-static {v6}, LX/0yO;->A05(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v0

    invoke-virtual {p0, p1, v4, v0}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {p0, p1, v6, v1, v0}, LX/3QC;->A04(LX/1QX;Ljava/lang/String;Ljava/lang/String;I)LX/5Kv;
    ...
    :goto_3
    invoke-virtual {p0, v4}, LX/3QC;->A0E(Ljava/net/HttpURLConnection;)V
...
.method public A06()Ljava/lang/String;
    ...
    iget-object v0, p0, LX/3QC;->A0D:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/3QC;->A0Z:Ljava/lang/String;
...
.method public final A07(LX/1QX;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/URL;I)Ljava/lang/String;
    .locals 22

    move-object/from16 v5, p2

    sget-object v0, LX/3QC;->A0c:Ljava/util/regex/Pattern;
    ...
    sget-object v0, LX/3QC;->A0f:Ljava/util/regex/Pattern;
    ...
    invoke-static {v0}, LX/3QC;->A02(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    invoke-static {v0, v7}, LX/0yL;->A0m(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, LX/0yL;->A0m(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/String;
    ...
    sget-object v0, LX/3QC;->A0b:Ljava/util/regex/Pattern;
    ...
    iput-object v0, v2, LX/3QC;->A0J:Ljava/lang/String;

    iput-object v0, v2, LX/3QC;->A0G:Ljava/lang/String;

    iput-object v0, v2, LX/3QC;->A0D:Ljava/lang/String;

    iget-object v0, v2, LX/3QC;->A0O:Ljava/util/LinkedHashSet;

    invoke-virtual {v0}, Ljava/util/AbstractCollection;->clear()V

    const/4 v0, 0x0

    iput-boolean v0, v2, LX/3QC;->A0P:Z

    iput v0, v2, LX/3QC;->A02:I

    iput-boolean v0, v2, LX/3QC;->A0Q:Z

    iput-boolean v0, v2, LX/3QC;->A0S:Z

    iput-boolean v0, v2, LX/3QC;->A0T:Z
    ...
    sget-object v0, LX/3QC;->A0a:Ljava/util/Set;
    ...
    invoke-virtual {v2, v7, v0, v6, v1}, LX/3QC;->A04(LX/1QX;Ljava/lang/String;Ljava/lang/String;I)LX/5Kv;
    ...
    invoke-virtual {v2, v7, v3, v0}, LX/3QC;->A05(LX/1QX;Ljava/util/Map;[Ljava/lang/String;)LX/5Kv;
    ...
    :cond_7
    iput-object v6, v2, LX/3QC;->A09:LX/5Kv;
    ...
    :cond_9
    iput-object v7, v2, LX/3QC;->A0O:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v3, v0}, LX/3QC;->A00(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v2, LX/3QC;->A0H:Ljava/lang/String;
    ...
    iput-object v0, v2, LX/3QC;->A0I:Ljava/lang/String;
    ...
    invoke-static {v3, v0}, LX/3QC;->A01(Ljava/util/HashMap;[Ljava/lang/String;)Ljava/net/URL;

    move-result-object v0

    iput-object v0, v2, LX/3QC;->A0N:Ljava/net/URL;
    ...
    iput-object v0, v2, LX/3QC;->A0C:Ljava/lang/String;
    ...
    iput-object v0, v2, LX/3QC;->A0F:Ljava/lang/String;
    ...
    iput-object v0, v2, LX/3QC;->A0L:Ljava/net/URL;
    ...
    iput-object v0, v2, LX/3QC;->A0K:Ljava/net/URL;
    ...
    iput-object v0, v2, LX/3QC;->A0M:Ljava/net/URL;
    ...
    invoke-virtual/range {p5 .. p5}, Ljava/net/URL;->getHost()Ljava/lang/String;
    ...
    :cond_d
    iget-boolean v0, v2, LX/3QC;->A0Q:Z
    ...
    :goto_2
    iput-boolean v6, v2, LX/3QC;->A0T:Z
    ...
    const-string/jumbo v9, "og:video"

    invoke-virtual {v3, v9}, Ljava/util/AbstractMap;->containsKey(Ljava/lang/Object;)Z

    move-result v0

    const-string/jumbo v1, "og:video:type"

    if-eqz v0, :cond_13

    invoke-static {v1, v3}, LX/0yL;->A0m(Ljava/lang/Object;Ljava/util/AbstractMap;)Ljava/lang/String;
    ...
    iget-object v0, v2, LX/3QC;->A0D:Ljava/lang/String;
    ...
    :cond_15
    iget-object v6, v2, LX/3QC;->A0Y:LX/5cD;
    ...
    :cond_16
    invoke-static {v6, v0}, LX/37N;->A01(LX/5cD;Ljava/lang/String;)I

    move-result v0

    iput v0, v2, LX/3QC;->A03:I

    const-string/jumbo v8, "og:video:url"

    const-string/jumbo v7, "og:video:secure_url"
    ...
    iput v4, v2, LX/3QC;->A02:I

    :cond_18
    :goto_5
    iget-boolean v0, v2, LX/3QC;->A0P:Z

    if-eqz v0, :cond_19

    iget v1, v2, LX/3QC;->A03:I
    ...
    invoke-direct {v0, v8, v7, v1}, LX/4yz;-><init>(Ljava/lang/String;II)V

    :goto_7
    iput-object v0, v2, LX/3QC;->A0A:LX/4yz;
    ...
    sget-object v1, LX/3QC;->A0i:Ljava/util/regex/Pattern;

    invoke-virtual {v6, v9}, LX/5cD;->A04(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0, v1}, LX/0yL;->A1X(Ljava/lang/CharSequence;Ljava/util/regex/Pattern;)Z
    ...
    invoke-virtual {v2, v9, v10, v0}, LX/3QC;->A0D(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v9, v7, v0}, LX/3QC;->A0D(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v9, v1, v0}, LX/3QC;->A0D(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    :cond_1f
    iput v1, v2, LX/3QC;->A02:I

    iget-boolean v0, v2, LX/3QC;->A0Q:Z

    if-eqz v0, :cond_18

    iget-boolean v0, v2, LX/3QC;->A0S:Z
    ...
    :cond_20
    iget-boolean v0, v2, LX/3QC;->A0T:Z
    ...
    sget-object v0, LX/3QC;->A0e:Ljava/util/regex/Pattern;
    ...
    invoke-virtual/range {p5 .. p5}, Ljava/net/URL;->getProtocol()Ljava/lang/String;
    ...
    invoke-virtual/range {p5 .. p5}, Ljava/net/URL;->getUserInfo()Ljava/lang/String;
    ...
    invoke-virtual/range {p5 .. p5}, Ljava/net/URL;->getPort()I
    ...
    :cond_2d
    iget-object v0, v2, LX/3QC;->A0J:Ljava/lang/String;
    ...
    sget-object v0, LX/3QC;->A0g:Ljava/util/regex/Pattern;
    ...
    :cond_2f
    iget-object v0, v2, LX/3QC;->A0G:Ljava/lang/String;
    ...
    invoke-static {v0}, LX/5X6;->A01(Ljava/lang/String;)Z
    ...
    iput-object v0, v2, LX/3QC;->A0B:Ljava/lang/Integer;
    ...
    iput-object v0, v2, LX/3QC;->A0E:Ljava/lang/String;
...
.method public final A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    .locals 11
...
.method public A09()V
    ...
    iget-boolean v0, p0, LX/3QC;->A0P:Z
    ...
    iget-object v0, p0, LX/3QC;->A0V:[B
...
.method public A0A(LX/1QX;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, v1}, LX/3QC;->A0C(LX/1QX;Ljava/lang/String;)V

    goto :goto_1
    :try_end_0
    .catch LX/1uZ; {:try_start_0 .. :try_end_0} :catch_0
...
.method public A0B(LX/1QX;Ljava/lang/String;)V
    .locals 21

    move-object/from16 v14, p0

    iget-object v2, v14, LX/3QC;->A0Z:Ljava/lang/String;

    const-wide/16 v0, 0x0

    iput-wide v0, v14, LX/3QC;->A05:J

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v11

    invoke-static {v2}, LX/0yO;->A05(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-virtual {v14, v15, v0, v6}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {v14, v3}, LX/3QC;->A0E(Ljava/net/HttpURLConnection;)V

    invoke-virtual {v14, v15, v2, v6}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    :cond_4
    invoke-static {v10, v9}, LX/000;->A0S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v14, v3}, LX/3QC;->A0E(Ljava/net/HttpURLConnection;)V

    invoke-static {v13}, LX/0yO;->A05(Ljava/lang/String;)Ljava/net/URL;

    move-result-object v0

    invoke-virtual {v14, v15, v2, v0}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {v15, v0, v1}, LX/2tw;->A0L(LX/2wY;I)I
    ...
    :try_start_3
    iget-object v1, v14, LX/3QC;->A0X:LX/2t8;
    ...
    invoke-static {v1, v2, v0, v3}, LX/1us;->A01(LX/2t8;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/net/URLConnection;)LX/1us;
    ...
    :cond_6
    invoke-virtual {v2, v4, v5, v9}, Ljava/io/InputStream;->read([BII)I
    ...
    invoke-virtual {v8, v4, v5, v10}, Ljava/io/OutputStream;->write([BII)V
    ...
    invoke-static {v10, v0}, LX/0yL;->A1X(Ljava/lang/CharSequence;Ljava/util/regex/Pattern;)Z
    ...
    :catch_3
    :try_start_f
    invoke-static {v7}, LX/0yM;->A0m([B)Ljava/lang/String;
    ...
    invoke-virtual/range {v14 .. v20}, LX/3QC;->A07(LX/1QX;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/net/URL;I)Ljava/lang/String;
    ...
    iput-object v0, v14, LX/3QC;->A0J:Ljava/lang/String;

    iput-object v0, v14, LX/3QC;->A0G:Ljava/lang/String;

    iput-object v0, v14, LX/3QC;->A0D:Ljava/lang/String;

    iget-object v0, v14, LX/3QC;->A0O:Ljava/util/LinkedHashSet;

    invoke-virtual {v0}, Ljava/util/AbstractCollection;->clear()V

    iput-boolean v5, v14, LX/3QC;->A0P:Z

    iput v5, v14, LX/3QC;->A02:I

    iput-boolean v5, v14, LX/3QC;->A0Q:Z

    iput-boolean v5, v14, LX/3QC;->A0S:Z

    iput-boolean v5, v14, LX/3QC;->A0T:Z
    ...
    iput-wide v0, v14, LX/3QC;->A06:J
    :try_end_11
    .catchall {:try_start_11 .. :try_end_11} :catchall_4

    invoke-virtual {v14, v3}, LX/3QC;->A0E(Ljava/net/HttpURLConnection;)V

    iget-object v0, v14, LX/3QC;->A0J:Ljava/lang/String;
    ...
    :cond_d
    iget-object v0, v14, LX/3QC;->A0G:Ljava/lang/String;
    ...
    :cond_e
    invoke-static {v11, v12}, LX/0yL;->A0C(J)J
...
.method public A0C(LX/1QX;Ljava/lang/String;)V
    .locals 12
    ...
    iput-wide v0, p0, LX/3QC;->A04:J

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    invoke-virtual {p0, p1, p2}, LX/3QC;->A0I(LX/1QX;Ljava/lang/String;)[B
    ...
    invoke-virtual/range {v5 .. v11}, LX/3QC;->A0J([BIIIIZ)[B
    ...
    sget-object v1, LX/3QC;->A0h:Ljava/util/regex/Pattern;

    iget-object v0, p0, LX/3QC;->A0Y:LX/5cD;

    invoke-virtual {v0, p2}, LX/5cD;->A04(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v0, p0, LX/3QC;->A03:I

    if-eqz v0, :cond_2

    :cond_0
    iget v2, p0, LX/3QC;->A01:I
    ...
    iput-object v0, p0, LX/3QC;->A0W:[B
...
.method public final varargs A0D(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iget-object v1, p0, LX/3QC;->A0O:Ljava/util/LinkedHashSet;

    invoke-static {v3, v0}, LX/000;->A0S(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final A0E(Ljava/net/HttpURLConnection;)V
    ...
    :cond_0
    :try_start_0
    iget-object v2, p0, LX/3QC;->A0X:LX/2t8;
    ...
    invoke-static {v2, v0, v1, p1}, LX/1us;->A01(LX/2t8;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/net/URLConnection;)LX/1us;
...
.method public A0F()Z
    ...
    :cond_0
    iget-object v0, p0, LX/3QC;->A0J:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/3QC;->A0G:Ljava/lang/String;

    invoke-static {v0}, LX/0yL;->A1W(Ljava/lang/CharSequence;)Z

    move-result v2

    iget-object v1, p0, LX/3QC;->A09:LX/5Kv;

    if-eqz v1, :cond_3

    const-string v0, "image/gif"

    iget-object v1, v1, LX/5Kv;->A01:Ljava/lang/String;
...
.method public A0G(Landroid/graphics/Bitmap;)[B
    ...
    invoke-virtual/range {v4 .. v9}, LX/3QC;->A0H(Landroid/graphics/Bitmap;Landroid/graphics/Rect;III)[B
...
.method public final A0I(LX/1QX;Ljava/lang/String;)[B
    .locals 13
    ...
    :cond_0
    invoke-virtual {p0, p1, v1, v2}, LX/3QC;->A08(LX/1QX;Ljava/lang/String;Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v2, v1, v0, v5}, LX/1us;->A01(LX/2t8;Ljava/lang/Integer;Ljava/lang/Integer;Ljava/net/URLConnection;)LX/1us;
    ...
    :cond_1
    invoke-virtual {v8, v6, v5, v4}, Ljava/io/InputStream;->read([BII)I
    ...
    :cond_2
    invoke-virtual {v7, v6, v5, v1}, Ljava/io/OutputStream;->write([BII)V
...
.method public A0J([BIIIIZ)[B
    ...
    iget-boolean v0, v12, LX/3QC;->A0R:Z
    ...
    invoke-direct/range {v6 .. v11}, LX/2xR;-><init>(Landroid/graphics/BitmapFactory$Options;Ljava/lang/Long;IIZ)V

    invoke-static {v8, v6, v5, v2}, LX/38h;->A05(LX/2hg;LX/2xR;[BZ)LX/2MB;

    move-result-object v0

    iget-object v13, v0, LX/2MB;->A02:Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v12 .. v17}, LX/3QC;->A0H(Landroid/graphics/Bitmap;Landroid/graphics/Rect;III)[B
    ...
    :cond_1
    invoke-virtual {v12, v13}, LX/3QC;->A0G(Landroid/graphics/Bitmap;)[B
