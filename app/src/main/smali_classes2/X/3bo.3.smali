...
# direct methods
.method public constructor <init>(LX/2tx;LX/42d;LX/1KP;LX/2R9;LX/35o;LX/8bd;Lcom/whatsapp/voipcalling/camera/VoipCameraManager;)V
    .locals 1
    ...
    iput v0, p0, LX/3bo;->A00:I

    invoke-static {}, LX/002;->A0P()Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, LX/3bo;->A0A:Ljava/util/Map;

    iput-object p1, p0, LX/3bo;->A03:LX/2tx;

    iput-object p2, p0, LX/3bo;->A04:LX/42d;

    iput-object p6, p0, LX/3bo;->A08:LX/8bd;

    iput-object p3, p0, LX/3bo;->A05:LX/1KP;

    iput-object p4, p0, LX/3bo;->A06:LX/2R9;

    iput-object p7, p0, LX/3bo;->A09:Lcom/whatsapp/voipcalling/camera/VoipCameraManager;

    iput-object p5, p0, LX/3bo;->A07:LX/35o;
...
# virtual methods
.method public A00(Lcom/whatsapp/jid/UserJid;)LX/7y1;
    .locals 11

    move-object v5, p0

    iget-object v2, p0, LX/3bo;->A0A:Ljava/util/Map;
    ...
    invoke-static {v2, p1}, LX/0yM;->A0d(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string/jumbo v0, "voip/VideoPortManager/getVideoPort creating port for "

    invoke-static {v1, v0, p1}, LX/0yE;->A1N(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v1, p0, LX/3bo;->A06:LX/2R9;

    iget-object v8, p0, LX/3bo;->A08:LX/8bd;

    iget-object v0, v1, LX/2R9;->A00:LX/2tx;
    ...
    iget-object v6, v1, LX/2R9;->A02:LX/1QX;

    new-instance v4, LX/20l;

    invoke-direct {v4}, LX/20l;-><init>()V
    ...
    invoke-direct/range {v3 .. v10}, LX/7y1;-><init>(LX/20l;LX/3bo;LX/1QX;Lcom/whatsapp/jid/UserJid;LX/8bd;Lcom/whatsapp/voipcalling/GlVideoRenderer;Z)V
...
.method public A01()V
    ...
    invoke-virtual {v0}, LX/7y1;->release()V
    ...
    iget-object v1, p0, LX/3bo;->A01:Landroid/os/Handler;
    ...
    iput-object v0, p0, LX/3bo;->A01:Landroid/os/Handler;
...
.method public A02()V
    ...
    iget-object v0, p0, LX/3bo;->A05:LX/1KP;

    invoke-virtual {v0}, LX/1KP;->A0U()Lcom/whatsapp/jid/UserJid;

    move-result-object v2

    iget-object v1, p0, LX/3bo;->A0A:Ljava/util/Map;
    ...
    const-string/jumbo v0, "voip/VideoPortManager/startCameraPreview no self video port"
    ...
    invoke-direct {v2, v3, v0}, LX/4BT;-><init>(Ljava/lang/Object;I)V

    iget-object v1, v3, LX/7y1;->A07:Landroid/os/Handler;
    ...
    invoke-virtual {p0, v3}, LX/3bo;->A03(LX/7y1;)V
...
.method public final A03(LX/7y1;)V
    .locals 4

    iget-object v2, p1, LX/7y1;->A0C:Lcom/whatsapp/jid/UserJid;

    iget-object v0, p0, LX/3bo;->A03:LX/2tx;
    ...
    iget-object v1, p0, LX/3bo;->A07:LX/35o;

    const/4 v0, 0x1

    invoke-static {v1, v0}, LX/38i;->A06(LX/35o;Z)Z
    ...
    :cond_1
    iget-object v0, p0, LX/3bo;->A01:Landroid/os/Handler;
    ...
    iput v1, p0, LX/3bo;->A00:I

    if-nez v2, :cond_5

    iget-object v0, p0, LX/3bo;->A09:Lcom/whatsapp/voipcalling/camera/VoipCameraManager;

    invoke-virtual {v0, p0}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->addCameraErrorListener(LX/8YJ;)V

    iput v3, p0, LX/3bo;->A00:I
    ...
    const-string/jumbo v0, "voip/VideoPortManager/setVideoPort failed to setup port for "

    invoke-static {v1, v0, v2}, LX/0yE;->A1M(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v0, p0, LX/3bo;->A02:Lcom/whatsapp/calling/callgrid/viewmodel/CallGridViewModel;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lcom/whatsapp/calling/callgrid/viewmodel/CallGridViewModel;->A0R:LX/1eX;
    ...
    invoke-virtual {v2, v0, v0, v1}, LX/38o;->A0d(Lcom/whatsapp/voipcalling/CallInfo;Ljava/lang/String;I)V
    ...
    iget-object v3, p0, LX/3bo;->A01:Landroid/os/Handler;
...
.method public A04(Lcom/whatsapp/jid/UserJid;)V
    ...
    const-string/jumbo v0, "voip/VideoPortManager/releaseVideoPort releasing port for "
...
.method public final A05(Lcom/whatsapp/jid/UserJid;)V
    ...
    iget-object v0, p0, LX/3bo;->A0A:Ljava/util/Map;
    ...
    invoke-virtual {v0, p0}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->removeCameraErrorListener(LX/8YJ;)V
    ...
    iput-object v1, p0, LX/3bo;->A01:Landroid/os/Handler;
