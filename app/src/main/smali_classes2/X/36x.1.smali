...
# direct methods
.method public constructor <init>(LX/2rn;LX/3hX;LX/2sa;)V
    .locals 1
    ...
    iput-object v0, p0, LX/36x;->A03:Ljava/util/Map;

    invoke-static {}, LX/0yN;->A1I()Ljava/util/concurrent/ConcurrentHashMap;

    move-result-object v0

    iput-object v0, p0, LX/36x;->A04:Ljava/util/Map;

    iput-object p1, p0, LX/36x;->A00:LX/2rn;

    iput-object p3, p0, LX/36x;->A02:LX/2sa;

    iput-object p2, p0, LX/36x;->A01:LX/3hX;

    return-void
.end method

.method public static A00(LX/2tm;Lcom/whatsapp/jid/Jid;)J
    .locals 8
    ...
    invoke-static {v2, v0, v6}, LX/0yL;->A1R([Ljava/lang/Object;II)V

    invoke-virtual {p1}, Lcom/whatsapp/jid/Jid;->getDevice()I

    move-result v0

    invoke-static {v2, v0, v4}, LX/0yL;->A1R([Ljava/lang/Object;II)V

    invoke-virtual {p1}, Lcom/whatsapp/jid/Jid;->getType()I

    move-result v0

    invoke-static {v2, v0, v1}, LX/0yL;->A1R([Ljava/lang/Object;II)V
    ...
    invoke-static {v2, v3}, LX/0yG;->A09(Landroid/database/Cursor;Ljava/lang/String;)J
...
.method public static A01(Landroid/database/Cursor;IIIIII)Lcom/whatsapp/jid/Jid;
    ...
    invoke-static {p0, p1}, LX/379;->A01(Landroid/database/Cursor;I)Ljava/lang/String;

    move-result-object v6

    invoke-static {p0, p2}, LX/379;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-static {p0, p6}, LX/379;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-static {v6, v0}, LX/5dh;->A0I(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    invoke-static {v5, v0}, LX/5dh;->A0I(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    invoke-static {v1}, LX/0yM;->A0P(Lcom/whatsapp/jid/Jid;)Lcom/whatsapp/jid/DeviceJid;
...
.method public static A02(LX/36x;J)Lcom/whatsapp/jid/UserJid;
    .locals 0

    invoke-virtual {p0, p1, p2}, LX/36x;->A09(J)Lcom/whatsapp/jid/Jid;
...
.method public static A03(LX/36x;Ljava/lang/Class;J)Lcom/whatsapp/jid/UserJid;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, LX/36x;->A0C(Ljava/lang/Class;J)Lcom/whatsapp/jid/Jid;
...
.method public static A04(LX/36x;Lcom/whatsapp/jid/Jid;)Ljava/lang/Long;
    .locals 0

    invoke-virtual {p0, p1}, LX/36x;->A06(Lcom/whatsapp/jid/Jid;)J
...
.method public static A05(LX/36x;Lcom/whatsapp/jid/Jid;)Ljava/lang/String;
    .locals 0
...
.method public A06(Lcom/whatsapp/jid/Jid;)J
    ...
    iget-object v1, v7, LX/36x;->A03:Ljava/util/Map;

    move-object/from16 v6, p1

    invoke-static {v6, v1}, LX/0yN;->A0x(Ljava/lang/Object;Ljava/util/Map;)Ljava/lang/Number;
    ...
    :cond_1
    iget-object v1, v7, LX/36x;->A01:LX/3hX;
    ...
    :try_start_0
    invoke-virtual {v7, v6}, LX/36x;->A08(Lcom/whatsapp/jid/Jid;)J
    ...
    :try_start_1
    invoke-static {v3}, LX/2tm;->A05(LX/3cx;)Z
    ...
    invoke-virtual {v3, v8}, LX/3cx;->A05(Ljava/lang/Runnable;)V

    goto/16 :goto_6

    :cond_2
    invoke-virtual {v7, v6, v1, v2}, LX/36x;->A0G(Lcom/whatsapp/jid/Jid;J)V

    goto/16 :goto_6

    :cond_3
    invoke-virtual {v3}, LX/3cx;->A04()LX/3cw;
    ...
    iget-object v5, v6, Lcom/whatsapp/jid/Jid;->user:Ljava/lang/String;

    invoke-virtual {v9, v0, v5}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6}, Lcom/whatsapp/jid/Jid;->getServer()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v9, v14, v5}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v6}, Lcom/whatsapp/jid/Jid;->getAgent()I

    move-result v5

    invoke-static {v9, v15, v5}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V

    invoke-virtual {v6}, Lcom/whatsapp/jid/Jid;->getDevice()I

    move-result v5

    invoke-static {v9, v4, v5}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V

    invoke-virtual {v6}, Lcom/whatsapp/jid/Jid;->getType()I

    move-result v5

    invoke-static {v9, v13, v5}, LX/0yF;->A0p(Landroid/content/ContentValues;Ljava/lang/String;I)V

    invoke-static {v9, v6, v12}, LX/0yG;->A0k(Landroid/content/ContentValues;Lcom/whatsapp/jid/Jid;Ljava/lang/String;)V

    iget-object v8, v3, LX/3cx;->A02:LX/2tm;

    const-string v5, "INSERT_JID_SQL"

    invoke-virtual {v8, v11, v5, v9}, LX/2tm;->A09(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    invoke-static {v6}, LX/0yE;->A1b(Lcom/whatsapp/jid/Jid;)[Ljava/lang/String;

    move-result-object v2

    const-string v1, "GET_JID_FROM_RAW_STRING"

    invoke-virtual {v10, v5, v1, v2}, LX/2tm;->A0E(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object v9, v7, LX/36x;->A04:Ljava/util/Map;
    ...
    invoke-virtual {v7, v1, v2}, LX/36x;->A09(J)Lcom/whatsapp/jid/Jid;
    ...
    invoke-static {v6, v4}, LX/0yI;->A1H(Lcom/whatsapp/jid/Jid;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v5, v14}, LX/0yG;->A0X(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v15}, LX/0yG;->A02(Landroid/database/Cursor;Ljava/lang/String;)I
    ...
    invoke-static {v5, v13}, LX/0yG;->A02(Landroid/database/Cursor;Ljava/lang/String;)I
    ...
    invoke-static {v5, v12}, LX/0yG;->A0X(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v4}, LX/0yI;->A1H(Lcom/whatsapp/jid/Jid;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4}, LX/0yG;->A0y(Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v5, v10}, LX/0yK;->A0g(Landroid/database/Cursor;I)Ljava/lang/Integer;
    ...
    invoke-static {v9, v4, v1, v2}, LX/0yE;->A0z(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    ...
    invoke-static {v6, v1}, LX/0yH;->A10(Lcom/whatsapp/jid/Jid;[Ljava/lang/Object;)V

    const-string v0, "getRowIdForJid/DELETE_JID_ON_MISMATCH"

    invoke-virtual {v10, v11, v2, v0, v1}, LX/2tm;->A07(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v6, v0, v1}, LX/0yL;->A0k(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :goto_4
    iget-object v8, v7, LX/36x;->A00:LX/2rn;
    ...
    invoke-static {v6, v0, v4}, LX/0yE;->A03(Lcom/whatsapp/jid/Jid;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;

    move-result-object v4

    const/4 v0, 0x0

    invoke-virtual {v8, v5, v0, v4}, LX/2rn;->A0B(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    invoke-static {v0, v4, v1, v2}, LX/0yE;->A0z(Ljava/lang/String;Ljava/lang/StringBuilder;J)V
    :try_end_9
...
.method public A07(Lcom/whatsapp/jid/Jid;)J
    ...
    iget-object v0, p0, LX/36x;->A03:Ljava/util/Map;
    ...
    :cond_0
    iget-object v0, p0, LX/36x;->A01:LX/3hX;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, LX/36x;->A08(Lcom/whatsapp/jid/Jid;)J
    ...
    invoke-virtual {v3, v4}, LX/3cx;->A05(Ljava/lang/Runnable;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p1, v8, v9}, LX/36x;->A0G(Lcom/whatsapp/jid/Jid;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final A08(Lcom/whatsapp/jid/Jid;)J
    .locals 3
    ...
    invoke-static {v0, p1}, LX/36x;->A00(LX/2tm;Lcom/whatsapp/jid/Jid;)J
...
.method public A09(J)Lcom/whatsapp/jid/Jid;
    ...
    iget-object v2, v5, LX/36x;->A04:Ljava/util/Map;
    ...
    :cond_0
    iget-object v0, v5, LX/36x;->A01:LX/3hX;
    ...
    invoke-static {v14, v15}, LX/0yE;->A1Z(J)[Ljava/lang/String;
    ...
    invoke-virtual/range {v5 .. v15}, LX/36x;->A0A(Landroid/database/Cursor;LX/3cx;IIIIIIJ)Lcom/whatsapp/jid/Jid;
...
.method public A0A(Landroid/database/Cursor;LX/3cx;IIIIIIJ)Lcom/whatsapp/jid/Jid;
    .locals 12
    ...
    iget-object v2, p0, LX/36x;->A04:Ljava/util/Map;
    ...
    invoke-static/range {v0 .. v6}, LX/36x;->A01(Landroid/database/Cursor;IIIIII)Lcom/whatsapp/jid/Jid;

    move-result-object v8

    if-eqz v8, :cond_0

    invoke-static {p2}, LX/2tm;->A05(LX/3cx;)Z
    ...
    invoke-virtual {p2, v6}, LX/3cx;->A05(Ljava/lang/Runnable;)V

    return-object v8

    :cond_3
    invoke-virtual {p0, v8, v10, v11}, LX/36x;->A0G(Lcom/whatsapp/jid/Jid;J)V

    return-object v8
.end method

.method public A0B(Landroid/database/Cursor;LX/3cx;Ljava/lang/Class;IIIIIIJ)Lcom/whatsapp/jid/Jid;
    .locals 14
    ...
    invoke-virtual/range {v3 .. v13}, LX/36x;->A0A(Landroid/database/Cursor;LX/3cx;IIIIIIJ)Lcom/whatsapp/jid/Jid;
...
.method public A0C(Ljava/lang/Class;J)Lcom/whatsapp/jid/Jid;
    ...
    :try_start_0
    invoke-virtual {p0, p2, p3}, LX/36x;->A09(J)Lcom/whatsapp/jid/Jid;
    ...
    invoke-virtual {p0, p2, p3}, LX/36x;->A0D(J)Ljava/lang/String;
...
.method public final A0D(J)Ljava/lang/String;
    .locals 14
    ...
    invoke-static/range {p1 .. p2}, LX/0yE;->A1Z(J)[Ljava/lang/String;
    ...
    invoke-static {v10, v11}, LX/5dh;->A0D(Ljava/lang/String;I)Ljava/lang/String;
...
.method public A0E(Ljava/lang/Class;Ljava/util/Collection;)Ljava/util/Map;
    .locals 20
    ...
    invoke-static {v5}, LX/0yN;->A0y(Ljava/util/Iterator;)Ljava/lang/Number;
    ...
    invoke-virtual {v8, v11, v1, v2}, LX/36x;->A0C(Ljava/lang/Class;J)Lcom/whatsapp/jid/Jid;
    ...
    invoke-direct {v2, v1, v0}, LX/3gu;-><init>([Ljava/lang/Object;I)V

    :goto_1
    invoke-virtual {v2}, LX/3gu;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-static {v2}, LX/3gu;->A01(LX/3gu;)[Ljava/lang/String;

    move-result-object v7

    iget-object v6, v10, LX/3cx;->A02:LX/2tm;
    ...
    invoke-static {v0, v1, v5}, LX/2uP;->A04(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
    ...
    invoke-virtual/range {v8 .. v19}, LX/36x;->A0B(Landroid/database/Cursor;LX/3cx;Ljava/lang/Class;IIIIIIJ)Lcom/whatsapp/jid/Jid;
    ...
    invoke-static {v0, v4, v3}, LX/0yK;->A1G(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/AbstractMap;)V
...
.method public final A0F(Landroid/database/Cursor;)V
    .locals 4
    ...
    invoke-static {p1, v3}, LX/379;->A01(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, LX/36x;->A06(Lcom/whatsapp/jid/Jid;)J
...
.method public final A0G(Lcom/whatsapp/jid/Jid;J)V
    .locals 2

    iget-object v0, p0, LX/36x;->A04:Ljava/util/Map;
...
.method public A0H()Z
    ...
    iget-object v7, p0, LX/36x;->A01:LX/3hX;

    invoke-static {v7}, LX/3hX;->A01(LX/3hX;)Z
    ...
    iget-object v1, p0, LX/36x;->A02:LX/2sa;
    ...
    :try_start_0
    invoke-static {v7}, LX/3hX;->A00(LX/3hX;)LX/0zb;
    ...
    invoke-static {v2, v7, v1}, LX/0zb;->A03(LX/3cx;LX/3hX;LX/0zb;)Z
