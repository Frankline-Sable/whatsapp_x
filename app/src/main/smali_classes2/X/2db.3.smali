...
# direct methods
.method public constructor <init>(LX/5W4;LX/32w;LX/5bV;LX/2pP;LX/35W;LX/35t;LX/1Nj;)V
    .locals 1
    ...
    iput-object v0, p0, LX/2db;->A00:Landroid/content/Context;

    iput-object p3, p0, LX/2db;->A03:LX/5bV;

    iput-object p1, p0, LX/2db;->A01:LX/5W4;

    iput-object p2, p0, LX/2db;->A02:LX/32w;

    iput-object p6, p0, LX/2db;->A05:LX/35t;

    iput-object p7, p0, LX/2db;->A06:LX/1Nj;

    iput-object p5, p0, LX/2db;->A04:LX/35W;
...
.method public A00(LX/2jR;Z)V
    ...
    :cond_0
    iget-object v0, p0, LX/2db;->A02:LX/32w;
    ...
    const-string v2, "com.gbwhatsapp.intent.action.OPEN_PRECALL_LOBBY"
    ...
    invoke-static {v7, v6, v0}, LX/0yI;->A15(Landroid/content/Intent;Lcom/whatsapp/jid/Jid;Ljava/lang/String;)V

    const/4 v0, 0x7

    invoke-static {v3, v7, v0}, LX/37u;->A04(Landroid/content/Context;Landroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iput-object v7, v5, LX/0VP;->A0A:Landroid/app/PendingIntent;

    invoke-virtual {v5, v2}, LX/0VP;->A0E(Z)V
    ...
    iget-object v0, p0, LX/2db;->A06:LX/1Nj;
    ...
    invoke-virtual {v8}, LX/1l3;->A0D()Ljava/lang/String;
    ...
    iput-object v1, v5, LX/0VP;->A0L:Ljava/lang/String;

    :cond_1
    iget-object v1, p0, LX/2db;->A03:LX/5bV;

    iget-object v0, p0, LX/2db;->A01:LX/5W4;
    ...
    invoke-static {v1, v2}, LX/0yM;->A1C(LX/0Mx;Ljava/lang/Object;)V

    new-instance v6, LX/0PD;

    invoke-direct {v6, v1}, LX/0PD;-><init>(LX/0Mx;)V

    new-instance v4, Landroidx/core/app/NotificationCompat$MessagingStyle;

    invoke-direct {v4, v6}, Landroidx/core/app/NotificationCompat$MessagingStyle;-><init>(LX/0PD;)V

    iget v1, p1, LX/2jR;->A00:I
    ...
    invoke-direct {v0, v6, v3, v1, v2}, LX/0UO;-><init>(LX/0PD;Ljava/lang/CharSequence;J)V

    invoke-virtual {v4, v0}, Landroidx/core/app/NotificationCompat$MessagingStyle;->A08(LX/0UO;)V
    ...
    iget-object v1, p0, LX/2db;->A04:LX/35W;
    ...
    :cond_4
    invoke-virtual {v8}, LX/1l3;->A0C()Ljava/lang/String;
