...
.field public A0G:LX/2lD;

.field public A0H:LX/3dS;
...
.method public constructor <init>(LX/1af;)V
    ...
    iput-boolean v2, p0, LX/3dS;->A0h:Z

    const-string/jumbo v0, "pn"

    iput-object v0, p0, LX/3dS;->A0N:Ljava/lang/String;

    const/4 v1, 0x0

    iput-object v1, p0, LX/3dS;->A0H:LX/3dS;

    const/4 v0, 0x0

    iput v0, p0, LX/3dS;->A01:I

    iput-object p1, p0, LX/3dS;->A0I:LX/1af;

    iput-boolean v2, p0, LX/3dS;->A10:Z

    iput-object v1, p0, LX/3dS;->A0G:LX/2lD;
    ...
    iput-object v0, p0, LX/3dS;->A0L:LX/30y;

    :cond_0
    return-void
.end method

.method public constructor <init>(LX/1af;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJZ)V
    .locals 4
    ...
    iput-boolean v3, p0, LX/3dS;->A0h:Z
    ...
    iput-object v0, p0, LX/3dS;->A0H:LX/3dS;
    ...
    iput-boolean p8, p0, LX/3dS;->A10:Z

    iput-object p3, p0, LX/3dS;->A0Q:Ljava/lang/String;
    ...
    invoke-direct {v0, p6, p7, p2}, LX/2lD;-><init>(JLjava/lang/String;)V

    iput-object v0, p0, LX/3dS;->A0G:LX/2lD;
    ...
    iput-object v0, p0, LX/3dS;->A0M:Ljava/lang/Integer;

    iput-object p4, p0, LX/3dS;->A0W:Ljava/lang/String;
    ...
    :cond_2
    iput-boolean v3, p0, LX/3dS;->A0n:Z

    return-void
.end method

.method public static A01(LX/3dS;)LX/1af;
    .locals 1
...
.method public static A02(LX/3dS;)LX/1af;
    .locals 1
...
.method public static A03(LX/3dS;)Lcom/whatsapp/jid/Jid;
    .locals 1
...
.method public static A04(LX/3dS;Ljava/lang/Class;)Lcom/whatsapp/jid/Jid;
    .locals 0
...
.method public static A06(LX/3dS;)Lcom/whatsapp/jid/UserJid;
    .locals 1
...
.method public static A07(LX/3dS;)Ljava/lang/Long;
    .locals 2
...
.method public static A08(LX/3dS;)Ljava/lang/String;
    .locals 0
...
.method public static A09(Ljava/util/Collection;)Ljava/util/List;
    .locals 4
...
.method public static A0A(Landroid/content/ContentValues;LX/3dS;)V
    .locals 2
    ...
    iget-object v0, p1, LX/3dS;->A0R:Ljava/lang/String;
...
.method public static A0B(LX/3dS;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    .locals 0
...
.method public static A0C(LX/2XO;Ljava/util/List;)Z
    .locals 8
    ...
    iget-object v3, p0, LX/2XO;->A00:LX/3dS;
    ...
    iget-boolean v0, v3, LX/3dS;->A0h:Z

    iput-boolean v0, v2, LX/3dS;->A0h:Z

    iget v4, v3, LX/3dS;->A06:I

    if-lez v4, :cond_5

    iget v0, v2, LX/3dS;->A06:I

    if-ne v0, v4, :cond_a

    :cond_5
    iget v1, v3, LX/3dS;->A07:I

    if-lez v1, :cond_6

    iget v0, v2, LX/3dS;->A07:I
    ...
    :goto_3
    iput v4, v2, LX/3dS;->A06:I

    iget v0, v3, LX/3dS;->A07:I

    iput v0, v2, LX/3dS;->A07:I

    iget-wide v0, v3, LX/3dS;->A0D:J

    iput-wide v0, v2, LX/3dS;->A0D:J
    ...
    iget-object v0, v3, LX/3dS;->A0O:Ljava/lang/String;

    iput-object v0, v2, LX/3dS;->A0O:Ljava/lang/String;

    invoke-virtual {v3}, LX/3dS;->A0K()Ljava/lang/String;

    move-result-object v1

    instance-of v0, v2, LX/1OD;
    ...
    :goto_4
    iget-object v0, v3, LX/3dS;->A0d:Ljava/util/Locale;

    iput-object v0, v2, LX/3dS;->A0d:Ljava/util/Locale;

    iget v0, v3, LX/3dS;->A09:I

    iput v0, v2, LX/3dS;->A09:I

    goto :goto_2

    :cond_f
    iput-object v1, v2, LX/3dS;->A0b:Ljava/lang/String;
...
.method public static A0D(LX/3dS;)Z
    .locals 0
...
.method public A0E()J
    ...
    :cond_0
    iget-wide v0, p0, LX/3dS;->A0B:J

    return-wide v0
.end method

.method public A0F()LX/3dS;
    .locals 3
...
.method public A0H(Ljava/lang/Class;)Lcom/whatsapp/jid/Jid;
    .locals 1
...
.method public A0I()Ljava/lang/String;
    ...
    iget-object v0, v0, LX/1OD;->A00:LX/2pP;
    ...
    :cond_1
    iget-object v0, p0, LX/3dS;->A0Q:Ljava/lang/String;
...
.method public A0J()Ljava/lang/String;
    ...
    iget-object v3, p0, LX/3dS;->A0G:LX/2lD;
    ...
    iget-object v0, v3, LX/2lD;->A01:Ljava/lang/String;
...
.method public A0K()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, LX/3dS;->A0b:Ljava/lang/String;

    return-object v0
.end method

.method public A0L(FI)Ljava/lang/String;
    .locals 2
    ...
    invoke-virtual {p0}, LX/3dS;->A0J()Ljava/lang/String;
    ...
    invoke-static {v0, v1, p2}, LX/0yJ;->A1J(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
...
.method public A0M(J)V
    ...
    invoke-static {v0, v1, p1, p2}, LX/0yE;->A0z(Ljava/lang/String;Ljava/lang/StringBuilder;J)V

    return-void

    :cond_0
    iput-wide p1, p0, LX/3dS;->A0B:J
...
.method public A0N(LX/30y;)V
    ...
    iget-object v0, p0, LX/3dS;->A0L:LX/30y;

    if-eqz v0, :cond_0

    iget-object v1, v0, LX/30y;->A04:Ljava/lang/String;

    iget-object v0, p1, LX/30y;->A04:Ljava/lang/String;
    ...
    iput-object p1, p0, LX/3dS;->A0L:LX/30y;
...
.method public A0T()Z
    ...
    iget-object v2, p0, LX/3dS;->A0G:LX/2lD;
    ...
    iget-object v0, p0, LX/3dS;->A0M:Ljava/lang/Integer;
    ...
    iget-object v0, v2, LX/2lD;->A01:Ljava/lang/String;
...
.method public A0V()Z
    ...
    iget-boolean v0, p0, LX/3dS;->A0j:Z
...
.method public A0W(LX/2rn;LX/2Kb;)Z
    .locals 6

    if-eqz p2, :cond_3

    iget v1, p2, LX/2Kb;->A00:I
    ...
    :cond_0
    iget-object v0, p2, LX/2Kb;->A01:LX/1aQ;
    ...
    invoke-virtual {p1, v0, v3, v1}, LX/2rn;->A0B(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    :cond_3
    iput-object p2, p0, LX/3dS;->A0K:LX/2Kb;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, LX/3dS;->A0I:LX/1af;
    ...
    iget-object v1, p0, LX/3dS;->A0G:LX/2lD;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, LX/3dS;->A0Y:Ljava/lang/String;
    ...
    iget-object v1, v2, LX/2lD;->A01:Ljava/lang/String;
