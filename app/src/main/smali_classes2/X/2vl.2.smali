...
.method public static declared-synchronized A00(Landroid/content/Context;)V
    ...
    const-class v8, LX/2vl;

    monitor-enter v8

    :try_start_0
    sget-boolean v0, LX/2vl;->A00:Z
    ...
    invoke-static {p0, v1, v0, v6}, Lcom/facebook/soloader/SoLoader;->A00(Landroid/content/Context;LX/45X;[Ljava/lang/String;I)V
    ...
    new-instance v5, LX/16C;

    invoke-direct {v5, v1, v0, v3}, LX/16C;-><init>(Ljava/io/File;[Ljava/lang/String;I)V
    ...
    invoke-static {v7}, LX/0yK;->A1O(Ljava/util/concurrent/locks/ReentrantReadWriteLock;)V
    :try_end_2
    ...
    :cond_2
    invoke-static {v7}, LX/0yH;->A1M(Ljava/util/concurrent/locks/ReentrantReadWriteLock;)V

    invoke-virtual {v5, v1}, LX/2f3;->A04(I)V
    ...
    new-array v2, v0, [LX/2f3;

    aput-object v5, v2, v6

    sget-object v1, Lcom/facebook/soloader/SoLoader;->A0C:[LX/2f3;
    ...
    sput-object v2, Lcom/facebook/soloader/SoLoader;->A0C:[LX/2f3;
