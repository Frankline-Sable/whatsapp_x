...
# direct methods
.method public constructor <init>(LX/1da;LX/2Ez;Ljava/lang/String;Ljava/net/ServerSocket;)V
    .locals 1
    ...
    iput-object p3, p0, LX/1pP;->A03:Ljava/lang/String;

    iput-object p4, p0, LX/1pP;->A04:Ljava/net/ServerSocket;

    iput-object p1, p0, LX/1pP;->A01:LX/1da;

    iput-object p2, p0, LX/1pP;->A02:LX/2Ez;
...
.method public A00()V
    ...
    iget-object v0, p0, LX/1pP;->A00:Ljava/net/Socket;

    invoke-static {v0}, LX/37q;->A03(Ljava/io/Closeable;)V

    iget-object v0, p0, LX/1pP;->A04:Ljava/net/ServerSocket;
...
.method public run()V
    ...
    iput-object v0, p0, LX/1pP;->A00:Ljava/net/Socket;

    const-string v0, "fpm/ReceiverNetworkingThread/Donor connected"

    invoke-static {v0}, Lcom/whatsapp/util/Log;->i(Ljava/lang/String;)V

    iget-object v0, p0, LX/1pP;->A02:LX/2Ez;

    iget-object v3, v0, LX/2Ez;->A00:Lcom/gbwhatsapp/migration/transfer/service/ReceiverP2pTransferService;

    iget-object v1, v3, Lcom/gbwhatsapp/migration/transfer/service/ReceiverP2pTransferService;->A05:LX/2dQ;

    if-eqz v1, :cond_0

    iget-object v0, v1, LX/2dQ;->A00:LX/1c8;
    ...
    iget-object v2, v0, LX/304;->A01:Landroid/net/wifi/p2p/WifiP2pManager;

    if-eqz v2, :cond_0

    iget-object v1, v0, LX/304;->A00:Landroid/net/wifi/p2p/WifiP2pManager$Channel;
    ...
    :cond_0
    iget-object v0, v3, Lcom/gbwhatsapp/migration/transfer/service/ReceiverP2pTransferService;->A04:LX/1da;
    ...
    invoke-static {v0, v5}, LX/38X;->A00(Landroid/os/CancellationSignal;Ljava/io/InputStream;)LX/34r;

    move-result-object v2

    iget v1, v2, LX/34r;->A01:I

    const/16 v0, 0x12c

    if-ne v1, v0, :cond_2

    iget-object v3, p0, LX/1pP;->A03:Ljava/lang/String;

    iget-wide v1, v2, LX/34r;->A02:J
    :try_end_0
    ...
    iget-object v0, p0, LX/1pP;->A01:LX/1da;

    invoke-virtual {v0, v5, v4}, LX/1da;->A09(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    :cond_2
    iget-object v1, p0, LX/1pP;->A01:LX/1da;

    const/16 v0, 0x6b

    invoke-virtual {v1, v0}, LX/1da;->A07(I)V

    invoke-virtual {p0}, LX/1pP;->A00()V
