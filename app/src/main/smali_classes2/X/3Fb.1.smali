...
# direct methods
.method public constructor <init>(LX/3bD;LX/2tS;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LX/3Fb;->A02:LX/2tS;

    iput-object p1, p0, LX/3Fb;->A01:LX/3bD;
...
.method public static A02(Landroid/app/Activity;Landroid/content/Intent;LX/3Fb;Ljava/lang/String;I)V
    .locals 1
    ...
    invoke-virtual {p2, p0, p1}, LX/3Fb;->A07(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static A03(Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, LX/0yI;->A12(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public A07(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object v2, p0, LX/3Fb;->A01:LX/3bD;

    invoke-static {p1, p2}, LX/3Fb;->A06(Landroid/content/Context;Landroid/content/Intent;)Z
...
.method public A08(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, LX/3Fb;->A09(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
...
.method public A09(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {p2, p3}, LX/2uo;->A00(Landroid/content/Intent;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, LX/3Fb;->A07(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public Bcb(Landroid/content/Context;Landroid/net/Uri;LX/373;)V
    ...
    :cond_1
    iget-object v2, p0, LX/3Fb;->A00:LX/1QX;
    ...
    invoke-static {p1, v3}, LX/3Fb;->A06(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-static {p1, v2}, LX/3Fb;->A06(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-static {p1, v1}, LX/3Fb;->A06(Landroid/content/Context;Landroid/content/Intent;)Z

    move-result v0

    if-nez v0, :cond_0

    iget-object v1, p0, LX/3Fb;->A01:LX/3bD;
