...
# direct methods
.method public constructor <init>(LX/3Qm;LX/35r;LX/2pP;LX/35z;LX/2bK;LX/8bd;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, LX/302;->A03:LX/2pP;

    iput-object p1, p0, LX/302;->A01:LX/3Qm;

    iput-object p6, p0, LX/302;->A06:LX/8bd;

    iput-object p2, p0, LX/302;->A02:LX/35r;

    iput-object p5, p0, LX/302;->A05:LX/2bK;

    iput-object p4, p0, LX/302;->A04:LX/35z;
...
.method public A00(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, LX/302;->A01()Z

    move-result v0

    if-eqz v0, :cond_4

    iget-object v4, p0, LX/302;->A04:LX/35z;
    ...
    iget-object v0, p0, LX/302;->A03:LX/2pP;

    iget-object v4, v0, LX/2pP;->A00:Landroid/content/Context;

    sget-object v6, LX/2w3;->A0A:Ljava/lang/String;

    sget-object v5, LX/26D;->A00:Ljava/util/List;
    ...
    invoke-static {v4, v3}, LX/2tz;->A01(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :goto_1
    invoke-static {v2, v3, v0}, LX/0yK;->A17(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v4, v2}, LX/2tz;->A00(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public A01()Z
    ...
    iget-object v1, p0, LX/302;->A01:LX/3Qm;
    ...
    :try_start_0
    iget-object v0, p0, LX/302;->A00:Ljava/lang/Boolean;

    if-nez v0, :cond_3

    iget-object v2, p0, LX/302;->A02:LX/35r;

    iget-object v1, v2, LX/35r;->A0F:Landroid/os/UserManager;

    if-nez v1, :cond_1

    const-string/jumbo v0, "user"

    invoke-static {v2, v0}, LX/35r;->A03(LX/35r;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/os/UserManager;

    iput-object v1, v2, LX/35r;->A0F:Landroid/os/UserManager;
    ...
    iput-object v0, p0, LX/302;->A00:Ljava/lang/Boolean;
