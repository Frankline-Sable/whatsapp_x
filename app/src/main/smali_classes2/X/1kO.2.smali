...
# instance fields
.field public final synthetic A00:LX/1kQ;
...
.method public constructor <init>(LX/1kQ;)V
    ...
    iput-object p1, p0, LX/1kO;->A00:LX/1kQ;

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0, v1, v1}, LX/1p6;-><init>(LX/2qS;ZZZ)V
...
.method public A0E()V
    ...
    iget-object v4, p0, LX/1kO;->A00:LX/1kQ;

    iget-object v0, v4, LX/1kQ;->A03:LX/1Nj;

    iget-object v2, v0, LX/1Nj;->A0S:LX/34t;

    iget-object v0, v0, LX/1Nj;->A0F:LX/2pP;
    ...
    iget-object v0, v4, LX/1kQ;->A04:LX/37e;
    ...
    iget-object v7, v4, LX/1kQ;->A05:LX/1Nh;

    monitor-enter v7

    :try_start_0
    iget-object v0, v7, LX/1Nh;->A07:LX/2fd;
    ...
    iget-object v1, v7, LX/1Nh;->A08:LX/34t;

    const-string/jumbo v0, "sticker_store"

    invoke-virtual {v1, v0, v2}, LX/34t;->A03(Ljava/lang/String;Ljava/io/File;)I
    ...
    :try_start_1
    invoke-virtual {v7, v2}, LX/1Nh;->A0E(Ljava/io/File;)Z

    move-result v3

    if-eqz v3, :cond_1

    iget-object v0, v7, LX/1Nh;->A09:LX/2pk;
    ...
    invoke-virtual {v6, v1, v0}, LX/2tm;->A0G(Ljava/lang/String;Ljava/lang/String;)LX/2tX;

    move-result-object v1

    const/4 v0, 0x1

    invoke-virtual {v1, v0, v9}, LX/2tX;->A07(ILjava/lang/String;)V

    const/4 v0, 0x2

    invoke-virtual {v1, v0, v2}, LX/2tX;->A07(ILjava/lang/String;)V
    ...
    iget-object v0, v7, LX/1Nh;->A01:LX/2sv;

    iget-object v0, v0, LX/2sv;->A03:LX/2ZC;
    ...
    invoke-static {v9, v2, v6}, LX/000;->A12(Ljava/lang/Object;Ljava/lang/Object;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v1, v0, v6}, LX/2tm;->A0I(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_6
    ...
    iget-object v7, v4, LX/1kQ;->A02:LX/34t;

    iget-object v2, v7, LX/34t;->A03:LX/35z;
    ...
    invoke-static {v0, v6, v1}, LX/34t;->A00(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v8

    iget-object v0, v7, LX/34t;->A01:LX/35r;
    ...
    :cond_3
    iget-object v1, v4, LX/1kQ;->A01:LX/2Qd;
    ...
    iput-object v0, v1, LX/1Vw;->A01:Ljava/lang/Boolean;
    ...
    :cond_5
    invoke-static {v2, v6, v1}, LX/0yF;->A13(LX/35z;Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v6, v0, v1}, LX/0yE;->A0S(LX/35z;Ljava/lang/String;J)V
    ...
    invoke-static {v2, v6, v0}, LX/0yE;->A0R(LX/35z;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v6, v9}, LX/0yJ;->A11(Landroid/content/SharedPreferences$Editor;Ljava/lang/String;Ljava/util/Set;)V
    ...
    invoke-static {v0, v6, v1, v9}, LX/0yE;->A0u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/lang/Throwable;)V
