...
.method public constructor <init>(LX/3hX;)V
    ...
    iput-object p1, p0, LX/2XD;->A00:LX/3hX;
...
# virtual methods
.method public final A00(J)LX/2kT;
    .locals 5

    iget-object v0, p0, LX/2XD;->A00:LX/3hX;
    ...
    const-string v2, "SELECT show_mm_disclosure FROM data_sharing_disclosure_metadata WHERE message_row_id = ?"
    ...
    invoke-static {v2, v0}, LX/21q;->A00(Landroid/database/Cursor;I)Z

    move-result v0

    new-instance v1, LX/2kT;

    invoke-direct {v1, v0}, LX/2kT;-><init>(Z)V
    :try_end_1
