...
# direct methods
.method public constructor <init>(LX/32F;I)V
    .locals 0
...
.method public static A00(LX/32F;Ljava/lang/Object;Ljava/util/Map;I)V
    .locals 1

    new-instance v0, LX/4Ab;

    invoke-direct {v0, p0, p3}, LX/4Ab;-><init>(LX/32F;I)V
...
.method public A02(LX/38n;)V
    ...
    invoke-static {v1}, LX/38n;->A0C(LX/38n;)LX/38n;
    ...
    iget-object v10, v1, LX/30Y;->A01:LX/43p;
    ...
    :goto_1
    invoke-interface {v10, v0}, LX/43p;->BY5(Landroid/os/Message;)V
    ...
    invoke-virtual {v1, v9}, LX/38n;->A0n(Ljava/lang/String;)LX/38n;

    move-result-object v5

    const-string/jumbo v8, "type"

    invoke-virtual {v1, v8}, LX/38n;->A0n(Ljava/lang/String;)LX/38n;
    ...
    invoke-virtual {v0, v13}, LX/38n;->A0n(Ljava/lang/String;)LX/38n;
    ...
    invoke-virtual {v1, v7}, LX/38n;->A0n(Ljava/lang/String;)LX/38n;
    ...
    invoke-static {v0, v13}, LX/38n;->A0P(LX/38n;Ljava/lang/String;)V

    aget-object v0, v12, v1

    invoke-static {v0, v10}, LX/38n;->A0Z(LX/38n;I)[B
    ...
    invoke-static {v5, v0}, LX/38n;->A0Z(LX/38n;I)[B

    move-result-object v5

    const/4 v0, 0x1

    invoke-static {v4, v0}, LX/38n;->A0Z(LX/38n;I)[B

    move-result-object v0

    aget-byte v4, v0, v14

    invoke-static {v3, v10}, LX/38n;->A0Z(LX/38n;I)[B

    move-result-object v3

    const/16 v0, 0x14

    invoke-static {v2, v0}, LX/38n;->A0Z(LX/38n;I)[B
    ...
    invoke-static {v2, v0}, LX/38n;->A0P(LX/38n;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3, v0}, LX/0yL;->A1B(LX/43p;Ljava/lang/Object;I)V
