...
# direct methods
.method public constructor <init>(Landroid/net/ConnectivityManager;LX/42d;)V
    .locals 2

    new-instance v1, LX/2Ch;

    invoke-direct {v1, p2}, LX/2Ch;-><init>(LX/42d;)V
    ...
    iput-object p1, p0, LX/37X;->A04:Landroid/net/ConnectivityManager;

    iput-object v1, p0, LX/37X;->A05:LX/2Ch;

    iput-object v0, p0, LX/37X;->A07:Ljava/util/concurrent/ScheduledExecutorService;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/37X;->A03:Z

    iput-object p2, p0, LX/37X;->A06:LX/42d;

    return-void
.end method

.method public static synthetic A00(LX/37X;)V
    .locals 2

    iget-boolean v1, p0, LX/37X;->A03:Z
    ...
    invoke-virtual {p0, v0}, LX/37X;->A07(Z)V
...
.method public static synthetic A01(LX/37X;)V
    .locals 3
    ...
    invoke-direct {v0, p0}, Lcom/whatsapp/calling/MultiNetworkCallback;-><init>(LX/37X;)V
    ...
    iput-boolean v2, p0, LX/37X;->A03:Z

    return-void
.end method

.method public static synthetic A02(LX/37X;Z)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1}, LX/37X;->A07(Z)V

    return-void
.end method

.method public static synthetic A03(LX/37X;ZZ)V
    .locals 6
    ...
    :cond_0
    iget-object v0, p0, LX/37X;->A01:Landroid/net/Network;
    ...
    iget-object v0, p0, LX/37X;->A02:Ljava/net/DatagramSocket;
    ...
    invoke-virtual {p0, v0, p2}, LX/37X;->A06(Landroid/net/Network;Z)V
    ...
    invoke-direct {v4, p0, v0, p2}, LX/3gT;-><init>(LX/37X;IZ)V

    iget-object v3, p0, LX/37X;->A07:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v0, p0, v1, p2}, LX/0zj;-><init>(LX/37X;Ljava/util/concurrent/ScheduledFuture;Z)V

    iput-object v0, p0, LX/37X;->A00:Landroid/net/ConnectivityManager$NetworkCallback;

    sget v4, Landroid/os/Build$VERSION;->SDK_INT:I

    const/16 v0, 0x1a

    iget-object v3, p0, LX/37X;->A04:Landroid/net/ConnectivityManager;

    invoke-virtual {v5}, Landroid/net/NetworkRequest$Builder;->build()Landroid/net/NetworkRequest;

    move-result-object v2

    iget-object v1, p0, LX/37X;->A00:Landroid/net/ConnectivityManager$NetworkCallback;
...
.method public A04()V
    ...
    iget-object v2, p0, LX/37X;->A07:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final A06(Landroid/net/Network;Z)V
    ...
    iput-object p1, p0, LX/37X;->A01:Landroid/net/Network;

    new-instance v1, Ljava/net/DatagramSocket;

    invoke-direct {v1}, Ljava/net/DatagramSocket;-><init>()V

    iput-object v1, p0, LX/37X;->A02:Ljava/net/DatagramSocket;
    ...
    :goto_2
    iget-object v2, p0, LX/37X;->A02:Ljava/net/DatagramSocket;
    ...
    :cond_1
    invoke-virtual {p0, v3}, LX/37X;->A07(Z)V
...
.method public final A07(Z)V
    ...
    iput-object v2, p0, LX/37X;->A02:Ljava/net/DatagramSocket;
    ...
    :try_start_0
    iget-object v0, p0, LX/37X;->A04:Landroid/net/ConnectivityManager;
    ...
    :goto_0
    iput-object v2, p0, LX/37X;->A00:Landroid/net/ConnectivityManager$NetworkCallback;

    :cond_1
    iput-object v2, p0, LX/37X;->A01:Landroid/net/Network;
