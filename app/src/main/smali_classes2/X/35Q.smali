...
.field public A0X:[Lcom/gbwhatsapp/InteractiveAnnotation;
...
.method public constructor <init>(LX/35Q;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-object v0, p1, LX/35Q;->A0S:[B

    iput-object v0, p0, LX/35Q;->A0S:[B

    iget-object v0, p1, LX/35Q;->A0G:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0G:Ljava/lang/String;

    iget-object v0, p1, LX/35Q;->A0H:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0H:Ljava/lang/String;

    iget v0, p1, LX/35Q;->A02:I

    iput v0, p0, LX/35Q;->A02:I

    iget v0, p1, LX/35Q;->A03:I

    iput v0, p0, LX/35Q;->A03:I

    iget-object v0, p1, LX/35Q;->A0F:Ljava/io/File;

    iput-object v0, p0, LX/35Q;->A0F:Ljava/io/File;

    iget-wide v0, p1, LX/35Q;->A0A:J

    iput-wide v0, p0, LX/35Q;->A0A:J

    iget v0, p1, LX/35Q;->A04:I

    iput v0, p0, LX/35Q;->A04:I

    iget-object v0, p1, LX/35Q;->A0T:[B

    iput-object v0, p0, LX/35Q;->A0T:[B

    iget-boolean v0, p1, LX/35Q;->A0N:Z

    iput-boolean v0, p0, LX/35Q;->A0N:Z

    iget v0, p1, LX/35Q;->A05:I

    iput v0, p0, LX/35Q;->A05:I

    iget v0, p1, LX/35Q;->A06:I

    iput v0, p0, LX/35Q;->A06:I

    iget-object v0, p1, LX/35Q;->A0U:[B

    iput-object v0, p0, LX/35Q;->A0U:[B

    iget-object v0, p1, LX/35Q;->A0X:[Lcom/gbwhatsapp/InteractiveAnnotation;

    iput-object v0, p0, LX/35Q;->A0X:[Lcom/gbwhatsapp/InteractiveAnnotation;

    iget-object v0, p1, LX/35Q;->A0V:[B

    iput-object v0, p0, LX/35Q;->A0V:[B

    iget-object v0, p1, LX/35Q;->A0I:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0I:Ljava/lang/String;

    iget-object v0, p1, LX/35Q;->A0W:[B

    iput-object v0, p0, LX/35Q;->A0W:[B

    iget-wide v0, p1, LX/35Q;->A0B:J

    iput-wide v0, p0, LX/35Q;->A0B:J

    iget v0, p1, LX/35Q;->A07:I

    iput v0, p0, LX/35Q;->A07:I

    iget v0, p1, LX/35Q;->A00:F

    iput v0, p0, LX/35Q;->A00:F

    iget-boolean v0, p1, LX/35Q;->A0R:Z

    iput-boolean v0, p0, LX/35Q;->A0R:Z

    iget v0, p1, LX/35Q;->A08:I

    iput v0, p0, LX/35Q;->A08:I

    iget-object v0, p1, LX/35Q;->A0L:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0L:Ljava/lang/String;

    iget-object v0, p1, LX/35Q;->A0K:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0K:Ljava/lang/String;

    iget-object v0, p1, LX/35Q;->A0J:Ljava/lang/String;

    iput-object v0, p0, LX/35Q;->A0J:Ljava/lang/String;

    iget v0, p1, LX/35Q;->A01:I
...
.method public static A00(Lcom/whatsapp/MediaData;)LX/35Q;
    .locals 3
    ...
    iput-boolean v0, v2, LX/35Q;->A0Y:Z
    ...
    iput-object v0, v2, LX/35Q;->A0H:Ljava/lang/String;
    ...
    iput-object v0, v2, LX/35Q;->A0X:[Lcom/gbwhatsapp/InteractiveAnnotation;
...
.method public static A01(Landroid/content/ContentValues;LX/35Q;)V
    .locals 2
    ...
    invoke-static {p0, v1, v0}, LX/38k;->A07(Landroid/content/ContentValues;Ljava/lang/String;[B)V
...
.method public A02()Lcom/whatsapp/MediaData;
    ...
    iget v0, p0, LX/35Q;->A08:I

    iput v0, v2, Lcom/whatsapp/MediaData;->width:I

    iget-boolean v0, p0, LX/35Q;->A0M:Z
...
.method public A03()LX/35Q;
    .locals 3

    new-instance v2, LX/35Q;

    invoke-direct {v2, p0}, LX/35Q;-><init>(LX/35Q;)V
    ...
    iget-boolean v0, p0, LX/35Q;->A0P:Z

    iput-boolean v0, v2, LX/35Q;->A0P:Z

    iget-boolean v0, p0, LX/35Q;->A0O:Z

    iput-boolean v0, v2, LX/35Q;->A0O:Z
