...
# direct methods
.method public constructor <init>(LX/4Ti;II)V
    .locals 2

    invoke-direct {p0}, LX/0PT;-><init>()V

    iput-object p1, p0, LX/4U8;->A03:LX/4Ti;

    iput p3, p0, LX/4U8;->A01:I
    ...
    iput-object v1, p0, LX/4U8;->A02:Landroid/graphics/Paint;
...
.method public A01(Landroid/graphics/Canvas;LX/0Qa;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, v1}, LX/4U8;->A04(Landroid/view/View;)Z
    ...
    iget-object v13, p0, LX/4U8;->A02:Landroid/graphics/Paint;

    iget v0, p0, LX/4U8;->A00:I
...
.method public A03(Landroid/graphics/Rect;Landroid/view/View;LX/0Qa;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, p2}, LX/4U8;->A04(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p0, LX/4U8;->A01:I
...
.method public final A04(Landroid/view/View;)Z
    ...
    iget-object v1, p0, LX/4U8;->A03:LX/4Ti;

    const/4 v0, -0x1

    if-eq v3, v0, :cond_2

    iget-object v2, v1, LX/4Ti;->A0z:LX/5vi;

    invoke-virtual {v2, v3}, LX/5vi;->A00(I)I
    ...
    invoke-virtual {v2, v1}, LX/5vi;->A00(I)I
