...
# direct methods
.method public static A00(Landroid/content/Context;LX/35r;Ljava/lang/CharSequence;)V
    .locals 3

    invoke-virtual {p1}, LX/35r;->A0O()Landroid/view/accessibility/AccessibilityManager;
...
.method public static A03(Landroid/view/View;I)V
    ...
    new-array v2, v0, [LX/5JY;

    const/16 v0, 0x10

    new-instance v1, LX/5JY;

    invoke-direct {v1, v0, p1}, LX/5JY;-><init>(II)V
    ...
    invoke-static {p0, v2, v0}, LX/4Dw;->A15(Landroid/view/View;Ljava/lang/Object;I)V
...
.method public static A06(Landroid/view/View;Z)V
    ...
    invoke-direct {v0, p1}, LX/4OD;-><init>(Z)V
...
.method public static A07(LX/35r;)Z
    .locals 1

    invoke-virtual {p0}, LX/35r;->A0O()Landroid/view/accessibility/AccessibilityManager;
