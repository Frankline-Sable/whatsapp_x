...
.method public static A00(Ljava/lang/String;)Landroid/text/Spannable;
    ...
    invoke-static {p0}, LX/4E3;->A0b(Ljava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;
...
.method public static varargs A02(Ljava/lang/String;[Landroid/text/Spannable;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-static {v1, v2}, LX/4E3;->A0L(Ljava/lang/String;I)I
...
.method public static A03(Landroid/text/TextPaint;LX/35r;LX/35t;LX/2zt;Ljava/lang/CharSequence;IIZ)Landroid/util/Pair;
    .locals 18
    ...
    invoke-static {v1, v0}, LX/33a;->A01(LX/35r;LX/2zt;)I
    ...
    invoke-static {v13, v5, v0}, LX/5dm;->A04(Ljava/lang/CharSequence;IZ)Landroid/util/Pair;
    ...
    invoke-static/range {v12 .. v18}, LX/5dm;->A0C(Landroid/text/TextPaint;Ljava/lang/CharSequence;Ljava/util/List;FIIZ)Ljava/util/List;
    ...
    :cond_2
    invoke-static {v3, v1}, LX/5dm;->A0J(Landroid/text/Editable;Ljava/util/List;)V
    ...
    invoke-static {v3, v8, v9}, LX/5dm;->A0G(Landroid/text/Editable;LX/5YB;I)V
    ...
    :goto_2
    iget-object v7, v8, LX/5YB;->A04:Landroid/text/ParcelableSpan;

    iget v1, v8, LX/5YB;->A00:I

    iget v0, v8, LX/5YB;->A01:I
    ...
    :cond_6
    invoke-static {v3, v8, v14}, LX/5dm;->A0H(Landroid/text/Editable;LX/5YB;Ljava/util/List;)V
    ...
    iget v9, v8, LX/5YB;->A00:I

    iget v7, v8, LX/5YB;->A03:I

    sub-int v0, v9, v7

    sget-object v1, LX/2w1;->A07:Ljava/lang/String;

    invoke-virtual {v3, v0, v9, v1}, Landroid/text/SpannableStringBuilder;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;

    iget v0, v8, LX/5YB;->A01:I

    add-int/2addr v7, v0

    invoke-virtual {v3, v0, v7, v1}, Landroid/text/SpannableStringBuilder;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;
    ...
    invoke-static/range {p2 .. p2}, LX/35t;->A05(LX/35t;)Ljava/util/Locale;
    ...
    invoke-virtual {v0, v1}, Landroid/text/BidiFormatter;->isRtl(Ljava/lang/String;)Z
    ...
    invoke-direct/range {v11 .. v19}, LX/5h8;-><init>(Landroid/text/TextPaint;FFFIIIZ)V
    ...
    invoke-virtual {v3, v11, v1, v0, v4}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
...
.method public static A04(Ljava/lang/CharSequence;IZ)Landroid/util/Pair;
    ...
    invoke-static {v6, v8, v1, v11}, LX/5dm;->A05(Ljava/lang/CharSequence;Ljava/lang/Character;IZ)LX/5YA;
    ...
    check-cast v13, LX/5YB;

    iget v15, v13, LX/5YB;->A00:I

    aget v12, v3, v9

    if-le v15, v12, :cond_a

    iget v12, v13, LX/5YB;->A01:I
    ...
    :goto_6
    new-instance v13, LX/5YB;

    invoke-direct {v13, v11, v12, v1}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;II)V
    ...
    new-instance v11, LX/5YB;

    move v13, v2

    move v14, v9

    invoke-direct/range {v11 .. v16}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;IIII)V
    ...
    iget v11, v12, LX/5YB;->A00:I

    add-int/lit8 v10, v2, -0x1

    if-le v11, v10, :cond_12

    iget v10, v12, LX/5YB;->A01:I
    ...
    invoke-direct/range {v13 .. v18}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;IIII)V
    ...
    :cond_1d
    invoke-static {v5, v7}, LX/0yN;->A0F(Ljava/lang/Object;Ljava/lang/Object;)Landroid/util/Pair;
...
.method public static A05(Ljava/lang/CharSequence;Ljava/lang/Character;IZ)LX/5YA;
    .locals 7
    ...
    invoke-direct {v2, v0, p2}, LX/5YA;-><init>(II)V
    ...
    invoke-direct {v2, v0, p2, v1}, LX/5YA;-><init>(III)V
...
.method public static A06(LX/35r;LX/2zt;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    .locals 2
    ...
    invoke-static {p0, p1, p2, v0, v1}, LX/5dm;->A08(LX/35r;LX/2zt;Ljava/lang/CharSequence;IZ)Ljava/lang/CharSequence;
...
.method public static A07(LX/35r;LX/2zt;Ljava/lang/CharSequence;F)Ljava/lang/CharSequence;
    .locals 4

    const/high16 v3, -0x1000000

    invoke-static {p0, p1}, LX/33a;->A01(LX/35r;LX/2zt;)I
    ...
    invoke-static {p2, p3, v3, v1, v0}, LX/5dm;->A09(Ljava/lang/CharSequence;FIIZ)Ljava/lang/CharSequence;
...
.method public static A08(LX/35r;LX/2zt;Ljava/lang/CharSequence;IZ)Ljava/lang/CharSequence;
    .locals 1
    ...
    invoke-static {p2, p0, v0}, LX/5dm;->A04(Ljava/lang/CharSequence;IZ)Landroid/util/Pair;
    ...
    invoke-static {p2, p0, p3, p4}, LX/5dm;->A0K(Landroid/text/Editable;Ljava/util/List;IZ)V
...
.method public static A09(Ljava/lang/CharSequence;FIIZ)Ljava/lang/CharSequence;
    ...
    invoke-static {p0, p3, v0}, LX/5dm;->A04(Ljava/lang/CharSequence;IZ)Landroid/util/Pair;
    ...
    invoke-static/range {v2 .. v8}, LX/5dm;->A0C(Landroid/text/TextPaint;Ljava/lang/CharSequence;Ljava/util/List;FIIZ)Ljava/util/List;

    move-result-object v0

    invoke-static {v1, v0}, LX/5dm;->A0J(Landroid/text/Editable;Ljava/util/List;)V

    invoke-static {v1, v4, p2, p4}, LX/5dm;->A0K(Landroid/text/Editable;Ljava/util/List;IZ)V
...
.method public static A0C(Landroid/text/TextPaint;Ljava/lang/CharSequence;Ljava/util/List;FIIZ)Ljava/util/List;
    ...
    invoke-static {v11, v14, v1, v8}, LX/5dm;->A05(Ljava/lang/CharSequence;Ljava/lang/Character;IZ)LX/5YA;
    ...
    check-cast v14, LX/5YB;

    iget v13, v14, LX/5YB;->A02:I

    const/4 v0, 0x1

    if-ne v13, v0, :cond_0

    iget v0, v14, LX/5YB;->A00:I

    if-ge v0, v1, :cond_0

    iget v0, v14, LX/5YB;->A01:I
    ...
    invoke-direct {v14, v5, v13}, Landroid/text/style/LeadingMarginSpan$Standard;-><init>(II)V
    ...
    invoke-direct/range {v19 .. v24}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;IIII)V

    invoke-virtual {v2, v13}, Ljava/util/AbstractCollection;->add(Ljava/lang/Object;)Z

    new-instance v14, LX/4G3;

    invoke-direct {v14, v7, v6}, LX/4G3;-><init>(II)V
    ...
    iget v0, v13, LX/5YA;->A03:I

    if-ne v0, v15, :cond_7

    iget v14, v13, LX/5YA;->A04:I

    iget v0, v13, LX/5YA;->A02:I

    add-int/2addr v0, v14

    add-int/lit8 v0, v0, 0x2

    invoke-static {v11, v14, v0, v12}, Landroid/text/Layout;->getDesiredWidth(Ljava/lang/CharSequence;IILandroid/text/TextPaint;)F

    move-result v14

    :goto_3
    iput v14, v13, LX/5YA;->A00:F

    iput v1, v13, LX/5YA;->A01:I
    ...
    invoke-direct {v13, v14, v0, v15}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;II)V
    ...
    new-instance v14, LX/4G1;

    invoke-direct {v14, v13, v7, v5, v9}, LX/4G1;-><init>(FIII)V
    ...
    invoke-direct {v8, v5, v4}, Landroid/text/style/LeadingMarginSpan$Standard;-><init>(II)V
    ...
    invoke-direct {v5, v7, v6}, LX/4G3;-><init>(II)V
    ...
    invoke-direct/range {v4 .. v9}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;IIII)V
    ...
    iget v9, v4, LX/5YA;->A04:I

    iget v10, v4, LX/5YA;->A01:I

    new-instance v8, LX/4G2;

    invoke-direct {v8, v1, v0}, LX/4G2;-><init>(II)V
    ...
    invoke-direct/range {v7 .. v12}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;IIII)V
    ...
    invoke-static {v11, v1, v0, v12}, Landroid/text/Layout;->getDesiredWidth(Ljava/lang/CharSequence;IILandroid/text/TextPaint;)F

    move-result v1

    iput v1, v13, LX/5YA;->A00:F

    iput v3, v13, LX/5YA;->A01:I
    ...
    new-instance v6, LX/5YB;

    invoke-direct {v6, v8, v0, v3}, LX/5YB;-><init>(Landroid/text/ParcelableSpan;II)V

    invoke-virtual {v2, v6}, Ljava/util/AbstractCollection;->add(Ljava/lang/Object;)Z

    int-to-float v4, v4

    new-instance v6, LX/4G1;

    invoke-direct {v6, v4, v7, v5, v9}, LX/4G1;-><init>(FIII)V
...
.method public static A0D(Landroid/content/Context;Landroid/graphics/Paint;Landroid/text/Editable;LX/35r;LX/5aD;LX/2zt;)V
    .locals 2
    ...
    invoke-static {p0, v1, p4}, LX/0yF;->A1A(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {p0, p1, p2, p4, v0}, LX/5dL;->A07(Landroid/content/Context;Landroid/graphics/Paint;Landroid/text/Editable;LX/5aD;F)V

    const/4 v0, 0x0

    invoke-static {p2, v0}, LX/5dm;->A0L(Landroid/text/Editable;Z)V

    invoke-virtual {p1}, Landroid/graphics/Paint;->getColor()I

    move-result v0

    invoke-static {p3, p5, p2, v0, v1}, LX/5dm;->A08(LX/35r;LX/2zt;Ljava/lang/CharSequence;IZ)Ljava/lang/CharSequence;

    return-void
.end method

.method public static A0E(Landroid/content/Context;Landroid/net/Uri;LX/3Fb;LX/3bD;Lcom/gbwhatsapp/TextEmojiLabel;LX/35r;Ljava/lang/String;Ljava/lang/String;)V
    .locals 7

    new-instance v6, LX/5vp;

    invoke-direct {v6, p7, p1}, LX/5vp;-><init>(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-static/range {v0 .. v6}, LX/5dm;->A0F(Landroid/content/Context;LX/3Fb;LX/3bD;Lcom/gbwhatsapp/TextEmojiLabel;LX/35r;Ljava/lang/String;Ljava/util/Map;)V

    return-void
.end method

.method public static A0F(Landroid/content/Context;LX/3Fb;LX/3bD;Lcom/gbwhatsapp/TextEmojiLabel;LX/35r;Ljava/lang/String;Ljava/util/Map;)V
    .locals 10
    ...
    :cond_0
    invoke-static {p5, v3}, LX/5dm;->A01(Ljava/lang/String;Ljava/util/Map;)Landroid/text/SpannableStringBuilder;

    move-result-object v0

    invoke-static {p3}, LX/4Fl;->A01(Lcom/gbwhatsapp/TextEmojiLabel;)V

    invoke-static {p3, p4}, LX/4NU;->A06(Lcom/gbwhatsapp/TextEmojiLabel;LX/35r;)V
...
.method public static A0G(Landroid/text/Editable;LX/5YB;I)V
    .locals 5
    ...
    iget v1, p1, LX/5YB;->A00:I

    iget v3, p1, LX/5YB;->A03:I
...
.method public static A0H(Landroid/text/Editable;LX/5YB;Ljava/util/List;)V
    .locals 4
    ...
    iget v0, p1, LX/5YB;->A00:I

    sub-int/2addr v0, v3

    invoke-static {p2, v0, v3}, LX/5dm;->A0M(Ljava/util/List;II)V

    iget v1, p1, LX/5YB;->A01:I
...
.method public static A0J(Landroid/text/Editable;Ljava/util/List;)V
    ...
    :cond_0
    iget-object v2, v4, LX/5YB;->A04:Landroid/text/ParcelableSpan;

    iget v1, v4, LX/5YB;->A00:I

    iget v0, v4, LX/5YB;->A01:I
...
.method public static A0K(Landroid/text/Editable;Ljava/util/List;IZ)V
    ...
    invoke-static {p0, v0, p2}, LX/5dm;->A0G(Landroid/text/Editable;LX/5YB;I)V

    :goto_1
    iget-object v3, v0, LX/5YB;->A04:Landroid/text/ParcelableSpan;

    iget v2, v0, LX/5YB;->A00:I

    iget v1, v0, LX/5YB;->A01:I
    ...
    :cond_0
    invoke-static {p0, v0, p1}, LX/5dm;->A0H(Landroid/text/Editable;LX/5YB;Ljava/util/List;)V
...
.method public static A0L(Landroid/text/Editable;Z)V
    ...
    invoke-static {p0, v0, v1}, LX/5dm;->A0I(Landroid/text/Editable;Ljava/lang/Class;I)V
...
.method public static A0M(Ljava/util/List;II)V
    .locals 2
    ...
    iget v0, v1, LX/5YB;->A00:I

    if-le v0, p1, :cond_1

    sub-int/2addr v0, p2

    iput v0, v1, LX/5YB;->A00:I

    :cond_1
    iget v0, v1, LX/5YB;->A01:I

    if-le v0, p1, :cond_0

    sub-int/2addr v0, p2

    iput v0, v1, LX/5YB;->A01:I
...
.method public static A0N(LX/35r;LX/2zt;Ljava/lang/CharSequence;)Z
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p0, p1, p2}, LX/5dm;->A06(LX/35r;LX/2zt;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
