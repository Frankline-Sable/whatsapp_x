...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, LX/4fh;-><init>(Landroid/content/Context;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, LX/4fh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/4fh;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public A04()V
    ...
    iget-boolean v0, v3, Lcom/gbwhatsapp/mentions/MentionPickerView;->A0J:Z

    if-eqz v0, :cond_2

    iget-object v0, v3, Lcom/gbwhatsapp/mentions/MentionPickerView;->A0G:LX/4Tg;
    ...
    invoke-virtual {v3, v0, v0}, LX/4pt;->A07(II)V
...
.method public final A05()V
    ...
    iget-object v0, p0, LX/4pt;->A02:Landroid/view/View;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LX/4pt;->getContentView()Landroid/view/View;
...
.method public A06(I)V
    ...
    iget-object v0, p0, LX/4pt;->A01:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    invoke-static {p0}, LX/4Dw;->A1Y(Landroid/view/View;)Z
    ...
    iput-object v1, p0, LX/4pt;->A01:Landroid/animation/ValueAnimator;

    const/16 v0, 0x1b

    invoke-static {v1, p0, v0}, LX/5Fx;->A03(Landroid/animation/ValueAnimator;Ljava/lang/Object;I)V

    iget-object v2, p0, LX/4pt;->A01:Landroid/animation/ValueAnimator;

    const/4 v1, 0x1

    new-instance v0, LX/6HD;

    invoke-direct {v0, p0, p1, v1}, LX/6HD;-><init>(Ljava/lang/Object;II)V
...
.method public A07(II)V
    ...
    invoke-virtual {p0, p2}, LX/4pt;->A06(I)V

    :cond_0
    return-void

    :cond_1
    invoke-direct {p0}, LX/4pt;->getActionBarSize()I
    ...
    iget-object v0, p0, LX/4pt;->A03:Landroid/view/View;
    ...
    iput-object v0, p0, LX/4pt;->A03:Landroid/view/View;
    ...
    invoke-static {p0, v2}, LX/4Dz;->A09(Landroid/view/View;[I)I
    ...
    invoke-virtual {p0, v0}, LX/4pt;->A06(I)V
...
.method public A08(Z)V
    ...
    iget-object v0, v0, Lcom/gbwhatsapp/mentions/MentionPickerView;->A0E:LX/6Ec;
    ...
    iget-object v0, v0, Lcom/gbwhatsapp/bonsai/commands/BotCommandsPickerView;->A03:LX/6C7;

    if-eqz v0, :cond_0

    check-cast v0, LX/5nQ;

    iget-object v1, v0, LX/5nQ;->A00:LX/5pH;
...
.method public setAnchorWidthView(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, LX/4pt;->A05()V
...
.method public setConstraintParentView(Landroid/view/View;)V
    ...
    iput-object p1, p0, LX/4pt;->A03:Landroid/view/View;
