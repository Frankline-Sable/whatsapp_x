...
# direct methods
.method public static final A00(Landroid/content/Context;)Lcom/gbwhatsapp/WaFrameLayout;
    .locals 17
    ...
    new-instance v5, Lcom/gbwhatsapp/WaFrameLayout;

    invoke-direct {v5, v8}, Lcom/gbwhatsapp/WaFrameLayout;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v5, v9, v4}, LX/4Dx;->A1C(Landroid/view/View;II)V

    const v0, 0x7f080115

    invoke-static {v8, v0}, LX/0S4;->A00(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {v5, v0}, Lcom/gbwhatsapp/WaFrameLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V

    new-instance v3, Landroid/widget/LinearLayout;

    invoke-direct {v3, v8}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    invoke-static {v3, v9, v4}, LX/4Dx;->A1C(Landroid/view/View;II)V

    const v0, 0x7f0808ca

    invoke-static {v8, v3, v0}, LX/4Dy;->A0t(Landroid/content/Context;Landroid/view/View;I)V
    ...
    invoke-static {v6, v0, v2}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I
    ...
    invoke-static {v1, v0, v9}, LX/4Dx;->A1C(Landroid/view/View;II)V
    ...
    invoke-static {v6, v15, v2}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I
    ...
    new-instance v13, Lcom/gbwhatsapp/conversation/conversationrow/ConversationRowParticipantHeaderQuotedView;

    invoke-direct {v13, v8}, Lcom/gbwhatsapp/conversation/conversationrow/ConversationRowParticipantHeaderQuotedView;-><init>(Landroid/content/Context;)V
    ...
    new-instance v11, Lcom/gbwhatsapp/TextEmojiLabel;

    invoke-direct {v11, v8}, Lcom/gbwhatsapp/TextEmojiLabel;-><init>(Landroid/content/Context;)V

    const v0, 0x7f0b149d

    invoke-static {v11, v0}, LX/5Wy;->A01(Landroid/widget/TextView;I)V

    const v12, 0x7f060a26

    invoke-static {v8, v11, v12}, LX/0yI;->A13(Landroid/content/Context;Landroid/widget/TextView;I)V

    invoke-virtual {v13, v11}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    new-instance v14, Lcom/gbwhatsapp/WaTextView;

    invoke-direct {v14, v8}, Lcom/gbwhatsapp/WaTextView;-><init>(Landroid/content/Context;)V

    const v0, 0x7f0b148f

    invoke-static {v14, v0}, LX/5Wy;->A01(Landroid/widget/TextView;I)V
    ...
    invoke-static {v8, v14, v12}, LX/0yI;->A13(Landroid/content/Context;Landroid/widget/TextView;I)V
    ...
    new-instance v12, Lcom/gbwhatsapp/TextEmojiLabel;

    invoke-direct {v12, v8}, Lcom/gbwhatsapp/TextEmojiLabel;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v12}, LX/4E3;->A1M(Landroid/widget/TextView;)V

    const v0, 0x7f060a73

    invoke-static {v8, v12, v0}, LX/0yI;->A13(Landroid/content/Context;Landroid/widget/TextView;I)V
    ...
    invoke-static {v6, v11, v2}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I
    ...
    invoke-direct {v14, v8}, Lcom/gbwhatsapp/TextEmojiLabel;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v8, v14, v0}, LX/0yI;->A13(Landroid/content/Context;Landroid/widget/TextView;I)V
    ...
    new-instance v13, Lcom/gbwhatsapp/WaImageView;

    invoke-direct {v13, v8}, Lcom/gbwhatsapp/WaImageView;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v6, v14, v2}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I

    move-result v9

    const/4 v0, -0x1

    invoke-static {v13, v9, v0}, LX/4Dx;->A1C(Landroid/view/View;II)V

    invoke-static {v13}, LX/4E0;->A1I(Landroid/widget/ImageView;)V
    ...
    invoke-static {v13, v4, v10}, LX/4Dx;->A1C(Landroid/view/View;II)V

    invoke-virtual {v13, v1}, Landroid/view/View;->setVisibility(I)V

    new-instance v9, Lcom/gbwhatsapp/WaImageView;

    invoke-direct {v9, v8}, Lcom/gbwhatsapp/WaImageView;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v9, v0, v10}, LX/4Dx;->A1C(Landroid/view/View;II)V
    ...
    new-instance v9, Lcom/gbwhatsapp/WaTextView;

    invoke-direct {v9, v8}, Lcom/gbwhatsapp/WaTextView;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v9, v2}, LX/0Ys;->A03(Landroid/widget/TextView;I)V

    const/16 v0, 0xc

    int-to-float v10, v0

    invoke-static {v6, v10, v12}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I
    ...
    invoke-static {v6, v0, v12}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I

    move-result v14

    invoke-static {v6, v11, v12}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I

    move-result v0

    invoke-static {v9, v15, v14, v0, v7}, LX/0Ys;->A07(Landroid/widget/TextView;IIII)V

    const v0, 0x7f060983

    invoke-static {v8, v9, v0}, LX/0yI;->A13(Landroid/content/Context;Landroid/widget/TextView;I)V
    ...
    invoke-static {v8, v7, v0}, LX/4Dw;->A0p(Landroid/content/Context;Landroid/view/View;I)V

    invoke-static {v6, v10, v2}, LX/6Bw;->A02(Landroid/util/DisplayMetrics;FI)I
    ...
    invoke-direct {v3, v8}, Lcom/gbwhatsapp/WaImageView;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v3, v1, v0}, LX/4E2;->A15(Landroid/view/View;II)V
