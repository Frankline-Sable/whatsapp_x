...
# direct methods
.method public constructor <init>(Landroid/content/res/Resources;Landroidx/recyclerview/widget/GridLayoutManager;LX/1QX;)V
    .locals 1

    invoke-direct {p0}, LX/0Ob;-><init>()V

    iput-object p2, p0, LX/4UH;->A01:Landroidx/recyclerview/widget/GridLayoutManager;

    iput-object p1, p0, LX/4UH;->A00:Landroid/content/res/Resources;
...
.method public A04(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    invoke-virtual {p0, p1}, LX/4UH;->A06(Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public A06(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object v9, p0, LX/4UH;->A01:Landroidx/recyclerview/widget/GridLayoutManager;
    ...
    iget-object v0, p0, LX/4UH;->A00:Landroid/content/res/Resources;
    ...
    invoke-virtual {v9}, LX/0Yb;->A08()I
    ...
    invoke-virtual {v9, v2}, LX/0Yb;->A0Q(I)Landroid/view/View;
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->A0H(Landroid/view/View;)LX/0VI;

    move-result-object v10

    check-cast v10, LX/4WF;
    ...
    :goto_2
    iget-boolean v0, v10, LX/4WF;->A02:Z

    if-eq v0, v1, :cond_0

    iput-boolean v1, v10, LX/4WF;->A02:Z

    if-eqz v1, :cond_1

    iget-boolean v0, v10, LX/4WF;->A03:Z

    if-eqz v0, :cond_1

    iget-object v1, v10, LX/4WF;->A07:Lcom/whatsapp/stickers/StickerView;
