...
.field public final synthetic A03:LX/5a9;


# direct methods
.method public constructor <init>(LX/5a9;IIZ)V
    .locals 0

    iput-object p1, p0, LX/4U5;->A03:LX/5a9;

    invoke-direct {p0}, LX/0PT;-><init>()V

    iput-boolean p4, p0, LX/4U5;->A02:Z

    iput p2, p0, LX/4U5;->A01:I

    iput p3, p0, LX/4U5;->A00:I
...
.method public A03(Landroid/graphics/Rect;Landroid/view/View;LX/0Qa;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object v0, p0, LX/4U5;->A03:LX/5a9;

    iget-object v0, v0, LX/5a9;->A0J:LX/4To;

    invoke-virtual {v0, v1}, LX/4To;->A0K(I)LX/5bG;

    move-result-object v2

    invoke-virtual {p4}, Lcom/gbwhatsapp/mediacomposer/doodle/shapepicker/ShapePickerRecyclerView;->A14()V
    ...
    iget v1, v2, LX/5bG;->A02:I

    const/4 v0, 0x1

    if-nez v1, :cond_3

    iget v0, v2, LX/5bG;->A01:I
