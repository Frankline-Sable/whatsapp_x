...
.method public constructor <init>(LX/4PH;)V
    ...
    iput-object p1, p0, LX/64B;->this$0:LX/4PH;
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    iget-object v6, p0, LX/64B;->this$0:LX/4PH;
    ...
    iget-object v0, v6, LX/4PH;->A0E:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "include"

    iget v0, v6, LX/4PH;->A00:I

    invoke-virtual {v2, v1, v0}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "preview"

    iget-boolean v0, v6, LX/4PH;->A0K:Z

    invoke-virtual {v2, v1, v0}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "jid"

    iget-object v0, v6, LX/4PH;->A0H:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "mentions"

    iget-object v0, v6, LX/4PH;->A0F:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "quoted_group_jid"

    iget-object v0, v6, LX/4PH;->A0G:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v6, LX/4PH;->A0C:Ljava/lang/Long;
    ...
    :cond_0
    iget-object v0, v6, LX/4PH;->A0A:Ljava/lang/Integer;
    ...
    :cond_1
    iget-object v0, v6, LX/4PH;->A04:Ljava/lang/Boolean;
    ...
    :cond_2
    iget-object v0, v6, LX/4PH;->A05:Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v0, v6, LX/4PH;->A06:Ljava/lang/Boolean;
    ...
    :cond_4
    iget-object v0, v6, LX/4PH;->A0D:Ljava/lang/Long;
    ...
    :cond_5
    iget-object v0, v6, LX/4PH;->A08:Ljava/lang/Boolean;
    ...
    :cond_6
    iget-object v0, v6, LX/4PH;->A07:Ljava/lang/Boolean;
    ...
    :cond_7
    iget-object v0, v6, LX/4PH;->A09:Ljava/lang/Boolean;
    ...
    :cond_8
    iget-object v0, v6, LX/4PH;->A0B:Ljava/lang/Integer;
