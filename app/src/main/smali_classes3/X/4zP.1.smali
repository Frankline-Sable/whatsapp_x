...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/4zP;->A01:Landroid/graphics/Path;
    ...
    iput-object v2, p0, LX/4zP;->A00:Landroid/graphics/Paint;

    invoke-static {}, LX/002;->A09()Landroid/graphics/RectF;

    move-result-object v0

    iput-object v0, p0, LX/4zP;->A04:Landroid/graphics/RectF;
    ...
    iput-object v3, p0, LX/4zP;->A06:[Landroid/graphics/PointF;

    invoke-static {}, LX/002;->A09()Landroid/graphics/RectF;

    move-result-object v0

    iput-object v0, p0, LX/4zP;->A05:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, LX/4zP;->A02:Landroid/graphics/PointF;

    new-instance v0, Landroid/graphics/PointF;

    invoke-direct {v0}, Landroid/graphics/PointF;-><init>()V

    iput-object v0, p0, LX/4zP;->A03:Landroid/graphics/PointF;
...
.method public constructor <init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {p0}, LX/4zP;-><init>()V
...
.method public A0E(F)V
    ...
    invoke-super {p0, p1}, LX/5WQ;->A0E(F)V
...
.method public A0H(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, v7, LX/5WQ;->A02:Landroid/graphics/RectF;

    invoke-virtual {v3}, Landroid/graphics/RectF;->sort()V

    iget-object v6, v7, LX/4zP;->A01:Landroid/graphics/Path;
    ...
    iget-object v8, v7, LX/4zP;->A04:Landroid/graphics/RectF;
    ...
    invoke-static {v2, v12, v3}, LX/4E3;->A00(FFF)F

    move-result v20

    mul-float v19, v20, v1

    iget-object v5, v7, LX/4zP;->A06:[Landroid/graphics/PointF;
    ...
    invoke-static {v0, v8}, LX/4zP;->A00(Landroid/graphics/PointF;Landroid/graphics/RectF;)V
    ...
    invoke-static {v1, v8}, LX/4zP;->A00(Landroid/graphics/PointF;Landroid/graphics/RectF;)V

    invoke-static {v8, v5, v9, v10}, LX/4zP;->A04(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V

    invoke-static {v8, v5, v14}, LX/4zP;->A02(Landroid/graphics/RectF;[Landroid/graphics/PointF;I)V
    ...
    :cond_0
    iget-object v12, v7, LX/4zP;->A02:Landroid/graphics/PointF;
    ...
    iget-object v9, v7, LX/4zP;->A03:Landroid/graphics/PointF;
    ...
    iget-object v2, v7, LX/4zP;->A05:Landroid/graphics/RectF;
    ...
    iget-object v1, v7, LX/4zP;->A05:Landroid/graphics/RectF;
    ...
    invoke-static {v1, v8, v11}, LX/4zP;->A01(Landroid/graphics/PointF;Landroid/graphics/RectF;F)V

    invoke-static {v8, v5, v2, v9}, LX/4zP;->A04(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V

    invoke-static {v8, v5, v10, v14}, LX/4zP;->A03(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V
    ...
    invoke-static {v0, v8, v13}, LX/4zP;->A01(Landroid/graphics/PointF;Landroid/graphics/RectF;F)V

    invoke-static {v8, v5, v2, v9}, LX/4zP;->A03(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V

    invoke-static {v8, v5, v10, v14}, LX/4zP;->A04(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V

    invoke-static {v8, v5, v4}, LX/4zP;->A02(Landroid/graphics/RectF;[Landroid/graphics/PointF;I)V
    ...
    invoke-static {v8, v5, v2}, LX/4zP;->A02(Landroid/graphics/RectF;[Landroid/graphics/PointF;I)V
    ...
    invoke-static {v8, v5, v9, v10}, LX/4zP;->A03(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V
    ...
    :cond_e
    invoke-static {v8, v5, v15}, LX/4zP;->A02(Landroid/graphics/RectF;[Landroid/graphics/PointF;I)V

    aget-object v0, v5, v15

    invoke-static {v0, v8, v11}, LX/4zP;->A01(Landroid/graphics/PointF;Landroid/graphics/RectF;F)V
    ...
    invoke-static {v13, v8, v1}, LX/4zP;->A01(Landroid/graphics/PointF;Landroid/graphics/RectF;F)V
    ...
    :cond_10
    invoke-static {v8, v5, v15, v2}, LX/4zP;->A04(Landroid/graphics/RectF;[Landroid/graphics/PointF;II)V
...
.method public A0I(Landroid/graphics/RectF;FFFF)V
    ...
    invoke-super/range {v1 .. v6}, LX/5WQ;->A0I(Landroid/graphics/RectF;FFFF)V
