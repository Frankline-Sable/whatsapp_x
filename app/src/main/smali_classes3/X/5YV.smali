...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/5YV;->A01:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LX/5YV;->A00:Landroid/graphics/Matrix;
...
# virtual methods
.method public A00(Landroid/graphics/Canvas;Landroid/graphics/Matrix;LX/5Yv;I)V
    .locals 20

    move-object/from16 v8, p0

    instance-of v1, v8, LX/4ZG;
    ...
    check-cast v8, LX/4ZG;

    iget-object v11, v8, LX/4ZG;->A02:LX/4ZC;

    iget v2, v11, LX/4ZC;->A01:F

    iget v10, v8, LX/4ZG;->A01:F

    sub-float/2addr v2, v10

    iget v1, v11, LX/4ZC;->A00:F

    iget v9, v8, LX/4ZG;->A00:F
    ...
    iget-object v5, v8, LX/5YV;->A00:Landroid/graphics/Matrix;
    ...
    sget-object v12, LX/5Yv;->A0B:[I

    const/4 v2, 0x0

    iget v1, v4, LX/5Yv;->A00:I

    aput v1, v12, v2

    const/4 v2, 0x1

    iget v1, v4, LX/5Yv;->A01:I

    aput v1, v12, v2

    const/4 v2, 0x2

    iget v1, v4, LX/5Yv;->A02:I

    aput v1, v12, v2

    iget-object v1, v4, LX/5Yv;->A04:Landroid/graphics/Paint;
    ...
    :cond_1
    instance-of v1, v8, LX/4ZE;

    if-eqz v1, :cond_4

    check-cast v8, LX/4ZE;

    iget-object v1, v8, LX/4ZE;->A00:LX/4ZD;

    iget v6, v1, LX/4ZD;->A03:F

    iget v5, v1, LX/4ZD;->A04:F

    iget v9, v1, LX/4ZD;->A01:F

    iget v8, v1, LX/4ZD;->A05:F

    iget v2, v1, LX/4ZD;->A02:F

    iget v1, v1, LX/4ZD;->A00:F

    invoke-static {v9, v8, v2, v1}, LX/4E4;->A08(FFFF)Landroid/graphics/RectF;
    ...
    iget-object v8, v4, LX/5Yv;->A07:Landroid/graphics/Path;
    ...
    iget-object v9, v4, LX/5Yv;->A03:Landroid/graphics/Paint;
    ...
    iget-object v1, v4, LX/5Yv;->A06:Landroid/graphics/Paint;
    ...
    iget-object v1, v8, LX/4ZF;->A02:Ljava/util/List;
    ...
    iget-object v1, v8, LX/4ZF;->A00:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v1, v4, v7}, LX/5YV;->A00(Landroid/graphics/Canvas;Landroid/graphics/Matrix;LX/5Yv;I)V
