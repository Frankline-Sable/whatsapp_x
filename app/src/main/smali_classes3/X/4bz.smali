...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, LX/4bz;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/4LM;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/4bz;->A05:Z

    invoke-virtual {p0, p2}, LX/4bz;->A05(Landroid/util/AttributeSet;)V

    return-void
.end method

.method public static A01(Landroid/content/Context;LX/4bz;I)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, LX/4bz;->setTitle(Ljava/lang/CharSequence;)V

    return-void
.end method

.method public static A02(Landroid/content/Context;LX/4bz;I)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, LX/4bz;->setDescription(Ljava/lang/CharSequence;)V
...
.method public A04(IZ)V
    ...
    invoke-direct {v1, v2, v0}, LX/4al;-><init>(Landroid/graphics/drawable/Drawable;LX/35t;)V

    iput-boolean p2, v1, LX/4al;->A00:Z

    iget-object v0, p0, LX/4bz;->A01:Lcom/gbwhatsapp/WaImageView;
    ...
    iget-object v1, p0, LX/4bz;->A01:Lcom/gbwhatsapp/WaImageView;
...
.method public A05(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0}, LX/4bz;->getRootLayoutID()I
    ...
    invoke-static {v14, v0}, LX/0yN;->A0M(Landroid/view/View;I)Lcom/gbwhatsapp/WaTextView;

    move-result-object v0

    iput-object v0, p0, LX/4bz;->A02:Lcom/gbwhatsapp/WaTextView;

    const v0, 0x7f0b0de3

    invoke-static {v14, v0}, LX/0yM;->A0J(Landroid/view/View;I)Lcom/gbwhatsapp/TextEmojiLabel;

    move-result-object v0

    iput-object v0, p0, LX/4bz;->A00:Lcom/gbwhatsapp/TextEmojiLabel;

    const v0, 0x7f0b0de4

    invoke-static {v14, v0}, LX/4E0;->A0Z(Landroid/view/View;I)Lcom/gbwhatsapp/WaImageView;

    move-result-object v0

    iput-object v0, p0, LX/4bz;->A01:Lcom/gbwhatsapp/WaImageView;

    if-eqz v13, :cond_1

    iget-object v0, p0, LX/4bz;->A02:Lcom/gbwhatsapp/WaTextView;
    ...
    invoke-virtual {p0, v12}, LX/4bz;->setDescription(I)V
    ...
    iget-object v0, p0, LX/4bz;->A00:Lcom/gbwhatsapp/TextEmojiLabel;

    :cond_4
    if-eqz v10, :cond_5

    invoke-virtual {p0, v10}, LX/4bz;->setIconColor(I)V

    :cond_5
    if-eqz v11, :cond_6

    invoke-virtual {p0, v11}, LX/4bz;->setIcon(I)V
    ...
    invoke-static {v0, v3}, LX/5dB;->A06(Landroid/view/View;Z)V
...
.method public setIcon(I)V
    ...
    iget-boolean v0, p0, LX/4bz;->A05:Z

    invoke-virtual {p0, p1, v0}, LX/4bz;->A04(IZ)V
