...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, LX/6Oc;-><init>(Landroid/content/Context;)V

    const/4 v0, -0x1

    iput v0, p0, LX/59m;->A02:I

    const/4 v1, 0x0

    iput v1, p0, LX/59m;->A01:I

    invoke-static {}, LX/002;->A06()Landroid/graphics/Matrix;

    move-result-object v0

    iput-object v0, p0, LX/59m;->A0I:Landroid/graphics/Matrix;

    iput v1, p0, LX/59m;->A00:I

    iput v1, p0, LX/59m;->A03:I

    invoke-virtual {p0}, LX/59m;->A00()V
...
.method public A00()V
    ...
    iput-object v1, p0, LX/59m;->A09:Landroid/media/MediaPlayer;

    const/4 v3, 0x1

    new-instance v0, LX/6Kf;

    invoke-direct {v0, p0, v3}, LX/6Kf;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v2, p0, LX/59m;->A09:Landroid/media/MediaPlayer;
    ...
    iget-object v1, p0, LX/59m;->A09:Landroid/media/MediaPlayer;

    new-instance v0, LX/5GM;

    invoke-direct {v0, p0, v3}, LX/5GM;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p0, v1}, LX/6Jw;-><init>(Ljava/lang/Object;I)V
...
.method public A01()Z
    ...
    iget-object v0, p0, LX/59m;->A09:Landroid/media/MediaPlayer;

    if-eqz v0, :cond_0

    iget v1, p0, LX/59m;->A00:I
...
.method public canPause()Z
    ...
    iget-boolean v0, p0, LX/59m;->A0C:Z
...
.method public canSeekBackward()Z
    ...
    iget-boolean v0, p0, LX/59m;->A0D:Z
...
.method public canSeekForward()Z
    ...
    iget-boolean v0, p0, LX/59m;->A0E:Z
...
.method public onMeasure(II)V
    ...
    iget v0, p0, LX/59m;->A05:I

    if-eqz v0, :cond_0

    iget v0, p0, LX/59m;->A04:I

    if-eqz v0, :cond_0

    iget v1, p0, LX/59m;->A01:I
    ...
    iget v3, p0, LX/59m;->A05:I

    mul-int v2, v3, v6

    iget v1, p0, LX/59m;->A04:I
    ...
    :cond_2
    iget-object v5, p0, LX/59m;->A0I:Landroid/graphics/Matrix;

    invoke-virtual {v5}, Landroid/graphics/Matrix;->reset()V

    iget v4, p0, LX/59m;->A05:I
...
.method public setLooping(Z)V
    ...
    iput-boolean p1, p0, LX/59m;->A0F:Z
...
.method public setMute(Z)V
    ...
    iput-boolean p1, p0, LX/59m;->A0G:Z
...
.method public setOnCompletionListener(Landroid/media/MediaPlayer$OnCompletionListener;)V
    ...
    iput-object p1, p0, LX/59m;->A06:Landroid/media/MediaPlayer$OnCompletionListener;
...
.method public setOnErrorListener(Landroid/media/MediaPlayer$OnErrorListener;)V
    ...
    iput-object p1, p0, LX/59m;->A07:Landroid/media/MediaPlayer$OnErrorListener;
...
.method public setOnPreparedListener(Landroid/media/MediaPlayer$OnPreparedListener;)V
    ...
    iput-object p1, p0, LX/59m;->A08:Landroid/media/MediaPlayer$OnPreparedListener;
...
.method public setVideoPath(Ljava/lang/String;)V
    ...
    iput-object p1, p0, LX/59m;->A0B:Ljava/lang/String;
