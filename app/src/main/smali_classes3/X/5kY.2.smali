...
.method public constructor <init>(Lcom/gbwhatsapp/businessdirectory/view/activity/BusinessDirectorySERPMapViewActivity;)V
    ...
    iput-object p1, p0, LX/5kY;->A00:Lcom/gbwhatsapp/businessdirectory/view/activity/BusinessDirectorySERPMapViewActivity;
...
.method public BdY(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, LX/5kY;->A00:Lcom/gbwhatsapp/businessdirectory/view/activity/BusinessDirectorySERPMapViewActivity;
    ...
    iget-object v0, v3, LX/4Pf;->A03:LX/5gh;

    if-eqz v0, :cond_1

    iget-object v1, v0, LX/5gh;->A03:LX/5gk;

    if-eqz v1, :cond_2

    iget-object v0, v2, LX/5gh;->A03:LX/5gk;

    invoke-static {v1}, LX/5gk;->A04(LX/5gk;)Lcom/google/android/gms/maps/model/LatLng;
    ...
    iget-object v6, v3, LX/4Pf;->A0K:LX/5mg;

    iget v1, v2, LX/5gh;->A02:F

    iget-object v0, v3, LX/4Pf;->A08:LX/5Vz;

    iget v5, v0, LX/5Vz;->A01:I

    iget v4, v0, LX/5Vz;->A00:I

    iget-object v0, v3, LX/4Pf;->A05:LX/5bc;
    ...
    :cond_1
    iput-object v2, v3, LX/4Pf;->A03:LX/5gh;
