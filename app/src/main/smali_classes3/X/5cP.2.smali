...
.method public static A00(Landroid/content/Context;Landroid/text/Layout;F)Ljava/util/List;
    ...
    invoke-static {p1}, LX/5cP;->A02(Landroid/text/Layout;)Ljava/util/List;
    ...
    invoke-static/range {v1 .. v6}, LX/5cP;->A03(Ljava/util/List;FFFFF)Ljava/util/List;
...
.method public static A01(Landroid/content/Context;Landroid/text/Layout;F)Ljava/util/List;
    ...
    invoke-static/range {v5 .. v10}, LX/5cP;->A03(Ljava/util/List;FFFFF)Ljava/util/List;
...
.method public static A03(Ljava/util/List;FFFFF)Ljava/util/List;
    ...
    invoke-static {p0, v10}, LX/4E3;->A1K(Ljava/util/List;I)Ljava/util/List;
    ...
    invoke-static {v7, v0, v6}, LX/5cP;->A04([Landroid/graphics/PointF;FZ)Ljava/util/List;

    move-result-object v3

    invoke-static {v8, v0, v5}, LX/5cP;->A04([Landroid/graphics/PointF;FZ)Ljava/util/List;
    ...
    invoke-static {v9, v3, v1}, LX/4Dy;->A10(Landroid/graphics/Path;Ljava/util/List;I)V
    ...
    invoke-static {v9, v2, v0}, LX/4Dy;->A10(Landroid/graphics/Path;Ljava/util/List;I)V
