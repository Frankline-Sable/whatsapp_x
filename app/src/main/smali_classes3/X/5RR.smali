...
.method public constructor <init>(Landroid/view/View;Landroid/view/View;I)V
    ...
    iput-object p1, p0, LX/5RR;->A02:Landroid/view/View;

    iput-object p2, p0, LX/5RR;->A01:Landroid/view/View;
...
.method public A00()V
    ...
    iget-object v0, p0, LX/5RR;->A02:Landroid/view/View;
...
.method public A01(Landroid/content/Context;Landroid/text/style/ClickableSpan;Landroid/widget/TextView;Ljava/lang/String;I)V
    ...
    invoke-static {p4}, LX/4E4;->A0A(Ljava/lang/CharSequence;)Landroid/text/SpannableString;
    ...
    invoke-direct {v0, p0}, LX/4GB;-><init>(LX/5RR;)V

    invoke-virtual {v3, v0, v1, v2, v1}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V

    invoke-static {p3}, LX/4E0;->A1J(Landroid/widget/TextView;)V

    invoke-static {p3, v3}, LX/4E2;->A1G(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
