...
# direct methods
.method public constructor <init>(Landroid/content/Context;LX/0eU;LX/0tN;LX/6H1;LX/1gx;)V
    .locals 15
    ...
    invoke-static {v4, v2, v3, v1, v0}, LX/0yE;->A0g(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-direct {p0}, LX/4Ta;-><init>()V

    iput-object v5, p0, LX/4px;->A01:Landroid/content/Context;

    iput-object v4, p0, LX/4px;->A02:LX/0eU;
    ...
    :cond_0
    iput-object v1, p0, LX/4px;->A04:Ljava/util/List;

    new-instance v0, LX/5dO;

    invoke-direct {v0, v3, v2}, LX/5dO;-><init>(LX/0tN;LX/6H1;)V

    iput-object v0, p0, LX/4px;->A03:LX/6Gz;
    ...
    invoke-interface {v3}, LX/46q;->AzB()LX/3CQ;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v8, v0, LX/3CQ;->A08:Ljava/lang/String;
    ...
    iget-object v5, p0, LX/4px;->A01:Landroid/content/Context;
...
.method public A0G()I
    ...
    iget-object v0, p0, LX/4px;->A04:Ljava/util/List;
...
.method public final A0K(LX/30h;)I
    .locals 3
...
.method public bridge synthetic BJS(Landroid/view/ViewGroup;I)LX/0VI;
    ...
    iget-object v3, p0, LX/4px;->A01:Landroid/content/Context;

    invoke-static {v3}, LX/4E4;->A0D(Landroid/content/Context;)Landroid/widget/FrameLayout;
    ...
    invoke-static {v1, p1}, LX/4Ta;->A00(Landroid/view/View;Landroid/view/ViewGroup;)Landroidx/cardview/widget/CardView;
    ...
    invoke-direct {v0, v2, v2, v2, v2}, LX/5Zk;-><init>(IIII)V

    invoke-static {v4, v0}, LX/5aw;->A01(Landroid/view/View;LX/5Zk;)V
    ...
    iget-object v5, p0, LX/4px;->A02:LX/0eU;

    iget-object v6, p0, LX/4px;->A03:LX/6Gz;

    iget v7, p0, LX/4px;->A00:I

    new-instance v2, LX/4q0;

    invoke-direct/range {v2 .. v7}, LX/4q0;-><init>(Landroid/content/Context;Landroidx/cardview/widget/CardView;LX/0eU;LX/6Gz;I)V
