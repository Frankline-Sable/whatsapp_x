...
.method public constructor <init>(Landroid/view/View;Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;)V
    ...
    iput-object p2, p0, LX/5qM;->A02:Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;

    iput-object p1, p0, LX/5qM;->A01:Landroid/view/View;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-object v0, p2, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A0B:LX/5dI;

    instance-of v0, v0, LX/4zp;

    if-nez v0, :cond_0

    invoke-virtual {p2}, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A1X()Z
...
# virtual methods
.method public BAl(Landroid/view/View;)Z
    .locals 1

    iget-object v0, p0, LX/5qM;->A02:Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;
...
.method public BKK(Landroid/view/View;)V
    ...
    iget-object v2, p0, LX/5qM;->A02:Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;

    iget-object v1, v2, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A0B:LX/5dI;

    instance-of v0, v1, LX/4zp;

    if-nez v0, :cond_0

    invoke-virtual {v2}, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A1X()Z
    ...
    iget-object v1, v2, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A09:LX/4xG;
    ...
    :cond_1
    invoke-virtual {v2}, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A1R()V
...
.method public BKe(I)V
    ...
    invoke-virtual {v1}, LX/5aT;->A09()LX/5A1;
...
.method public BTv(Landroid/view/View;)V
    ...
    invoke-interface {v0}, LX/6GW;->BWC()V
...
.method public BUF(Landroid/view/View;F)V
    ...
    iget-object v4, p0, LX/5qM;->A02:Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;
    ...
    invoke-interface {v1}, LX/6GW;->isFinishing()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-interface {v1}, LX/6GW;->BKO()V

    const/high16 v2, 0x3f800000    # 1.0f

    sub-float v5, v2, p2

    iget v1, p0, LX/5qM;->A00:F
    ...
    :goto_0
    iget-object v0, p0, LX/5qM;->A01:Landroid/view/View;
    ...
    iget-object v0, v4, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A0B:LX/5dI;
    ...
    invoke-virtual {v4, v0, v0}, Lcom/gbwhatsapp/mediaview/MediaViewBaseFragment;->A1W(ZZ)V
