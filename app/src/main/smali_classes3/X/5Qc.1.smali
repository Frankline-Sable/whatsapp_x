...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, LX/5Qc;->A0M:Z

    const-wide/16 v0, -0x1

    iput-wide v0, p0, LX/5Qc;->A04:J

    const/4 v0, -0x1

    iput v0, p0, LX/5Qc;->A03:I

    iput v0, p0, LX/5Qc;->A00:I

    iput-object p1, p0, LX/5Qc;->A0P:Landroid/content/Context;

    return-void
.end method

.method public static A00(LX/31g;LX/5Qc;)V
    .locals 1
    ...
    invoke-virtual {p0, v0}, LX/31g;->A02(Landroid/os/Bundle;)V

    iput-object v0, p1, LX/5Qc;->A08:Landroid/os/Bundle;
...
.method public A01()Landroid/content/Intent;
    ...
    iget-object v0, p0, LX/5Qc;->A0P:Landroid/content/Context;
    ...
    iget-object v0, p0, LX/5Qc;->A0G:Ljava/util/ArrayList;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;

    const-string v1, "android.intent.extra.TEXT"

    iget-object v0, p0, LX/5Qc;->A0E:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "first_caption"

    iget-object v0, p0, LX/5Qc;->A0B:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "jid"

    iget-object v0, p0, LX/5Qc;->A0C:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "jids"

    iget-object v0, p0, LX/5Qc;->A0F:Ljava/util/ArrayList;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;

    const-string v1, "max_items"

    iget v0, p0, LX/5Qc;->A01:I

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v1, "skip_max_items_new_limit"

    iget-boolean v0, p0, LX/5Qc;->A0N:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "origin"

    iget v0, p0, LX/5Qc;->A02:I

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    iget-wide v3, p0, LX/5Qc;->A05:J
    ...
    iget-boolean v0, p0, LX/5Qc;->A0K:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v3, "quoted_message_row_id"

    iget-wide v0, p0, LX/5Qc;->A06:J

    invoke-virtual {v2, v3, v0, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;J)Landroid/content/Intent;

    const-string v1, "quoted_group_jid"

    iget-object v0, p0, LX/5Qc;->A0D:Ljava/lang/String;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string v1, "number_from_url"

    iget-boolean v0, p0, LX/5Qc;->A0H:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "media_preview_params"

    iget-object v0, p0, LX/5Qc;->A08:Landroid/os/Bundle;
    ...
    iget-boolean v0, p0, LX/5Qc;->A0M:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "should_hide_caption_view"

    iget-boolean v0, p0, LX/5Qc;->A0L:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "start_home"

    iget-boolean v0, p0, LX/5Qc;->A0O:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "animate_uri"

    iget-object v0, p0, LX/5Qc;->A07:Landroid/net/Uri;
    ...
    iget-boolean v0, p0, LX/5Qc;->A0J:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "is_new_content"

    iget-boolean v0, p0, LX/5Qc;->A0I:Z

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v1, "status_distribution"

    iget-object v0, p0, LX/5Qc;->A09:LX/5gj;

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const-string v3, "gallery_duration_ms"

    iget v1, p0, LX/5Qc;->A02:I
    ...
    iget v0, p0, LX/5Qc;->A03:I

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v1, "preview_bottom_margin"

    iget v0, p0, LX/5Qc;->A00:I

    invoke-virtual {v2, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    iget-object v1, p0, LX/5Qc;->A0A:Ljava/lang/Integer;
