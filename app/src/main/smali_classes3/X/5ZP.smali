...
# direct methods
.method public constructor <init>(Landroid/graphics/Rect;LX/1af;Ljava/lang/Integer;)V
    .locals 1
    ...
    iput-object p2, p0, LX/5ZP;->A07:LX/1af;

    iput-object p3, p0, LX/5ZP;->A08:Ljava/lang/Integer;

    iput-object p1, p0, LX/5ZP;->A06:Landroid/graphics/Rect;

    return-void
.end method

.method public constructor <init>(Landroid/view/View;LX/1af;Ljava/lang/Integer;)V
    .locals 6
    ...
    invoke-static {p1, v5}, LX/4Dz;->A09(Landroid/view/View;[I)I
    ...
    iput-object v3, p0, LX/5ZP;->A06:Landroid/graphics/Rect;

    return-void
.end method

.method public static A00(Landroid/view/View;LX/1af;Ljava/lang/Integer;)LX/5ZP;
    .locals 2

    new-instance v1, LX/5ZP;

    invoke-direct {v1, p0, p1, p2}, LX/5ZP;-><init>(Landroid/view/View;LX/1af;Ljava/lang/Integer;)V
...
.method public A01(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    :goto_0
    iget-object v13, p0, LX/5ZP;->A08:Ljava/lang/Integer;

    iget-object v12, p0, LX/5ZP;->A04:Ljava/lang/String;

    iget-object v4, p0, LX/5ZP;->A06:Landroid/graphics/Rect;

    iget-boolean v6, p0, LX/5ZP;->A05:Z

    iget-object v9, p0, LX/5ZP;->A01:LX/1af;

    iget-object v8, p0, LX/5ZP;->A02:Ljava/lang/Double;

    iget-object v7, p0, LX/5ZP;->A03:Ljava/lang/Double;

    iget-object v5, p0, LX/5ZP;->A07:LX/1af;

    iget v3, p0, LX/5ZP;->A00:I
    ...
    invoke-static {v2, v9, v0}, LX/0yI;->A15(Landroid/content/Intent;Lcom/whatsapp/jid/Jid;Ljava/lang/String;)V
...
.method public A02(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, p1}, LX/5ZP;->A01(Landroid/app/Activity;)Landroid/content/Intent;

    move-result-object v1

    invoke-static {}, LX/0WR;->A00()LX/0WR;
