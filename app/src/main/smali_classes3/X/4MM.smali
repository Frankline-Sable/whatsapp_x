...
# direct methods
.method public constructor <init>(Landroid/app/Activity;LX/2rn;LX/6Ct;LX/35r;LX/35z;LX/5Z7;)V
    .locals 2
    ...
    iput-object p1, p0, LX/4MM;->A03:Landroid/app/Activity;

    iput-object p6, p0, LX/4MM;->A08:LX/5Z7;

    iput-object p2, p0, LX/4MM;->A04:LX/2rn;

    iput-object p4, p0, LX/4MM;->A06:LX/35r;

    iput-object p5, p0, LX/4MM;->A07:LX/35z;

    iput-object p3, p0, LX/4MM;->A05:LX/6Ct;

    invoke-static {}, LX/002;->A0Q()Ljava/util/HashSet;

    move-result-object v0

    iput-object v0, p0, LX/4MM;->A0A:Ljava/util/Set;

    const/16 v1, 0x2c

    new-instance v0, LX/5ul;

    invoke-direct {v0, p3, v1}, LX/5ul;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, LX/4MM;->A09:Ljava/lang/Runnable;
...
.method public static A01(Landroid/graphics/Point;Landroid/view/View;)Z
    ...
    invoke-static {p1, v0}, LX/4E3;->A09(Landroid/view/View;I)I
...
.method public A03()V
    ...
    invoke-virtual {p0, v0}, LX/4MM;->A08(I)I
...
.method public A04()V
    ...
    iget-object v2, p0, LX/4MM;->A05:LX/6Ct;
    ...
    iget-object v0, p0, LX/4MM;->A09:Ljava/lang/Runnable;
    ...
    iput-boolean v0, v2, Lcom/gbwhatsapp/KeyboardPopupLayout;->A07:Z

    return-void
.end method

.method public final A05(LX/6Cu;Lcom/gbwhatsapp/WaEditText;Ljava/lang/Runnable;)V
    .locals 5
    ...
    iget-object v3, p0, LX/4MM;->A0A:Ljava/util/Set;

    new-instance v2, LX/4Ff;

    invoke-direct {v2, v0, p3, v3}, LX/4Ff;-><init>(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/util/Set;)V

    check-cast p1, LX/6Mb;

    iget v0, p1, LX/6Mb;->A01:I

    if-eqz v0, :cond_2

    iget-object v0, p1, LX/6Mb;->A00:Ljava/lang/Object;
    ...
    :cond_2
    iget-object v1, p1, LX/6Mb;->A00:Ljava/lang/Object;
...
.method public A06(Lcom/gbwhatsapp/WaEditText;)V
    .locals 3
    ...
    iget-object v1, p0, LX/4MM;->A05:LX/6Ct;

    check-cast v1, Lcom/gbwhatsapp/KeyboardPopupLayout;

    iget-object v0, v1, Lcom/gbwhatsapp/KeyboardPopupLayout;->A04:LX/4MM;

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, v1, Lcom/gbwhatsapp/KeyboardPopupLayout;->A04:LX/4MM;
    ...
    invoke-direct {v0, p1, v1}, LX/6Mb;-><init>(Lcom/gbwhatsapp/WaEditText;I)V

    invoke-virtual {p0, v0, p1, v2}, LX/4MM;->A05(LX/6Cu;Lcom/gbwhatsapp/WaEditText;Ljava/lang/Runnable;)V
...
.method public A08(I)I
    ...
    invoke-static {v3, v0}, LX/4Dw;->A0l(Landroid/app/Activity;Landroid/graphics/Point;)V

    iget v4, v0, Landroid/graphics/Point;->y:I

    invoke-static {v3}, LX/4Dw;->A03(Landroid/content/Context;)I
    ...
    invoke-virtual {p0}, LX/4MM;->A07()Z
    ...
    iget-object v4, v2, LX/4MM;->A03:Landroid/app/Activity;

    invoke-static {v4, v0}, LX/4Dw;->A0l(Landroid/app/Activity;Landroid/graphics/Point;)V
    ...
    invoke-virtual {v2}, LX/4MM;->A07()Z
    ...
    iget-object v0, v2, LX/4MM;->A07:LX/35z;
    ...
    :cond_7
    iget-object v0, v2, LX/4bk;->A03:Lcom/gbwhatsapp/conversation/ConversationAttachmentContentView;

    iget-object v0, v0, Lcom/gbwhatsapp/conversation/ConversationAttachmentContentView;->A09:Landroid/widget/LinearLayout;
