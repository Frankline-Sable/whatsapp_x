...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/4Gk;->A01:Landroid/animation/ValueAnimator;

    invoke-static {}, LX/4E3;->A0W()Landroid/graphics/Paint;

    move-result-object v0

    iput-object v0, p0, LX/4Gk;->A03:Landroid/graphics/Paint;

    invoke-static {}, LX/4E3;->A0W()Landroid/graphics/Paint;

    move-result-object v0

    iput-object v0, p0, LX/4Gk;->A02:Landroid/graphics/Paint;

    iget-object v2, p0, LX/4Gk;->A01:Landroid/animation/ValueAnimator;

    const-wide/16 v0, 0x7d0

    invoke-virtual {v2, v0, v1}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v0, p0, LX/4Gk;->A01:Landroid/animation/ValueAnimator;

    invoke-static {v0}, LX/4Dz;->A10(Landroid/animation/Animator;)V

    iget-object v0, p0, LX/4Gk;->A03:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, LX/4Gk;->A03:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, LX/4Gk;->A02:Landroid/graphics/Paint;

    invoke-static {v0}, LX/4Dz;->A16(Landroid/graphics/Paint;)V

    iget-object v1, p0, LX/4Gk;->A02:Landroid/graphics/Paint;
...
.method private final getOvalPath()Landroid/graphics/Path;
    ...
    invoke-static {v6, v1}, LX/4E4;->A07(FF)Landroid/graphics/PointF;

    move-result-object v5

    add-float/2addr v3, v1

    invoke-static {v2, v3}, LX/4E4;->A07(FF)Landroid/graphics/PointF;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, LX/4Gk;->A04:Landroid/graphics/Path;
...
.method public onSizeChanged(IIII)V
    ...
    :cond_0
    invoke-direct {p0}, LX/4Gk;->getOvalPath()Landroid/graphics/Path;

    move-result-object v2

    iput-object v2, p0, LX/4Gk;->A04:Landroid/graphics/Path;
    ...
    iput-object v0, p0, LX/4Gk;->A05:Landroid/graphics/PathMeasure;

    invoke-virtual {v0}, Landroid/graphics/PathMeasure;->getLength()F

    move-result v4

    iput v4, p0, LX/4Gk;->A00:F

    iget-object v3, p0, LX/4Gk;->A02:Landroid/graphics/Paint;
