...
.method public static A01(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, v0}, LX/5dR;->A03(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
...
.method public static A02(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, LX/0yM;->A0A(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public static A03(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, v0, p2}, LX/0yN;->A0D(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
...
.method public static A04(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-static {p0, v1, v0}, LX/5dR;->A06(Landroid/content/Context;Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public static A05(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1, v4, v0, v3}, LX/4E3;->A0U([I[[III)Landroid/content/res/ColorStateList;
...
.method public static A0B(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, LX/5dR;->A0A(Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
...
.method public static A0C(Landroid/content/Context;Landroid/widget/ImageView;I)V
    .locals 0
    ...
    invoke-static {p1, p0}, LX/5dR;->A0F(Landroid/widget/ImageView;I)V

    return-void
.end method

.method public static A0D(Landroid/content/Context;Landroid/widget/ImageView;II)V
    .locals 0

    invoke-static {p0, p2, p3}, LX/5dR;->A03(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
...
.method public static A0E(Landroid/view/View;Landroid/widget/PopupWindow;)V
    .locals 5
...
.method public static A0F(Landroid/widget/ImageView;I)V
    .locals 1

    sget-object v0, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {v0, p0}, LX/0SW;->A01(Landroid/graphics/PorterDuff$Mode;Landroid/widget/ImageView;)V
...
.method public static A0G(Landroid/widget/TextView;I)V
    .locals 4
    ...
    invoke-static {v0, v1, p1}, LX/001;->A11(Landroid/graphics/PorterDuff$Mode;Landroid/graphics/drawable/Drawable;I)V
