...
.field public A08:LX/8On;

.field public A09:Z

.field public A0A:Z

.field public final A0B:LX/5aF;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, p3, v9}, LX/5Xa;->A00(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object v0

    invoke-direct {p0, v0, p2, p3}, LX/03A;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v6, LX/5HZ;->A0I:[I

    new-array v7, v1, [I

    invoke-static/range {v4 .. v9}, LX/5cq;->A00(Landroid/content/Context;Landroid/util/AttributeSet;[I[III)Landroid/content/res/TypedArray;
    ...
    invoke-static {v0, v2}, LX/5aU;->A01(Landroid/graphics/PorterDuff$Mode;I)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, v3, v0}, LX/5bk;->A00(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v3, v0}, LX/5bk;->A02(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v4, p2, p3, v9}, LX/5cw;->A02(Landroid/content/Context;Landroid/util/AttributeSet;II)LX/5cw;

    move-result-object v0

    new-instance v8, LX/5aF;

    invoke-direct {v8, p0, v0}, LX/5aF;-><init>(Lcom/google/android/material/button/MaterialButton;LX/5cw;)V

    iput-object v8, p0, Lcom/google/android/material/button/MaterialButton;->A0B:LX/5aF;
    ...
    iput v0, v8, LX/5aF;->A00:I

    iget-object v2, v8, LX/5aF;->A0D:LX/5cw;
    ...
    invoke-virtual {v8, v0}, LX/5aF;->A06(LX/5cw;)V

    iput-boolean v4, v8, LX/5aF;->A0G:Z
    ...
    iput-object v0, v8, LX/5aF;->A0A:Landroid/graphics/PorterDuff$Mode;

    iget-object v7, v8, LX/5aF;->A0J:Lcom/google/android/material/button/MaterialButton;
    ...
    iput-object v0, v8, LX/5aF;->A07:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v8, LX/5aF;->A09:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, v8, LX/5aF;->A08:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v0, v8, LX/5aF;->A0F:Z
    ...
    iput-boolean v0, v8, LX/5aF;->A0I:Z
    ...
    iput-boolean v0, v8, LX/5aF;->A0E:Z

    iget-object v0, v8, LX/5aF;->A07:Landroid/content/res/ColorStateList;

    invoke-virtual {v7, v0}, LX/03A;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V

    iget-object v0, v8, LX/5aF;->A0A:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {v7, v0}, LX/03A;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :goto_0
    iget v0, v8, LX/5aF;->A03:I

    add-int/2addr v6, v0

    iget v0, v8, LX/5aF;->A05:I

    add-int/2addr v5, v0

    iget v0, v8, LX/5aF;->A04:I

    add-int/2addr v4, v0

    iget v0, v8, LX/5aF;->A02:I

    add-int/2addr v2, v0

    invoke-static {v7, v6, v5, v4, v2}, LX/0Z2;->A07(Landroid/view/View;IIII)V
    ...
    :cond_2
    invoke-virtual {v8}, LX/5aF;->A03()V
...
.method private getA11yClassName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->A0B:LX/5aF;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, LX/5aF;->A0F:Z
...
.method private getTextHeight()I
    ...
    invoke-static {p0}, LX/4Dy;->A0l(Landroid/widget/TextView;)Ljava/lang/String;
...
.method public final A01(Z)V
    ...
    invoke-static {v1, v0}, LX/0Z1;->A04(Landroid/graphics/PorterDuff$Mode;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0}, LX/0Xq;->A04(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1, v1, v1, p0}, LX/0Xq;->A02(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/widget/TextView;)V
    ...
    invoke-static {v1, v0, v1, v1, p0}, LX/0Xq;->A02(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/widget/TextView;)V
    ...
    invoke-static {v1, v1, v0, v1, p0}, LX/0Xq;->A02(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/widget/TextView;)V
...
.method public final A02()Z
    ...
    iget-boolean v1, v0, LX/5aF;->A0E:Z
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0}, LX/03A;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p0}, LX/03A;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, LX/5aF;->A08:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()LX/5cw;
    ...
    iget-object v0, v0, LX/5aF;->A0D:LX/5cw;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, LX/5aF;->A09:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, LX/5aF;->A07:Landroid/content/res/ColorStateList;

    return-object v0

    :cond_0
    invoke-super {p0}, LX/03A;->getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, LX/5aF;->A0A:Landroid/graphics/PorterDuff$Mode;

    return-object v0

    :cond_0
    invoke-super {p0}, LX/03A;->getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
...
.method public onAttachedToWindow()V
    ...
    invoke-static {v0}, LX/5aF;->A00(LX/5aF;)LX/4F1;
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, LX/03A;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, LX/03A;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-boolean v1, v0, LX/5aF;->A0F:Z
...
.method public onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, LX/03A;->onLayout(ZIIII)V
    ...
    iget-object v4, p0, Lcom/google/android/material/button/MaterialButton;->A0B:LX/5aF;
    ...
    iget-object v3, v4, LX/5aF;->A0B:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget v2, v4, LX/5aF;->A03:I

    iget v1, v4, LX/5aF;->A05:I

    iget v0, v4, LX/5aF;->A04:I

    sub-int/2addr p4, v0

    iget v0, v4, LX/5aF;->A02:I
    ...
    :cond_0
    invoke-static {p0}, LX/4E1;->A1N(Lcom/google/android/material/button/MaterialButton;)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-boolean v0, p1, LX/4OO;->A00:Z
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, LX/4OO;-><init>(Landroid/os/Parcelable;)V
...
.method public onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, LX/03A;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public performClick()Z
    ...
    iget-boolean v0, v0, LX/5aF;->A0I:Z
...
.method public setBackgroundColor(I)V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->A0B:LX/5aF;

    invoke-static {v1}, LX/5aF;->A00(LX/5aF;)LX/4F1;
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/button/MaterialButton;->A0B:LX/5aF;

    const/4 v0, 0x1

    iput-boolean v0, v2, LX/5aF;->A0E:Z

    iget-object v1, v2, LX/5aF;->A0J:Lcom/google/android/material/button/MaterialButton;

    iget-object v0, v2, LX/5aF;->A07:Landroid/content/res/ColorStateList;

    invoke-virtual {v1, v0}, LX/03A;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V

    iget-object v0, v2, LX/5aF;->A0A:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {v1, v0}, LX/03A;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    invoke-super {p0, p1}, LX/03A;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p1}, LX/03A;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p1}, LX/03A;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCheckable(Z)V
    ...
    iput-boolean p1, v0, LX/5aF;->A0F:Z
...
.method public setCornerRadius(I)V
    ...
    iget-boolean v0, v2, LX/5aF;->A0G:Z

    if-eqz v0, :cond_0

    iget v0, v2, LX/5aF;->A00:I

    if-eq v0, p1, :cond_1

    :cond_0
    iput p1, v2, LX/5aF;->A00:I

    const/4 v0, 0x1

    iput-boolean v0, v2, LX/5aF;->A0G:Z

    iget-object v1, v2, LX/5aF;->A0D:LX/5cw;

    int-to-float v0, p1

    invoke-static {v1, v0}, LX/5ZS;->A00(LX/5cw;F)LX/5cw;

    move-result-object v0

    invoke-virtual {v2, v0}, LX/5aF;->A06(LX/5cw;)V
...
.method public setInsetBottom(I)V
    ...
    iget v0, v1, LX/5aF;->A05:I

    invoke-virtual {v1, v0, p1}, LX/5aF;->A05(II)V
...
.method public setInsetTop(I)V
    ...
    iget v0, v1, LX/5aF;->A02:I

    invoke-virtual {v1, p1, v0}, LX/5aF;->A05(II)V
...
.method public setOnPressedChangeListenerInternal(LX/8On;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->A08:LX/8On;
...
.method public setPressed(Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->A08:LX/8On;

    if-eqz v0, :cond_0

    check-cast v0, LX/7sx;

    iget-object v0, v0, LX/7sx;->A00:Lcom/google/android/material/button/MaterialButtonToggleGroup;
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, v1, LX/5aF;->A08:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, v1, LX/5aF;->A08:Landroid/content/res/ColorStateList;

    iget-object v1, v1, LX/5aF;->A0J:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {p1}, LX/5cZ;->A02(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setShapeAppearanceModel(LX/5cw;)V
    ...
    invoke-virtual {v0, p1}, LX/5aF;->A06(LX/5cw;)V
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, v0, LX/5aF;->A0H:Z

    invoke-virtual {v0}, LX/5aF;->A04()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, v1, LX/5aF;->A09:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, v1, LX/5aF;->A09:Landroid/content/res/ColorStateList;

    invoke-virtual {v1}, LX/5aF;->A04()V
...
.method public setStrokeWidth(I)V
    ...
    iget v0, v1, LX/5aF;->A06:I

    if-eq v0, p1, :cond_0

    iput p1, v1, LX/5aF;->A06:I
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, v2, LX/5aF;->A07:Landroid/content/res/ColorStateList;

    invoke-static {v2}, LX/5aF;->A00(LX/5aF;)LX/4F1;
    ...
    :cond_1
    invoke-super {p0, p1}, LX/03A;->setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v2, LX/5aF;->A0A:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_1
    invoke-super {p0, p1}, LX/03A;->setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setToggleCheckedStateOnClick(Z)V
    ...
    iput-boolean p1, v0, LX/5aF;->A0I:Z
