...
.method public A0I(Landroid/view/View;Landroidx/coordinatorlayout/widget/CoordinatorLayout;I)Z
    ...
    invoke-static {p2}, LX/001;->A0J(Landroid/view/View;)I
    ...
    iget-object v2, p2, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A06:LX/0YI;
    ...
    invoke-virtual {v2}, LX/0YI;->A04()I
    ...
    invoke-static/range {v5 .. v10}, LX/0IR;->A00(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
    ...
    :goto_2
    iget-object v2, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A01:LX/5PH;

    if-nez v2, :cond_3

    new-instance v2, LX/5PH;

    invoke-direct {v2, p1}, LX/5PH;-><init>(Landroid/view/View;)V

    iput-object v2, p0, Lcom/google/android/material/appbar/ViewOffsetBehavior;->A01:LX/5PH;
