...
.field public final A0T:LX/5Yp;

.field public final A0U:LX/5aS;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v4, LX/5aS;

    invoke-direct {v4, p0}, LX/5aS;-><init>(Landroid/view/View;)V

    iput-object v4, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0U:LX/5aS;

    sget-object v0, LX/5bD;->A00:Landroid/animation/TimeInterpolator;

    iput-object v0, v4, LX/5aS;->A0c:Landroid/animation/TimeInterpolator;

    invoke-virtual {v4, v2}, LX/5aS;->A0B(Z)V

    iput-boolean v2, v4, LX/5aS;->A0z:Z

    new-instance v0, LX/5Yp;

    invoke-direct {v0, v7}, LX/5Yp;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0T:LX/5Yp;

    sget-object v9, LX/5HZ;->A09:[I
    ...
    invoke-virtual {v4, v0}, LX/5aS;->A08(I)V

    const v0, 0x7f1503b5

    invoke-virtual {v4, v0}, LX/5aS;->A06(I)V
    ...
    invoke-static {v7, v5, v3}, LX/5bk;->A00(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iget-object v0, v4, LX/5aS;->A0g:Landroid/content/res/ColorStateList;

    if-eq v0, v3, :cond_8

    iput-object v3, v4, LX/5aS;->A0g:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v4, LX/5aS;->A0e:Landroid/content/res/ColorStateList;

    if-eq v0, v3, :cond_9

    iput-object v3, v4, LX/5aS;->A0e:Landroid/content/res/ColorStateList;
    ...
    iget v0, v4, LX/5aS;->A0a:I

    if-eq v3, v0, :cond_a

    iput v3, v4, LX/5aS;->A0a:I
    ...
    iput-object v0, v4, LX/5aS;->A0b:Landroid/animation/TimeInterpolator;
    ...
    sget-object v0, LX/5bD;->A01:Landroid/animation/TimeInterpolator;

    invoke-static {v0, v7, v3}, LX/5aV;->A01(Landroid/animation/TimeInterpolator;Landroid/content/Context;I)Landroid/animation/TimeInterpolator;
    ...
    invoke-direct {v0, p0, v1}, LX/6M1;-><init>(Ljava/lang/Object;I)V
...
.method public static A00(Landroid/view/View;)LX/5PH;
    .locals 2
    ...
    invoke-direct {v0, p0}, LX/5PH;-><init>(Landroid/view/View;)V
...
.method public final A01()V
    ...
    invoke-static {p0, v1}, LX/4E0;->A0M(Landroid/view/View;I)Landroid/view/ViewGroup;
...
.method public final A04()V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0U:LX/5aS;

    iget-object v0, v0, LX/5aS;->A0t:Ljava/lang/CharSequence;
...
.method public final A05(IIIIZ)V
    ...
    :cond_4
    invoke-static {v6}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A00(Landroid/view/View;)LX/5PH;

    move-result-object v0

    invoke-static {v6}, LX/4E2;->A0N(Landroid/view/View;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    iget v0, v0, LX/5PH;->A01:I

    sub-int/2addr v1, v0

    invoke-static {v6, v1}, LX/4E3;->A0B(Landroid/view/View;I)I
    ...
    invoke-static {v8, v0, p0}, LX/5b8;->A01(Landroid/graphics/Rect;Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    :goto_0
    iget-object v6, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0U:LX/5aS;
    ...
    iget-object v1, v6, LX/5aS;->A11:Landroid/graphics/Rect;
    ...
    iget-object v1, v6, LX/5aS;->A12:Landroid/graphics/Rect;
    ...
    :goto_4
    invoke-virtual {v6, v2}, LX/5aS;->A0B(Z)V
    ...
    iput-boolean v0, v6, LX/5aS;->A0w:Z
    ...
    iput-boolean v7, v6, LX/5aS;->A0w:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0U:LX/5aS;

    iget v1, v3, LX/5aS;->A0I:F

    iget v0, v3, LX/5aS;->A0Q:F
    ...
    invoke-virtual {v3, p1}, LX/5aS;->A0A(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0I:LX/0YI;
...
.method public drawableStateChanged()V
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0U:LX/5aS;

    if-eqz v1, :cond_4

    iput-object v3, v1, LX/5aS;->A10:[I
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, LX/4Ij;-><init>(II)V
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, LX/4Ij;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, LX/4Ij;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public getCollapsedTitleTypeface()Landroid/graphics/Typeface;
    ...
    iget-object v0, v0, LX/5aS;->A0h:Landroid/graphics/Typeface;
...
.method public getExpandedTitleTypeface()Landroid/graphics/Typeface;
    ...
    iget-object v0, v0, LX/5aS;->A0l:Landroid/graphics/Typeface;
...
.method public getLineCount()I
    ...
    iget-object v0, v0, LX/5aS;->A0o:Landroid/text/StaticLayout;
...
.method public getTitlePositionInterpolator()Landroid/animation/TimeInterpolator;
    ...
    iget-object v0, v0, LX/5aS;->A0b:Landroid/animation/TimeInterpolator;
...
.method public getTitleTextEllipsize()Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v0, v0, LX/5aS;->A0p:Landroid/text/TextUtils$TruncateAt;
...
.method public onAttachedToWindow()V
    ...
    iget-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0J:LX/8bU;

    if-nez v0, :cond_1

    new-instance v0, LX/5lQ;

    invoke-direct {v0, p0}, LX/5lQ;-><init>(Lcom/google/android/material/appbar/CollapsingToolbarLayout;)V

    iput-object v0, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0J:LX/8bU;

    :cond_1
    invoke-virtual {v2, v0}, Lcom/google/android/material/appbar/AppBarLayout;->A02(LX/8bU;)V
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0J:LX/8bU;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {v1}, LX/0ZL;->A0B(Landroid/view/View;)Z
    ...
    invoke-static {v1, v4}, LX/0ZR;->A0J(Landroid/view/View;I)V
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A00(Landroid/view/View;)LX/5PH;

    move-result-object v2

    iget-object v1, v2, LX/5PH;->A03:Landroid/view/View;

    invoke-virtual {v1}, Landroid/view/View;->getTop()I

    move-result v0

    iput v0, v2, LX/5PH;->A01:I

    invoke-virtual {v1}, Landroid/view/View;->getLeft()I

    move-result v0

    iput v0, v2, LX/5PH;->A00:I
    ...
    invoke-virtual {v0}, LX/5PH;->A00()V
...
.method public onMeasure(II)V
    ...
    iget v4, v1, LX/5aS;->A0X:I

    if-le v4, v10, :cond_2

    iget-object v3, v1, LX/5aS;->A15:Landroid/text/TextPaint;

    iget v0, v1, LX/5aS;->A0O:F

    invoke-virtual {v3, v0}, Landroid/graphics/Paint;->setTextSize(F)V

    iget-object v0, v1, LX/5aS;->A0l:Landroid/graphics/Typeface;

    invoke-virtual {v3, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v0, v1, LX/5aS;->A0J:F
    ...
    iget-object v2, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0G:Landroid/view/View;
...
.method public setCollapsedTitleGravity(I)V
    ...
    invoke-virtual {v0, p1}, LX/5aS;->A07(I)V
...
.method public setCollapsedTitleTextSize(F)V
    ...
    iget v0, v1, LX/5aS;->A07:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, v1, LX/5aS;->A07:F
...
.method public setExpandedTitleGravity(I)V
    ...
    iget v0, v1, LX/5aS;->A0Y:I

    if-eq v0, p1, :cond_0

    iput p1, v1, LX/5aS;->A0Y:I
...
.method public setExpandedTitleTextAppearance(I)V
    ...
    invoke-virtual {v0, p1}, LX/5aS;->A08(I)V
...
.method public setExpandedTitleTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, v1, LX/5aS;->A0g:Landroid/content/res/ColorStateList;
...
.method public setRtlTextDirectionHeuristicsEnabled(Z)V
    ...
    iput-boolean p1, v0, LX/5aS;->A0z:Z
...
.method public setStaticLayoutBuilderConfigurer(LX/8bV;)V
    .locals 2
    ...
    iput-object p1, v1, LX/5aS;->A0q:LX/8Ov;
...
.method public setTitleCollapseMode(I)V
    ...
    iput-boolean v3, v0, LX/5aS;->A0x:Z
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/CollapsingToolbarLayout;->A0T:LX/5Yp;

    iget v0, v1, LX/5Yp;->A01:I

    invoke-virtual {v1, v0, v2}, LX/5Yp;->A00(IF)I
...
.method public setTitleEllipsize(Landroid/text/TextUtils$TruncateAt;)V
    ...
    iput-object p1, v1, LX/5aS;->A0p:Landroid/text/TextUtils$TruncateAt;
...
.method public setTitlePositionInterpolator(Landroid/animation/TimeInterpolator;)V
    ...
    iput-object p1, v1, LX/5aS;->A0b:Landroid/animation/TimeInterpolator;
