...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/6qg;->A0K:[I

    invoke-static {}, LX/0yH;->A0q()Ljava/util/concurrent/atomic/AtomicBoolean;

    move-result-object v0

    sput-object v0, LX/6qg;->A0J:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public constructor <init>(Landroid/content/Context;LX/35r;LX/1QX;LX/7KW;LX/8bd;LX/49C;IIIII)V
    .locals 12
    ...
    invoke-direct {p0, p1, p3, v0, v1}, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;-><init>(Landroid/content/Context;LX/1QX;LX/8bd;LX/7KW;)V

    const/4 v1, 0x0

    iput v1, p0, LX/6qg;->A00:I

    iput-boolean v1, p0, LX/6qg;->A08:Z

    invoke-static {}, LX/002;->A0I()Ljava/lang/Object;

    move-result-object v0

    iput-object v0, p0, LX/6qg;->A0I:Ljava/lang/Object;

    iput-boolean v1, p0, LX/6qg;->A07:Z

    iput-boolean v1, p0, LX/6qg;->A09:Z

    new-instance v0, LX/6Ns;

    invoke-direct {v0, p0}, LX/6Ns;-><init>(LX/6qg;)V

    iput-object v0, p0, LX/6qg;->A0C:Landroid/hardware/camera2/CameraDevice$StateCallback;

    iput-object p2, p0, LX/6qg;->A0F:LX/35r;

    move-object/from16 v0, p6

    iput-object v0, p0, LX/6qg;->A0G:LX/49C;
    ...
    invoke-virtual {p2}, LX/35r;->A0D()Landroid/hardware/camera2/CameraManager;

    move-result-object v1

    invoke-static {v1}, LX/39J;->A06(Ljava/lang/Object;)V

    iput-object v1, p0, LX/6qg;->A0D:Landroid/hardware/camera2/CameraManager;

    iput v11, p0, LX/6qg;->A0A:I
    ...
    iput-object v2, p0, LX/6qg;->A0B:Landroid/hardware/camera2/CameraCharacteristics;
    :try_end_0
    ...
    iput-object v4, p0, LX/6qg;->A0H:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
    ...
    iput-object v3, p0, LX/6qg;->A0E:Landroid/media/ImageReader;
    ...
    invoke-direct {v2, p0, v0}, LX/8dl;-><init>(Ljava/lang/Object;I)V

    iget-object v1, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraProcessor:LX/8YW;

    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraThreadHandler:Landroid/os/Handler;

    if-eqz v1, :cond_1

    invoke-interface {v1, v2, v0}, LX/8YW;->BeW(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
    ...
    invoke-virtual {p0, p1}, LX/6qg;->A04(Landroid/content/Context;)Z
...
.method public final A02()I
    ...
    iget-object v0, p0, LX/6qg;->A02:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v2, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->textureHolder:LX/2is;

    if-nez v2, :cond_0

    iget-object v0, p0, LX/6qg;->A0H:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
    ...
    :cond_0
    iget-object v7, p0, LX/6qg;->A04:Landroid/view/Surface;
    ...
    iget-object v0, v1, LX/7xV;->A08:LX/7KJ;

    iget-object v2, v0, LX/7KJ;->A04:Landroid/graphics/SurfaceTexture;

    if-nez v2, :cond_1

    invoke-virtual {v0}, LX/7KJ;->A00()Landroid/graphics/SurfaceTexture;
    ...
    :goto_0
    iput-object v1, p0, LX/6qg;->A04:Landroid/view/Surface;

    invoke-virtual {p0}, LX/6qg;->A03()V

    goto :goto_1

    :cond_2
    iget-object v0, v2, LX/2is;->A01:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v0, p0, LX/6qg;->A04:Landroid/view/Surface;
    ...
    iget-object v9, p0, LX/6qg;->A0E:Landroid/media/ImageReader;
    ...
    invoke-static {v0, v1, v6}, LX/0yL;->A0x(Ljava/lang/Object;[Ljava/lang/Object;I)Ljava/util/List;
    ...
    iget-boolean v0, p0, LX/6qg;->A09:Z

    if-eqz v0, :cond_3

    new-array v8, v2, [Landroid/hardware/camera2/params/OutputConfiguration;

    iget-object v2, p0, LX/6qg;->A04:Landroid/view/Surface;

    const-wide/16 v0, 0x1

    invoke-static {v2, v0, v1}, LX/6qg;->A00(Landroid/view/Surface;J)Landroid/hardware/camera2/params/OutputConfiguration;
    ...
    invoke-static {v0, v8, v6}, LX/0yL;->A0x(Ljava/lang/Object;[Ljava/lang/Object;I)Ljava/util/List;

    move-result-object v8

    :cond_3
    :goto_2
    iput-boolean v6, p0, LX/6qg;->A08:Z

    new-instance v2, LX/6Nr;

    invoke-direct {v2, v5, v7, p0}, LX/6Nr;-><init>(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/view/Surface;LX/6qg;)V
    ...
    invoke-direct {v0, v1}, LX/0of;-><init>(Landroid/os/Handler;)V
    ...
    :cond_5
    iget-object v1, p0, LX/6qg;->A02:Landroid/hardware/camera2/CameraDevice;
...
.method public final A03()V
    ...
    iget-object v0, p0, LX/6qg;->A0F:LX/35r;
    ...
    iget-object v3, p0, LX/6qg;->A0H:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
    ...
    iput-object v0, p0, LX/6qg;->A01:Landroid/graphics/Point;
...
.method public final A04(Landroid/content/Context;)Z
    ...
    :cond_2
    iget-object v1, p0, LX/6qg;->A0B:Landroid/hardware/camera2/CameraCharacteristics;
...
.method public closeOnCameraThread()V
    ...
    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraEventsDispatcher:LX/7Nd;

    invoke-virtual {v0}, LX/7Nd;->A00()V

    iget-object v0, p0, LX/6qg;->A0E:Landroid/media/ImageReader;

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iget-object v2, p0, LX/6qg;->A0I:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v0, p0, LX/6qg;->A03:Landroid/media/Image;
    ...
    iput-object v1, p0, LX/6qg;->A03:Landroid/media/Image;
    ...
    invoke-interface {v0, v1, v1}, LX/8YW;->BeJ(LX/8Pr;LX/7Wb;)V

    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraProcessor:LX/8YW;

    check-cast v0, LX/7xV;

    iget-object v0, v0, LX/7xV;->A05:LX/9Ae;

    invoke-virtual {v0}, LX/9Ae;->pause()V

    invoke-virtual {v0}, LX/9Ae;->destroy()V

    iput-object v1, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraProcessor:LX/8YW;
...
.method public disableAREffectOnCameraThread()I
    ...
    invoke-interface {v1, v0, v0}, LX/8YW;->BeJ(LX/8Pr;LX/7Wb;)V
    ...
    invoke-direct {v2, p0, v3}, LX/8dl;-><init>(Ljava/lang/Object;I)V

    iget-object v1, p0, LX/6qg;->A0E:Landroid/media/ImageReader;
    ...
    invoke-virtual {p0}, LX/6qg;->A02()I
...
.method public enableAREffectOnCameraThread(LX/7Wb;LX/8Pr;)I
    .locals 7
    ...
    invoke-interface {v0, p2, p1}, LX/8YW;->BeJ(LX/8Pr;LX/7Wb;)V
    ...
    iget-object v2, p0, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraProcessor:LX/8YW;
    ...
    invoke-interface {v2, v1, v0}, LX/8YW;->BeW(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    goto :goto_0

    :cond_5
    invoke-interface {v0}, LX/8YW;->start()V
...
.method public getAdjustedPreviewSize()Landroid/graphics/Point;
    ...
    iget-object v0, p0, LX/6qg;->A01:Landroid/graphics/Point;
...
.method public getCameraInfo()Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
    ...
    iget-object v1, p0, LX/6qg;->A0H:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
...
.method public getLastCachedFrame()LX/2T6;
    ...
    iget-object v1, v2, LX/6qg;->A0I:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v0, v2, LX/6qg;->A03:Landroid/media/Image;
    ...
    iget-object v0, v2, LX/6qg;->A06:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, v2, LX/6qg;->A06:Ljava/nio/ByteBuffer;
    ...
    :goto_1
    iget-object v0, v2, LX/6qg;->A0H:Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera$CameraInfo;
    ...
    invoke-direct/range {v7 .. v13}, LX/2T6;-><init>([BIIIIZ)V
...
.method public onFrameAvailableOnCameraThread()V
    ...
    invoke-interface {v3, v2, v1, v0}, Lcom/whatsapp/voipcalling/VideoPort;->renderTexture(LX/2is;II)V
...
.method public setVideoPortOnCameraThread(Lcom/whatsapp/voipcalling/VideoPort;)I
    ...
    invoke-static {p1}, LX/0yH;->A06(Ljava/lang/Object;)I
    ...
    invoke-static {v3}, LX/0yH;->A06(Ljava/lang/Object;)I
...
.method public startOnCameraThread()I
    ...
    :cond_1
    sget-object v0, LX/6qg;->A0J:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, LX/6qg;->A05:Ljava/lang/Runnable;
    ...
    invoke-direct {v3, p0, v0}, LX/3du;-><init>(Ljava/lang/Object;I)V

    iput-object v3, p0, LX/6qg;->A05:Ljava/lang/Runnable;
    ...
    iget-object v3, p0, LX/6qg;->A0D:Landroid/hardware/camera2/CameraManager;

    iget v0, p0, LX/6qg;->A0A:I

    invoke-static {v0}, Ljava/lang/Integer;->toString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v1, p0, LX/6qg;->A0C:Landroid/hardware/camera2/CameraDevice$StateCallback;
...
.method public stopOnCameraThread()I
    ...
    iget-object v3, p0, LX/6qg;->A02:Landroid/hardware/camera2/CameraDevice;

    const/4 v2, 0x0

    if-eqz v3, :cond_0

    iput-object v2, p0, LX/6qg;->A02:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v1, p0, LX/6qg;->A0G:LX/49C;
    ...
    iput-object v2, p0, LX/6qg;->A04:Landroid/view/Surface;

    :cond_1
    invoke-virtual {p0}, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->releaseTexture()V

    iget-object v1, p0, LX/6qg;->A05:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, LX/6qg;->A05:Ljava/lang/Runnable;

    :cond_2
    const/4 v0, 0x0

    iput-boolean v0, p0, LX/6qg;->A07:Z

    iput-boolean v0, p0, LX/6qg;->A08:Z
