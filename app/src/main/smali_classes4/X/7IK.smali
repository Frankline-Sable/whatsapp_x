...
.method public constructor <init>(LX/71p;)V
    ...
    iput-object p1, p0, LX/7IK;->A00:LX/71p;
...
# virtual methods
.method public A00(Landroid/os/Bundle;)LX/7Tm;
    .locals 8
    ...
    :try_start_1
    sget-object v1, LX/6u6;->A02:LX/6u6;

    goto :goto_1

    :cond_0
    sget-object v1, LX/6u6;->A03:LX/6u6;
    ...
    sget-object v1, LX/6u6;->A01:LX/6u6;
    ...
    :goto_2
    sget-object v0, LX/6u6;->A03:LX/6u6;
    ...
    :cond_3
    invoke-virtual {v3, v1}, LX/6eM;->add(Ljava/lang/Object;)LX/6eM;
    ...
    invoke-direct {v0, v1, v5, v6, v7}, LX/7Tm;-><init>(LX/6eW;Ljava/lang/String;Ljava/lang/Throwable;I)V
