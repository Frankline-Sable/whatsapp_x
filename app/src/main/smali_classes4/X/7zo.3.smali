...
.method public run()V
    ...
    sget-object v0, LX/7YE;->A02:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v1, v0}, LX/7YE;->A00(LX/7AM;I)V
    ...
    sget-object v2, LX/7YE;->A00:Ljava/lang/Runnable;
    ...
    sget-object v6, LX/7TC;->A02:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, v0, LX/7AR;->A01:Ljava/util/Date;
    ...
    iget-object v3, v0, LX/7AR;->A00:LX/7Wd;

    iget-object v2, v3, LX/7Wd;->A0A:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v2, LX/7YE;->A01:Ljava/lang/Runnable;
    ...
    :pswitch_e
    :try_start_1
    sget-object v0, LX/4Xr;->A03:Ljava/util/concurrent/BlockingQueue;
    ...
    :try_start_2
    iget-object v0, v3, LX/7Cz;->A01:Ljava/lang/String;
    ...
    :cond_8
    :try_start_4
    sget-object v6, LX/4Xr;->A05:LX/7yb;

    iget-object v7, v3, LX/7Cz;->A01:Ljava/lang/String;
    ...
    :try_start_5
    iget-object v0, v6, LX/7yb;->A04:Ljava/io/Writer;

    if-eqz v0, :cond_f

    invoke-static {v7}, LX/7yb;->A05(Ljava/lang/String;)V

    iget-object v0, v6, LX/7yb;->A0B:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {v1, v6, v7}, LX/7Mb;-><init>(LX/7yb;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v1, v6}, LX/7K6;-><init>(LX/7Mb;LX/7yb;)V

    iput-object v5, v1, LX/7Mb;->A01:LX/7K6;

    iget-object v4, v6, LX/7yb;->A04:Ljava/io/Writer;
    ...
    :cond_a
    iget-object v0, v1, LX/7Mb;->A01:LX/7K6;
    ...
    :try_start_7
    iget-object v6, v5, LX/7K6;->A04:LX/7yb;

    iget v4, v6, LX/7yb;->A06:I
    ...
    :try_start_8
    iget-object v8, v5, LX/7K6;->A02:LX/7Mb;

    iget-object v0, v8, LX/7Mb;->A01:LX/7K6;

    if-ne v0, v5, :cond_d

    iget-boolean v0, v8, LX/7Mb;->A02:Z

    if-nez v0, :cond_b

    iget-object v1, v5, LX/7K6;->A03:[Z
    ...
    :cond_b
    invoke-virtual {v8}, LX/7Mb;->A01()Ljava/io/File;
    ...
    :catch_1
    :try_start_a
    iget-object v0, v6, LX/7yb;->A07:Ljava/io/File;
    ...
    invoke-direct {v4, v5, v0}, LX/1uV;-><init>(LX/7K6;Ljava/io/OutputStream;)V

    goto :goto_9

    :catch_2
    sget-object v4, LX/7yb;->A0E:Ljava/io/OutputStream;
    ...
    :try_start_d
    iget-object v1, v3, LX/7Cz;->A02:[B

    iget v0, v3, LX/7Cz;->A00:I

    invoke-virtual {v4, v1, v7, v0}, Ljava/io/OutputStream;->write([BII)V

    iget-boolean v0, v5, LX/7K6;->A01:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_c

    invoke-static {v5, v6, v7}, LX/7yb;->A01(LX/7K6;LX/7yb;Z)V

    iget-object v0, v8, LX/7Mb;->A03:Ljava/lang/String;

    invoke-virtual {v6, v0}, LX/7yb;->A07(Ljava/lang/String;)V

    :goto_a
    iput-boolean v1, v5, LX/7K6;->A00:Z

    goto :goto_f

    :cond_c
    invoke-static {v5, v6, v1}, LX/7yb;->A01(LX/7K6;LX/7yb;Z)V
    ...
    :goto_e
    :try_start_13
    sget-object v0, LX/5Zv;->A0B:LX/5Zv;
    ...
    iget-boolean v0, v2, LX/7K6;->A00:Z

    if-nez v0, :cond_10

    :try_start_14
    invoke-virtual {v2}, LX/7K6;->A00()V
    :try_end_14
