...
.method public constructor <init>(LX/35t;)V
    ...
    iput-object p1, p0, LX/7Uy;->A00:LX/35t;

    invoke-static {}, LX/0yN;->A1E()Ljava/util/LinkedList;

    move-result-object v0

    iput-object v0, p0, LX/7Uy;->A02:Ljava/util/LinkedList;

    invoke-static {}, LX/0yN;->A1E()Ljava/util/LinkedList;

    move-result-object v0

    iput-object v0, p0, LX/7Uy;->A01:Ljava/util/LinkedList;

    invoke-static {}, LX/0yN;->A1E()Ljava/util/LinkedList;

    move-result-object v0

    iput-object v0, p0, LX/7Uy;->A03:Ljava/util/LinkedList;
...
# virtual methods
.method public final A01(LX/7HU;)V
    .locals 5

    iget-object v1, p1, LX/7HU;->A09:Ljava/util/List;

    invoke-static {v1}, LX/7cX;->A0B(Ljava/lang/Object;)V

    iget-object v0, p0, LX/7Uy;->A01:Ljava/util/LinkedList;

    invoke-static {v0, v1}, LX/7Uy;->A00(Ljava/util/LinkedList;Ljava/util/List;)V

    iget-object v1, p1, LX/7HU;->A0C:Ljava/util/List;

    invoke-static {v1}, LX/7cX;->A0B(Ljava/lang/Object;)V

    iget-object v0, p0, LX/7Uy;->A03:Ljava/util/LinkedList;

    invoke-static {v0, v1}, LX/7Uy;->A00(Ljava/util/LinkedList;Ljava/util/List;)V

    iget-object v0, p1, LX/7HU;->A0A:Ljava/util/List;
    ...
    iget-object v2, p0, LX/7Uy;->A02:Ljava/util/LinkedList;
