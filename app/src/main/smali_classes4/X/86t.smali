...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LX/86t;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, LX/86t;->A01:LX/8Qp;

    iput-boolean p1, p0, LX/86t;->A02:Z
...
# virtual methods
.method public A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/813;)Ljava/security/cert/CertPathBuilderResult;
    .locals 8
    ...
    iget-object v0, p3, LX/813;->A01:Ljava/util/Set;
    ...
    iget v1, p3, LX/813;->A00:I

    const/4 v0, -0x1

    if-eq v1, v0, :cond_1

    invoke-static {p2}, LX/4E0;->A0A(Ljava/util/List;)I
    ...
    iget-boolean v0, p0, LX/86t;->A02:Z

    new-instance v6, LX/86x;

    invoke-direct {v6, v0}, LX/86x;-><init>(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_5

    :try_start_1
    iget-object v4, p3, LX/813;->A02:LX/814;

    iget-object v3, v4, LX/814;->A08:Ljava/util/Set;

    iget-object v7, v4, LX/814;->A01:Ljava/security/cert/PKIXParameters;
    ...
    :try_start_2
    invoke-static {v0, p1, v3}, LX/7cH;->A01(Ljava/lang/String;Ljava/security/cert/X509Certificate;Ljava/util/Set;)Ljava/security/cert/TrustAnchor;
    ...
    goto/16 :goto_6
    :try_end_5
    .catch LX/6wl; {:try_start_5 .. :try_end_5} :catch_6
    ...
    goto :goto_4
    :try_end_6
    .catch LX/6wl; {:try_start_6 .. :try_end_6} :catch_6
    ...
    iget-object v0, v4, LX/814;->A05:Ljava/util/List;

    invoke-virtual {v6, v0}, Ljava/util/AbstractCollection;->addAll(Ljava/util/Collection;)Z
    :try_end_7
    .catch LX/6wl; {:try_start_7 .. :try_end_7} :catch_6
    ...
    iget-object v5, v4, LX/814;->A07:Ljava/util/Map;
    ...
    .catch LX/6wl; {:try_start_8 .. :try_end_8} :catch_6
    ...
    move-result-object v1
    :try_end_9
    .catch LX/6wl; {:try_start_9 .. :try_end_9} :catch_6
    ...
    invoke-static {p1, v0, v6}, LX/7cH;->A02(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/util/AbstractCollection;->addAll(Ljava/util/Collection;)Z
    :try_end_a
    .catch LX/6wl; {:try_start_a .. :try_end_a} :catch_3
    ...
    invoke-virtual {p0, v0, p2, p3}, LX/86t;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/813;)Ljava/security/cert/CertPathBuilderResult;
    ...
    goto :goto_5
    :try_end_b
    .catch LX/6wl; {:try_start_b .. :try_end_b} :catch_6
    ...
    goto :goto_4
    :try_end_c
    .catch LX/6wl; {:try_start_c .. :try_end_c} :catch_6
    ...
    throw v0
    :try_end_d
    .catch LX/6wl; {:try_start_d .. :try_end_d} :catch_6

    :catch_6
    move-exception v0

    iput-object v0, p0, LX/86t;->A00:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v3, v1}, LX/7UG;-><init>(Ljava/security/cert/PKIXParameters;)V

    instance-of v0, p1, LX/870;

    if-eqz v0, :cond_0

    check-cast p1, LX/8Ms;

    iget-object v0, p1, LX/870;->A01:Ljava/util/List;
    ...
    invoke-direct {v2, v1}, LX/7Td;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V

    goto :goto_1

    :cond_1
    instance-of v0, p1, LX/813;

    if-eqz v0, :cond_8

    check-cast p1, LX/813;
    ...
    invoke-direct {v0, v3}, LX/814;-><init>(LX/7UG;)V

    new-instance v2, LX/7Td;

    invoke-direct {v2, v0}, LX/7Td;-><init>(LX/814;)V

    iget-object v0, p1, LX/8Ms;->A01:Ljava/util/Set;

    invoke-static {v0}, Ljava/util/Collections;->unmodifiableSet(Ljava/util/Set;)Ljava/util/Set;

    move-result-object v1

    iget-object v0, v2, LX/7Td;->A01:Ljava/util/Set;

    invoke-interface {v0, v1}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iget v1, p1, LX/8Ms;->A00:I

    const/4 v0, -0x1

    if-lt v1, v0, :cond_7

    iput v1, v2, LX/7Td;->A00:I

    :goto_1
    new-instance p1, LX/813;

    invoke-direct {p1, v2}, LX/813;-><init>(LX/7Td;)V
    ...
    invoke-static {p1}, LX/7cH;->A03(LX/813;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v0, v3, p1}, LX/86t;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/813;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object v2, p0, LX/86t;->A00:Ljava/lang/Exception;
    ...
    iget-object v0, p0, LX/86t;->A00:Ljava/lang/Exception;
...
.method public bridge synthetic engineGetRevocationChecker()Ljava/security/cert/CertPathChecker;
    ...
    iget-object v1, p0, LX/86t;->A01:LX/8Qp;
