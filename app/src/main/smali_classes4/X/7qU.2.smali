...
.field public final A03:LX/7Vr;

.field public final A04:LX/6Uq;

.field public final A05:LX/6VA;
...
.field public volatile A0E:LX/8Yg;


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;LX/7Vr;LX/6Uq;LX/6VA;LX/8XP;LX/7Gq;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/concurrent/locks/Lock;)V
    .locals 3
    ...
    iput-object v0, p0, LX/7qU;->A0A:Ljava/util/Map;

    const/4 v0, 0x0

    iput-object v0, p0, LX/7qU;->A01:LX/6Y7;

    iput-object p1, p0, LX/7qU;->A02:Landroid/content/Context;

    iput-object p11, p0, LX/7qU;->A0D:Ljava/util/concurrent/locks/Lock;

    iput-object p3, p0, LX/7qU;->A03:LX/7Vr;

    iput-object p9, p0, LX/7qU;->A09:Ljava/util/Map;

    iput-object p7, p0, LX/7qU;->A08:LX/7Gq;

    iput-object p10, p0, LX/7qU;->A0B:Ljava/util/Map;

    iput-object p4, p0, LX/7qU;->A04:LX/6Uq;

    iput-object p5, p0, LX/7qU;->A05:LX/6VA;

    iput-object p6, p0, LX/7qU;->A07:LX/8XP;
    ...
    iput-object p0, v0, LX/7px;->A00:LX/8bG;
    ...
    invoke-direct {v0, p2, p0}, LX/6Zm;-><init>(Landroid/os/Looper;LX/7qU;)V

    iput-object v0, p0, LX/7qU;->A06:LX/6Zm;

    invoke-interface {p11}, Ljava/util/concurrent/locks/Lock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object v0

    iput-object v0, p0, LX/7qU;->A0C:Ljava/util/concurrent/locks/Condition;

    new-instance v0, LX/7qP;

    invoke-direct {v0, p0}, LX/7qP;-><init>(LX/7qU;)V

    iput-object v0, p0, LX/7qU;->A0E:LX/8Yg;
...
# virtual methods
.method public final A00(LX/6Y7;)V
    .locals 2

    iget-object v1, p0, LX/7qU;->A0D:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iput-object p1, p0, LX/7qU;->A01:LX/6Y7;
    ...
    iget-object v0, p0, LX/7qU;->A0E:LX/8Yg;

    invoke-interface {v0}, LX/8Yg;->Bks()V

    iget-object v0, p0, LX/7qU;->A0C:Ljava/util/concurrent/locks/Condition;
...
.method public final Bku(LX/6VI;)LX/6VI;
    ...
    invoke-interface {v0, p1}, LX/8Yg;->Bkl(LX/6VI;)LX/6VI;
...
.method public final Bkx(LX/6VI;)LX/6VI;
    ...
    invoke-interface {v0, p1}, LX/8Yg;->Bkn(LX/6VI;)LX/6VI;
...
.method public final Bl2()V
    ...
    invoke-interface {v0}, LX/8Yg;->Bkv()V
...
.method public final Bl3()V
    ...
    invoke-interface {v0}, LX/8Yg;->Bl1()Z

    iget-object v0, p0, LX/7qU;->A0A:Ljava/util/Map;
...
.method public final Bl4(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, v3, LX/7qU;->A0B:Ljava/util/Map;
    ...
    iget-object v0, v2, LX/7De;->A02:Ljava/lang/String;
    ...
    iget-object v1, v3, LX/7qU;->A09:Ljava/util/Map;
    ...
    check-cast v7, LX/8bF;

    check-cast v7, LX/7Ze;

    iget-object v1, v7, LX/7Ze;->A0M:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget v12, v7, LX/7Ze;->A02:I

    iget-object v11, v7, LX/7Ze;->A06:Landroid/os/IInterface;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    iget-object v1, v7, LX/7Ze;->A0N:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, v7, LX/7Ze;->A09:Lcom/google/android/gms/common/internal/IGmsServiceBroker;
    ...
    invoke-static {v0, v12, v11}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v0, v9, v8}, LX/000;->A0U(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget v0, v7, LX/7Ze;->A01:I

    invoke-static {v0}, LX/6zm;->A00(I)Ljava/lang/String;
    ...
    invoke-static {v0}, LX/6NG;->A0i(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_7
    invoke-virtual {v7}, LX/7Ze;->A03()Ljava/lang/String;
...
.method public final onConnected(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, LX/8Yg;->Bky(Landroid/os/Bundle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onConnectionSuspended(I)V
    ...
    invoke-interface {v0, p1}, LX/8Yg;->Bl0(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
