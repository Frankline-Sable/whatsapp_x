...
.field public final synthetic A02:LX/6qg;


# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/view/Surface;LX/6qg;)V
    .locals 0

    iput-object p3, p0, LX/6Nr;->A02:LX/6qg;

    iput-object p2, p0, LX/6Nr;->A01:Landroid/view/Surface;

    iput-object p1, p0, LX/6Nr;->A00:Landroid/hardware/camera2/CaptureRequest$Builder;
...
.method public onConfigureFailed(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iget-object v1, p0, LX/6Nr;->A01:Landroid/view/Surface;

    if-eqz v1, :cond_0

    iget-object v0, p0, LX/6Nr;->A02:LX/6qg;

    iget-object v0, v0, LX/6qg;->A04:Landroid/view/Surface;
    ...
    :cond_0
    iget-object v1, p0, LX/6Nr;->A02:LX/6qg;

    const/4 v0, 0x0

    iput-boolean v0, v1, LX/6qg;->A08:Z

    const-string v0, "voip/video/VoipCamera/ cameraDevice configure failed"

    invoke-static {v0}, Lcom/whatsapp/util/Log;->i(Ljava/lang/String;)V

    iget-object v0, v1, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraEventsDispatcher:LX/7Nd;

    invoke-virtual {v0}, LX/7Nd;->A01()V
...
.method public onConfigured(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iget-object v2, p0, LX/6Nr;->A02:LX/6qg;

    const/4 v12, 0x0

    iput-boolean v12, v2, LX/6qg;->A08:Z

    iget-object v1, p0, LX/6Nr;->A01:Landroid/view/Surface;

    if-eqz v1, :cond_0

    iget-object v0, v2, LX/6qg;->A04:Landroid/view/Surface;
    ...
    :cond_0
    iget-object v0, v2, LX/6qg;->A02:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v0, v2, Lcom/whatsapp/voipcalling/camera/VoipPhysicalCamera;->cameraEventsDispatcher:LX/7Nd;
    ...
    iget-object v5, p0, LX/6Nr;->A00:Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v1, v2, LX/6qg;->A0B:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-static {v6, v1, v9}, LX/0yE;->A0x(Ljava/lang/String;Ljava/lang/StringBuilder;I)V
