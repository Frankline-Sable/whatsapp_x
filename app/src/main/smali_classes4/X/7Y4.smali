...
.field public static A01:LX/6Rc;
...
.method public static A00(Landroid/content/Context;I)V
    ...
    invoke-static {v5}, LX/2vl;->A00(Landroid/content/Context;)V
    :try_end_0
    ...
    sput-object v1, LX/7Y4;->A01:LX/6Rc;

    const/4 v0, 0x5

    new-array v2, v0, [LX/7X4;
    ...
    invoke-direct {v8, v5, v0, v1, v2}, LX/7lo;-><init>(Landroid/content/Context;LX/7R1;Ljava/io/File;[LX/7X4;)V

    sget-object v0, LX/7lo;->A09:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {v4, v8, v0}, LX/0Ip;->A00(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    :try_start_2
    sget-object v7, LX/7R1;->A00:LX/7AW;
    ...
    :try_start_4
    iget-object v2, v8, LX/7lo;->A01:LX/7V8;

    iget-object v11, v2, LX/7V8;->A06:Ljava/io/File;

    iget-object v0, v2, LX/7V8;->A04:Ljava/io/File;
    ...
    iput-object v10, v8, LX/7lo;->A02:Lcom/facebook/profilo/mmapbuf/core/MmapBufferManager;

    sget-object v0, LX/7Wl;->A0A:LX/7Wl;
    ...
    invoke-direct/range {v5 .. v11}, LX/7Wl;-><init>(Landroid/util/SparseArray;LX/7AW;LX/7lo;LX/8Xp;Lcom/facebook/profilo/mmapbuf/core/MmapBufferManager;Ljava/io/File;)V

    sput-object v5, LX/7Wl;->A0A:LX/7Wl;
    ...
    iget-object v0, v8, LX/7lo;->A08:LX/7AW;
    ...
    iput-object v7, v8, LX/7lo;->A08:LX/7AW;

    sget-object v0, LX/7Wl;->A0A:LX/7Wl;

    if-eqz v0, :cond_3

    iget-object v1, v0, LX/7Wl;->A07:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    invoke-static {v0, v7, v1}, LX/0Ip;->A00(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    iput-wide v3, v2, LX/7V8;->A01:J

    const/16 v0, 0xa

    iput v0, v2, LX/7V8;->A00:I

    iget-object v0, v8, LX/7lo;->A05:LX/7ln;

    new-instance v1, LX/7lm;

    invoke-direct {v1}, LX/7lm;-><init>()V

    iget-object v0, v0, LX/7ln;->A00:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v0, v4, LX/7Wl;->A06:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, v4, LX/7Wl;->A01:Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v10, v0, v1}, LX/7Wl;->A00(IJ)LX/7i1;

    move-result-object v0

    if-nez v0, :cond_6

    iget-object v0, v4, LX/7Wl;->A07:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, LX/7AW;

    iget-object v0, v9, LX/7TM;->A00:Ljava/util/ArrayList;

    sget-object v3, Lcom/facebook/profilo/core/ProvidersRegistry;->A00:LX/7NH;

    invoke-virtual {v3, v0}, LX/7NH;->A00(Ljava/lang/Iterable;)I
    ...
    :cond_7
    sget-object v0, LX/7Wl;->A09:Ljava/lang/ThreadLocal;
    ...
    invoke-static/range {v31 .. v32}, LX/7Qt;->A00(J)Ljava/lang/String;
    ...
    iget-boolean v1, v9, LX/7TM;->A01:Z
    ...
    invoke-direct {v6, v2, v1}, LX/7hu;-><init>(Ljava/util/TreeMap;Ljava/util/TreeMap;)V

    const-string v1, "trace_config.buffers"

    const/4 v0, 0x1

    invoke-virtual {v6, v1, v0}, LX/7hu;->A00(Ljava/lang/String;I)I
    ...
    iget-object v0, v8, LX/7AW;->A00:Lcom/facebook/profilo/config/ConfigParams;
    ...
    iget-object v0, v6, LX/7hu;->A00:Ljava/util/TreeMap;
    ...
    iget-object v0, v6, LX/7hu;->A01:Ljava/util/TreeMap;
    ...
    iget-object v14, v4, LX/7Wl;->A04:Lcom/facebook/profilo/mmapbuf/core/MmapBufferManager;
    ...
    iget-object v2, v4, LX/7Wl;->A05:Ljava/io/File;
    ...
    invoke-direct/range {v21 .. v34}, LX/7i1;-><init>(LX/7AW;LX/7hu;Lcom/facebook/profilo/mmapbuf/core/Buffer;Ljava/io/File;Ljava/lang/Object;Ljava/lang/String;[Lcom/facebook/profilo/mmapbuf/core/Buffer;IIJJ)V

    iget-object v11, v2, LX/7i1;->A0F:[Lcom/facebook/profilo/mmapbuf/core/Buffer;
    ...
    iget-object v9, v2, LX/7i1;->A09:Lcom/facebook/profilo/mmapbuf/core/Buffer;
    ...
    iget-object v0, v2, LX/7i1;->A0D:Ljava/lang/String;
    ...
    iget-object v6, v4, LX/7Wl;->A08:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-static {v0, v2, v6, v1}, LX/6yi;->A00(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Z
    ...
    iget v0, v2, LX/7i1;->A02:I

    move/from16 v17, v0

    iget-wide v6, v2, LX/7i1;->A05:J

    iget-wide v0, v2, LX/7i1;->A06:J
    ...
    :cond_13
    iget-object v13, v2, LX/7i1;->A08:LX/7hu;

    const-string v10, "trace_config.trace_timeout_ms"

    const/16 v8, 0x7530

    invoke-virtual {v13, v10, v8}, LX/7hu;->A00(Ljava/lang/String;I)I
    ...
    :goto_a
    :try_start_b
    invoke-virtual {v4}, LX/7Wl;->A02()V

    invoke-virtual {v4, v0, v1}, LX/7Wl;->A01(J)LX/7i1;

    move-result-object v8

    if-eqz v8, :cond_1d

    iget-object v8, v4, LX/7Wl;->A00:LX/6OM;
    ...
    :try_start_c
    iget-object v14, v8, LX/6OM;->A00:LX/77D;
    ...
    :try_start_d
    new-instance v15, LX/7Ew;

    invoke-direct {v15, v2}, LX/7Ew;-><init>(LX/7i1;)V

    iget-boolean v13, v15, LX/7Ew;->A02:Z
    ...
    :cond_14
    :try_start_10
    iget-boolean v13, v15, LX/7Ew;->A03:Z

    if-eqz v13, :cond_15

    iget-object v13, v14, LX/77D;->A00:Landroid/util/LongSparseArray;
    ...
    :try_start_12
    iget-object v13, v2, LX/7i1;->A0A:Ljava/io/File;

    invoke-virtual {v13}, Ljava/io/File;->getCanonicalPath()Ljava/lang/String;

    move-result-object v22

    iget-object v15, v2, LX/7i1;->A0E:Ljava/lang/String;

    new-instance v14, LX/7lp;

    invoke-direct {v14, v8, v2}, LX/7lp;-><init>(LX/6OM;LX/7i1;)V

    new-instance v13, LX/86F;
    ...
    invoke-direct/range {v20 .. v26}, LX/86F;-><init>(Lcom/facebook/profilo/writer/NativeTraceWriterCallbacks;Ljava/lang/String;Ljava/lang/String;[Lcom/facebook/profilo/mmapbuf/core/Buffer;J)V
    :try_end_12
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_12} :catch_1
    .catchall {:try_start_12 .. :try_end_12} :catchall_a

    :try_start_13
    iput-object v13, v2, LX/7i1;->A0G:LX/86F;

    and-int/lit8 v11, v12, 0x2

    if-nez v11, :cond_17

    iget-object v15, v13, LX/86F;->A02:Lcom/facebook/profilo/writer/NativeTraceWriter;
    ...
    :cond_16
    iget-object v14, v2, LX/7i1;->A08:LX/7hu;

    const-string v13, "trace_config.trace_timeout_ms"

    const/16 v11, 0x7530

    invoke-virtual {v14, v13, v11}, LX/7hu;->A00(Ljava/lang/String;I)I
    ...
    :cond_17
    iget-object v11, v8, LX/6OM;->A03:Ljava/util/HashSet;

    invoke-static {v11, v0, v1}, LX/0yG;->A1L(Ljava/util/AbstractCollection;J)V

    iget-object v12, v8, LX/6OM;->A01:LX/7lo;
    ...
    :try_start_14
    iget-object v11, v3, LX/7NH;->A01:Ljava/util/ArrayList;

    invoke-virtual {v3, v11}, LX/7NH;->A00(Ljava/lang/Iterable;)I
    ...
    invoke-virtual {v3, v0}, LX/7NH;->A01(Ljava/lang/Object;)I
    ...
    :try_start_1a
    iget-object v14, v12, LX/7lo;->A04:[LX/7X4;
    ...
    :try_start_1b
    iget-object v13, v12, LX/7lo;->A06:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, LX/7X4;->getSupportedProviders()I
    ...
    invoke-virtual {v1}, LX/7X4;->A01()V

    invoke-virtual {v1, v2}, LX/7X4;->A02(LX/7i1;)V

    invoke-virtual {v1, v2, v12}, LX/7X4;->onTraceStarted(LX/7i1;LX/7lo;)V
    ...
    invoke-static {v8, v2, v0}, LX/6NE;->A0y(Landroid/os/Handler;Ljava/lang/Object;I)V
    ...
    iget-object v0, v2, LX/7i1;->A0A:Ljava/io/File;
    ...
    invoke-static {v0, v1, v10}, LX/000;->A0E(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/IllegalArgumentException;
