...
# direct methods
.method public static A00([B[B)LX/850;
    .locals 7

    new-instance v5, LX/850;

    invoke-direct {v5}, LX/850;-><init>()V

    new-instance v0, LX/84q;

    invoke-direct {v0, p0}, LX/84q;-><init>([B)V

    new-instance v1, LX/84s;

    invoke-direct {v1, v0, p1}, LX/84s;-><init>(LX/41y;[B)V

    iget-object v4, v1, LX/84s;->A01:[B
    ...
    iget-boolean v2, v5, LX/850;->A04:Z
    ...
    :cond_1
    instance-of v0, v1, LX/84q;

    if-eqz v0, :cond_9

    check-cast v1, LX/84q;

    iget-object p0, v1, LX/84q;->A00:[B
    ...
    iget-object v6, v5, LX/850;->A06:[I

    sget-object p1, LX/850;->A0A:[I
    ...
    invoke-static {p0, v6, v1, v0}, LX/7bO;->A05([B[III)V
    ...
    invoke-static {p0, v6, v3, v0}, LX/7bO;->A05([B[III)V
    ...
    invoke-static {v4, v6, v3, v0}, LX/7bO;->A05([B[III)V
    ...
    invoke-static {v4, v6, v2, v0}, LX/7bO;->A05([B[III)V
    ...
    invoke-static {v6, v2}, LX/850;->A02([I[I)V
    ...
    iput v4, v5, LX/850;->A03:I

    iput v4, v5, LX/850;->A00:I

    iput v4, v5, LX/850;->A01:I

    iput v4, v5, LX/850;->A02:I
    ...
    iget-object v2, v5, LX/850;->A05:[B

    iget-object v1, v5, LX/850;->A07:[I

    invoke-static {v6, v1}, LX/850;->A02([I[I)V
    ...
    invoke-static {v2, v0, v3}, LX/6NF;->A1L([BII)V
    ...
    iput-boolean v0, v5, LX/850;->A04:Z
...
.method public static A01([B[B[B)[B
    ...
    invoke-static {p0, p1}, LX/7XV;->A00([B[B)LX/850;
    ...
    invoke-virtual/range {v5 .. v10}, LX/850;->A03([B[BIII)V

    new-instance v0, LX/84q;

    invoke-direct {v0, v6}, LX/84q;-><init>([B)V

    invoke-virtual {v4, v0}, LX/84z;->B9K(LX/41y;)V
    ...
    invoke-virtual {v4, p2, p0, p1}, LX/84z;->update([BII)V

    invoke-virtual {v4, v2, v8}, LX/84z;->AvS([BI)I
    ...
    invoke-virtual/range {v9 .. v14}, LX/850;->A03([B[BIII)V
...
.method public static A02([B[B[B)[B
    ...
    invoke-virtual/range {v6 .. v11}, LX/850;->A03([B[BIII)V
    ...
    invoke-virtual {v1, v8, p2, p1}, LX/84z;->update([BII)V

    invoke-virtual {v1, v8, v5}, LX/84z;->AvS([BI)I
