...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/7a9;->A00:Ljava/util/Map;
...
.method public static declared-synchronized A01(Ljava/net/URI;Ljava/security/cert/CertificateFactory;Ljava/util/Date;)LX/85S;
    .locals 5

    const-class v4, LX/7a9;

    monitor-enter v4

    :try_start_0
    sget-object v2, LX/7a9;->A00:Ljava/util/Map;
    ...
    iget-object v0, v3, LX/85S;->A00:Ljava/util/Collection;
    ...
    invoke-static {p0, p1}, LX/7a9;->A00(Ljava/net/URI;Ljava/security/cert/CertificateFactory;)Ljava/util/Collection;
    ...
    invoke-direct {v0, v1}, LX/85T;-><init>(Ljava/util/Collection;)V

    new-instance v1, LX/85S;

    invoke-direct {v1, v0}, LX/85S;-><init>(LX/8VU;)V
