...
# virtual methods
.method public final A00(Lorg/json/JSONObject;)LX/7Tj;
    .locals 16
    ...
    :try_start_0
    sget-object v5, LX/6uR;->A05:LX/6uR;
    ...
    :cond_1
    invoke-static {v14, v9}, LX/0yI;->A0o(Ljava/lang/String;Lorg/json/JSONObject;)Ljava/lang/String;

    move-result-object v0

    new-instance v1, LX/79g;

    invoke-direct {v1, v0}, LX/79g;-><init>(Ljava/lang/String;)V

    new-instance v0, LX/7EU;

    invoke-direct {v0, v1, v2, v4}, LX/7EU;-><init>(LX/79g;Ljava/util/Map;Z)V
    ...
    invoke-virtual {v0, v1}, LX/7L3;->A00(Lorg/json/JSONObject;)LX/7Tj;
    ...
    invoke-direct {v0, v5, v7, v6}, LX/7Tj;-><init>(LX/6uR;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    return-object v0
.end method

.method public final A01(LX/7Tj;)Lorg/json/JSONObject;
    .locals 8
    ...
    iget-object v0, p1, LX/7Tj;->A00:LX/6uR;
    ...
    iget-object v0, p1, LX/7Tj;->A02:Ljava/util/ArrayList;
    ...
    iget-boolean v0, v4, LX/7EU;->A02:Z
    ...
    iget-object v0, v4, LX/7EU;->A01:Ljava/util/Map;
    ...
    iget-object v0, v4, LX/7EU;->A00:LX/79g;

    iget-object v0, v0, LX/79g;->A00:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, LX/7L3;->A01(LX/7Tj;)Lorg/json/JSONObject;
