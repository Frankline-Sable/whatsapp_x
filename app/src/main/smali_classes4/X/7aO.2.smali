...
.method public constructor <init>(JJ)V
    ...
    iput-wide p1, p0, LX/7aO;->A0G:J

    iput-wide p3, p0, LX/7aO;->A0H:J

    invoke-static {}, LX/002;->A0Q()Ljava/util/HashSet;

    move-result-object v0

    iput-object v0, p0, LX/7aO;->A0D:Ljava/util/Set;

    invoke-static {}, LX/002;->A0Q()Ljava/util/HashSet;

    move-result-object v0

    iput-object v0, p0, LX/7aO;->A0F:Ljava/util/Set;

    invoke-static {}, LX/002;->A0Q()Ljava/util/HashSet;

    move-result-object v0

    iput-object v0, p0, LX/7aO;->A0E:Ljava/util/Set;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;JJJJJJJJJJJJJJ)V
    ...
    iput-wide p5, p0, LX/7aO;->A0H:J

    iput-wide p7, p0, LX/7aO;->A0G:J

    iput-wide p9, p0, LX/7aO;->A02:J

    iput-wide p11, p0, LX/7aO;->A05:J

    iput-wide p13, p0, LX/7aO;->A03:J

    move-wide/from16 v0, p15

    iput-wide v0, p0, LX/7aO;->A04:J

    move-wide/from16 v0, p17

    iput-wide v0, p0, LX/7aO;->A0B:J

    move-wide/from16 v0, p19

    iput-wide v0, p0, LX/7aO;->A0A:J

    move-wide/from16 v0, p21

    iput-wide v0, p0, LX/7aO;->A08:J

    move-wide/from16 v0, p23

    iput-wide v0, p0, LX/7aO;->A07:J

    move-wide/from16 v0, p25

    iput-wide v0, p0, LX/7aO;->A09:J

    move-wide/from16 v0, p27

    iput-wide v0, p0, LX/7aO;->A06:J

    move-wide/from16 v0, p29

    iput-wide v0, p0, LX/7aO;->A01:J

    iput-object p2, p0, LX/7aO;->A0D:Ljava/util/Set;

    iput-object p3, p0, LX/7aO;->A0F:Ljava/util/Set;

    move-wide/from16 v0, p31

    iput-wide v0, p0, LX/7aO;->A00:J

    iput-object p4, p0, LX/7aO;->A0E:Ljava/util/Set;

    iput-object p1, p0, LX/7aO;->A0C:Ljava/lang/String;

    return-void
.end method

.method public static A00(Ljava/lang/String;)LX/7aO;
    .locals 32
    ...
    invoke-static {v1}, LX/7aO;->A01(Lorg/json/JSONArray;)Ljava/util/Set;
    ...
    invoke-direct/range {v0 .. v32}, LX/7aO;-><init>(Ljava/lang/String;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;JJJJJJJJJJJJJJ)V
