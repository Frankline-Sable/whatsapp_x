...
# direct methods
.method public constructor <init>(LX/7Yy;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, LX/7Z2;->A04:Ljava/lang/String;

    iput-object p1, p0, LX/7Z2;->A00:LX/7Yy;

    iput-object p3, p0, LX/7Z2;->A02:Ljava/lang/String;

    iput-object p4, p0, LX/7Z2;->A03:Ljava/lang/String;

    iput-object p5, p0, LX/7Z2;->A01:Ljava/lang/String;
...
.method public static A01(Ljava/lang/String;Ljava/lang/String;Ljava/text/BreakIterator;II)LX/7Z2;
    .locals 25
    ...
    invoke-static {v3, v0}, LX/7Z2;->A00([II)I
    ...
    invoke-static/range {v16 .. v16}, LX/7Zm;->A01(I)Z
    ...
    :cond_7
    invoke-static {v13}, LX/7Yy;->A00(Ljava/nio/CharBuffer;)V
    ...
    invoke-static {v1, v0}, LX/6NE;->A1H(Ljava/lang/StringBuilder;I)V

    const-string v0, " at string index "

    invoke-static {v0, v1, v14}, LX/000;->A0E(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/IllegalArgumentException;
    ...
    invoke-static {v0, v3}, LX/000;->A0D(Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/IllegalArgumentException;
    ...
    invoke-direct {v3, v0, v2, v2}, LX/7Yy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "IPFutureV6 / IPFutureAddress missing closing bracket"

    new-instance v0, LX/6wx;

    invoke-direct {v0, v3, v1}, LX/6wx;-><init>(LX/7Yy;Ljava/lang/String;)V
    ...
    move-result-object v3
    :try_end_0
    .catch LX/6wx; {:try_start_0 .. :try_end_0} :catch_3
    ...
    invoke-static {v11}, LX/7Zm;->A03(I)Z

    move-result v0

    if-nez v0, :cond_1f

    invoke-static {v11}, LX/7Zm;->A02(I)Z
    ...
    .catch LX/6wx; {:try_start_1 .. :try_end_1} :catch_3

    :try_start_2
    invoke-virtual {v4}, Ljava/text/BreakIterator;->next()I

    invoke-static {v3, v4}, LX/7Zm;->A00(Ljava/lang/String;Ljava/text/BreakIterator;)V
    :try_end_2
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2 .. :try_end_2} :catch_0
    .catch LX/6wx; {:try_start_2 .. :try_end_2} :catch_3
    ...
    invoke-static {v1, v11}, LX/6NE;->A1H(Ljava/lang/StringBuilder;I)V

    const-string v0, " at string index "

    invoke-static {v0, v1, v9}, LX/000;->A0E(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/IllegalArgumentException;
    ...
    .catch LX/6wx; {:try_start_3 .. :try_end_3} :catch_3

    :try_start_4
    move/from16 v0, v22

    invoke-static {v0, v10}, LX/0yM;->A0e(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v24

    const/16 v1, 0xa
    :try_end_4
    .catch LX/6wx; {:try_start_4 .. :try_end_4} :catch_3
    ...
    .catch LX/6wx; {:try_start_5 .. :try_end_5} :catch_3
    ...
    invoke-direct {v9, v0, v3, v1}, LX/7Yy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_a
    :try_end_6
    .catch LX/6wx; {:try_start_6 .. :try_end_6} :catch_3
    ...
    invoke-direct {v4, v0, v3, v1}, LX/7Yy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "Invalid port number"

    new-instance v0, LX/6wx;

    invoke-direct {v0, v4, v1, v5}, LX/6wx;-><init>(LX/7Yy;Ljava/lang/String;Ljava/lang/Throwable;)V

    throw v0
    :try_end_7
    .catch LX/6wx; {:try_start_7 .. :try_end_7} :catch_3
    ...
    .catch LX/6wx; {:try_start_8 .. :try_end_8} :catch_3
    ...
    invoke-direct {v4, v0, v3, v2}, LX/7Yy;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    throw v0
    :try_end_9
    .catch LX/6wx; {:try_start_9 .. :try_end_9} :catch_3

    :catch_3
    move-exception v3

    iget-object v0, v3, LX/6wx;->mAuthority:LX/7Yy;
    ...
    invoke-direct/range {v24 .. v29}, LX/7Z2;-><init>(LX/7Yy;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "Unable to parse authority"

    new-instance v2, LX/6wy;

    invoke-direct {v2, v1, v0, v3}, LX/6wy;-><init>(LX/7Z2;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v0}, LX/7Z2;->A00([II)I
    ...
    invoke-static {v3}, LX/7Zm;->A03(I)Z

    move-result v0

    if-nez v0, :cond_2c

    invoke-static {v3}, LX/7Zm;->A02(I)Z
    ...
    invoke-static {v7, v4}, LX/7Zm;->A00(Ljava/lang/String;Ljava/text/BreakIterator;)V
    :try_end_b
    ...
    invoke-static {v1, v3}, LX/6NE;->A1H(Ljava/lang/StringBuilder;I)V
    ...
    invoke-direct/range {v3 .. v8}, LX/7Z2;-><init>(LX/7Yy;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v4}, LX/7Zm;->A00(Ljava/lang/String;Ljava/text/BreakIterator;)V
    ...
    invoke-static {v0, v1, v8}, LX/000;->A0E(Ljava/lang/String;Ljava/lang/StringBuilder;I)Ljava/lang/IllegalArgumentException;
    ...
    invoke-direct/range {v8 .. v13}, LX/7Z2;-><init>(LX/7Yy;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "Uri contained invalid query string"

    new-instance v0, LX/6wy;

    invoke-direct {v0, v3, v1, v4}, LX/6wy;-><init>(LX/7Z2;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v4}, LX/7Zm;->A00(Ljava/lang/String;Ljava/text/BreakIterator;)V
...
.method public A02()Ljava/lang/String;
    ...
    iget-object v1, p0, LX/7Z2;->A04:Ljava/lang/String;
    ...
    invoke-static {v2, v1}, LX/0yH;->A1H(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    :cond_0
    iget-object v1, p0, LX/7Z2;->A00:LX/7Yy;
    ...
    invoke-virtual {v1}, LX/7Yy;->A01()Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, LX/7Z2;->A02:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p0, LX/7Z2;->A03:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, LX/7Z2;->A01:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, LX/7Z2;->A02()Ljava/lang/String;
