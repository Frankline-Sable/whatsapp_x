...
.method public BAI(Ljava/lang/Runnable;LX/8Y2;J)LX/8VG;
    ...
    iget-object v3, v4, LX/8GH;->A00:Landroid/os/Handler;
    ...
    invoke-direct {v0, p1, v4}, LX/83W;-><init>(Ljava/lang/Runnable;LX/8GH;)V

    return-object v0

    :cond_1
    invoke-virtual {v4, p1, p2}, LX/8GH;->A05(Ljava/lang/Runnable;LX/8Y2;)V
