...
.method public synthetic constructor <init>(Landroid/accounts/Account;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, LX/7pi;->A00:Landroid/accounts/Account;

    iput-object p2, p0, LX/7pi;->A01:Landroid/os/Bundle;
...
# virtual methods
.method public final BlC(Landroid/os/IBinder;)Ljava/lang/Object;
    .locals 7

    iget-object v6, p0, LX/7pi;->A00:Landroid/accounts/Account;

    const-string v5, "oauth2:https://www.googleapis.com/auth/drive.appdata"

    iget-object v4, p0, LX/7pi;->A01:Landroid/os/Bundle;
    ...
    invoke-virtual {v3, v0, v2}, LX/7dV;->A00(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v3, p1}, LX/6Z4;-><init>(Landroid/os/IBinder;)V
