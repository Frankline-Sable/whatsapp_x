...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    invoke-static {p1}, LX/7a8;->A02(Ljava/io/InputStream;)I
    ...
    iput v1, p0, LX/6sN;->A00:I

    iput-boolean v0, p0, LX/6sN;->A01:Z

    const/16 v0, 0xb

    new-array v0, v0, [[B

    iput-object v0, p0, LX/6sN;->A02:[[B
...
.method public static A02(LX/8Kz;)LX/7aT;
    .locals 2

    iget v1, p0, LX/8Kz;->A00:I
    ...
    invoke-direct {p0, v0}, LX/7aT;-><init>(I)V
    ...
    invoke-direct {v1, p0}, LX/6sN;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {p0, v0}, LX/7aT;->A03(LX/8VQ;)V

    goto :goto_0
.end method

.method public static A03(Ljava/lang/StringBuffer;LX/8KS;LX/8K5;)LX/6sN;
    .locals 2
    ...
    invoke-direct {v1, v0}, LX/6sN;-><init>([B)V

    const-string v0, "                       critical("

    invoke-virtual {p0, v0}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget-boolean v0, p2, LX/8K5;->A02:Z
...
.method public static A04(LX/8Kz;[[BI)LX/8Kx;
    .locals 10
    ...
    :pswitch_0
    invoke-virtual {p0}, LX/8Kz;->A02()[B

    move-result-object v0

    new-instance v2, LX/8Ka;

    invoke-direct {v2, v0}, LX/8Ka;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KY;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KU;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8Kd;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KL;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KQ;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KT;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KZ;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KW;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8Kc;-><init>([B)V

    return-object v2

    :pswitch_a
    invoke-static {p0, p1}, LX/6sN;->A05(LX/8Kz;[[B)[B
    ...
    invoke-direct {v2, v1}, LX/8KO;-><init>(B)V

    return-object v2

    :cond_0
    sget-object v2, LX/8KO;->A01:LX/8KO;

    return-object v2

    :cond_1
    sget-object v2, LX/8KO;->A02:LX/8KO;
    ...
    invoke-direct {v2, v1, v0}, LX/8KP;-><init>([BZ)V
    ...
    :pswitch_d
    sget-object v2, LX/8JN;->A00:LX/8JN;
    ...
    invoke-direct {v1, v3}, LX/7Lt;-><init>([B)V
    ...
    invoke-direct {v2, v3}, LX/8KR;-><init>([B)V

    return-object v2

    :pswitch_f
    iget v5, p0, LX/8Kz;->A00:I
    ...
    invoke-direct {v2, v3, v4}, LX/8JI;-><init>([BI)V
    ...
    invoke-direct {v2, v3, v4}, LX/8JJ;-><init>([BI)V
    ...
    invoke-static {v5, v0, v1}, LX/6NG;->A0G([BII)I
    ...
    invoke-direct {v2, v7}, LX/8KV;-><init>([C)V
    ...
    invoke-direct {v2, v0}, LX/8Kb;-><init>([B)V
    ...
    sget-object v1, LX/8KN;->A02:[LX/8KN;
    ...
    invoke-direct {v2, v4}, LX/8KN;-><init>([B)V
    ...
    invoke-direct {v2, v0}, LX/8KX;-><init>([B)V
...
.method public static A05(LX/8Kz;[[B)[B
    .locals 6
    ...
    iget v2, p0, LX/6sv;->A00:I

    if-ge v5, v2, :cond_5

    iget-object v2, p0, LX/6sv;->A01:Ljava/io/InputStream;
    ...
    iput v5, p0, LX/8Kz;->A00:I

    if-nez v5, :cond_4

    invoke-virtual {p0}, LX/6sv;->A01()V

    return-object v4

    :cond_4
    invoke-static {p0}, LX/8Kz;->A00(LX/8Kz;)Ljava/lang/StringBuilder;
...
.method public A06()LX/8Kx;
    ...
    :cond_1
    invoke-static {p0, v7}, LX/6sN;->A00(Ljava/io/InputStream;I)I
    ...
    invoke-static {p0, v3, v0}, LX/6sN;->A01(Ljava/io/InputStream;IZ)I
    ...
    invoke-direct {v0, p0, v3}, LX/8Ky;-><init>(Ljava/io/InputStream;I)V

    new-instance v1, LX/7No;

    invoke-direct {v1, v0, v3}, LX/7No;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-direct {v0, v1, v4}, LX/84V;-><init>(LX/7No;I)V

    invoke-virtual {v0}, LX/84V;->B2X()LX/8Kx;
    ...
    invoke-virtual {v1, v4, v0}, LX/7No;->A02(IZ)LX/8Kx;
    ...
    invoke-virtual {v0}, LX/84a;->B2X()LX/8Kx;
    ...
    invoke-virtual {v0}, LX/84Y;->B2X()LX/8Kx;
    ...
    invoke-virtual {v0}, LX/84U;->B2X()LX/8Kx;
    ...
    invoke-virtual {v0}, LX/84W;->B2X()LX/8Kx;
    ...
    invoke-direct {v2, p0, v0, v3}, LX/8Kz;-><init>(Ljava/io/InputStream;II)V
    ...
    invoke-direct {v3, v0, v4, v5}, LX/8JH;-><init>([BIZ)V
    ...
    invoke-direct {v0, v2, v1}, LX/7No;-><init>(Ljava/io/InputStream;I)V

    invoke-virtual {v0, v4, v5}, LX/7No;->A02(IZ)LX/8Kx;
    ...
    invoke-static {v2}, LX/6sN;->A02(LX/8Kz;)LX/7aT;

    move-result-object v2

    iget v1, v2, LX/7aT;->A00:I

    const/4 v0, 0x1

    if-ge v1, v0, :cond_c

    sget-object v3, LX/75m;->A01:LX/8Kn;
    ...
    invoke-direct {v3, v2}, LX/8Kl;-><init>(LX/7aT;)V
    ...
    invoke-direct {v3, v0}, LX/8Kf;-><init>([B)V
    ...
    sget-object v3, LX/75m;->A00:LX/8Kj;
    ...
    invoke-direct {v3, v2}, LX/8Kh;-><init>(LX/7aT;)V
    ...
    new-instance v3, LX/8JK;

    invoke-direct {v3, v0}, LX/8JK;-><init>(LX/7aT;)V
    ...
    iget v3, v4, LX/7aT;->A00:I

    new-array v1, v3, [LX/8KS;

    :goto_0
    if-eq v6, v3, :cond_14

    invoke-virtual {v4, v6}, LX/7aT;->A02(I)LX/8VQ;
    ...
    invoke-direct {v1, v0}, LX/6sn;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v3, v1}, LX/8KG;-><init>([LX/8KS;)V

    return-object v3

    :cond_15
    iget-object v0, p0, LX/6sN;->A02:[[B

    invoke-static {v2, v0, v4}, LX/6sN;->A04(LX/8Kz;[[BI)LX/8Kx;
