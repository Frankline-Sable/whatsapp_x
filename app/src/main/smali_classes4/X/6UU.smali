...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/6UU;->A01:Ljava/lang/Object;
...
.method public static final A00(Landroid/content/Context;Landroid/content/DialogInterface$OnCancelListener;LX/7cm;I)Landroid/app/Dialog;
    .locals 5
...
.method public static A01()LX/6UU;
    .locals 1
...
.method public static final A02(Landroid/app/Activity;Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0, p3}, Landroidx/fragment/app/DialogFragment;->A1P(LX/0eU;Ljava/lang/String;)V
    ...
    invoke-direct {v1}, LX/6NO;-><init>()V
    ...
    iput-object p1, v1, LX/6NO;->A00:Landroid/app/Dialog;

    iput-object p2, v1, LX/6NO;->A02:Landroid/content/DialogInterface$OnCancelListener;
...
# virtual methods
.method public final A06(Landroid/content/Context;LX/7Hp;)LX/6Na;
    .locals 5
    ...
    invoke-direct {v3, p2}, LX/6Na;-><init>(LX/7Hp;)V
    ...
    invoke-static {v0}, LX/6NG;->A01(Ljava/lang/String;)C
    ...
    :goto_0
    iput-object p1, v3, LX/6Na;->A00:Landroid/content/Context;

    invoke-static {p1}, LX/7bu;->A05(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {p2}, LX/7Hp;->A00()V

    invoke-virtual {v3}, LX/6Na;->A00()V
...
.method public final A07(Landroid/app/PendingIntent;Landroid/content/Context;I)V
    ...
    new-instance v2, LX/6Zn;

    invoke-direct {v2, p2, p0}, LX/6Zn;-><init>(Landroid/content/Context;LX/6UU;)V
    ...
    invoke-static {p2, v0}, LX/7bc;->A03(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p3}, LX/7bc;->A01(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v2, p2, v0}, LX/0VP;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v4, v2, LX/0VP;->A0V:Z

    invoke-virtual {v2, v4}, LX/0VP;->A0E(Z)V
    ...
    invoke-virtual {v2, v0}, LX/0VP;->A08(LX/0RO;)V

    invoke-virtual {p2}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v9

    sget-object v0, LX/7SP;->A00:Ljava/lang/Boolean;
    ...
    sput-object v0, LX/7SP;->A00:Ljava/lang/Boolean;
    ...
    iput v6, v2, LX/0VP;->A03:I

    invoke-static {p2}, LX/7SP;->A00(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v1, v0, p1}, LX/0VP;->A04(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    sget-object v1, LX/6UU;->A01:Ljava/lang/Object;
    ...
    :cond_6
    iput-object p1, v2, LX/0VP;->A0A:Landroid/app/PendingIntent;
    ...
    invoke-virtual {v2, v7}, LX/0VP;->A0A(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2}, LX/7bc;->A00(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_a
    invoke-static {p2, p3}, LX/7bc;->A02(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_b
    iput-object v8, v2, LX/0VP;->A0L:Ljava/lang/String;
    ...
    :cond_d
    sget-object v0, LX/7bu;->A02:Ljava/util/concurrent/atomic/AtomicBoolean;
