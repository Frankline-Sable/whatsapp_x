...
.method public constructor <init>(LX/8YM;)V
    ...
    invoke-direct {v0, p0}, LX/6sI;-><init>(LX/854;)V

    iput-object v0, p0, LX/854;->A04:LX/6sI;

    new-instance v0, LX/6sI;

    invoke-direct {v0, p0}, LX/6sI;-><init>(LX/854;)V

    iput-object v0, p0, LX/854;->A05:LX/6sI;

    iput-object p1, p0, LX/854;->A02:LX/8YM;

    invoke-interface {p1}, LX/8YM;->Ay0()I

    move-result v1

    iput v1, p0, LX/854;->A00:I

    new-array v0, v1, [B

    iput-object v0, p0, LX/854;->A08:[B
...
.method public final A00([B[BII)V
    ...
    iget-object v3, v1, LX/854;->A02:LX/8YM;

    iget v0, v1, LX/854;->A01:I
    ...
    invoke-direct {v9, v3}, LX/84d;-><init>(LX/8YM;)V
    ...
    iget-object v2, v1, LX/854;->A03:LX/41y;
    ...
    :cond_0
    invoke-virtual {v9}, LX/84d;->reset()V

    const/4 v12, 0x1

    invoke-virtual {v9, v2, v12}, LX/84d;->B9L(LX/41y;Z)V
    ...
    iget-object v0, v1, LX/854;->A07:[B
    ...
    iget-object v4, v1, LX/854;->A09:[B
    ...
    invoke-static {v15, v3, v0, v5}, LX/6NF;->A0z(I[BII)V
    ...
    invoke-static {v3, v4, v0}, LX/6NG;->A1C([BII)V
    ...
    iget-object v0, v9, LX/84d;->A01:LX/8YM;
    ...
    invoke-virtual {v9, v6, v7, v5, v5}, LX/84d;->BZc([B[BII)I
    ...
    invoke-virtual {v9, v3, v7, v2, v5}, LX/84d;->BZc([B[BII)I
    ...
    :goto_6
    iget-object v3, v1, LX/854;->A07:[B
    ...
    invoke-virtual {v9, v3, v7, v1, v5}, LX/84d;->BZc([B[BII)I
    ...
    invoke-virtual/range {v17 .. v17}, LX/6sI;->A00()[B
    ...
    invoke-virtual {v9, v1, v7, v11, v5}, LX/84d;->BZc([B[BII)I
...
.method public AvS([BI)I
    ...
    iget-object v8, p0, LX/854;->A05:LX/6sI;

    invoke-virtual {v8}, LX/6sI;->A00()[B
    ...
    iget-object v0, p0, LX/854;->A03:LX/41y;

    if-eqz v0, :cond_9

    iget-object v5, p0, LX/854;->A09:[B
    ...
    iget-object v6, p0, LX/854;->A02:LX/8YM;

    new-instance v5, LX/8LJ;

    invoke-direct {v5, v6}, LX/8LJ;-><init>(LX/8YM;)V

    iget-boolean v2, p0, LX/854;->A06:Z

    iget-object v1, p0, LX/854;->A03:LX/41y;

    new-instance v0, LX/84s;

    invoke-direct {v0, v1, v3}, LX/84s;-><init>(LX/41y;[B)V

    invoke-virtual {v5, v0, v2}, LX/8LJ;->B9L(LX/41y;Z)V

    iget-boolean v0, p0, LX/854;->A06:Z

    const-string v3, "Output buffer too short."

    iget v2, p0, LX/854;->A01:I
    ...
    iget-object v0, p0, LX/854;->A08:[B

    invoke-virtual {p0, v11, v0, v10, v9}, LX/854;->A00([B[BII)V

    new-array v3, v7, [B

    invoke-virtual {v5, v0, v3, v10, v10}, LX/8LJ;->BZc([B[BII)I
    ...
    invoke-virtual {v5, v11, p1, v10, v12}, LX/8LJ;->BZc([B[BII)I
    ...
    invoke-direct {v1, v3}, LX/8L8;-><init>(Ljava/lang/String;)V
    ...
    iget-object v4, p0, LX/854;->A08:[B

    invoke-static {v11, v9, v4, v10, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-virtual {v5, v4, v4, v10, v10}, LX/8LJ;->BZc([B[BII)I

    iget v1, p0, LX/854;->A01:I
    ...
    invoke-virtual {v5, v11, p1, v3, v2}, LX/8LJ;->BZc([B[BII)I
    ...
    invoke-virtual {v5, v1, v1, v10, v10}, LX/8LJ;->BZc([B[BII)I

    invoke-static {v1, v10, p1, v2, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    new-array v0, v7, [B

    invoke-virtual {p0, p1, v0, p2, v9}, LX/854;->A00([B[BII)V

    invoke-static {v4, v0}, LX/7Zx;->A01([B[B)Z
    ...
    iget-object v0, p0, LX/854;->A04:LX/6sI;
    ...
    invoke-direct {v1, v0}, LX/8L7;-><init>(Ljava/lang/String;)V
...
.method public Axg()Ljava/lang/String;
    ...
    iget-object v0, p0, LX/854;->A02:LX/8YM;
...
.method public B2e()[B
    ...
    iget v3, p0, LX/854;->A01:I

    new-array v2, v3, [B

    iget-object v1, p0, LX/854;->A08:[B
...
.method public B3h(I)I
    ...
    iget-object v0, p0, LX/854;->A05:LX/6sI;
...
.method public B9L(LX/41y;Z)V
    ...
    iput-boolean p2, p0, LX/854;->A06:Z
    ...
    iput-object v0, p0, LX/854;->A09:[B
    ...
    iput-object v0, p0, LX/854;->A07:[B

    iget v1, p1, LX/84n;->A00:I
    ...
    iput v0, p0, LX/854;->A01:I

    iget-object v0, p1, LX/84n;->A01:LX/84q;

    :goto_0
    if-eqz v0, :cond_1

    iput-object v0, p0, LX/854;->A03:LX/41y;

    :cond_1
    iget-object v0, p0, LX/854;->A09:[B
    ...
    invoke-static {p1, v0, v1}, LX/6NE;->A0X(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/IllegalArgumentException;
