...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    iput-object v0, p0, LX/7WJ;->A04:Ljava/lang/Object;
    ...
    :cond_0
    iput-object p1, p0, LX/7WJ;->A03:Landroid/content/Context;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/7WJ;->A02:Z

    iput-boolean p3, p0, LX/7WJ;->A05:Z

    return-void
.end method

.method public static A00(Landroid/content/Context;)LX/2YZ;
    .locals 23
    ...
    invoke-direct {v8, v3, v15, v0}, LX/7WJ;-><init>(Landroid/content/Context;ZZ)V
    ...
    invoke-static {v5}, LX/7bx;->A08(Ljava/lang/String;)V
    ...
    :try_start_7
    iget-boolean v0, v8, LX/7WJ;->A02:Z

    if-eqz v0, :cond_5

    invoke-virtual {v8}, LX/7WJ;->A01()V

    :cond_5
    iget-object v3, v8, LX/7WJ;->A03:Landroid/content/Context;

    iget-boolean v2, v8, LX/7WJ;->A05:Z
    :try_end_7
    ...
    invoke-virtual {v1, v3, v0}, LX/7Vr;->A04(Landroid/content/Context;I)I
    ...
    invoke-direct {v4}, LX/7cp;-><init>()V
    ...
    :try_start_a
    invoke-static {}, LX/7ZC;->A00()LX/7ZC;

    move-result-object v1

    const/4 v0, 0x1

    invoke-virtual {v1, v3, v2, v4, v0}, LX/7ZC;->A02(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    :try_start_b
    iput-object v4, v8, LX/7WJ;->A00:LX/7cp;
    :try_end_b
    ...
    invoke-static {v2}, LX/7bx;->A08(Ljava/lang/String;)V

    iget-boolean v2, v4, LX/7cp;->A00:Z

    if-nez v2, :cond_b

    const/4 v2, 0x1

    iput-boolean v2, v4, LX/7cp;->A00:Z

    iget-object v2, v4, LX/7cp;->A01:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-direct {v1, v2}, LX/7da;-><init>(Landroid/os/IBinder;)V
    :try_end_c
    ...
    :goto_9
    :try_start_d
    iput-object v1, v8, LX/7WJ;->A01:LX/8a8;

    const/4 v0, 0x1

    iput-boolean v0, v8, LX/7WJ;->A02:Z
    ...
    iget-object v1, v8, LX/7WJ;->A04:Ljava/lang/Object;
    ...
    :cond_9
    :try_start_11
    iget-object v0, v8, LX/7WJ;->A00:LX/7cp;

    invoke-static {v0}, LX/7bx;->A03(Ljava/lang/Object;)V

    iget-object v2, v8, LX/7WJ;->A01:LX/8a8;
    ...
    invoke-virtual {v2, v0, v1}, LX/7da;->A00(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    invoke-direct {v9, v3, v0}, LX/2YZ;-><init>(Ljava/lang/String;Z)V
    :try_end_13
    ...
    invoke-virtual/range {v8 .. v15}, LX/7WJ;->A02(LX/2YZ;Ljava/lang/String;Ljava/lang/Throwable;FJZ)V
    :try_end_17
    ...
    invoke-virtual/range {v16 .. v23}, LX/7WJ;->A02(LX/2YZ;Ljava/lang/String;Ljava/lang/Throwable;FJZ)V
...
.method public final A01()V
    ...
    :try_start_0
    iget-object v2, p0, LX/7WJ;->A03:Landroid/content/Context;

    if-eqz v2, :cond_1

    iget-object v0, p0, LX/7WJ;->A00:LX/7cp;
    ...
    :try_start_1
    iget-boolean v0, p0, LX/7WJ;->A02:Z
    ...
    invoke-virtual {v1, v2, v0}, LX/7ZC;->A01(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    iput-object v0, p0, LX/7WJ;->A01:LX/8a8;

    iput-object v0, p0, LX/7WJ;->A00:LX/7cp;
...
.method public final A02(LX/2YZ;Ljava/lang/String;Ljava/lang/Throwable;FJZ)V
    .locals 5
    ...
    iget-boolean v0, p1, LX/2YZ;->A01:Z
    ...
    iget-object v0, p1, LX/2YZ;->A00:Ljava/lang/String;
    ...
    invoke-static {p3}, LX/000;->A0M(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2}, LX/86C;-><init>(Ljava/util/Map;)V
...
.method public finalize()V
    ...
    invoke-virtual {p0}, LX/7WJ;->A01()V
