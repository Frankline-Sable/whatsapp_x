...
.method public static final A00(Ljava/util/Map;)Lorg/json/JSONArray;
    ...
    invoke-static {v3}, LX/0yF;->A0m(Ljava/lang/Object;)Lorg/json/JSONObject;

    move-result-object v2

    iget-object v1, v3, LX/7NR;->A01:Ljava/lang/String;
    ...
    iget-object v0, v3, LX/7NR;->A00:Ljava/lang/String;
...
# virtual methods
.method public final A01(Lorg/json/JSONObject;)LX/7WC;
    .locals 4
    ...
    invoke-virtual {p0, v2}, LX/7VO;->A02(Lorg/json/JSONArray;)Ljava/util/Map;

    move-result-object v3

    invoke-virtual {p0, v1}, LX/7VO;->A02(Lorg/json/JSONArray;)Ljava/util/Map;

    move-result-object v2

    invoke-virtual {p0, v0}, LX/7VO;->A02(Lorg/json/JSONArray;)Ljava/util/Map;

    move-result-object v1

    new-instance v0, LX/7WC;

    invoke-direct {v0, v3, v2, v1}, LX/7WC;-><init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
...
.method public final A02(Lorg/json/JSONArray;)Ljava/util/Map;
    ...
    invoke-direct {v0, v2, v1}, LX/7NR;-><init>(Ljava/lang/String;Ljava/lang/String;)V
