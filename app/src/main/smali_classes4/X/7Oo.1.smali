...
# instance fields
.field public final A00:LX/6t0;

.field public final A01:LX/6t0;

.field public final A02:Ljava/io/InputStream;


# direct methods
.method public constructor <init>(LX/6t0;Ljava/io/InputStream;)V
    .locals 1
    ...
    iput-object p2, p0, LX/7Oo;->A02:Ljava/io/InputStream;

    new-instance v0, LX/6t0;

    invoke-direct {v0}, LX/6t0;-><init>()V

    iput-object v0, p0, LX/7Oo;->A00:LX/6t0;

    iput-object p1, p0, LX/7Oo;->A01:LX/6t0;
...
# virtual methods
.method public A00()LX/79H;
    .locals 7

    const/16 v5, 0x50

    :try_start_0
    iget-object v6, p0, LX/7Oo;->A00:LX/6t0;
    ...
    invoke-virtual {v6}, LX/6t0;->A00()V
    ...
    invoke-direct {v0, v2}, LX/6nS;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nV;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nU;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nI;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nT;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nO;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nQ;-><init>([B)V
    ...
    sget-object v0, LX/7SY;->A05:[B

    invoke-static {v1, v0}, LX/7c3;->A06([B[B)Z
    ...
    invoke-direct {v0, v2}, LX/6nP;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nW;-><init>([B)V
    ...
    invoke-direct {v0, v2}, LX/6nK;-><init>([B)V
...
.method public A01()LX/79H;
    ...
    :try_start_0
    invoke-virtual {p0}, LX/7Oo;->A00()LX/79H;
    ...
    :cond_0
    invoke-virtual {p0}, LX/7Oo;->A02()Z
    ...
    iget-object v10, p0, LX/7Oo;->A01:LX/6t0;
    ...
    invoke-static {v0}, LX/7c3;->A00(Ljava/nio/ByteBuffer;)I
    ...
    :pswitch_0
    iget-object v0, p0, LX/7Oo;->A00:LX/6t0;
    ...
    invoke-direct {v1, v5}, LX/6nG;-><init>([B)V
    ...
    invoke-direct {v1, v5}, LX/6nF;-><init>([B)V
    ...
    invoke-virtual {v0, v5, v7, v6}, LX/6t0;->Aqc([BII)V
    ...
    invoke-static {v2, v9, v0, v1, v6}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V
    ...
    invoke-static {v2, v9, v0, v1, v5}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V
    ...
    iget-object v0, p0, LX/7Oo;->A02:Ljava/io/InputStream;
    ...
    iget-object v0, p0, LX/7Oo;->A01:LX/6t0;

    invoke-virtual {v0, v2, v7, v1}, LX/6t0;->Aqc([BII)V
    ...
    invoke-direct {v1, v0, v3, v4}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;BZ)V
    ...
    invoke-direct {v0, v1, v3, v4}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;BZ)V
    ...
    :try_start_2
    invoke-virtual {v6}, LX/7Oo;->A00()LX/79H;
    ...
    :cond_8
    invoke-virtual {v6}, LX/7Oo;->A02()Z
    ...
    iget-object v1, v6, LX/7Oo;->A01:LX/6t0;
    ...
    :cond_a
    iget-object v2, v6, LX/6nZ;->A01:LX/8Pe;

    iget-wide v0, v6, LX/6nZ;->A00:J

    check-cast v2, LX/7vz;

    iget-object v12, v2, LX/7vz;->A02:[B

    invoke-static {v12, v0, v1}, LX/7vy;->A00([BJ)[B
    ...
    :try_start_5
    iget-object v12, v2, LX/7vz;->A00:Ljavax/crypto/Cipher;

    iget-object v1, v2, LX/7vz;->A01:Ljavax/crypto/SecretKey;

    const/4 v0, 0x2

    invoke-virtual {v12, v0, v1, v13}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V

    iget-object v0, v2, LX/7vz;->A00:Ljavax/crypto/Cipher;
    ...
    invoke-static {v9, v0}, LX/0yE;->A05(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :pswitch_3
    iget-object v0, v6, LX/7Oo;->A00:LX/6t0;
    ...
    invoke-direct {v1, v2}, LX/6nG;-><init>([B)V
    ...
    invoke-direct {v1, v2}, LX/6nF;-><init>([B)V

    return-object v1

    :pswitch_5
    iget-object v1, v6, LX/7Oo;->A00:LX/6t0;

    array-length v0, v2

    invoke-virtual {v1, v2, v5, v0}, LX/6t0;->Aqc([BII)V
    ...
    invoke-static {v2, v12, v0, v1, v7}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V
    ...
    invoke-static {v2, v12, v0, v7, v8}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V
    ...
    iget-object v0, v6, LX/7Oo;->A02:Ljava/io/InputStream;
    ...
    iget-object v0, v6, LX/7Oo;->A01:LX/6t0;

    invoke-virtual {v0, v2, v5, v1}, LX/6t0;->Aqc([BII)V
    ...
    invoke-direct {v1, v2, v0}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;B)V
...
.method public A02()Z
    ...
    :try_start_0
    iget-object v6, p0, LX/7Oo;->A01:LX/6t0;
    ...
    invoke-static {v1}, LX/7c3;->A00(Ljava/nio/ByteBuffer;)I

    move-result v2

    sget-object v1, LX/74j;->A00:Ljava/util/HashSet;
    ...
    invoke-static {v5}, LX/7c3;->A04([B)Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v0, v3}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;BZ)V
