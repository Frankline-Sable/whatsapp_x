...
.method public static constructor <clinit>()V
    ...
    sput-object v2, LX/84y;->A07:Ljava/util/Hashtable;
    ...
    sget-object v2, LX/84y;->A07:Ljava/util/Hashtable;
    ...
    sget-object v1, LX/84y;->A07:Ljava/util/Hashtable;
...
.method public constructor <init>(LX/8YY;)V
    ...
    invoke-interface {v0}, LX/8dD;->AyJ()I
    ...
    iput-object p1, p0, LX/84y;->A02:LX/8YY;

    invoke-interface {p1}, LX/8YY;->B0P()I

    move-result v1

    iput v1, p0, LX/84y;->A01:I

    iput v2, p0, LX/84y;->A00:I

    new-array v0, v2, [B

    iput-object v0, p0, LX/84y;->A05:[B

    add-int/2addr v2, v1

    new-array v0, v2, [B

    iput-object v0, p0, LX/84y;->A06:[B
    ...
    invoke-interface {p1}, LX/8YY;->Axg()Ljava/lang/String;
...
.method public AvS([BI)I
    ...
    iget-object v6, p0, LX/84y;->A02:LX/8YY;

    iget-object v5, p0, LX/84y;->A06:[B

    iget v4, p0, LX/84y;->A00:I

    invoke-interface {v6, v5, v4}, LX/8YY;->AvS([BI)I

    iget-object v1, p0, LX/84y;->A04:LX/8Wy;
    ...
    invoke-interface {v0, v1}, LX/8Wy;->Bbw(LX/8Wy;)V

    invoke-interface {v6}, LX/8YY;->B0P()I

    move-result v0

    invoke-interface {v6, v5, v4, v0}, LX/8YY;->update([BII)V

    :goto_0
    invoke-interface {v6, p1, p2}, LX/8YY;->AvS([BI)I
    ...
    invoke-interface {v6, v5, v3, v0}, LX/8YY;->update([BII)V

    goto :goto_0

    :cond_1
    iget-object v0, p0, LX/84y;->A03:LX/8Wy;

    if-eqz v0, :cond_2

    check-cast v6, LX/8Wy;

    invoke-interface {v6, v0}, LX/8Wy;->Bbw(LX/8Wy;)V

    return v2

    :cond_2
    iget-object v1, p0, LX/84y;->A05:[B

    array-length v0, v1

    invoke-interface {v6, v1, v3, v0}, LX/8YY;->update([BII)V
...
.method public B9K(LX/41y;)V
    ...
    iget-object v1, p1, LX/84q;->A00:[B

    array-length v0, v1

    iget v7, p0, LX/84y;->A00:I

    const/4 v5, 0x0

    if-le v0, v7, :cond_0

    invoke-interface {v6, v1, v5, v0}, LX/8YY;->update([BII)V

    iget-object v4, p0, LX/84y;->A05:[B
    ...
    :cond_1
    iget-object v2, p0, LX/84y;->A06:[B
    ...
    invoke-static {v2, v0, v1}, LX/6NG;->A0E([BII)I
    ...
    invoke-interface {v0}, LX/8Wy;->At8()LX/8Wy;

    move-result-object v0

    iput-object v0, p0, LX/84y;->A04:LX/8Wy;

    check-cast v0, LX/8YY;

    invoke-interface {v0, v2, v5, v7}, LX/8YY;->update([BII)V
    ...
    invoke-interface {v6}, LX/8Wy;->At8()LX/8Wy;

    move-result-object v0

    iput-object v0, p0, LX/84y;->A03:LX/8Wy;
...
.method public BjV(B)V
    ...
    iget-object v0, p0, LX/84y;->A02:LX/8YY;
...
.method public reset()V
    ...
    iget-object v3, p0, LX/84y;->A02:LX/8YY;

    invoke-interface {v3}, LX/8YY;->reset()V

    iget-object v2, p0, LX/84y;->A05:[B
