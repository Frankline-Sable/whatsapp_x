...
.method public constructor <init>(Landroid/view/View;Lcom/gbwhatsapp/catalogcategory/view/CategoryThumbnailLoader;)V
    ...
    iput-object p2, p0, LX/6iy;->A00:Lcom/gbwhatsapp/catalogcategory/view/CategoryThumbnailLoader;

    new-instance v1, LX/8C6;

    invoke-direct {v1, p1}, LX/8C6;-><init>(Landroid/view/View;)V

    new-instance v0, LX/831;

    invoke-direct {v0, v1}, LX/831;-><init>(LX/8cU;)V

    iput-object v0, p0, LX/6iy;->A03:LX/8Wp;

    new-instance v1, LX/8C4;

    invoke-direct {v1, p1}, LX/8C4;-><init>(Landroid/view/View;)V

    new-instance v0, LX/831;

    invoke-direct {v0, v1}, LX/831;-><init>(LX/8cU;)V

    iput-object v0, p0, LX/6iy;->A01:LX/8Wp;

    new-instance v1, LX/8C5;

    invoke-direct {v1, p1}, LX/8C5;-><init>(Landroid/view/View;)V

    new-instance v0, LX/831;

    invoke-direct {v0, v1}, LX/831;-><init>(LX/8cU;)V

    iput-object v0, p0, LX/6iy;->A02:LX/8Wp;
