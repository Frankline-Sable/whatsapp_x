...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/7X0;->A00:Ljava/util/Set;
...
# virtual methods
.method public A01(LX/6VI;)LX/6VI;
    .locals 6

    instance-of v0, p0, LX/6V9;
    ...
    iget-object v1, v0, LX/6V9;->A00:LX/7pz;

    const/4 v0, 0x1

    invoke-virtual {v1, p1, v0}, LX/7pz;->A03(LX/6VI;I)V
    ...
    iget-object v2, p1, LX/6VI;->A01:LX/7De;

    iget-object v1, v5, LX/6VA;->A0G:Ljava/util/Map;

    iget-object v0, p1, LX/6VI;->A00:LX/6zO;

    invoke-interface {v1, v0}, Ljava/util/Map;->containsKey(Ljava/lang/Object;)Z

    move-result v3

    iget-object v2, v2, LX/7De;->A02:Ljava/lang/String;
    ...
    iget-object v4, v5, LX/6VA;->A0J:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v4}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v1, v5, LX/6VA;->A01:LX/8Yh;

    if-eqz v1, :cond_3

    iget-boolean v0, v5, LX/6VA;->A0K:Z

    if-eqz v0, :cond_1

    iget-object v3, v5, LX/6VA;->A0I:Ljava/util/Queue;
    ...
    iget-object v1, v5, LX/6VA;->A0B:LX/7TJ;
    ...
    invoke-virtual {v2, v0}, LX/6VI;->A01(Lcom/google/android/gms/common/api/Status;)V

    goto :goto_0

    :cond_1
    invoke-interface {v1, p1}, LX/8Yh;->Bkx(LX/6VI;)LX/6VI;
...
.method public A02()V
    ...
    iget-object v5, v6, LX/6VA;->A0J:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v5}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v0, v6, LX/6VA;->A0B:LX/7TJ;

    iget-object v9, v0, LX/7TJ;->A01:Ljava/util/Set;
    ...
    :cond_3
    iget-object v0, v6, LX/6VA;->A01:LX/8Yh;

    if-eqz v0, :cond_4

    invoke-interface {v0}, LX/8Yh;->Bl3()V

    :cond_4
    iget-object v0, v6, LX/6VA;->A09:LX/77k;

    iget-object v3, v0, LX/77k;->A00:Ljava/util/Set;
    ...
    iget-object v4, v6, LX/6VA;->A0I:Ljava/util/Queue;
    ...
    invoke-virtual {v6}, LX/6VA;->A08()Z

    iget-object v1, v6, LX/6VA;->A0E:LX/7dD;

    const/4 v0, 0x0

    iput-boolean v0, v1, LX/7dD;->A08:Z

    iget-object v0, v1, LX/7dD;->A07:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public A03(LX/6VI;)V
    ...
    iget-object v1, v4, LX/6VA;->A0G:Ljava/util/Map;
    ...
    iget-object v1, v4, LX/6VA;->A0J:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v0, v4, LX/6VA;->A01:LX/8Yh;

    if-nez v0, :cond_1

    iget-object v0, v4, LX/6VA;->A0I:Ljava/util/Queue;
    ...
    :cond_1
    invoke-interface {v0, p1}, LX/8Yh;->Bku(LX/6VI;)LX/6VI;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public A04()Z
    ...
    iget-object v0, v0, LX/6VA;->A01:LX/8Yh;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/8Yh;->Bl6()Z
