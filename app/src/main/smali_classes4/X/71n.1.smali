...
# direct methods
.method public static A00(Landroid/content/Context;LX/35z;)V
    .locals 7
    ...
    invoke-direct {v3, p0}, LX/0Wc;-><init>(Landroid/content/Context;)V

    new-instance v5, LX/7iv;

    invoke-direct {v5, v3, p1}, LX/7iv;-><init>(LX/0Wc;LX/35z;)V

    iget v2, v3, LX/0Wc;->A00:I

    const/4 v0, 0x2

    if-ne v2, v0, :cond_0

    iget-object v0, v3, LX/0Wc;->A02:Lcom/google/android/finsky/externalreferrer/IGetInstallReferrerService;

    if-eqz v0, :cond_0

    iget-object v1, v3, LX/0Wc;->A01:Landroid/content/ServiceConnection;
    ...
    invoke-virtual {v5, v4}, LX/7iv;->BNS(I)V
    ...
    iget-object v2, v3, LX/0Wc;->A03:Landroid/content/Context;
    ...
    invoke-direct {v0, v3, v5}, LX/0Zv;-><init>(LX/0Wc;LX/0tx;)V

    iput-object v0, v3, LX/0Wc;->A01:Landroid/content/ServiceConnection;
