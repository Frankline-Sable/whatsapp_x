...
# direct methods
.method public static A00(LX/7w0;[BZ)V
    .locals 14
    ...
    invoke-direct {v6, v0}, LX/7WF;-><init>([B)V

    const/16 v0, 0x2b

    invoke-virtual {v6, v0}, LX/7WF;->A00(S)LX/7JM;
    ...
    sget-object v2, LX/7SY;->A01:Ljava/util/Set;

    iget-object v5, v0, LX/7JM;->A01:[B

    invoke-static {v5}, LX/7c3;->A02([B)I
    ...
    iget-object v0, p0, LX/7w0;->A0n:[B

    const/16 v8, 0x2f

    if-eqz v0, :cond_0

    invoke-static {v5, v0}, LX/7c3;->A06([B[B)Z
    ...
    invoke-static {v0, v8}, LX/6x0;->A01(Ljava/lang/String;B)LX/6x0;
    ...
    sget-object v2, LX/7SY;->A03:Ljava/util/Set;

    :goto_0
    iget-object v0, v6, LX/7WF;->A03:Ljava/util/Map;
    ...
    :cond_1
    sget-object v2, LX/7SY;->A04:Ljava/util/Set;

    goto :goto_0

    :cond_2
    sget-object v10, LX/7SY;->A00:Ljava/lang/Short;
    ...
    invoke-static {v0, v12}, LX/7c3;->A06([B[B)Z

    move-result v0

    if-eqz v0, :cond_e

    iget-short v0, p0, LX/7w0;->A0V:S
    ...
    iput-object v0, p0, LX/7w0;->A0m:[B
    ...
    iput-boolean v0, p0, LX/7w0;->A0b:Z

    iput-boolean v0, p0, LX/7w0;->A0g:Z

    :cond_5
    if-eqz p2, :cond_6

    iput-object v5, p0, LX/7w0;->A0n:[B

    iput-short v7, p0, LX/7w0;->A0V:S

    iput-short v4, p0, LX/7w0;->A0W:S
    ...
    iput-object v0, p0, LX/7w0;->A0k:[B
    ...
    invoke-static {v0, v9, v1, v8, v3}, LX/0yE;->A0t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;II)V
    ...
    invoke-static {v0, v9, v1, v11}, LX/0yH;->A1E(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;I)V

    invoke-static {v10, v1}, LX/000;->A0P(Ljava/lang/Object;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-direct {v2, v1, v0}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;B)V
