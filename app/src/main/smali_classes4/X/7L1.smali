...
.method public A00([BIIB)V
    ...
    iget-boolean v0, v5, LX/6na;->A01:Z

    if-nez v0, :cond_0

    iput-boolean v4, v5, LX/6na;->A01:Z
    ...
    invoke-static {p3, v2}, LX/7c3;->A05(ILjava/nio/ByteBuffer;)V

    invoke-virtual {v2, p1, p2, p3}, Ljava/nio/ByteBuffer;->put([BII)Ljava/nio/ByteBuffer;

    iget-object v1, v5, LX/6na;->A00:Ljava/io/OutputStream;
    ...
    iget-object v11, v7, LX/6nb;->A01:LX/8Pe;
    ...
    invoke-static {v0, v8}, LX/7c3;->A05(ILjava/nio/ByteBuffer;)V

    iget-wide v0, v7, LX/6nb;->A00:J
    ...
    iget-object v2, v11, LX/7vz;->A02:[B

    invoke-static {v2, v0, v1}, LX/7vy;->A00([BJ)[B
    ...
    :try_start_2
    iget-object v2, v11, LX/7vz;->A00:Ljavax/crypto/Cipher;

    iget-object v1, v11, LX/7vz;->A01:Ljavax/crypto/SecretKey;

    const/4 v0, 0x1

    invoke-virtual {v2, v0, v1, v4}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V

    iget-object v0, v11, LX/7vz;->A00:Ljavax/crypto/Cipher;
    ...
    iget-wide v4, v7, LX/6nb;->A00:J

    const-wide/16 v0, 0x1

    add-long/2addr v4, v0

    iput-wide v4, v7, LX/6nb;->A00:J
    ...
    iget-object v1, v7, LX/6nb;->A02:Ljava/io/OutputStream;
    ...
    invoke-direct {v2, v1, v3, v0}, LX/6x0;-><init>(Ljavax/net/ssl/SSLException;BZ)V
...
.method public declared-synchronized A01([BIIB)V
    ...
    invoke-virtual {p0, p1, p2, v0, p4}, LX/7L1;->A00([BIIB)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, LX/7L1;->A00([BIIB)V
    :try_end_0
