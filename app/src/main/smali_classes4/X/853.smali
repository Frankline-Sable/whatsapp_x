...
.method public constructor <init>(LX/8YM;)V
    ...
    iput-object v0, p0, LX/853;->A04:[B

    iput-object v0, p0, LX/853;->A05:[B

    const/4 v0, 0x0

    iput-object v0, p0, LX/853;->A03:[B

    iput-object p1, p0, LX/853;->A00:LX/8YM;
...
.method public Axg()Ljava/lang/String;
    ...
    iget-object v0, p0, LX/853;->A00:LX/8YM;
...
.method public B9L(LX/41y;Z)V
    ...
    iput-boolean p2, p0, LX/853;->A02:Z
    ...
    iput-object p1, p0, LX/853;->A01:LX/84q;

    iget-object v0, p0, LX/853;->A04:[B
    ...
    iput-object v1, p0, LX/853;->A05:[B

    iget-object v0, p1, LX/84s;->A00:LX/41y;

    check-cast v0, LX/84q;

    iput-object v0, p0, LX/853;->A01:LX/84q;
...
.method public BjT([BII)[B
    ...
    iget-boolean v0, v10, LX/853;->A02:Z
    ...
    iget-object v2, v10, LX/853;->A00:LX/8YM;

    iget-object v0, v10, LX/853;->A01:LX/84q;

    invoke-interface {v2, v0, v6}, LX/8YM;->B9L(LX/41y;Z)V
    ...
    invoke-interface {v2, v4, v3, v1, v1}, LX/8YM;->BZc([B[BII)I
    ...
    iget-object v13, v10, LX/853;->A00:LX/8YM;

    iget-object v0, v10, LX/853;->A01:LX/84q;

    invoke-interface {v13, v0, v6}, LX/8YM;->B9L(LX/41y;Z)V
    ...
    invoke-static {v2, v14, v0, v1}, LX/6NG;->A0x(I[BII)V
    ...
    :cond_3
    invoke-interface {v13, v14, v14, v6, v6}, LX/8YM;->BZc([B[BII)I
    ...
    iput-object v15, v10, LX/853;->A03:[B
    ...
    invoke-static {v3, v2, v0, v1}, LX/6NE;->A0E([BIII)I

    move-result v4

    iget-object v0, v10, LX/853;->A05:[B

    invoke-static {v9, v0}, LX/7Zx;->A01([B[B)Z
...
.method public BkU([BII)[B
    ...
    iget-boolean v0, p0, LX/853;->A02:Z
    ...
    invoke-static {v2, v6, v3}, LX/7bO;->A02([BII)V

    iget-object v1, p0, LX/853;->A05:[B
    ...
    iget-object v0, p0, LX/853;->A05:[B
    ...
    iget-object v1, p0, LX/853;->A00:LX/8YM;

    iget-object v0, p0, LX/853;->A01:LX/84q;

    invoke-interface {v1, v0, v3}, LX/8YM;->B9L(LX/41y;Z)V

    :cond_1
    invoke-interface {v1, v2, v2, v12, v12}, LX/8YM;->BZc([B[BII)I

    invoke-interface {v1}, LX/8YM;->Ay0()I
    ...
    :cond_2
    iget-object v11, p0, LX/853;->A00:LX/8YM;

    iget-object v1, p0, LX/853;->A01:LX/84q;

    new-instance v0, LX/84s;

    invoke-direct {v0, v1, v7}, LX/84s;-><init>(LX/41y;[B)V

    iget-object v2, v0, LX/84s;->A01:[B
    ...
    invoke-interface {v11, v1, v3}, LX/8YM;->B9L(LX/41y;Z)V
    ...
    invoke-interface {v11, v7, v7, v12, v12}, LX/8YM;->BZc([B[BII)I
    ...
    invoke-static {v2, v7, v0, v1}, LX/6NG;->A0x(I[BII)V
