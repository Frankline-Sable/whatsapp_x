...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Bundle;Landroid/os/Looper;LX/8bL;LX/8bM;LX/7Gq;)V
    .locals 8
    ...
    iput-object p6, p0, LX/6Vs;->A01:LX/7Gq;

    iput-object p2, p0, LX/6Vs;->A00:Landroid/os/Bundle;

    iget-object v0, p6, LX/7Gq;->A00:Ljava/lang/Integer;

    iput-object v0, p0, LX/6Vs;->A02:Ljava/lang/Integer;

    return-void
.end method

.method public static A00(LX/7Gq;)Landroid/os/Bundle;
    .locals 4

    iget-object v2, p0, LX/7Gq;->A00:Ljava/lang/Integer;
...
.method public final Bkt(LX/8aV;)V
    .locals 7
    ...
    invoke-static {v0}, LX/7aV;->A00(Landroid/content/Context;)LX/7aV;
    ...
    :goto_0
    iget-object v0, p0, LX/6Vs;->A02:Ljava/lang/Integer;
    ...
    invoke-direct {v0, v6, v3, v1, v2}, LX/6Wd;-><init>(Landroid/accounts/Account;Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;II)V

    invoke-virtual {p0}, LX/7Ze;->A02()Landroid/os/IInterface;
    ...
    invoke-direct {v2, v0, v5}, LX/6W9;-><init>(LX/6Wd;I)V
    ...
    invoke-virtual {v2, v1, v0}, LX/6W9;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-direct {v0, v1, v4, v5}, LX/6WX;-><init>(LX/6Y7;LX/6XJ;I)V

    invoke-interface {p1, v0}, LX/8aV;->Bkq(LX/6WX;)V
