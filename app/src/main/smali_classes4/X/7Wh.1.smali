...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/7Wh;->A05:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    sput-object v0, LX/7Wh;->A06:LX/7Ix;
...
.method public constructor <init>(IZ)V
    ...
    iput p1, p0, LX/7Wh;->A00:I

    iput-boolean p2, p0, LX/7Wh;->A03:Z

    add-int/lit8 v2, p1, -0x1

    iput v2, p0, LX/7Wh;->A01:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object v0, p0, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final A00(Ljava/lang/Object;)I
    ...
    sget-object v10, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    iget-boolean v0, v11, LX/7Wh;->A03:Z

    const v2, 0x3fffffff    # 1.9999999f

    if-nez v0, :cond_4

    iget-object v1, v11, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-virtual {v11}, LX/7Wh;->A01()J

    move-result-wide v0

    invoke-virtual {v11, v0, v1}, LX/7Wh;->A03(J)LX/7Wh;

    move-result-object v11

    iget-object v3, v11, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v2, v11, LX/7Wh;->A01:I
...
.method public final A01()J
    ...
    sget-object v7, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method public final A02()Ljava/lang/Object;
    ...
    sget-object v12, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    :cond_1
    invoke-static {v14, v15}, LX/6NF;->A0C(J)I
    ...
    iget-object v4, v13, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    iget-boolean v0, v13, LX/7Wh;->A03:Z
    ...
    :cond_4
    iget-boolean v4, v13, LX/7Wh;->A03:Z
    ...
    invoke-virtual {v13}, LX/7Wh;->A01()J

    move-result-wide v4

    invoke-virtual {v13, v4, v5}, LX/7Wh;->A03(J)LX/7Wh;
    ...
    iget-object v1, v13, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final A03(J)LX/7Wh;
    .locals 8

    sget-object v7, LX/7Wh;->A05:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    invoke-direct {v5, v1, v0}, LX/7Wh;-><init>(IZ)V

    invoke-static {p1, p2}, LX/6NF;->A0C(J)I
    ...
    iget-object v0, p0, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    invoke-direct {v2, v4}, LX/79s;-><init>(I)V

    :cond_1
    iget-object v1, v5, LX/7Wh;->A02:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget v0, v5, LX/7Wh;->A01:I
    ...
    :cond_2
    sget-object v4, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    invoke-static {p0, v6, v5, v7}, LX/0HY;->A00(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;)Z
...
.method public final A04()Z
    ...
    sget-object v8, LX/7Wh;->A04:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
